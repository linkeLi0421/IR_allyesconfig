; ModuleID = '/llk/IR_all_yes/arch/arm/crypto/sha1-ce-glue.c_pt.bc'
...
@__UNIQUE_ID_description173 = internal constant [71 x i8] c"sha1_arm_ce.description=SHA1 secure hash using ARMv8 Crypto Extensions\00", section ".modinfo", align 1
@__UNIQUE_ID_author174 = internal constant [62 x i8] c"sha1_arm_ce.author=Ard Biesheuvel <ard.biesheuvel@linaro.org>\00", section ".modinfo", align 1
@__UNIQUE_ID_file175 = internal constant [45 x i8] c"sha1_arm_ce.file=arch/arm/crypto/sha1-arm-ce\00", section ".modinfo", align 1
@__UNIQUE_ID_license176 = internal constant [27 x i8] c"sha1_arm_ce.license=GPL v2\00", section ".modinfo", align 1
@alg = internal global %struct.shash_alg { ptr @sha1_base_init, ptr @sha1_ce_update, ptr @sha1_ce_final, ptr @sha1_ce_finup, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, i32 96, [84 x i8] undef, i32 20, i32 0, [120 x i8] undef, %struct.crypto_alg { %struct.list_head zeroinitializer, %struct.list_head zeroinitializer, i32 0, i32 64, i32 0, i32 0, i32 200, %struct.refcount_struct zeroinitializer, [128 x i8] c"sha1\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", [128 x i8] c"sha1-ce\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null, %union.anon zeroinitializer, ptr null, ptr null, ptr null, ptr null, %union.anon.44 zeroinitializer, [120 x i8] undef } }, align 128
@__initcall__kmod_sha1_arm_ce__177_91_cpu_feature_match_SHA1_init6 = internal global ptr @cpu_feature_match_SHA1_init, section ".initcall6.init", align 4
@__exitcall_sha1_ce_mod_fini = internal global ptr @sha1_ce_mod_fini, section ".exitcall.exit", align 4
@elf_hwcap2 = external dso_local local_unnamed_addr global i32, align 4
@llvm.compiler.used = appending global [7 x ptr] [ptr @__UNIQUE_ID_author174, ptr @__UNIQUE_ID_description173, ptr @__UNIQUE_ID_file175, ptr @__UNIQUE_ID_license176, ptr @__exitcall_sha1_ce_mod_fini, ptr @__initcall__kmod_sha1_arm_ce__177_91_cpu_feature_match_SHA1_init6, ptr @sha1_ce_mod_fini], section "llvm.metadata"
@llvm.used = appending global [1 x ptr] [ptr @asan.module_ctor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal void @sha1_ce_mod_fini() #0 section ".exit.text" align 64 {
entry:
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @cpu_feature_match_SHA1_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
...
if.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #7
  %call.i = tail call i32 @crypto_register_shash(ptr noundef nonnull @alg) #5
  br label %return
...
define internal i32 @sha1_ce_update(ptr noundef %desc, ptr noundef %data, i32 noundef %len) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %__ctx.i = getelementptr inbounds %struct.shash_desc, ptr %desc, i32 0, i32 2
...
if.then7.i:                                       ; preds = %if.then.i
  ...
  tail call void @sha1_ce_transform(ptr noundef %__ctx.i, ptr noundef %buffer.i, i32 noundef 1) #5
  br label %if.end.i
...
if.then14.i:                                      ; preds = %if.end.i
  ...
  tail call void @sha1_ce_transform(ptr noundef %__ctx.i, ptr noundef %data.addr.0.i, i32 noundef %div1.i) #5
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sha1_ce_final(ptr noundef %desc, ptr noundef %out) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @sha1_ce_finup(ptr noundef %desc, ptr noundef null, i32 noundef 0, ptr noundef %out)
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sha1_ce_finup(ptr noundef %desc, ptr noundef %data, i32 noundef %len, ptr noundef %out) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = tail call i32 @llvm.read_register.i32(metadata !13) #5
...
if.then7.i:                                       ; preds = %if.then.i
  ...
  %add.ptr8.i = getelementptr i8, ptr %data, i32 %sub.i
  %sub9.i = sub i32 %len, %sub.i
  tail call void @sha1_ce_transform(ptr noundef %__ctx.i.i, ptr noundef %buffer.i, i32 noundef 1) #5
  br label %if.end.i
...
if.then14.i:                                      ; preds = %if.end.i
  call void @__sanitizer_cov_trace_pc() #7
  %div1.i = lshr i32 %len.addr.0.i, 6
  tail call void @sha1_ce_transform(ptr noundef %__ctx.i.i, ptr noundef %data.addr.0.i, i32 noundef %div1.i) #5
  %mul.i = and i32 %len.addr.0.i, -64
  %add.ptr15.i = getelementptr i8, ptr %data.addr.0.i, i32 %mul.i
  br label %if.end17.i
...
if.then.i20:                                      ; preds = %if.end4
  ...
  tail call void @sha1_ce_transform(ptr noundef %__ctx.i.i14, ptr noundef %buffer.i15, i32 noundef 1) #5
  br label %sha1_base_do_finalize.exit
...
!1 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 22, i32 1}
!2 = !{ptr @__UNIQUE_ID_author174, !3, !"__UNIQUE_ID_author174", i1 false, i1 false}
!3 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 23, i32 1}
!4 = !{ptr @__UNIQUE_ID_file175, !5, !"__UNIQUE_ID_file175", i1 false, i1 false}
!5 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 24, i32 1}
!6 = !{ptr @__UNIQUE_ID_license176, !5, !"__UNIQUE_ID_license176", i1 false, i1 false}
!7 = !{ptr @__initcall__kmod_sha1_arm_ce__177_91_cpu_feature_match_SHA1_init6, !8, !"__initcall__kmod_sha1_arm_ce__177_91_cpu_feature_match_SHA1_init6", i1 false, i1 false}
!8 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 91, i32 1}
!9 = !{ptr @__exitcall_sha1_ce_mod_fini, !10, !"__exitcall_sha1_ce_mod_fini", i1 false, i1 false}
!10 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 92, i32 1}
!11 = !{ptr @alg, !12, !"alg", i1 false, i1 false}
!12 = !{!"../arch/arm/crypto/sha1-ce-glue.c", i32 65, i32 25}
!13 = !{!"sp"}
