; ModuleID = '/llk/IR_all_yes/arch/arm/crypto/sha2-ce-glue.c_pt.bc'
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @cpu_feature_match_SHA2_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
...
if.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #7
  %call.i = tail call i32 @crypto_register_shashes(ptr noundef nonnull @algs, i32 noundef 2) #5
  br label %return

return:                                           ; preds = %if.end, %entry.return_crit_edge
  %retval.0 = phi i32 [ %call.i, %if.end ], [ -19, %entry.return_crit_edge ]
  ret i32 %retval.0
}
...
define internal i32 @sha224_base_init(ptr nocapture noundef writeonly %desc) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
...
define internal i32 @sha2_ce_update(ptr noundef %desc, ptr noundef %data, i32 noundef %len) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %__ctx.i = getelementptr inbounds %struct.shash_desc, ptr %desc, i32 0, i32 2
...
if.then:                                          ; preds = %lor.lhs.false.if.then_crit_edge, %entry.if.then_crit_edge
  %call3 = tail call i32 @crypto_sha256_arm_update(ptr noundef %desc, ptr noundef %data, i32 noundef %len) #5
  br label %cleanup
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  br i1 %cmp.i, label %if.then.i, label %if.end.if.end17.i_crit_edge, !prof !23
...
if.then7.i:                                       ; preds = %if.then.i
  ...
  tail call void @sha2_ce_transform(ptr noundef %__ctx.i, ptr noundef %buf.i, i32 noundef 1) #5
  br label %if.end.i
...
if.then14.i:                                      ; preds = %if.end.i
  ...
  tail call void @sha2_ce_transform(ptr noundef %__ctx.i, ptr noundef %data.addr.0.i, i32 noundef %div1.i) #5
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sha2_ce_final(ptr noundef %desc, ptr noundef %out) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @sha2_ce_finup(ptr noundef %desc, ptr noundef null, i32 noundef 0, ptr noundef %out)
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sha2_ce_finup(ptr noundef %desc, ptr noundef %data, i32 noundef %len, ptr noundef %out) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = tail call i32 @llvm.read_register.i32(metadata !13) #5
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #7
  %call1 = tail call i32 @crypto_sha256_arm_finup(ptr noundef %desc, ptr noundef %data, i32 noundef %len, ptr noundef %out) #5
  br label %return
...
if.then2:                                         ; preds = %if.end
  ...
  call void @__sanitizer_cov_trace_const_cmp4(i32 63, i32 %add3.i)
  %cmp.i = icmp ugt i32 %add3.i, 63
  br i1 %cmp.i, label %if.then.i, label %if.then2.if.then19.i_crit_edge, !prof !23
...
if.then7.i:                                       ; preds = %if.then.i
  ...
  %add.ptr8.i = getelementptr i8, ptr %data, i32 %sub.i
  %sub9.i = sub i32 %len, %sub.i
  tail call void @sha2_ce_transform(ptr noundef %__ctx.i.i, ptr noundef %buf.i, i32 noundef 1) #5
  br label %if.end.i
...
if.then14.i:                                      ; preds = %if.end.i
  call void @__sanitizer_cov_trace_pc() #7
  %div1.i = lshr i32 %len.addr.0.i, 6
  tail call void @sha2_ce_transform(ptr noundef %__ctx.i.i, ptr noundef %data.addr.0.i, i32 noundef %div1.i) #5
  %mul.i = and i32 %len.addr.0.i, -64
  %add.ptr15.i = getelementptr i8, ptr %data.addr.0.i, i32 %mul.i
  br label %if.end17.i
...
if.then.i20:                                      ; preds = %if.end4
  ...
  tail call void @sha2_ce_transform(ptr noundef %__ctx.i.i14, ptr noundef %buf.i15, i32 noundef 1) #5
  br label %sha256_base_do_finalize.exit
...
sha256_base_finish.exit:                          ; preds = %for.body.i.sha256_base_finish.exit_crit_edge, %sha256_base_do_finalize.exit.sha256_base_finish.exit_crit_edge
  ...
  tail call void asm sideeffect "", "r,~{memory}"(ptr %__ctx.i.i14) #5, !srcloc !24
  br label %return
...
; Function Attrs: argmemonly inlinehint mustprogress nofree norecurse nosync nounwind null_pointer_is_valid sanitize_address sspstrong willreturn writeonly uwtable(sync)
define internal i32 @sha256_base_init(ptr nocapture noundef writeonly %desc) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  %__ctx.i = getelementptr inbounds %struct.shash_desc, ptr %desc, i32 0, i32 2
  %0 = ptrtoint ptr %__ctx.i to i32
...
!1 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 23, i32 1}
!2 = !{ptr @__UNIQUE_ID_author174, !3, !"__UNIQUE_ID_author174", i1 false, i1 false}
!3 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 24, i32 1}
!4 = !{ptr @__UNIQUE_ID_file175, !5, !"__UNIQUE_ID_file175", i1 false, i1 false}
!5 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 25, i32 1}
!6 = !{ptr @__UNIQUE_ID_license176, !5, !"__UNIQUE_ID_license176", i1 false, i1 false}
!7 = !{ptr @__initcall__kmod_sha2_arm_ce__177_108_cpu_feature_match_SHA2_init6, !8, !"__initcall__kmod_sha2_arm_ce__177_108_cpu_feature_match_SHA2_init6", i1 false, i1 false}
!8 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 108, i32 1}
!9 = !{ptr @__exitcall_sha2_ce_mod_fini, !10, !"__exitcall_sha2_ce_mod_fini", i1 false, i1 false}
!10 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 109, i32 1}
!11 = !{ptr @algs, !12, !"algs", i1 false, i1 false}
!12 = !{!"../arch/arm/crypto/sha2-ce-glue.c", i32 68, i32 25}
!13 = !{!"sp"}
