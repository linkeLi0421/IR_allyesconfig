; ModuleID = '/llk/IR_all_yes/arch/arm/mach-mmp/mmp2-dt.c_pt.bc'
...
@.str = internal constant { [35 x i8], [61 x i8] } { [35 x i8] c"Marvell MMP2 (Device Tree Support)\00", [61 x i8] zeroinitializer }, align 32
...
@.str.1 = internal constant { [10 x i8], [22 x i8] } { [10 x i8] c"mrvl,mmp2\00", [22 x i8] zeroinitializer }, align 32
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.6, i32 34, i32 1 }
@___asan_gen_.5 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.6 = private constant [31 x i8] c"../arch/arm/mach-mmp/mmp2-dt.c\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.6, i32 30, i32 2 }
@llvm.compiler.used = appending global [3 x ptr] [ptr @__mach_desc_MMP2_DT, ptr @.str, ptr @.str.1], section "llvm.metadata"
...
define internal void @mmp_init_time() #1 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  tail call void @tauros2_init(i32 noundef 0) #6
...
!1 = !{!"../arch/arm/mach-mmp/mmp2-dt.c", i32 34, i32 1}
!2 = !{ptr @__mach_desc_MMP2_DT, !1, !"__mach_desc_MMP2_DT", i1 false, i1 false}
!3 = !{ptr @.str.1, !4, !"<string literal>", i1 false, i1 false}
!4 = !{!"../arch/arm/mach-mmp/mmp2-dt.c", i32 30, i32 2}
!5 = !{ptr @mmp2_dt_board_compat, !6, !"mmp2_dt_board_compat", i1 false, i1 false}
!6 = !{!"../arch/arm/mach-mmp/mmp2-dt.c", i32 29, i32 26}
