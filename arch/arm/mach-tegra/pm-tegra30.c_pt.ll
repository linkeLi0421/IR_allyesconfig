; ModuleID = '/llk/IR_all_yes/arch/arm/mach-tegra/pm-tegra30.c_pt.bc'
...
define dso_local void @tegra30_lp1_iram_hook() local_unnamed_addr #0 align 64 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid sanitize_address sspstrong willreturn writeonly uwtable(sync)
define dso_local void @tegra30_sleep_core_init() local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
