; ModuleID = '/llk/IR_all_yes/block/blk-mq-debugfs-zoned.c_pt.bc'
source_filename = "../block/blk-mq-debugfs-zoned.c"
...
@___asan_gen_.2 = private constant [32 x i8] c"../block/blk-mq-debugfs-zoned.c\00", align 1
...
define dso_local i32 @queue_zone_wlock_show(ptr nocapture noundef readonly %data, ptr noundef %m) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %seq_zones_wlock = getelementptr inbounds %struct.request_queue, ptr %data, i32 0, i32 41
  %0 = ptrtoint ptr %seq_zones_wlock to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %seq_zones_wlock, align 4
...
for.cond.preheader:                               ; preds = %entry
  %nr_zones = getelementptr inbounds %struct.request_queue, ptr %data, i32 0, i32 39
...
if.then3:                                         ; preds = %for.body
  call void @__sanitizer_cov_trace_pc() #4
  tail call void (ptr, ptr, ...) @seq_printf(ptr noundef %m, ptr noundef nonnull @.str, i32 noundef %i.012) #2
  br label %for.inc

for.inc:                                          ; preds = %if.then3, %for.body.for.inc_crit_edge
  %inc = add nuw i32 %i.012, 1
  %10 = ptrtoint ptr %nr_zones to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %nr_zones, align 4
...
!1 = !{!"../block/blk-mq-debugfs-zoned.c", i32 19, i32 18}
