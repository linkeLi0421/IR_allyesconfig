; ModuleID = '/llk/IR_all_yes/crypto/crc32c_generic.c_pt.bc'
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @crc32c_mod_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #10
...
define internal i32 @chksum_init(ptr nocapture noundef %desc) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #10
  call void @llvm.arm.gnu.eabi.mcount()
...
entry:
  ...
  %call1 = tail call i32 @__crc32c_le(i32 noundef %1, ptr noundef %data, i32 noundef %length) #11
...
entry:
  ...
  %1 = load i32, ptr %__ctx.i, align 4
  %neg = xor i32 %1, -1
  %2 = tail call i32 @llvm.bswap.i32(i32 %neg) #8
...
entry:
  ...
  call void @__asan_load4_noabort(i32 %0)
  %1 = load i32, ptr %__ctx.i, align 4
  %call.i = tail call i32 @__crc32c_le(i32 noundef %1, ptr noundef %data, i32 noundef %len) #11
  %neg.i = xor i32 %call.i, -1
  %2 = tail call i32 @llvm.bswap.i32(i32 %neg.i) #8
  %3 = ptrtoint ptr %out to i32
  call void @__asan_storeN_noabort(i32 %3, i32 4)
  store i32 %2, ptr %out, align 1
  ret i32 0
...
; Function Attrs: mustprogress nofree nounwind null_pointer_is_valid sanitize_address sspstrong willreturn uwtable(sync)
define internal i32 @chksum_digest(ptr nocapture noundef readonly %desc, ptr noundef %data, i32 noundef %length, ptr nocapture noundef writeonly %out) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #10
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %desc to i32
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load i32, ptr %__crt_ctx.i.i, align 4
  %call.i = tail call i32 @__crc32c_le(i32 noundef %3, ptr noundef %data, i32 noundef %length) #11
  %neg.i = xor i32 %call.i, -1
  %4 = tail call i32 @llvm.bswap.i32(i32 %neg.i) #8
...
; Function Attrs: argmemonly mustprogress nofree nosync nounwind null_pointer_is_valid sanitize_address sspstrong willreturn uwtable(sync)
define internal i32 @chksum_setkey(ptr nocapture noundef writeonly %tfm, ptr nocapture noundef readonly %key, i32 noundef %keylen) #4 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #10
  call void @llvm.arm.gnu.eabi.mcount()
...
!0 = !{ptr @__initcall__kmod_crc32c_generic__173_161_crc32c_mod_init4, !1, !"__initcall__kmod_crc32c_generic__173_161_crc32c_mod_init4", i1 false, i1 false}
!1 = !{!"../crypto/crc32c_generic.c", i32 161, i32 1}
!2 = !{ptr @__exitcall_crc32c_mod_fini, !3, !"__exitcall_crc32c_mod_fini", i1 false, i1 false}
!3 = !{!"../crypto/crc32c_generic.c", i32 162, i32 1}
!4 = !{ptr @__UNIQUE_ID_author174, !5, !"__UNIQUE_ID_author174", i1 false, i1 false}
!5 = !{!"../crypto/crc32c_generic.c", i32 164, i32 1}
!6 = !{ptr @__UNIQUE_ID_description175, !7, !"__UNIQUE_ID_description175", i1 false, i1 false}
!7 = !{!"../crypto/crc32c_generic.c", i32 165, i32 1}
!8 = !{ptr @__UNIQUE_ID_file176, !9, !"__UNIQUE_ID_file176", i1 false, i1 false}
!9 = !{!"../crypto/crc32c_generic.c", i32 166, i32 1}
...
!12 = !{!"../crypto/crc32c_generic.c", i32 167, i32 1}
