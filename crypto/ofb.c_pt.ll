; ModuleID = '/llk/IR_all_yes/crypto/ofb.c_pt.bc'
source_filename = "../crypto/ofb.c"
...
@crypto_ofb_tmpl = internal global { %struct.crypto_template, [44 x i8] } { %struct.crypto_template { %struct.list_head zeroinitializer, %struct.hlist_head zeroinitializer, ptr null, ptr @crypto_ofb_create, [128 x i8] c"ofb\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00" }, [44 x i8] zeroinitializer }, align 32
@__initcall__kmod_ofb__173_100_crypto_ofb_module_init4 = internal global ptr @crypto_ofb_module_init, section ".initcall4.init", align 4
@__exitcall_crypto_ofb_module_exit = internal global ptr @crypto_ofb_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_file174 = internal constant [20 x i8] c"ofb.file=crypto/ofb\00", section ".modinfo", align 1
@__UNIQUE_ID_license175 = internal constant [16 x i8] c"ofb.license=GPL\00", section ".modinfo", align 1
@__UNIQUE_ID_description176 = internal constant [51 x i8] c"ofb.description=OFB block cipher mode of operation\00", section ".modinfo", align 1
@__UNIQUE_ID_alias_userspace177 = internal constant [14 x i8] c"ofb.alias=ofb\00", section ".modinfo", align 1
@__UNIQUE_ID_alias_crypto178 = internal constant [21 x i8] c"ofb.alias=crypto-ofb\00", section ".modinfo", align 1
@__UNIQUE_ID_import_ns179 = internal constant [30 x i8] c"ofb.import_ns=CRYPTO_INTERNAL\00", section ".modinfo", align 1
@___asan_gen_.1 = private unnamed_addr constant [16 x i8] c"crypto_ofb_tmpl\00", align 1
@___asan_gen_.2 = private constant [16 x i8] c"../crypto/ofb.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 84, i32 31 }
@llvm.compiler.used = appending global [10 x ptr] [ptr @__UNIQUE_ID_alias_crypto178, ptr @__UNIQUE_ID_alias_userspace177, ptr @__UNIQUE_ID_description176, ptr @__UNIQUE_ID_file174, ptr @__UNIQUE_ID_import_ns179, ptr @__UNIQUE_ID_license175, ptr @__exitcall_crypto_ofb_module_exit, ptr @__initcall__kmod_ofb__173_100_crypto_ofb_module_init4, ptr @crypto_ofb_module_exit, ptr @crypto_ofb_tmpl], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @crypto_ofb_tmpl to i32), i32 148, i32 192, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal void @crypto_ofb_module_exit() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  tail call void @crypto_unregister_template(ptr noundef nonnull @crypto_ofb_tmpl) #4
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @crypto_ofb_module_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @crypto_register_template(ptr noundef nonnull @crypto_ofb_tmpl) #4
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @crypto_ofb_create(ptr noundef %tmpl, ptr noundef %tb) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %entry
  ...
  store ptr @crypto_ofb_crypt, ptr %encrypt, align 4
  ...
  store ptr @crypto_ofb_crypt, ptr %decrypt, align 8
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @crypto_ofb_crypt(ptr noundef %req) #2 align 64 {
entry:
  ...
  %call3 = call i32 @skcipher_walk_virt(ptr noundef nonnull %walk, ptr noundef %req, i1 noundef zeroext false) #4
  ...
  %cmp.not54 = icmp ult i32 %10, %7
  br i1 %cmp.not54, label %entry.while.end_crit_edge, label %while.body.lr.ph
...
while.body.lr.ph:                                 ; preds = %entry
  ...
  %addr6 = getelementptr inbounds %struct.skcipher_walk, ptr %walk, i32 0, i32 1, i32 0, i32 1
  %iv7 = getelementptr inbounds %struct.skcipher_walk, ptr %walk, i32 0, i32 10
  br label %while.body

while.body:                                       ; preds = %do.end.while.body_crit_edge, %while.body.lr.ph
  %11 = phi i32 [ %10, %while.body.lr.ph ], [ %19, %do.end.while.body_crit_edge ]
  %12 = ptrtoint ptr %addr to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %addr, align 4
  %14 = ptrtoint ptr %addr6 to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %addr6, align 4
  %16 = ptrtoint ptr %iv7 to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %iv7, align 4
  br label %do.body

do.body:                                          ; preds = %do.body.do.body_crit_edge, %while.body
  %src.0 = phi ptr [ %13, %while.body ], [ %add.ptr10, %do.body.do.body_crit_edge ]
  %dst.0 = phi ptr [ %15, %while.body ], [ %add.ptr, %do.body.do.body_crit_edge ]
  %nbytes8.0 = phi i32 [ %11, %while.body ], [ %sub, %do.body.do.body_crit_edge ]
  call void @crypto_cipher_encrypt_one(ptr noundef %3, ptr noundef %17, ptr noundef %17) #4
  call void @__crypto_xor(ptr noundef %dst.0, ptr noundef %src.0, ptr noundef %17, i32 noundef %7) #4
  %add.ptr = getelementptr i8, ptr %dst.0, i32 %7
  %add.ptr10 = getelementptr i8, ptr %src.0, i32 %7
  %sub = sub i32 %nbytes8.0, %7
  %cmp11.not = icmp ult i32 %sub, %7
...
do.end:                                           ; preds = %do.body
  %call12 = call i32 @skcipher_walk_done(ptr noundef nonnull %walk, i32 noundef %sub) #4
  %18 = ptrtoint ptr %nbytes to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load i32, ptr %nbytes, align 4
  %cmp.not = icmp ult i32 %19, %7
...
while.end:                                        ; preds = %do.end.while.end_crit_edge, %entry.while.end_crit_edge
  %err.0.lcssa = phi i32 [ %call3, %entry.while.end_crit_edge ], [ %call12, %do.end.while.end_crit_edge ]
  %.lcssa = phi i32 [ %10, %entry.while.end_crit_edge ], [ %19, %do.end.while.end_crit_edge ]
...
if.then:                                          ; preds = %while.end
  call void @__sanitizer_cov_trace_pc() #6
  %iv14 = getelementptr inbounds %struct.skcipher_walk, ptr %walk, i32 0, i32 10
  %20 = ptrtoint ptr %iv14 to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %iv14, align 4
  call void @crypto_cipher_encrypt_one(ptr noundef %3, ptr noundef %21, ptr noundef %21) #4
  %22 = ptrtoint ptr %nbytes to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load i32, ptr %nbytes, align 4
  %24 = ptrtoint ptr %iv14 to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %iv14, align 4
  %addr19 = getelementptr inbounds %struct.anon.51, ptr %walk, i32 0, i32 1
  %26 = ptrtoint ptr %addr19 to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %addr19, align 4
  %addr17 = getelementptr inbounds %struct.skcipher_walk, ptr %walk, i32 0, i32 1, i32 0, i32 1
  %28 = ptrtoint ptr %addr17 to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %addr17, align 4
  call void @__crypto_xor(ptr noundef %29, ptr noundef %27, ptr noundef %25, i32 noundef %23) #4
  %call22 = call i32 @skcipher_walk_done(ptr noundef nonnull %walk, i32 noundef 0) #4
  br label %if.end

if.end:                                           ; preds = %if.then, %while.end.if.end_crit_edge
  %err.1 = phi i32 [ %call22, %if.then ], [ %err.0.lcssa, %while.end.if.end_crit_edge ]
...
!0 = !{ptr @__initcall__kmod_ofb__173_100_crypto_ofb_module_init4, !1, !"__initcall__kmod_ofb__173_100_crypto_ofb_module_init4", i1 false, i1 false}
!1 = !{!"../crypto/ofb.c", i32 100, i32 1}
!2 = !{ptr @__exitcall_crypto_ofb_module_exit, !3, !"__exitcall_crypto_ofb_module_exit", i1 false, i1 false}
!3 = !{!"../crypto/ofb.c", i32 101, i32 1}
!4 = !{ptr @__UNIQUE_ID_file174, !5, !"__UNIQUE_ID_file174", i1 false, i1 false}
!5 = !{!"../crypto/ofb.c", i32 103, i32 1}
...
!13 = !{!"../crypto/ofb.c", i32 106, i32 1}
!14 = !{ptr @crypto_ofb_tmpl, !15, !"crypto_ofb_tmpl", i1 false, i1 false}
!15 = !{!"../crypto/ofb.c", i32 84, i32 31}
