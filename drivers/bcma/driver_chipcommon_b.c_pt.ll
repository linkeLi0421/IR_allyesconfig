; ModuleID = '/llk/IR_all_yes/drivers/bcma/driver_chipcommon_b.c_pt.bc'
source_filename = "../drivers/bcma/driver_chipcommon_b.c"
target datalayout = "E-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "armebv6k-unknown-linux-gnueabi"

module asm ".syntax unified"
module asm "\09.section \22___kcrctab_gpl+bcma_chipco_b_mii_write\22, \22a\22\09"
module asm "\09.weak\09__crc_bcma_chipco_b_mii_write\09\09\09\09"
module asm "\09.long\09__crc_bcma_chipco_b_mii_write\09\09\09\09"
...
@bcma_wait_reg._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 28, ptr @.str.3, ptr @.str.4 }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [40 x i8], [56 x i8] } { [40 x i8] c"bus%d: Timeout waiting for register %p\0A\00", [56 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [14 x i8], [18 x i8] } { [14 x i8] c"bcma_wait_reg\00", [18 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [35 x i8], [61 x i8] } { [35 x i8] c"drivers/bcma/driver_chipcommon_b.c\00", [61 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [3 x i8], [29 x i8] } { [3 x i8] c"\013\00", [29 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"%s %s: \00", [24 x i8] zeroinitializer }, align 32
@bcma_wait_reg._entry_ptr = internal global ptr @bcma_wait_reg._entry, section ".printk_index", align 4
@___asan_gen_.5 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.20 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.21 = private constant [38 x i8] c"../drivers/bcma/driver_chipcommon_b.c\00", align 1
@___asan_gen_.22 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 28, i32 2 }
@llvm.compiler.used = appending global [8 x ptr] [ptr @__ksymtab_bcma_chipco_b_mii_write, ptr @bcma_wait_reg._entry, ptr @bcma_wait_reg._entry_ptr, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str.4], section "llvm.metadata"
@0 = internal global [6 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @bcma_wait_reg._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 40, i32 96, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 14, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 35, i32 96, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 3, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @bcma_chipco_b_mii_write(ptr nocapture noundef readonly %ccb, i32 noundef %offset, i32 noundef %value) #0 align 64 {
entry:
  ...
  %mii2 = getelementptr inbounds %struct.bcma_drv_cc_b, ptr %ccb, i32 0, i32 2
  %4 = ptrtoint ptr %mii2 to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %mii2, align 4
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !19
  tail call void @arm_heavy_mb() #4
  %6 = tail call i32 @llvm.bswap.i32(i32 %offset)
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %5, i32 %6) #4, !srcloc !20
  call void @__asan_load4_noabort(i32 ptrtoint (ptr @jiffies to i32))
  %7 = load volatile i32, ptr @jiffies, align 128
  %add.neg.i = sub i32 -100, %7
  br label %do.body.i

do.body.i:                                        ; preds = %do.end.i.do.body.i_crit_edge, %entry
  %8 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %5) #4, !srcloc !21
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !22
  %9 = and i32 %8, 65536
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %9)
  %cmp.i = icmp eq i32 %9, 0
  br i1 %cmp.i, label %do.body.i.bcma_wait_reg.exit_crit_edge, label %do.end.i

do.body.i.bcma_wait_reg.exit_crit_edge:           ; preds = %do.body.i
  call void @__sanitizer_cov_trace_pc() #6
  br label %bcma_wait_reg.exit

do.end.i:                                         ; preds = %do.body.i
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !23
  tail call void asm sideeffect "nop; nop; nop; nop; nop; nop; nop; nop; nop; nop;", ""() #4, !srcloc !24
  ...
  br i1 %cmp10.i, label %do.end.i.do.body.i_crit_edge, label %do.end14.i
...
do.end14.i:                                       ; preds = %do.end.i
  ...
  %15 = load i8, ptr %num.i, align 1
  %conv.i = zext i8 %15 to i32
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %13, ptr noundef nonnull @.str, i32 noundef %conv.i, ptr noundef %5) #7
  br label %bcma_wait_reg.exit

bcma_wait_reg.exit:                               ; preds = %do.end14.i, %do.body.i.bcma_wait_reg.exit_crit_edge
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !25
  tail call void @arm_heavy_mb() #4
  %16 = tail call i32 @llvm.bswap.i32(i32 %value)
  %add.ptr7 = getelementptr i8, ptr %5, i32 4
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr7, i32 %16) #4, !srcloc !20
  call void @__asan_load4_noabort(i32 ptrtoint (ptr @jiffies to i32))
  %17 = load volatile i32, ptr @jiffies, align 128
  %add.neg.i15 = sub i32 -100, %17
  br label %do.body.i17

do.body.i17:                                      ; preds = %do.end.i20.do.body.i17_crit_edge, %bcma_wait_reg.exit
  %18 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %5) #4, !srcloc !21
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !22
  %19 = and i32 %18, 65536
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %19)
  %cmp.i16 = icmp eq i32 %19, 0
  br i1 %cmp.i16, label %do.body.i17.bcma_wait_reg.exit24_crit_edge, label %do.end.i20

do.body.i17.bcma_wait_reg.exit24_crit_edge:       ; preds = %do.body.i17
  call void @__sanitizer_cov_trace_pc() #6
  br label %bcma_wait_reg.exit24

do.end.i20:                                       ; preds = %do.body.i17
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !23
  tail call void asm sideeffect "nop; nop; nop; nop; nop; nop; nop; nop; nop; nop;", ""() #4, !srcloc !24
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.arm_delay_ops, ptr @arm_delay_ops, i32 0, i32 1) to i32))
  ...
  %sub.i18 = add i32 %add.neg.i15, %21
  %cmp10.i19 = icmp slt i32 %sub.i18, 0
  br i1 %cmp10.i19, label %do.end.i20.do.body.i17_crit_edge, label %do.end14.i23

do.end.i20.do.body.i17_crit_edge:                 ; preds = %do.end.i20
  call void @__sanitizer_cov_trace_pc() #6
  br label %do.body.i17

do.end14.i23:                                     ; preds = %do.end.i20
  call void @__sanitizer_cov_trace_pc() #6
  %22 = ptrtoint ptr %3 to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %3, align 4
  %num.i21 = getelementptr inbounds %struct.bcma_bus, ptr %3, i32 0, i32 11
  %24 = ptrtoint ptr %num.i21 to i32
  call void @__asan_load1_noabort(i32 %24)
  %25 = load i8, ptr %num.i21, align 1
  %conv.i22 = zext i8 %25 to i32
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %23, ptr noundef nonnull @.str, i32 noundef %conv.i22, ptr noundef %5) #7
  br label %bcma_wait_reg.exit24

bcma_wait_reg.exit24:                             ; preds = %do.end14.i23, %do.body.i17.bcma_wait_reg.exit24_crit_edge
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @bcma_core_chipcommon_b_init(ptr nocapture noundef %ccb) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %setup_done = getelementptr inbounds %struct.bcma_drv_cc_b, ptr %ccb, i32 0, i32 1
...
if.end:                                           ; preds = %entry
  ...
  %1 = ptrtoint ptr %setup_done to i32
  call void @__asan_store1_noabort(i32 %1)
  store i8 %bf.set, ptr %setup_done, align 4
  %2 = ptrtoint ptr %ccb to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %ccb, align 4
  %arrayidx = getelementptr %struct.bcma_device, ptr %3, i32 0, i32 9, i32 1
  %4 = ptrtoint ptr %arrayidx to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load i32, ptr %arrayidx, align 4
  %call = tail call ptr @ioremap(i32 noundef %5, i32 noundef 4096) #4
  %mii = getelementptr inbounds %struct.bcma_drv_cc_b, ptr %ccb, i32 0, i32 2
  %6 = ptrtoint ptr %mii to i32
  call void @__asan_store4_noabort(i32 %6)
  store ptr %call, ptr %mii, align 4
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @bcma_core_chipcommon_b_free(ptr nocapture noundef readonly %ccb) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %mii = getelementptr inbounds %struct.bcma_drv_cc_b, ptr %ccb, i32 0, i32 2
...
!0 = !{ptr @__ksymtab_bcma_chipco_b_mii_write, !1, !"__ksymtab_bcma_chipco_b_mii_write", i1 false, i1 false}
!1 = !{!"../drivers/bcma/driver_chipcommon_b.c", i32 43, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/bcma/driver_chipcommon_b.c", i32 28, i32 2}
!4 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.2, !3, !"<string literal>", i1 false, i1 false}
!6 = !{ptr @.str.3, !3, !"<string literal>", i1 false, i1 false}
!7 = !{ptr @.str.4, !3, !"<string literal>", i1 false, i1 false}
!8 = !{ptr @bcma_wait_reg._entry, !3, !"_entry", i1 false, i1 false}
!9 = !{ptr @bcma_wait_reg._entry_ptr, !3, !"_entry_ptr", i1 false, i1 false}
