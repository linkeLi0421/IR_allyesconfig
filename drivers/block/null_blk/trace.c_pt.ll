; ModuleID = '/llk/IR_all_yes/drivers/block/null_blk/trace.c_pt.bc'
source_filename = "../drivers/block/null_blk/trace.c"
...
@___asan_gen_.2 = private constant [34 x i8] c"../drivers/block/null_blk/trace.c\00", align 1
...
define dso_local ptr @nullb_trace_disk_name(ptr noundef %p, ptr noundef %name) local_unnamed_addr #0 align 64 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, ptr, ...) @trace_seq_printf(ptr noundef %p, ptr noundef nonnull @.str, ptr noundef nonnull %name) #3
  br label %if.end
...
!1 = !{!"../drivers/block/null_blk/trace.c", i32 17, i32 23}
