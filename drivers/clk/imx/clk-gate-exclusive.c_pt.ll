; ModuleID = '/llk/IR_all_yes/drivers/clk/imx/clk-gate-exclusive.c_pt.bc'
...
@___asan_gen_.1 = private unnamed_addr constant [23 x i8] c"clk_gate_exclusive_ops\00", align 1
@___asan_gen_.2 = private constant [40 x i8] c"../drivers/clk/imx/clk-gate-exclusive.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 52, i32 29 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @clk_gate_exclusive_ops], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @clk_gate_exclusive_ops to i32), i32 100, i32 160, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @imx_clk_hw_gate_exclusive(ptr noundef %name, ptr noundef %parent, ptr noundef %reg, i8 noundef zeroext %shift, i32 noundef %exclusive_mask) local_unnamed_addr #0 align 64 {
entry:
  ...
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %exclusive_mask)
  %cmp = icmp eq i32 %exclusive_mask, 0
...
if.end4:                                          ; preds = %if.end
  ...
  store ptr @clk_gate_exclusive_ops, ptr %ops, align 4
  ...
  %reg10 = getelementptr inbounds %struct.clk_gate, ptr %call7.i.i, i32 0, i32 1
  ...
  store i8 %shift, ptr %bit_idx, align 8
  ...
  %exclusive_mask13 = getelementptr inbounds %struct.clk_gate_exclusive, ptr %call7.i.i, i32 0, i32 1
  %15 = ptrtoint ptr %exclusive_mask13 to i32
  call void @__asan_store4_noabort(i32 %15)
  store i32 %exclusive_mask, ptr %exclusive_mask13, align 8
  %call15 = call i32 @clk_hw_register(ptr noundef null, ptr noundef nonnull %call7.i.i) #5
...
cleanup:                                          ; preds = %if.then17, %if.end4.cleanup_crit_edge, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi ptr [ %16, %if.then17 ], [ %call7.i.i, %if.end4.cleanup_crit_edge ], [ inttoptr (i32 -22 to ptr), %entry.cleanup_crit_edge ], [ inttoptr (i32 -12 to ptr), %if.end.cleanup_crit_edge ]
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @clk_gate_exclusive_enable(ptr noundef %hw) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %exclusive_mask = getelementptr inbounds %struct.clk_gate_exclusive, ptr %hw, i32 0, i32 1
  %4 = ptrtoint ptr %exclusive_mask to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load i32, ptr %exclusive_mask, align 4
  %and = and i32 %5, %3
...
if.end:                                           ; preds = %entry
  ...
  %call6 = tail call i32 %6(ptr noundef %hw) #5
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @clk_gate_exclusive_disable(ptr noundef %hw) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  tail call void %0(ptr noundef %hw) #5
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @clk_gate_exclusive_is_enabled(ptr noundef %hw) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call = tail call i32 %0(ptr noundef %hw) #5
  ret i32 %call
}
...
!0 = !{ptr @clk_gate_exclusive_ops, !1, !"clk_gate_exclusive_ops", i1 false, i1 false}
!1 = !{!"../drivers/clk/imx/clk-gate-exclusive.c", i32 52, i32 29}
