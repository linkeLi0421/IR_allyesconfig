; ModuleID = '/llk/IR_all_yes/drivers/clk/uniphier/clk-uniphier-fixed-rate.c_pt.bc'
...
define dso_local ptr @uniphier_clk_register_fixed_rate(ptr noundef %dev, ptr noundef %name, ptr nocapture noundef readonly %data) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %fixed_rate3 = getelementptr inbounds %struct.clk_fixed_rate, ptr %call.i, i32 0, i32 1
  %8 = ptrtoint ptr %fixed_rate3 to i32
  call void @__asan_store4_noabort(i32 %8)
  store i32 %7, ptr %fixed_rate3, align 4
  ...
  %call6 = call i32 @devm_clk_hw_register(ptr noundef %dev, ptr noundef nonnull %call.i) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call6)
  %tobool7.not = icmp eq i32 %call6, 0
  %10 = inttoptr i32 %call6 to ptr
  %spec.select = select i1 %tobool7.not, ptr %call.i, ptr %10
  br label %cleanup
