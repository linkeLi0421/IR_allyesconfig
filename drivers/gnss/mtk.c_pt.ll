; ModuleID = '/llk/IR_all_yes/drivers/gnss/mtk.c_pt.bc'
source_filename = "../drivers/gnss/mtk.c"
...
@__initcall__kmod_gnss_mtk__288_148_mtk_driver_init6 = internal global ptr @mtk_driver_init, section ".initcall6.init", align 4
@mtk_driver = internal global { %struct.serdev_device_driver, [44 x i8] } { %struct.serdev_device_driver { %struct.device_driver { ptr @.str, ptr null, ptr null, ptr null, i8 0, i32 0, ptr @mtk_of_match, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @gnss_serial_pm_ops, ptr null, ptr null }, ptr @mtk_probe, ptr @mtk_remove }, [44 x i8] zeroinitializer }, align 32
@__exitcall_mtk_driver_exit = internal global ptr @mtk_driver_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_author289 = internal constant [55 x i8] c"gnss_mtk.author=Loys Ollivier <lollivier@baylibre.com>\00", section ".modinfo", align 1
@__UNIQUE_ID_description290 = internal constant [51 x i8] c"gnss_mtk.description=Mediatek GNSS receiver driver\00", section ".modinfo", align 1
@__UNIQUE_ID_file291 = internal constant [36 x i8] c"gnss_mtk.file=drivers/gnss/gnss-mtk\00", section ".modinfo", align 1
@__UNIQUE_ID_license292 = internal constant [24 x i8] c"gnss_mtk.license=GPL v2\00", section ".modinfo", align 1
@.str = internal constant { [9 x i8], [23 x i8] } { [9 x i8] c"gnss-mtk\00", [23 x i8] zeroinitializer }, align 32
@mtk_of_match = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"globaltop,pa6h\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
@gnss_serial_pm_ops = external dso_local constant %struct.dev_pm_ops, align 4
@mtk_gserial_ops = internal constant { %struct.gnss_serial_ops, [28 x i8] } { %struct.gnss_serial_ops { ptr @mtk_set_power }, [28 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [4 x i8], [28 x i8] } { [4 x i8] c"vcc\00", [28 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"vbackup\00", [24 x i8] zeroinitializer }, align 32
@__sancov_gen_cov_switch_values = internal global [5 x i64] [i64 3, i64 32, i64 0, i64 1, i64 2]
@___asan_gen_.3 = private unnamed_addr constant [11 x i8] c"mtk_driver\00", align 1
@___asan_gen_.5 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.19, i32 139, i32 36 }
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.19, i32 141, i32 12 }
@___asan_gen_.9 = private unnamed_addr constant [13 x i8] c"mtk_of_match\00", align 1
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.19, i32 132, i32 34 }
@___asan_gen_.12 = private unnamed_addr constant [16 x i8] c"mtk_gserial_ops\00", align 1
...
@___asan_gen_.19 = private constant [22 x i8] c"../drivers/gnss/mtk.c\00", align 1
@___asan_gen_.20 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.19, i32 90, i32 60 }
@llvm.compiler.used = appending global [13 x ptr] [ptr @__UNIQUE_ID_author289, ptr @__UNIQUE_ID_description290, ptr @__UNIQUE_ID_file291, ptr @__UNIQUE_ID_license292, ptr @__exitcall_mtk_driver_exit, ptr @__initcall__kmod_gnss_mtk__288_148_mtk_driver_init6, ptr @mtk_driver_exit, ptr @mtk_driver, ptr @.str, ptr @mtk_of_match, ptr @mtk_gserial_ops, ptr @.str.1, ptr @.str.2], section "llvm.metadata"
@0 = internal global [6 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @mtk_driver to i32), i32 84, i32 128, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 9, i32 32, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @mtk_of_match to i32), i32 392, i32 512, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @mtk_gserial_ops to i32), i32 4, i32 32, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 4, i32 32, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @mtk_driver_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @__serdev_device_driver_register(ptr noundef nonnull @mtk_driver, ptr noundef null) #3
  ret i32 %call
}

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal void @mtk_driver_exit() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @driver_unregister(ptr noundef nonnull @mtk_driver) #3
  ret void
}
...
define internal i32 @mtk_probe(ptr noundef %serdev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %entry
  ...
  store ptr @mtk_gserial_ops, ptr %ops, align 4
...
if.end29:                                         ; preds = %if.then23.if.end29_crit_edge, %if.end21.if.end29_crit_edge, %if.end21.thread
  ...
  br i1 %tobool31.not, label %if.end29.cleanup_crit_edge, label %err_disable_vbackup

if.end29.cleanup_crit_edge:                       ; preds = %if.end29
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

err_disable_vbackup:                              ; preds = %if.end29
  %10 = ptrtoint ptr %drvdata.i to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %drvdata.i, align 4
  %tobool35.not = icmp eq ptr %11, null
  br i1 %tobool35.not, label %err_disable_vbackup.err_free_gserial_crit_edge, label %if.then36

err_disable_vbackup.err_free_gserial_crit_edge:   ; preds = %err_disable_vbackup
  call void @__sanitizer_cov_trace_pc() #5
  br label %err_free_gserial

if.then36:                                        ; preds = %err_disable_vbackup
  call void @__sanitizer_cov_trace_pc() #5
  %call38 = tail call i32 @regulator_disable(ptr noundef nonnull %11) #3
  br label %err_free_gserial

err_free_gserial:                                 ; preds = %if.then36, %err_disable_vbackup.err_free_gserial_crit_edge, %if.then23.err_free_gserial_crit_edge, %if.then15.err_free_gserial_crit_edge, %if.then7
  %ret.0 = phi i32 [ %6, %if.then7 ], [ %call25, %if.then23.err_free_gserial_crit_edge ], [ %call30, %if.then36 ], [ %call30, %err_disable_vbackup.err_free_gserial_crit_edge ], [ %8, %if.then15.err_free_gserial_crit_edge ]
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @mtk_remove(ptr nocapture noundef readonly %serdev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @mtk_set_power(ptr nocapture noundef readonly %gserial, i32 noundef %state) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
!0 = !{ptr @__initcall__kmod_gnss_mtk__288_148_mtk_driver_init6, !1, !"__initcall__kmod_gnss_mtk__288_148_mtk_driver_init6", i1 false, i1 false}
!1 = !{!"../drivers/gnss/mtk.c", i32 148, i32 1}
!2 = !{ptr @__exitcall_mtk_driver_exit, !1, !"__exitcall_mtk_driver_exit", i1 false, i1 false}
!3 = !{ptr @__UNIQUE_ID_author289, !4, !"__UNIQUE_ID_author289", i1 false, i1 false}
!4 = !{!"../drivers/gnss/mtk.c", i32 150, i32 1}
!5 = !{ptr @__UNIQUE_ID_description290, !6, !"__UNIQUE_ID_description290", i1 false, i1 false}
!6 = !{!"../drivers/gnss/mtk.c", i32 151, i32 1}
!7 = !{ptr @__UNIQUE_ID_file291, !8, !"__UNIQUE_ID_file291", i1 false, i1 false}
!8 = !{!"../drivers/gnss/mtk.c", i32 152, i32 1}
!9 = !{ptr @__UNIQUE_ID_license292, !8, !"__UNIQUE_ID_license292", i1 false, i1 false}
!10 = !{ptr @.str, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/gnss/mtk.c", i32 141, i32 12}
!12 = !{ptr @mtk_driver, !13, !"mtk_driver", i1 false, i1 false}
!13 = !{!"../drivers/gnss/mtk.c", i32 139, i32 36}
!14 = !{ptr @mtk_of_match, !15, !"mtk_of_match", i1 false, i1 false}
!15 = !{!"../drivers/gnss/mtk.c", i32 132, i32 34}
!16 = !{ptr @.str.1, !17, !"<string literal>", i1 false, i1 false}
!17 = !{!"../drivers/gnss/mtk.c", i32 84, i32 47}
!18 = !{ptr @.str.2, !19, !"<string literal>", i1 false, i1 false}
!19 = !{!"../drivers/gnss/mtk.c", i32 90, i32 60}
!20 = !{ptr @mtk_gserial_ops, !21, !"mtk_gserial_ops", i1 false, i1 false}
!21 = !{!"../drivers/gnss/mtk.c", i32 62, i32 37}
