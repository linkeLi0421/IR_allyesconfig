; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/amdgpu/amdgpu_nbio.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/amdgpu_nbio.c"
...
@.str = internal constant { [19 x i8], [45 x i8] } { [19 x i8] c"pcie_bif_err_count\00", [45 x i8] zeroinitializer }, align 32
@__const.amdgpu_nbio_ras_late_init.fs_info = private unnamed_addr constant %struct.ras_fs_if { %struct.ras_common_if zeroinitializer, ptr @.str, [32 x i8] zeroinitializer }, align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [4 x [14 x ptr]], align 4
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private constant [44 x i8] c"../drivers/gpu/drm/amd/amdgpu/amdgpu_nbio.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 32, i32 17 }
...
define dso_local i32 @amdgpu_nbio_ras_late_init(ptr noundef %adev) local_unnamed_addr #0 align 64 {
entry:
  ...
  %2 = call ptr @memcpy(ptr %fs_info, ptr @__const.amdgpu_nbio_ras_late_init.fs_info, i32 80)
  %ras_if = getelementptr inbounds %struct.amdgpu_device, ptr %adev, i32 0, i32 101, i32 3
  %3 = ptrtoint ptr %ras_if to i32
  call void @__asan_load4_noabort(i32 %3)
  %4 = load ptr, ptr %ras_if, align 4
...
if.end22:                                         ; preds = %if.end13
  ...
  %15 = load ptr, ptr %ras_if, align 4
...
if.then28:                                        ; preds = %amdgpu_ras_is_supported.exit
  ...
  %call30 = call i32 @amdgpu_irq_get(ptr noundef %adev, ptr noundef %ras_controller_irq, i32 noundef 0) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call30)
  %tobool31.not = icmp eq i32 %call30, 0
  br i1 %tobool31.not, label %if.end33, label %if.then28.late_fini_crit_edge

if.then28.late_fini_crit_edge:                    ; preds = %if.then28
  call void @__sanitizer_cov_trace_pc() #6
  br label %late_fini

if.end33:                                         ; preds = %if.then28
  %ras_err_event_athub_irq = getelementptr inbounds %struct.amdgpu_device, ptr %adev, i32 0, i32 101, i32 2
  %call35 = call i32 @amdgpu_irq_get(ptr noundef %adev, ptr noundef %ras_err_event_athub_irq, i32 noundef 0) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call35)
  %tobool36.not = icmp eq i32 %call35, 0
  br i1 %tobool36.not, label %if.end33.cleanup_crit_edge, label %if.end33.late_fini_crit_edge

if.end33.late_fini_crit_edge:                     ; preds = %if.end33
  call void @__sanitizer_cov_trace_pc() #6
  br label %late_fini
...
late_fini:                                        ; preds = %if.end33.late_fini_crit_edge, %if.then28.late_fini_crit_edge
  %r.0 = phi i32 [ %call30, %if.then28.late_fini_crit_edge ], [ %call35, %if.end33.late_fini_crit_edge ]
  %24 = ptrtoint ptr %ras_if to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %ras_if, align 4
  call void @amdgpu_ras_late_fini(ptr noundef %adev, ptr noundef %25, ptr noundef nonnull %ih_info) #4
  br label %free
...
free:                                             ; preds = %late_fini, %amdgpu_ras_is_supported.exit.free_crit_edge, %if.end.i.free_crit_edge, %if.end22.free_crit_edge, %if.end13.free_crit_edge
  %r.1 = phi i32 [ %call19, %if.end13.free_crit_edge ], [ %r.0, %late_fini ], [ 0, %amdgpu_ras_is_supported.exit.free_crit_edge ], [ 0, %if.end22.free_crit_edge ], [ 0, %if.end.i.free_crit_edge ]
  %26 = ptrtoint ptr %ras_if to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %ras_if, align 4
  call void @kfree(ptr noundef %27) #4
  %28 = ptrtoint ptr %ras_if to i32
  call void @__asan_store4_noabort(i32 %28)
  store ptr null, ptr %ras_if, align 4
  br label %cleanup

cleanup:                                          ; preds = %free, %if.end33.cleanup_crit_edge, %if.then.cleanup_crit_edge
  %retval.0 = phi i32 [ %r.1, %free ], [ -12, %if.then.cleanup_crit_edge ], [ 0, %if.end33.cleanup_crit_edge ]
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @amdgpu_nbio_ras_fini(ptr noundef %adev) local_unnamed_addr #0 align 64 {
entry:
  %ih_info = alloca %struct.ras_ih_if, align 4
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
...
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/amdgpu_nbio.c", i32 32, i32 17}
