; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/amdgpu/athub_v2_1.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/athub_v2_1.c"
...
define dso_local i32 @athub_v2_1_set_clockgating(ptr noundef %adev, i32 noundef %state) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %.off = add i32 %3, -131328
  call void @__sanitizer_cov_trace_const_cmp4(i32 3, i32 %.off)
  %switch = icmp ult i32 %.off, 3
  br i1 %switch, label %cond.end.i, label %if.end.return_crit_edge
...
land.lhs.true20.i:                                ; preds = %cond.end.i
  ...
  %8 = ptrtoint ptr %cg_flags.i to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load i32, ptr %cg_flags.i, align 8
  %and21.i = and i32 %9, 512
...
if.end.i:                                         ; preds = %if.else.i, %if.then.i
  ...
  br i1 %cmp.not.i, label %if.end.i.athub_v2_1_update_medium_grain_clock_gating.exit_crit_edge, label %if.then24.i

if.end.i.athub_v2_1_update_medium_grain_clock_gating.exit_crit_edge: ; preds = %if.end.i
  call void @__sanitizer_cov_trace_pc() #4
  br label %athub_v2_1_update_medium_grain_clock_gating.exit

if.then24.i:                                      ; preds = %if.end.i
  %10 = ptrtoint ptr %virt to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %virt, align 8
  %and27.i = and i32 %11, 4
...
land.lhs.true29.i:                                ; preds = %if.then24.i
  ...
  %12 = ptrtoint ptr %funcs32.i to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %funcs32.i, align 4
...
cond.true39.i:                                    ; preds = %land.lhs.true34.i
  ...
  %add48.i = add i32 %19, 9
  tail call void %15(ptr noundef %adev, i32 noundef %add48.i, i32 noundef %data.0.i, i32 noundef 0, i32 noundef 12) #2
  br label %athub_v2_1_update_medium_grain_clock_gating.exit
...
cond.false49.i:                                   ; preds = %land.lhs.true34.i.cond.false49.i_crit_edge, %land.lhs.true29.i.cond.false49.i_crit_edge, %if.then24.i.cond.false49.i_crit_edge
  ...
  %add54.i = add i32 %23, 9
  tail call void @amdgpu_device_wreg(ptr noundef %adev, i32 noundef %add54.i, i32 noundef %data.0.i, i32 noundef 0) #2
  br label %athub_v2_1_update_medium_grain_clock_gating.exit

athub_v2_1_update_medium_grain_clock_gating.exit: ; preds = %cond.false49.i, %cond.true39.i, %if.end.i.athub_v2_1_update_medium_grain_clock_gating.exit_crit_edge
  ...
  br i1 %tobool.not.i9, label %athub_v2_1_update_medium_grain_clock_gating.exit.cond.false.i23_crit_edge, label %land.lhs.true.i12

athub_v2_1_update_medium_grain_clock_gating.exit.cond.false.i23_crit_edge: ; preds = %athub_v2_1_update_medium_grain_clock_gating.exit
  call void @__sanitizer_cov_trace_pc() #4
  br label %cond.false.i23

land.lhs.true.i12:                                ; preds = %athub_v2_1_update_medium_grain_clock_gating.exit
  %funcs.i10 = getelementptr inbounds %struct.amdgpu_device, ptr %adev, i32 0, i32 106, i32 2, i32 15
  %26 = ptrtoint ptr %funcs.i10 to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %funcs.i10, align 4
  %tobool1.not.i11 = icmp eq ptr %27, null
  br i1 %tobool1.not.i11, label %land.lhs.true.i12.cond.false.i23_crit_edge, label %land.lhs.true2.i15

land.lhs.true.i12.cond.false.i23_crit_edge:       ; preds = %land.lhs.true.i12
  call void @__sanitizer_cov_trace_pc() #4
  br label %cond.false.i23

land.lhs.true2.i15:                               ; preds = %land.lhs.true.i12
  %sriov_rreg.i13 = getelementptr inbounds %struct.amdgpu_rlc_funcs, ptr %27, i32 0, i32 13
  %28 = ptrtoint ptr %sriov_rreg.i13 to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %sriov_rreg.i13, align 4
  %tobool6.not.i14 = icmp eq ptr %29, null
  br i1 %tobool6.not.i14, label %land.lhs.true2.i15.cond.false.i23_crit_edge, label %cond.true.i19

land.lhs.true2.i15.cond.false.i23_crit_edge:      ; preds = %land.lhs.true2.i15
  call void @__sanitizer_cov_trace_pc() #4
  br label %cond.false.i23

cond.true.i19:                                    ; preds = %land.lhs.true2.i15
  call void @__sanitizer_cov_trace_pc() #4
  %30 = ptrtoint ptr %arrayidx14.i to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load ptr, ptr %arrayidx14.i, align 8
  %32 = ptrtoint ptr %31 to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load i32, ptr %31, align 4
  %add.i17 = add i32 %33, 9
  %call.i18 = tail call i32 %29(ptr noundef %adev, i32 noundef %add.i17, i32 noundef 0, i32 noundef 12) #2
  br label %cond.end.i25

cond.false.i23:                                   ; preds = %land.lhs.true2.i15.cond.false.i23_crit_edge, %land.lhs.true.i12.cond.false.i23_crit_edge, %athub_v2_1_update_medium_grain_clock_gating.exit.cond.false.i23_crit_edge
  %34 = ptrtoint ptr %arrayidx14.i to i32
  call void @__asan_load4_noabort(i32 %34)
  %35 = load ptr, ptr %arrayidx14.i, align 8
  %36 = ptrtoint ptr %35 to i32
  call void @__asan_load4_noabort(i32 %36)
  %37 = load i32, ptr %35, align 4
  %add17.i21 = add i32 %37, 9
  %call18.i22 = tail call i32 @amdgpu_device_rreg(ptr noundef %adev, i32 noundef %add17.i21, i32 noundef 0) #2
  br label %cond.end.i25

cond.end.i25:                                     ; preds = %cond.false.i23, %cond.true.i19
  %cond.i24 = phi i32 [ %call.i18, %cond.true.i19 ], [ %call18.i22, %cond.false.i23 ]
  br i1 %cmp, label %land.lhs.true20.i27, label %cond.end.i25.if.else.i31_crit_edge

cond.end.i25.if.else.i31_crit_edge:               ; preds = %cond.end.i25
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.else.i31

land.lhs.true20.i27:                              ; preds = %cond.end.i25
  %cg_flags.i26 = getelementptr inbounds %struct.amdgpu_device, ptr %adev, i32 0, i32 99
  %38 = ptrtoint ptr %cg_flags.i26 to i32
  call void @__asan_load4_noabort(i32 %38)
  %39 = load i32, ptr %cg_flags.i26, align 8
  %40 = and i32 %39, 33024
  call void @__sanitizer_cov_trace_const_cmp4(i32 33024, i32 %40)
  %.not.i = icmp eq i32 %40, 33024
  br i1 %.not.i, label %if.then.i29, label %land.lhs.true20.i27.if.else.i31_crit_edge

land.lhs.true20.i27.if.else.i31_crit_edge:        ; preds = %land.lhs.true20.i27
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.else.i31

if.then.i29:                                      ; preds = %land.lhs.true20.i27
  call void @__sanitizer_cov_trace_pc() #4
  %or.i28 = or i32 %cond.i24, 128
  br label %if.end.i34

if.else.i31:                                      ; preds = %land.lhs.true20.i27.if.else.i31_crit_edge, %cond.end.i25.if.else.i31_crit_edge
  %and27.i30 = and i32 %cond.i24, -129
  br label %if.end.i34

if.end.i34:                                       ; preds = %if.else.i31, %if.then.i29
  %data.0.i32 = phi i32 [ %or.i28, %if.then.i29 ], [ %and27.i30, %if.else.i31 ]
  call void @__sanitizer_cov_trace_cmp4(i32 %cond.i24, i32 %data.0.i32)
  %cmp.not.i33 = icmp eq i32 %cond.i24, %data.0.i32
  br i1 %cmp.not.i33, label %if.end.i34.return_crit_edge, label %if.then28.i

if.end.i34.return_crit_edge:                      ; preds = %if.end.i34
  call void @__sanitizer_cov_trace_pc() #4
  br label %return

if.then28.i:                                      ; preds = %if.end.i34
  %41 = ptrtoint ptr %virt to i32
  call void @__asan_load4_noabort(i32 %41)
  %42 = load i32, ptr %virt, align 8
  %and31.i = and i32 %42, 4
...
land.lhs.true33.i:                                ; preds = %if.then28.i
  ...
  %43 = ptrtoint ptr %funcs36.i to i32
  call void @__asan_load4_noabort(i32 %43)
  %44 = load ptr, ptr %funcs36.i, align 4
...
land.lhs.true38.i:                                ; preds = %land.lhs.true33.i
  %sriov_wreg.i35 = getelementptr inbounds %struct.amdgpu_rlc_funcs, ptr %44, i32 0, i32 12
  %45 = ptrtoint ptr %sriov_wreg.i35 to i32
  call void @__asan_load4_noabort(i32 %45)
  %46 = load ptr, ptr %sriov_wreg.i35, align 4
  %tobool42.not.i = icmp eq ptr %46, null
...
cond.true43.i:                                    ; preds = %land.lhs.true38.i
  ...
  %add52.i = add i32 %50, 9
  tail call void %46(ptr noundef %adev, i32 noundef %add52.i, i32 noundef %data.0.i32, i32 noundef 0, i32 noundef 12) #2
  br label %return
...
cond.false53.i:                                   ; preds = %land.lhs.true38.i.cond.false53.i_crit_edge, %land.lhs.true33.i.cond.false53.i_crit_edge, %if.then28.i.cond.false53.i_crit_edge
  ...
  %add58.i = add i32 %54, 9
  tail call void @amdgpu_device_wreg(ptr noundef %adev, i32 noundef %add58.i, i32 noundef %data.0.i32, i32 noundef 0) #2
  br label %return

return:                                           ; preds = %cond.false53.i, %cond.true43.i, %if.end.i34.return_crit_edge, %if.end.return_crit_edge, %entry.return_crit_edge
  ret i32 0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @athub_v2_1_get_clockgating(ptr noundef %adev, ptr nocapture noundef %flags) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %virt = getelementptr inbounds %struct.amdgpu_device, ptr %adev, i32 0, i32 132
