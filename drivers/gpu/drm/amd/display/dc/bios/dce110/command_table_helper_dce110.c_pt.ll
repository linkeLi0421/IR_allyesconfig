; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/display/dc/bios/dce110/command_table_helper_dce110.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c"
...
@.str.1 = internal constant { [83 x i8], [45 x i8] } { [83 x i8] c"drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c\00", [45 x i8] zeroinitializer }, align 32
...
@__sancov_gen_cov_switch_values.2 = internal global [9 x i64] [i64 7, i64 32, i64 1, i64 2, i64 4, i64 8, i64 32, i64 64, i64 128]
@___asan_gen_.3 = private unnamed_addr constant [27 x i8] c"command_table_helper_funcs\00", align 1
@___asan_gen_.5 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 304, i32 42 }
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 273, i32 3 }
@___asan_gen_.9 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.10 = private constant [86 x i8] c"../drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c\00", align 1
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 296, i32 3 }
@___asan_gen_.12 = private unnamed_addr constant [31 x i8] c"switch.table.engine_bp_to_atom\00", align 1
@___asan_gen_.13 = private unnamed_addr constant [28 x i8] c"switch.table.phy_id_to_atom\00", align 1
...
do.body:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (i32, ptr, ...) @__drm_dbg(i32 noundef 2, ptr noundef nonnull @.str, ptr noundef nonnull @__func__.encoder_action_to_atom, i32 noundef 273) #4
...
if.end.sink.split:                                ; preds = %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %sw.bb2, %sw.bb1, %if.then.if.end.sink.split_crit_edge
  %.sink = phi i32 [ 0, %sw.bb1 ], [ 1, %sw.bb2 ], [ 255, %sw.bb3 ], [ 8, %sw.bb4 ], [ 255, %sw.bb5 ], [ 255, %sw.bb6 ], [ 255, %sw.bb7 ], [ 2, %if.then.if.end.sink.split_crit_edge ]
  %result.0.off0.ph = phi i1 [ true, %sw.bb1 ], [ true, %sw.bb2 ], [ true, %sw.bb3 ], [ true, %sw.bb4 ], [ true, %sw.bb5 ], [ true, %sw.bb6 ], [ false, %sw.bb7 ], [ true, %if.then.if.end.sink.split_crit_edge ]
...
do.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str.1, i32 noundef 296, i32 noundef 9, ptr noundef null) #4
  tail call void @kgdb_breakpoint() #4
  br label %sw.epilog
...
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c", i32 304, i32 42}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c", i32 273, i32 3}
!4 = !{ptr @__func__.encoder_action_to_atom, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.1, !6, !"<string literal>", i1 false, i1 false}
!6 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/bios/dce110/command_table_helper_dce110.c", i32 296, i32 3}
