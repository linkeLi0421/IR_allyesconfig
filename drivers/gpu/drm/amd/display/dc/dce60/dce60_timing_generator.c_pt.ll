; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/display/dc/dce60/dce60_timing_generator.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c"
...
@___asan_gen_.4 = private unnamed_addr constant [15 x i8] c"dce60_tg_funcs\00", align 1
@___asan_gen_.5 = private constant [75 x i8] c"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 204, i32 44 }
@llvm.compiler.used = appending global [2 x ptr] [ptr @reg_offsets, ptr @dce60_tg_funcs], section "llvm.metadata"
@0 = internal global [2 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @reg_offsets to i32), i32 72, i32 128, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @dce60_tg_funcs to i32), i32 280, i32 352, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: argmemonly mustprogress nofree nosync nounwind null_pointer_is_valid sanitize_address sspstrong willreturn uwtable(sync)
define dso_local void @dce60_timing_generator_construct(ptr nocapture noundef writeonly %tg110, ptr noundef %ctx, i32 noundef %instance, ptr nocapture noundef readonly %offsets) local_unnamed_addr #0 align 64 {
entry:
  ...
  store ptr @dce60_tg_funcs, ptr %tg110, align 4
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @dce60_timing_generator_enable_advanced_request(ptr nocapture noundef readonly %tg, i1 noundef zeroext %enable, ptr nocapture noundef readonly %timing) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call = tail call i32 @dm_read_reg_func(ptr noundef %3, i32 noundef %add, ptr noundef nonnull @__func__.dce60_timing_generator_enable_advanced_request) #3
  ...
  %call5 = tail call i32 @dm_read_reg_func(ptr noundef %7, i32 noundef %add3, ptr noundef nonnull @__func__.dce60_timing_generator_enable_advanced_request) #3
  %v_sync_width = getelementptr inbounds %struct.dc_crtc_timing, ptr %timing, i32 0, i32 11
  %8 = ptrtoint ptr %v_sync_width to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load i32, ptr %v_sync_width, align 4
  %v_front_porch = getelementptr inbounds %struct.dc_crtc_timing, ptr %timing, i32 0, i32 10
  %10 = ptrtoint ptr %v_front_porch to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %v_front_porch, align 4
  %add6 = add i32 %11, %9
  call void @__sanitizer_cov_trace_const_cmp4(i32 4, i32 %add6)
  %cmp = icmp ult i32 %add6, 4
  %and.i = and i32 %call, -983298
  %and.i29 = and i32 %call5, -268435457
  %value.0.v = select i1 %cmp, i32 196608, i32 262144
  %value.0 = or i32 %and.i, %value.0.v
  %masksel = select i1 %cmp, i32 0, i32 268435456
  %value2.0 = or i32 %and.i29, %masksel
  %or.i37 = or i32 %value.0, 257
  %12 = ptrtoint ptr %ctx to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %ctx, align 4
  tail call void @dm_write_reg_func(ptr noundef %13, i32 noundef %add, i32 noundef %or.i37, ptr noundef nonnull @__func__.dce60_timing_generator_enable_advanced_request) #3
  %14 = ptrtoint ptr %ctx to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %ctx, align 4
  tail call void @dm_write_reg_func(ptr noundef %15, i32 noundef %add3, i32 noundef %value2.0, ptr noundef nonnull @__func__.dce60_timing_generator_enable_advanced_request) #3
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal zeroext i1 @dce60_configure_crc(ptr nocapture noundef readonly %tg, ptr nocapture noundef readnone %params) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call.i = tail call i32 @dm_read_reg_func(ptr noundef %3, i32 noundef %add.i, ptr noundef nonnull @__func__.dce60_is_tg_enabled) #3
...
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c", i32 51, i32 53}
!2 = !{ptr @dce60_tg_funcs, !3, !"dce60_tg_funcs", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c", i32 204, i32 44}
!4 = !{ptr @__func__.program_pix_dur, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c", i32 92, i32 19}
...
!9 = !{ptr @__func__.dce60_timing_generator_enable_advanced_request, !10, !"<string literal>", i1 false, i1 false}
!10 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c", i32 130, i32 19}
!11 = !{ptr @__func__.dce60_is_tg_enabled, !12, !"<string literal>", i1 false, i1 false}
!12 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/dce60/dce60_timing_generator.c", i32 186, i32 10}
...
!22 = !{i64 2148776611, i64 2148776891, i64 2148777225, i64 2148777559}
