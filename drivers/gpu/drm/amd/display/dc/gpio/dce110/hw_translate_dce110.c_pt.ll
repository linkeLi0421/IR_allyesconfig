; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/display/dc/gpio/dce110/hw_translate_dce110.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../display/dc/gpio/dce110/hw_translate_dce110.c"
...
@.str = internal constant { [75 x i8], [53 x i8] } { [75 x i8] c"drivers/gpu/drm/amd/amdgpu/../display/dc/gpio/dce110/hw_translate_dce110.c\00", [53 x i8] zeroinitializer }, align 32
@__sancov_gen_cov_switch_values = internal global [18 x i64] [i64 16, i64 32, i64 18436, i64 18529, i64 18537, i64 18541, i64 18545, i64 18549, i64 18553, i64 18557, i64 18561, i64 18565, i64 18569, i64 18573, i64 18577, i64 18580, i64 18581, i64 18585]
...
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.16, i32 369, i32 40 }
@___asan_gen_.15 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.16 = private constant [78 x i8] c"../drivers/gpu/drm/amd/amdgpu/../display/dc/gpio/dce110/hw_translate_dce110.c\00", align 1
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.16, i32 72, i32 4 }
...
define dso_local void @dal_hw_translate_dce110_init(ptr nocapture noundef writeonly %tr) local_unnamed_addr #0 align 64 {
entry:
...
entry:
  ...
  switch i32 %offset, label %do.end165 [
    i32 18529, label %sw.bb
    i32 18573, label %sw.bb28
    i32 18565, label %sw.bb68
    i32 18569, label %sw.bb104
    i32 18537, label %sw.bb142
    i32 18541, label %sw.bb143
    i32 18545, label %sw.bb144
    i32 18549, label %sw.bb145
    i32 18553, label %sw.bb146
    i32 18557, label %sw.bb147
    i32 18561, label %sw.bb148
    i32 18585, label %sw.bb149
    i32 18577, label %entry.return_crit_edge
    i32 18580, label %entry.return_crit_edge221
    i32 18581, label %entry.return_crit_edge222
    i32 18436, label %entry.return_crit_edge223
  ]
...
do.end165:                                        ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 176, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %return
...
sw.bb1:                                           ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %3)
  store i32 18537, ptr %info, align 4
  br label %if.then311
...
sw.bb2:                                           ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %4)
  store i32 18541, ptr %info, align 4
  br label %if.then311
...
sw.bb4:                                           ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %5)
  store i32 18545, ptr %info, align 4
  br label %if.then311
...
sw.bb6:                                           ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %6)
  store i32 18549, ptr %info, align 4
  br label %if.then311
...
sw.bb8:                                           ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %7)
  store i32 18553, ptr %info, align 4
  br label %if.then311
...
sw.bb10:                                          ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %8)
  store i32 18557, ptr %info, align 4
  br label %if.then311
...
sw.bb12:                                          ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %9)
  store i32 18561, ptr %info, align 4
  br label %if.then311
...
sw.bb14:                                          ; preds = %sw.bb
  ...
  call void @__asan_store4_noabort(i32 %10)
  store i32 18585, ptr %info, align 4
  br label %if.then311

do.end:                                           ; preds = %sw.bb
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 217, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319
...
do.end68:                                         ; preds = %sw.bb36
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 249, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319
...
sw.bb88:                                          ; preds = %entry
  ...
  call void @__asan_store4_noabort(i32 %21)
  store i32 18529, ptr %info, align 4
...
do.end118:                                        ; preds = %sw.bb88
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 278, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319
...
sw.bb138:                                         ; preds = %entry
  ...
  call void @__asan_store4_noabort(i32 %30)
  store i32 18573, ptr %info, align 4
...
sw.bb187:                                         ; preds = %sw.bb186
  ...
  store i32 18565, ptr %info, align 4
...
do.end208:                                        ; preds = %sw.bb186
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 321, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319
...
sw.bb229:                                         ; preds = %sw.bb228
  ...
  store i32 18569, ptr %info, align 4
...
do.end255:                                        ; preds = %sw.bb228
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 345, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319

do.end290:                                        ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 351, i32 noundef 9, ptr noundef null) #3
  tail call void @kgdb_breakpoint() #3
  br label %if.end319
...
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/gpio/dce110/hw_translate_dce110.c", i32 369, i32 40}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/amd/amdgpu/../display/dc/gpio/dce110/hw_translate_dce110.c", i32 72, i32 4}
