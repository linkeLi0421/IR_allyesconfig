; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/pm/powerplay/hwmgr/smu7_baco.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/smu7_baco.c"
...
@__sancov_gen_cov_switch_values = internal global [11 x i64] [i64 9, i64 32, i64 5, i64 8, i64 10, i64 11, i64 12, i64 15, i64 16, i64 17, i64 18]
@llvm.used = appending global [1 x ptr] [ptr @asan.module_ctor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @smu7_baco_get_capability(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %cap) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  %call2 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef 5335, i32 noundef 0) #2
  %and = and i32 %call2, 2
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @smu7_baco_get_state(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %state) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %hwmgr to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %hwmgr, align 4
  %call = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef 5349, i32 noundef 0) #2
  %and = lshr i32 %call, 6
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @smu7_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %hwmgr to i32
  ...
  switch i32 %3, label %entry.cleanup_crit_edge [
    ...
    i32 16, label %entry.sw.bb4_crit_edge16
    i32 17, label %entry.sw.bb4_crit_edge17
    i32 18, label %entry.sw.bb4_crit_edge18
    i32 5, label %entry.sw.bb6_crit_edge
    i32 8, label %entry.sw.bb6_crit_edge19
  ]
...
sw.bb:                                            ; preds = %entry.sw.bb_crit_edge, %entry.sw.bb_crit_edge15
  %call = tail call i32 @tonga_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) #2
  br label %cleanup

sw.bb2:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %call3 = tail call i32 @fiji_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) #2
  br label %cleanup

sw.bb4:                                           ; preds = %entry.sw.bb4_crit_edge, %entry.sw.bb4_crit_edge16, %entry.sw.bb4_crit_edge17, %entry.sw.bb4_crit_edge18
  %call5 = tail call i32 @polaris_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) #2
  br label %cleanup

sw.bb6:                                           ; preds = %entry.sw.bb6_crit_edge, %entry.sw.bb6_crit_edge19
  %call7 = tail call i32 @ci_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) #2
  br label %cleanup

cleanup:                                          ; preds = %sw.bb6, %sw.bb4, %sw.bb2, %sw.bb, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %call7, %sw.bb6 ], [ %call5, %sw.bb4 ], [ %call3, %sw.bb2 ], [ %call, %sw.bb ], [ -22, %entry.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @tonga_baco_set_state(ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @fiji_baco_set_state(ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @polaris_baco_set_state(ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @ci_baco_set_state(ptr noundef, i32 noundef) local_unnamed_addr #1
