; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/pm/powerplay/hwmgr/smu9_baco.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/smu9_baco.c"
...
define dso_local i32 @smu9_baco_get_capability(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %cap) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  tail call void @amdgpu_device_wreg(ptr noundef %1, i32 noundef 73844, i32 noundef -1048517, i32 noundef 0) #2
  %call2 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef 73845, i32 noundef 0) #2
...
if.then3:                                         ; preds = %if.end
  ...
  br i1 %tobool.not, label %if.then3.cond.false_crit_edge, label %land.lhs.true
...
cond.true:                                        ; preds = %land.lhs.true5
  call void @__sanitizer_cov_trace_pc() #4
  %arrayidx = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  %11 = ptrtoint ptr %arrayidx to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %arrayidx, align 8
  %arrayidx15 = getelementptr i32, ptr %12, i32 2
  %13 = ptrtoint ptr %arrayidx15 to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load i32, ptr %arrayidx15, align 4
  %call16 = tail call i32 %10(ptr noundef %1, i32 noundef %14, i32 noundef 0, i32 noundef 24) #2
  br label %cond.end

cond.false:                                       ; preds = %land.lhs.true5.cond.false_crit_edge, %land.lhs.true.cond.false_crit_edge, %if.then3.cond.false_crit_edge
  %arrayidx18 = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  %15 = ptrtoint ptr %arrayidx18 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %arrayidx18, align 8
  %arrayidx20 = getelementptr i32, ptr %16, i32 2
  %17 = ptrtoint ptr %arrayidx20 to i32
  call void @__asan_load4_noabort(i32 %17)
  %18 = load i32, ptr %arrayidx20, align 4
  %call22 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef %18, i32 noundef 0) #2
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %call16, %cond.true ], [ %call22, %cond.false ]
  %and23 = and i32 %cond, 128
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and23)
  %tobool24.not = icmp eq i32 %and23, 0
  br i1 %tobool24.not, label %cond.end.cleanup_crit_edge, label %if.then25
...
cleanup:                                          ; preds = %if.then25, %cond.end.cleanup_crit_edge, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  ret i32 0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @smu9_baco_get_state(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %state) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %hwmgr to i32
...
cond.true:                                        ; preds = %land.lhs.true3
  ...
  %arrayidx13 = getelementptr i32, ptr %9, i32 2
  %10 = ptrtoint ptr %arrayidx13 to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %arrayidx13, align 4
  %add = add i32 %11, 267
  %call = tail call i32 %7(ptr noundef %1, i32 noundef %add, i32 noundef 0, i32 noundef 24) #2
  br label %cond.end

cond.false:                                       ; preds = %land.lhs.true3.cond.false_crit_edge, %land.lhs.true.cond.false_crit_edge, %entry.cond.false_crit_edge
  %arrayidx15 = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  %12 = ptrtoint ptr %arrayidx15 to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %arrayidx15, align 8
  %arrayidx17 = getelementptr i32, ptr %13, i32 2
  %14 = ptrtoint ptr %arrayidx17 to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load i32, ptr %arrayidx17, align 4
  %add18 = add i32 %15, 267
  %call19 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef %add18, i32 noundef 0) #2
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %call, %cond.true ], [ %call19, %cond.false ]
  %and20 = lshr i32 %cond, 8
  %and20.lobit = and i32 %and20, 1
  %16 = ptrtoint ptr %state to i32
  call void @__asan_store4_noabort(i32 %16)
  store i32 %and20.lobit, ptr %state, align 4
  ret i32 0
}
