; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/pm/powerplay/hwmgr/vega10_baco.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c"
...
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 34, i32 43 }
@___asan_gen_.4 = private unnamed_addr constant [15 x i8] c"enter_baco_tbl\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 42, i32 42 }
@___asan_gen_.7 = private unnamed_addr constant [14 x i8] c"exit_baco_tbl\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 61, i32 42 }
@___asan_gen_.10 = private unnamed_addr constant [15 x i8] c"clean_baco_tbl\00", align 1
@___asan_gen_.11 = private constant [66 x i8] c"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 82, i32 42 }
...
define dso_local i32 @vega10_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) local_unnamed_addr #0 align 64 {
entry:
...
if.then4:                                         ; preds = %if.then2
  %call5 = call i32 @smum_send_msg_to_smc(ptr noundef %hwmgr, i16 noundef zeroext 30, ptr noundef null) #3
...
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c", i32 34, i32 43}
!2 = !{ptr @enter_baco_tbl, !3, !"enter_baco_tbl", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c", i32 42, i32 42}
!4 = !{ptr @exit_baco_tbl, !5, !"exit_baco_tbl", i1 false, i1 false}
!5 = !{!"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c", i32 61, i32 42}
!6 = !{ptr @clean_baco_tbl, !7, !"clean_baco_tbl", i1 false, i1 false}
!7 = !{!"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega10_baco.c", i32 82, i32 42}
