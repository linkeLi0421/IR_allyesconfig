; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/amd/pm/powerplay/hwmgr/vega20_baco.c_pt.bc'
source_filename = "../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega20_baco.c"
...
@___asan_gen_.1 = private unnamed_addr constant [15 x i8] c"clean_baco_tbl\00", align 1
@___asan_gen_.2 = private constant [66 x i8] c"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega20_baco.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 34, i32 42 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @clean_baco_tbl], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @clean_baco_tbl to i32), i32 72, i32 128, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @vega20_baco_get_capability(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %cap) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  %call2 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef 95593, i32 noundef 0) #2
  %5 = and i32 %call2, 536870912
...
cond.true:                                        ; preds = %land.lhs.true6
  ...
  %call17 = tail call i32 %11(ptr noundef %1, i32 noundef %15, i32 noundef 0, i32 noundef 24) #2
  br label %cond.end

cond.false:                                       ; preds = %land.lhs.true6.cond.false_crit_edge, %land.lhs.true.cond.false_crit_edge, %if.then3.cond.false_crit_edge
  %arrayidx19 = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  ...
  %call23 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef %19, i32 noundef 0) #2
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %call17, %cond.true ], [ %call23, %cond.false ]
  %and24 = and i32 %cond, 128
...
cleanup:                                          ; preds = %if.then26, %cond.end.cleanup_crit_edge, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  ret i32 0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @vega20_baco_get_state(ptr nocapture noundef readonly %hwmgr, ptr nocapture noundef writeonly %state) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %hwmgr to i32
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @vega20_baco_set_state(ptr noundef %hwmgr, i32 noundef %state) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %hwmgr to i32
  ...
  %2 = ptrtoint ptr %ras2 to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %ras2, align 8
...
cond.true.i:                                      ; preds = %land.lhs.true3.i
  call void @__sanitizer_cov_trace_pc() #4
  %arrayidx.i = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  %10 = ptrtoint ptr %arrayidx.i to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %arrayidx.i, align 8
  %arrayidx13.i = getelementptr i32, ptr %11, i32 2
  %12 = ptrtoint ptr %arrayidx13.i to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load i32, ptr %arrayidx13.i, align 4
  %add.i = add i32 %13, 267
  %call.i = tail call i32 %9(ptr noundef %1, i32 noundef %add.i, i32 noundef 0, i32 noundef 24) #2
  br label %vega20_baco_get_state.exit
...
cond.false.i:                                     ; preds = %land.lhs.true3.i.cond.false.i_crit_edge, %land.lhs.true.i.cond.false.i_crit_edge, %entry.cond.false.i_crit_edge
  %arrayidx15.i = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 24
  %14 = ptrtoint ptr %arrayidx15.i to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %arrayidx15.i, align 8
  %arrayidx17.i = getelementptr i32, ptr %15, i32 2
  %16 = ptrtoint ptr %arrayidx17.i to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load i32, ptr %arrayidx17.i, align 4
  %add18.i = add i32 %17, 267
  %call19.i = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef %add18.i, i32 noundef 0) #2
  br label %vega20_baco_get_state.exit

vega20_baco_get_state.exit:                       ; preds = %cond.false.i, %cond.true.i
  %cond.i = phi i32 [ %call.i, %cond.true.i ], [ %call19.i, %cond.false.i ]
  %and20.i = lshr i32 %cond.i, 8
  %and20.lobit.i = and i32 %and20.i, 1
  call void @__sanitizer_cov_trace_cmp4(i32 %and20.lobit.i, i32 %state)
  %cmp = icmp eq i32 %and20.lobit.i, %state
  br i1 %cmp, label %vega20_baco_get_state.exit.cleanup_crit_edge, label %if.end

vega20_baco_get_state.exit.cleanup_crit_edge:     ; preds = %vega20_baco_get_state.exit
  call void @__sanitizer_cov_trace_pc() #4
  br label %cleanup

if.end:                                           ; preds = %vega20_baco_get_state.exit
  %18 = zext i32 %state to i64
  call void @__sanitizer_cov_trace_switch(i64 %18, ptr @__sancov_gen_cov_switch_values)
  switch i32 %state, label %if.end.if.end78_crit_edge [
...
if.then4:                                         ; preds = %if.end
  ...
  br i1 %tobool.not, label %if.then4.if.then6_crit_edge, label %lor.lhs.false
...
lor.lhs.false:                                    ; preds = %if.then4
  ...
  %19 = ptrtoint ptr %ras_enabled to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load i32, ptr %ras_enabled, align 8
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %20)
  %tobool5.not = icmp eq i32 %20, 0
  br i1 %tobool5.not, label %lor.lhs.false.if.then6_crit_edge, label %if.else

lor.lhs.false.if.then6_crit_edge:                 ; preds = %lor.lhs.false
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.then6

if.then6:                                         ; preds = %lor.lhs.false.if.then6_crit_edge, %if.then4.if.then6_crit_edge
...
land.lhs.true9:                                   ; preds = %land.lhs.true
  %sriov_rreg = getelementptr inbounds %struct.amdgpu_rlc_funcs, ptr %24, i32 0, i32 13
  %25 = ptrtoint ptr %sriov_rreg to i32
  call void @__asan_load4_noabort(i32 %25)
  %26 = load ptr, ptr %sriov_rreg, align 4
...
cond.true:                                        ; preds = %land.lhs.true9
  ...
  %add = add i32 %30, 129
  %call20 = tail call i32 %26(ptr noundef %1, i32 noundef %add, i32 noundef 0, i32 noundef 25) #2
  br label %cond.end
...
cond.false:                                       ; preds = %land.lhs.true9.cond.false_crit_edge, %land.lhs.true.cond.false_crit_edge, %if.then6.cond.false_crit_edge
  ...
  %add25 = add i32 %34, 129
  %call26 = tail call i32 @amdgpu_device_rreg(ptr noundef %1, i32 noundef %add25, i32 noundef 0) #2
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i32 [ %call20, %cond.true ], [ %call26, %cond.false ]
  ...
  br i1 %tobool30.not, label %cond.end.cond.false51_crit_edge, label %land.lhs.true31
...
land.lhs.true31:                                  ; preds = %cond.end
  ...
  %37 = ptrtoint ptr %funcs34 to i32
  call void @__asan_load4_noabort(i32 %37)
  %38 = load ptr, ptr %funcs34, align 4
...
cond.true41:                                      ; preds = %land.lhs.true36
  ...
  %add50 = add i32 %44, 129
  tail call void %40(ptr noundef %1, i32 noundef %add50, i32 noundef %or, i32 noundef 0, i32 noundef 25) #2
  br label %cond.end57

cond.false51:                                     ; preds = %land.lhs.true36.cond.false51_crit_edge, %land.lhs.true31.cond.false51_crit_edge, %cond.end.cond.false51_crit_edge
  %arrayidx53 = getelementptr %struct.amdgpu_device, ptr %1, i32 0, i32 130, i32 25
  ...
  %add56 = add i32 %48, 129
  tail call void @amdgpu_device_wreg(ptr noundef %1, i32 noundef %add56, i32 noundef %or, i32 noundef 0) #2
  br label %cond.end57

cond.end57:                                       ; preds = %cond.false51, %cond.true41
  %call58 = tail call i32 @smum_send_msg_to_smc_with_parameter(ptr noundef %hwmgr, i16 noundef zeroext 37, i32 noundef 0, ptr noundef null) #2
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call58)
  %tobool59.not = icmp eq i32 %call58, 0
  br i1 %tobool59.not, label %cond.end57.if.end78_crit_edge, label %cond.end57.cleanup_crit_edge

cond.end57.cleanup_crit_edge:                     ; preds = %cond.end57
  call void @__sanitizer_cov_trace_pc() #4
  br label %cleanup

cond.end57.if.end78_crit_edge:                    ; preds = %cond.end57
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.end78

if.else:                                          ; preds = %lor.lhs.false
  %call62 = tail call i32 @smum_send_msg_to_smc_with_parameter(ptr noundef %hwmgr, i16 noundef zeroext 37, i32 noundef 1, ptr noundef null) #2
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call62)
  %tobool63.not = icmp eq i32 %call62, 0
  br i1 %tobool63.not, label %if.else.if.end78_crit_edge, label %if.else.cleanup_crit_edge
...
if.then69:                                        ; preds = %if.end
  %call70 = tail call i32 @smum_send_msg_to_smc(ptr noundef %hwmgr, i16 noundef zeroext 88, ptr noundef null) #2
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call70)
  %tobool71.not = icmp eq i32 %call70, 0
  br i1 %tobool71.not, label %if.end73, label %if.then69.cleanup_crit_edge
...
if.end73:                                         ; preds = %if.then69
  %call74 = tail call zeroext i1 @soc15_baco_program_registers(ptr noundef %hwmgr, ptr noundef nonnull @clean_baco_tbl, i32 noundef 2) #2
  br i1 %call74, label %if.end73.if.end78_crit_edge, label %if.end73.cleanup_crit_edge
...
if.end78:                                         ; preds = %if.end73.if.end78_crit_edge, %if.else.if.end78_crit_edge, %cond.end57.if.end78_crit_edge, %if.end.if.end78_crit_edge
  br label %cleanup

cleanup:                                          ; preds = %if.end78, %if.end73.cleanup_crit_edge, %if.then69.cleanup_crit_edge, %if.else.cleanup_crit_edge, %cond.end57.cleanup_crit_edge, %vega20_baco_get_state.exit.cleanup_crit_edge
  %retval.0 = phi i32 [ 0, %if.end78 ], [ 0, %vega20_baco_get_state.exit.cleanup_crit_edge ], [ -22, %cond.end57.cleanup_crit_edge ], [ -22, %if.else.cleanup_crit_edge ], [ -22, %if.then69.cleanup_crit_edge ], [ -22, %if.end73.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local zeroext i1 @soc15_baco_program_registers(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @vega20_baco_apply_vdci_flush_workaround(ptr noundef %hwmgr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @vega20_set_pptable_driver_address(ptr noundef %hwmgr) #2
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @vega20_set_pptable_driver_address(ptr noundef) local_unnamed_addr #1
...
!0 = !{ptr @clean_baco_tbl, !1, !"clean_baco_tbl", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/amd/amdgpu/../pm/powerplay/hwmgr/vega20_baco.c", i32 34, i32 42}
