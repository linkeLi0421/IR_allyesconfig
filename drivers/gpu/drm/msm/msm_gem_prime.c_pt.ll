; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/msm/msm_gem_prime.c_pt.bc'
...
%struct.dma_buf_map = type { %union.anon.90, i8 }
%union.anon.90 = type { ptr }

@.str = internal constant { [36 x i8], [60 x i8] } { [36 x i8] c"drivers/gpu/drm/msm/msm_gem_prime.c\00", [60 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private constant [39 x i8] c"../drivers/gpu/drm/msm/msm_gem_prime.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 19, i32 6 }
...
define dso_local ptr @msm_gem_prime_get_sg_table(ptr nocapture noundef readonly %obj) local_unnamed_addr #0 align 64 {
entry:
  ...
  br i1 %tobool.not, label %do.end, label %if.end24, !prof !11
...
if.end24:                                         ; preds = %entry
  ...
  %call = tail call ptr @drm_prime_pages_to_sg(ptr noundef %5, ptr noundef nonnull %1, i32 noundef %shr) #2
  br label %cleanup

cleanup:                                          ; preds = %if.end24, %do.end
  %retval.0 = phi ptr [ null, %do.end ], [ %call, %if.end24 ]
  ret ptr %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @msm_gem_prime_vmap(ptr noundef %obj, ptr nocapture noundef writeonly %map) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call ptr @msm_gem_get_vaddr(ptr noundef %obj) #2
...
if.end:                                           ; preds = %entry
  ...
  %2 = ptrtoint ptr %is_iomem.i to i32
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @msm_gem_prime_vunmap(ptr noundef %obj, ptr nocapture noundef readnone %map) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  tail call void @msm_gem_put_vaddr(ptr noundef %obj) #2
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @msm_gem_prime_import_sg_table(ptr noundef %dev, ptr nocapture noundef readonly %attach, ptr noundef %sg) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call = tail call ptr @msm_gem_import(ptr noundef %dev, ptr noundef %1, ptr noundef %sg) #2
  ret ptr %call
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @msm_gem_prime_pin(ptr noundef %obj) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %call = tail call ptr @msm_gem_get_pages(ptr noundef %obj) #2
  br label %if.end
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @msm_gem_prime_unpin(ptr noundef %obj) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %import_attach = getelementptr inbounds %struct.drm_gem_object, ptr %obj, i32 0, i32 8
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @msm_gem_put_pages(ptr noundef %obj) #2
  br label %if.end
...
!1 = !{!"../drivers/gpu/drm/msm/msm_gem_prime.c", i32 19, i32 6}
