; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/dispnv50/core.c_pt.bc'
...
%struct.anon.141 = type { i32, i32, ptr }
...
@__const.nv50_core_new.cores = private unnamed_addr constant [16 x %struct.anon.141] [%struct.anon.141 { i32 50813, i32 0, ptr @corec57d_new }, %struct.anon.141 { i32 50557, i32 0, ptr @corec57d_new }, %struct.anon.141 { i32 50045, i32 0, ptr @corec37d_new }, %struct.anon.141 { i32 39037, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 38781, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 38269, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 38013, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 37501, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 37245, i32 0, ptr @core917d_new }, %struct.anon.141 { i32 36989, i32 0, ptr @core907d_new }, %struct.anon.141 { i32 34173, i32 0, ptr @core827d_new }, %struct.anon.141 { i32 34941, i32 0, ptr @core827d_new }, %struct.anon.141 { i32 33661, i32 0, ptr @core827d_new }, %struct.anon.141 { i32 33405, i32 0, ptr @core827d_new }, %struct.anon.141 { i32 20605, i32 0, ptr @core507d_new }, %struct.anon.141 zeroinitializer], align 4
@nv50_core_new._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 67, ptr @.str.3, ptr @.str.4 }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [37 x i8], [59 x i8] } { [37 x i8] c"%s: No supported core channel class\0A\00", [59 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [14 x i8], [18 x i8] } { [14 x i8] c"nv50_core_new\00", [18 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [40 x i8], [56 x i8] } { [40 x i8] c"drivers/gpu/drm/nouveau/dispnv50/core.c\00", [56 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [3 x i8], [29 x i8] } { [3 x i8] c"\013\00", [29 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"%s %s: \00", [24 x i8] zeroinitializer }, align 32
@nv50_core_new._entry_ptr = internal global ptr @nv50_core_new._entry, section ".printk_index", align 4
@___asan_gen_.5 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.20 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.21 = private constant [43 x i8] c"../drivers/gpu/drm/nouveau/dispnv50/core.c\00", align 1
@___asan_gen_.22 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 67, i32 3 }
@llvm.compiler.used = appending global [7 x ptr] [ptr @nv50_core_new._entry, ptr @nv50_core_new._entry_ptr, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str.4], section "llvm.metadata"
@0 = internal global [6 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv50_core_new._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 37, i32 96, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 14, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 40, i32 96, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 3, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nv50_core_del(ptr nocapture noundef %pcore) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %pcore to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %pcore, align 4
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  %chan = getelementptr inbounds %struct.nv50_core, ptr %1, i32 0, i32 1
  tail call void @nv50_dmac_destroy(ptr noundef %chan) #4
  %2 = ptrtoint ptr %pcore to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %pcore, align 4
  tail call void @kfree(ptr noundef %3) #4
  %4 = ptrtoint ptr %pcore to i32
  call void @__asan_store4_noabort(i32 %4)
  store ptr null, ptr %pcore, align 4
  br label %if.end
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv50_core_new(ptr noundef %drm, ptr noundef %pcore) local_unnamed_addr #0 align 64 {
entry:
...
for.cond5.preheader:                              ; preds = %for.inc22.for.cond5.preheader_crit_edge, %for.cond.preheader
  %11 = phi i32 [ 50813, %for.cond.preheader ], [ %23, %for.inc22.for.cond5.preheader_crit_edge ]
...
for.body7.lr.ph:                                  ; preds = %for.cond5.preheader
  ...
  %version = getelementptr %struct.anon.141, ptr @__const.nv50_core_new.cores, i32 %i.07385, i32 1
  br label %for.body7
...
for.inc22:                                        ; preds = %for.inc.for.inc22_crit_edge, %for.cond5.preheader.for.inc22_crit_edge
  ...
  %arrayidx = getelementptr %struct.anon.141, ptr @__const.nv50_core_new.cores, i32 %inc23
  %22 = ptrtoint ptr %arrayidx to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load i32, ptr %arrayidx, align 4
  %exitcond76 = icmp eq i32 %inc23, 15
...
if.end35:                                         ; preds = %land.lhs.true16
  ...
  call void @nvif_object_sclass_put(ptr noundef nonnull %sclass) #4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %sclass) #4
  %arrayidx36 = getelementptr [16 x %struct.anon.141], ptr @__const.nv50_core_new.cores, i32 0, i32 %i.07385
  %new = getelementptr [16 x %struct.anon.141], ptr @__const.nv50_core_new.cores, i32 0, i32 %i.07385, i32 2
  ...
  %call39 = call i32 %31(ptr noundef %drm, i32 noundef %33, ptr noundef %pcore) #4
  br label %cleanup
...
!1 = !{!"../drivers/gpu/drm/nouveau/dispnv50/core.c", i32 67, i32 3}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @.str.3, !1, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.4, !1, !"<string literal>", i1 false, i1 false}
!6 = !{ptr @nv50_core_new._entry, !1, !"_entry", i1 false, i1 false}
!7 = !{ptr @nv50_core_new._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
