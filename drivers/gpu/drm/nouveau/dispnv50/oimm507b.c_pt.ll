; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/dispnv50/oimm507b.c_pt.bc'
...
@.str = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"kmsOvim\00", [24 x i8] zeroinitializer }, align 32
@oimm507b_init_._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.1, ptr @.str.2, ptr @.str.3, i32 39, ptr @.str.4, ptr @.str.5 }, [40 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [36 x i8], [60 x i8] } { [36 x i8] c"%s: oimm%04x allocation failed: %d\0A\00", [60 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [15 x i8], [17 x i8] } { [15 x i8] c"oimm507b_init_\00", [17 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [44 x i8], [52 x i8] } { [44 x i8] c"drivers/gpu/drm/nouveau/dispnv50/oimm507b.c\00", [52 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [3 x i8], [29 x i8] } { [3 x i8] c"\013\00", [29 x i8] zeroinitializer }, align 32
@.str.5 = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"%s %s: \00", [24 x i8] zeroinitializer }, align 32
@oimm507b_init_._entry_ptr = internal global ptr @oimm507b_init_._entry, section ".printk_index", align 4
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.25, i32 36, i32 46 }
@___asan_gen_.9 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.24 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.25 = private constant [47 x i8] c"../drivers/gpu/drm/nouveau/dispnv50/oimm507b.c\00", align 1
@___asan_gen_.26 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.25, i32 39, i32 3 }
@llvm.compiler.used = appending global [8 x ptr] [ptr @oimm507b_init_._entry, ptr @oimm507b_init_._entry_ptr, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str.4, ptr @.str.5], section "llvm.metadata"
@0 = internal global [7 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @oimm507b_init_._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 36, i32 96, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 15, i32 32, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 44, i32 96, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 3, i32 32, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.5 to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @oimm507b_init(ptr noundef %drm, i32 noundef %oclass, ptr noundef %wndw) local_unnamed_addr #0 align 64 {
entry:
  %args.i = alloca %struct.nv50_disp_overlay_v0, align 1
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %args.i) #4
  %0 = getelementptr inbounds %struct.nv50_disp_overlay_v0, ptr %args.i, i32 0, i32 1
  %1 = getelementptr inbounds %struct.nv50_disp_overlay_v0, ptr %args.i, i32 0, i32 2
  ...
  %6 = call ptr @memset(ptr %1, i32 0, i32 6)
  %dev.i = getelementptr inbounds %struct.nouveau_drm, ptr %drm, i32 0, i32 3
  %7 = ptrtoint ptr %dev.i to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %dev.i, align 8
  %dev_private.i.i.i.i = getelementptr inbounds %struct.drm_device, ptr %8, i32 0, i32 5
  %9 = ptrtoint ptr %dev_private.i.i.i.i to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %dev_private.i.i.i.i, align 4
  %display.i.i.i = getelementptr inbounds %struct.nouveau_drm, ptr %10, i32 0, i32 19
  %11 = ptrtoint ptr %display.i.i.i to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %display.i.i.i, align 4
  ...
  %call2.i = call i32 @nvif_object_ctor(ptr noundef %16, ptr noundef nonnull @.str, i32 noundef 0, i32 noundef %oclass, ptr noundef nonnull %args.i, i32 noundef 8, ptr noundef %wimm.i) #4
...
do.body.i:                                        ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  %drm4.i = getelementptr inbounds %struct.nouveau_drm, ptr %drm, i32 0, i32 2, i32 1
  %17 = ptrtoint ptr %drm4.i to i32
  call void @__asan_load4_noabort(i32 %17)
  %18 = load ptr, ptr %drm4.i, align 8
  %dev5.i = getelementptr inbounds %struct.nouveau_drm, ptr %18, i32 0, i32 3
  %19 = ptrtoint ptr %dev5.i to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load ptr, ptr %dev5.i, align 8
  %dev6.i = getelementptr inbounds %struct.drm_device, ptr %20, i32 0, i32 2
  %21 = ptrtoint ptr %dev6.i to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load ptr, ptr %dev6.i, align 4
  %name.i = getelementptr inbounds %struct.nouveau_drm, ptr %drm, i32 0, i32 2, i32 12
  call void (ptr, ptr, ...) @_dev_err(ptr noundef %22, ptr noundef nonnull @.str.1, ptr noundef %name.i, i32 noundef %oclass, i32 noundef %call2.i) #7
  br label %oimm507b_init_.exit

if.end.i:                                         ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  %call12.i = call i32 @nvif_object_map(ptr noundef %wimm.i, ptr noundef null, i32 noundef 0) #4
  %immd.i = getelementptr inbounds %struct.nv50_wndw, ptr %wndw, i32 0, i32 1
  %23 = ptrtoint ptr %immd.i to i32
  call void @__asan_store4_noabort(i32 %23)
  store ptr @curs507a, ptr %immd.i, align 4
  br label %oimm507b_init_.exit

oimm507b_init_.exit:                              ; preds = %if.end.i, %do.body.i
...
!1 = !{!"../drivers/gpu/drm/nouveau/dispnv50/oimm507b.c", i32 36, i32 46}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/dispnv50/oimm507b.c", i32 39, i32 3}
!4 = !{ptr @.str.2, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.3, !3, !"<string literal>", i1 false, i1 false}
!6 = !{ptr @.str.4, !3, !"<string literal>", i1 false, i1 false}
!7 = !{ptr @.str.5, !3, !"<string literal>", i1 false, i1 false}
!8 = !{ptr @oimm507b_init_._entry, !3, !"_entry", i1 false, i1 false}
!9 = !{ptr @oimm507b_init_._entry_ptr, !3, !"_entry_ptr", i1 false, i1 false}
