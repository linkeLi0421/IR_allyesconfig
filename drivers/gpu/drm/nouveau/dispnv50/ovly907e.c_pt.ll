; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/dispnv50/ovly907e.c_pt.bc'
...
@ovly907e_format = internal constant { [7 x i32], [36 x i8] } { [7 x i32] [i32 1448695129, i32 1498831189, i32 875713112, i32 892424792, i32 808665688, i32 1211384408, i32 0], [36 x i8] zeroinitializer }, align 32
@.str = internal constant { [44 x i8], [52 x i8] } { [44 x i8] c"drivers/gpu/drm/nouveau/dispnv50/ovly907e.c\00", [52 x i8] zeroinitializer }, align 32
...
@__func__.ovly907e_image_set = private unnamed_addr constant [19 x i8] c"ovly907e_image_set\00", align 1
@.str.6 = internal constant { [54 x i8], [42 x i8] } { [54 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SET_PRESENT_CONTROL\0A\00", [42 x i8] zeroinitializer }, align 32
@.str.7 = internal constant { [54 x i8], [42 x i8] } { [54 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SET_CONTEXT_DMA_ISO\0A\00", [42 x i8] zeroinitializer }, align 32
@.str.8 = internal constant { [58 x i8], [38 x i8] } { [58 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SET_COMPOSITION_CONTROL\0A\00", [38 x i8] zeroinitializer }, align 32
@.str.9 = internal constant { [53 x i8], [43 x i8] } { [53 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SURFACE_SET_OFFSET\0A\00", [43 x i8] zeroinitializer }, align 32
@.str.12 = internal constant { [51 x i8], [45 x i8] } { [51 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SURFACE_SET_SIZE\0A\00", [45 x i8] zeroinitializer }, align 32
@.str.13 = internal constant { [54 x i8], [42 x i8] } { [54 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SURFACE_SET_STORAGE\0A\00", [42 x i8] zeroinitializer }, align 32
@.str.14 = internal constant { [53 x i8], [43 x i8] } { [53 x i8] c"[%s/%08x:%s] %08x: %08x-> NV907E_SURFACE_SET_PARAMS\0A\00", [43 x i8] zeroinitializer }, align 32
@___asan_gen_.15 = private unnamed_addr constant [9 x i8] c"ovly907e\00", align 1
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 66, i32 1 }
@___asan_gen_.18 = private unnamed_addr constant [16 x i8] c"ovly907e_format\00", align 1
@___asan_gen_.20 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 80, i32 1 }
@___asan_gen_.35 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 38, i32 2 }
@___asan_gen_.38 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 42, i32 2 }
@___asan_gen_.41 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 44, i32 2 }
@___asan_gen_.44 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 47, i32 2 }
@___asan_gen_.51 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.52 = private constant [47 x i8] c"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c\00", align 1
@___asan_gen_.53 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.52, i32 49, i32 2 }
@llvm.compiler.used = appending global [13 x ptr] [ptr @ovly907e, ptr @ovly907e_format, ptr @.str, ptr @.str.3, ptr @.str.4, ptr @.str.5, ptr @.str.6, ptr @.str.7, ptr @.str.8, ptr @.str.9, ptr @.str.12, ptr @.str.13, ptr @.str.14], section "llvm.metadata"
@0 = internal global [13 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @ovly907e to i32), i32 92, i32 128, i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @ovly907e_format to i32), i32 28, i32 64, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 44, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.35 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.35 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.35 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.5 to i32), i32 50, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.35 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.6 to i32), i32 54, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.35 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.7 to i32), i32 54, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.38 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.8 to i32), i32 58, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.41 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.9 to i32), i32 53, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.44 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.12 to i32), i32 51, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.53 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.13 to i32), i32 54, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.53 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.14 to i32), i32 53, i32 96, i32 ptrtoint (ptr @___asan_gen_.51 to i32), i32 ptrtoint (ptr @___asan_gen_.52 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.53 to i32), i32 -1 }]
...
define internal i32 @ovly907e_image_set(ptr nocapture noundef readonly %wndw, ptr nocapture noundef readonly %asyw) #1 align 64 {
entry:
...
if.then.i:                                        ; preds = %entry
  ...
  %call.i = tail call i32 %7(ptr noundef %1, i32 noundef 12) #2
...
if.end117:                                        ; preds = %do.end111, %if.end80.if.end117_crit_edge
  ...
  tail call void (ptr, ptr, ...) %24(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %28, i32 noundef %30, ptr noundef %32, i32 noundef %sub.ptr.sub, i32 noundef 262276, i32 noundef 132, i32 noundef 1, ptr noundef nonnull @__func__.ovly907e_image_set) #2
...
if.end216:                                        ; preds = %do.end210, %if.end177.if.end216_crit_edge
  ...
  tail call void (ptr, ptr, ...) %55(ptr noundef %mem, ptr noundef nonnull @.str.6, ptr noundef %59, i32 noundef %61, ptr noundef %63, i32 noundef %sub.ptr.sub236, i32 noundef %conv147) #2
...
do.end348:                                        ; preds = %if.end216
  call void @__sanitizer_cov_trace_pc() #4
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 42, i32 noundef 9, ptr noundef nonnull @.str.3) #2
  br label %if.end354
...
if.end393:                                        ; preds = %do.end387, %if.end354.if.end393_crit_edge
  ...
  tail call void (ptr, ptr, ...) %83(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %87, i32 noundef %89, ptr noundef %91, i32 noundef %sub.ptr.sub413, i32 noundef 262336, i32 noundef 192, i32 noundef 1, ptr noundef nonnull @__func__.ovly907e_image_set) #2
...
if.end512:                                        ; preds = %do.end506, %if.end473.if.end512_crit_edge
  ...
  tail call void (ptr, ptr, ...) %113(ptr noundef %mem, ptr noundef nonnull @.str.7, ptr noundef %117, i32 noundef %119, ptr noundef %121, i32 noundef %sub.ptr.sub532, i32 noundef %96) #2
...
do.end644:                                        ; preds = %if.end512
  call void @__sanitizer_cov_trace_pc() #4
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 45, i32 noundef 9, ptr noundef nonnull @.str.3) #2
  br label %if.end650
...
if.end689:                                        ; preds = %do.end683, %if.end650.if.end689_crit_edge
  ...
  tail call void (ptr, ptr, ...) %141(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %145, i32 noundef %147, ptr noundef %149, i32 noundef %sub.ptr.sub709, i32 noundef 262400, i32 noundef 256, i32 noundef 1, ptr noundef nonnull @__func__.ovly907e_image_set) #2
...
if.end806:                                        ; preds = %do.end800, %if.end767.if.end806_crit_edge
  ...
  tail call void (ptr, ptr, ...) %169(ptr noundef %mem, ptr noundef nonnull @.str.8, ptr noundef %173, i32 noundef %175, ptr noundef %177, i32 noundef %sub.ptr.sub826, i32 noundef 2) #2
...
do.end938:                                        ; preds = %if.end806
  call void @__sanitizer_cov_trace_pc() #4
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 47, i32 noundef 9, ptr noundef nonnull @.str.3) #2
  br label %if.end944
...
do.end977:                                        ; preds = %if.end944
  call void @__sanitizer_cov_trace_pc() #4
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 47, i32 noundef 9, ptr noundef nonnull @.str.4) #2
  br label %if.end983
...
if.end983:                                        ; preds = %do.end977, %if.end944.if.end983_crit_edge
  ...
  tail call void (ptr, ptr, ...) %197(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %201, i32 noundef %203, ptr noundef %205, i32 noundef %sub.ptr.sub1003, i32 noundef 263168, i32 noundef 1024, i32 noundef 1, ptr noundef nonnull @__func__.ovly907e_image_set) #2
  ...
  store i32 263168, ptr %207, align 4
...
if.end1103:                                       ; preds = %do.end1097, %if.end1064.if.end1103_crit_edge
  ...
  tail call void (ptr, ptr, ...) %227(ptr noundef %mem, ptr noundef nonnull @.str.9, ptr noundef %231, i32 noundef %233, ptr noundef %235, i32 noundef %sub.ptr.sub1123, i32 noundef %conv1034) #2
...
if.end1340:                                       ; preds = %do.end1334, %if.end1301.if.end1340_crit_edge
  ...
  tail call void (ptr, ptr, ...) %255(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %259, i32 noundef %261, ptr noundef %263, i32 noundef %sub.ptr.sub1360, i32 noundef 787464, i32 noundef 1032, i32 noundef 3, ptr noundef nonnull @__func__.ovly907e_image_set) #2
  ...
  store i32 787464, ptr %265, align 4
  ...
  %conv1390 = zext i16 %268 to i32
  %h = getelementptr inbounds %struct.nv50_wndw_atom, ptr %asyw, i32 0, i32 8, i32 6
  %269 = ptrtoint ptr %h to i32
  call void @__asan_load2_noabort(i32 %269)
  %270 = load i16, ptr %h, align 2
  %conv1394 = zext i16 %270 to i32
  %shl1396 = shl nuw i32 %conv1394, 16
  %or1397 = or i32 %shl1396, %conv1390
  %271 = load ptr, ptr %cur.i, align 4
  %272 = ptrtoint ptr %seg.i to i32
  call void @__asan_load4_noabort(i32 %272)
  %273 = load ptr, ptr %seg.i, align 8
  %cmp1403.not = icmp ult ptr %271, %273
...
if.end1428:                                       ; preds = %do.end1422, %if.end1340.if.end1428_crit_edge
  ...
  %cmp1442.not = icmp ult ptr %275, %277
...
if.end1467:                                       ; preds = %do.end1461, %if.end1428.if.end1467_crit_edge
  ...
  %280 = ptrtoint ptr %map to i32
  call void @__asan_load4_noabort(i32 %280)
  %281 = load ptr, ptr %map, align 8
  %sub.ptr.lhs.cast1485 = ptrtoint ptr %279 to i32
  %sub.ptr.rhs.cast1486 = ptrtoint ptr %281 to i32
  %sub.ptr.sub1487 = sub i32 %sub.ptr.lhs.cast1485, %sub.ptr.rhs.cast1486
  %282 = ptrtoint ptr %mem to i32
  call void @__asan_load4_noabort(i32 %282)
  %283 = load ptr, ptr %mem, align 8
  ...
  %288 = ptrtoint ptr %client to i32
  call void @__asan_load4_noabort(i32 %288)
  %289 = load ptr, ptr %client, align 4
  %name1499 = getelementptr inbounds %struct.nvif_object, ptr %289, i32 0, i32 2
  %290 = ptrtoint ptr %name1499 to i32
  call void @__asan_load4_noabort(i32 %290)
  %291 = load ptr, ptr %name1499, align 8
  %292 = ptrtoint ptr %handle to i32
  call void @__asan_load4_noabort(i32 %292)
  %293 = load i32, ptr %handle, align 4
  %294 = ptrtoint ptr %name134 to i32
  call void @__asan_load4_noabort(i32 %294)
  %295 = load ptr, ptr %name134, align 8
  tail call void (ptr, ptr, ...) %287(ptr noundef %mem, ptr noundef nonnull @.str.12, ptr noundef %291, i32 noundef %293, ptr noundef %295, i32 noundef %sub.ptr.sub1487, i32 noundef %or1397) #2
  %296 = ptrtoint ptr %cur.i to i32
  call void @__asan_load4_noabort(i32 %296)
  %297 = load ptr, ptr %cur.i, align 4
  %incdec.ptr1508 = getelementptr i32, ptr %297, i32 1
  store ptr %incdec.ptr1508, ptr %cur.i, align 4
  %298 = ptrtoint ptr %297 to i32
  call void @__asan_store4_noabort(i32 %298)
  store i32 %or1397, ptr %297, align 4
  %blockh = getelementptr inbounds %struct.nv50_wndw_atom, ptr %asyw, i32 0, i32 8, i32 2
  %299 = ptrtoint ptr %blockh to i32
  call void @__asan_load2_noabort(i32 %299)
  %bf.load1517 = load i16, ptr %blockh, align 2
  %300 = lshr i16 %bf.load1517, 4
  %301 = and i16 %300, 15
  %conv1520 = zext i16 %301 to i32
  %pitch = getelementptr inbounds %struct.nv50_wndw_atom, ptr %asyw, i32 0, i32 8, i32 4
  %302 = ptrtoint ptr %pitch to i32
  call void @__asan_load4_noabort(i32 %302)
  %303 = load i32, ptr %pitch, align 4
  %304 = and i32 %303, 2096896
  %or1529 = or i32 %304, %conv1520
  %blocks = getelementptr inbounds %struct.nv50_wndw_atom, ptr %asyw, i32 0, i32 8, i32 3
  %305 = ptrtoint ptr %blocks to i32
  call void @__asan_load2_noabort(i32 %305)
  %306 = load i16, ptr %blocks, align 4
  %307 = and i16 %306, 8191
  %and1533 = zext i16 %307 to i32
  %shl1534 = shl nuw nsw i32 %and1533, 8
  %or1535 = or i32 %or1529, %shl1534
  %bf.lshr1538 = lshr i16 %bf.load1517, 8
  %308 = and i16 %bf.lshr1538, 1
  %309 = zext i16 %308 to i32
  %shl1543 = shl nuw nsw i32 %309, 24
  ...
  %cmp1550.not = icmp ult ptr %310, %312
...
if.end1575:                                       ; preds = %do.end1569, %if.end1467.if.end1575_crit_edge
  ...
  %cmp1589.not = icmp ult ptr %314, %316
...
if.end1614:                                       ; preds = %do.end1608, %if.end1575.if.end1614_crit_edge
  ...
  %319 = ptrtoint ptr %map to i32
  call void @__asan_load4_noabort(i32 %319)
  %320 = load ptr, ptr %map, align 8
  %sub.ptr.lhs.cast1632 = ptrtoint ptr %318 to i32
  %sub.ptr.rhs.cast1633 = ptrtoint ptr %320 to i32
  %sub.ptr.sub1634 = sub i32 %sub.ptr.lhs.cast1632, %sub.ptr.rhs.cast1633
  %321 = ptrtoint ptr %mem to i32
  call void @__asan_load4_noabort(i32 %321)
  %322 = load ptr, ptr %mem, align 8
  ...
  %327 = ptrtoint ptr %client to i32
  call void @__asan_load4_noabort(i32 %327)
  %328 = load ptr, ptr %client, align 4
  %name1646 = getelementptr inbounds %struct.nvif_object, ptr %328, i32 0, i32 2
  %329 = ptrtoint ptr %name1646 to i32
  call void @__asan_load4_noabort(i32 %329)
  %330 = load ptr, ptr %name1646, align 8
  %331 = ptrtoint ptr %handle to i32
  call void @__asan_load4_noabort(i32 %331)
  %332 = load i32, ptr %handle, align 4
  %333 = ptrtoint ptr %name134 to i32
  call void @__asan_load4_noabort(i32 %333)
  %334 = load ptr, ptr %name134, align 8
  tail call void (ptr, ptr, ...) %326(ptr noundef %mem, ptr noundef nonnull @.str.13, ptr noundef %330, i32 noundef %332, ptr noundef %334, i32 noundef %sub.ptr.sub1634, i32 noundef %or1544) #2
  %335 = ptrtoint ptr %cur.i to i32
  call void @__asan_load4_noabort(i32 %335)
  %336 = load ptr, ptr %cur.i, align 4
  %incdec.ptr1655 = getelementptr i32, ptr %336, i32 1
  store ptr %incdec.ptr1655, ptr %cur.i, align 4
  %337 = ptrtoint ptr %336 to i32
  call void @__asan_store4_noabort(i32 %337)
  store i32 %or1544, ptr %336, align 4
  %format = getelementptr inbounds %struct.nv50_wndw_atom, ptr %asyw, i32 0, i32 8, i32 1
  %338 = ptrtoint ptr %format to i32
  call void @__asan_load1_noabort(i32 %338)
  %339 = load i8, ptr %format, align 1
  %conv1664 = zext i8 %339 to i32
  %shl1666 = shl nuw nsw i32 %conv1664, 8
  %340 = ptrtoint ptr %image to i32
  call void @__asan_load1_noabort(i32 %340)
  %bf.load1668 = load i8, ptr %image, align 8
  %341 = and i8 %bf.load1668, 3
  %and1671 = zext i8 %341 to i32
  ...
  %cmp1679.not = icmp ult ptr %342, %344
...
if.end1704:                                       ; preds = %do.end1698, %if.end1614.if.end1704_crit_edge
  ...
  %cmp1718.not = icmp ult ptr %346, %348
...
if.end1743:                                       ; preds = %do.end1737, %if.end1704.if.end1743_crit_edge
  ...
  %sub.ptr.lhs.cast1761 = ptrtoint ptr %350 to i32
  %sub.ptr.rhs.cast1762 = ptrtoint ptr %352 to i32
  ...
  %name1775 = getelementptr inbounds %struct.nvif_object, ptr %360, i32 0, i32 2
  %361 = ptrtoint ptr %name1775 to i32
  call void @__asan_load4_noabort(i32 %361)
  %362 = load ptr, ptr %name1775, align 8
  ...
  tail call void (ptr, ptr, ...) %358(ptr noundef %mem, ptr noundef nonnull @.str.14, ptr noundef %362, i32 noundef %364, ptr noundef %366, i32 noundef %sub.ptr.sub1763, i32 noundef %or1673) #2
  %367 = ptrtoint ptr %cur.i to i32
  call void @__asan_load4_noabort(i32 %367)
  %368 = load ptr, ptr %cur.i, align 4
  %incdec.ptr1784 = getelementptr i32, ptr %368, i32 1
  store ptr %incdec.ptr1784, ptr %cur.i, align 4
  %369 = ptrtoint ptr %368 to i32
  call void @__asan_store4_noabort(i32 %369)
  store i32 %or1673, ptr %368, align 4
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @ovly907e_new(ptr noundef %drm, i32 noundef %head, i32 noundef %oclass, ptr noundef %pwndw) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %mul = shl i32 %head, 2
  %shl = shl i32 4, %mul
  %call = tail call i32 @ovly507e_new_(ptr noundef nonnull @ovly907e, ptr noundef nonnull @ovly907e_format, ptr noundef %drm, i32 noundef %head, i32 noundef %oclass, i32 noundef %shl, ptr noundef %pwndw) #2
  ret i32 %call
}
...
!llvm.asan.globals = !{!0, !2, !4, !5, !6, !7, !8, !9, !10, !11, !13, !15, !17, !19, !20, !21, !22, !23}
!llvm.module.flags = !{!25, !26, !27, !28, !29, !30, !31, !32}
!llvm.ident = !{!33}

!0 = !{ptr @ovly907e, !1, !"ovly907e", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 66, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 38, i32 2}
...
!9 = !{ptr @__func__.ovly907e_image_set, !3, !"<string literal>", i1 false, i1 false}
!10 = !{ptr @.str.6, !3, !"<string literal>", i1 false, i1 false}
!11 = !{ptr @.str.7, !12, !"<string literal>", i1 false, i1 false}
!12 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 42, i32 2}
!13 = !{ptr @.str.8, !14, !"<string literal>", i1 false, i1 false}
!14 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 44, i32 2}
!15 = !{ptr @.str.9, !16, !"<string literal>", i1 false, i1 false}
!16 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 47, i32 2}
!17 = distinct !{null, !18, !"<string literal>", i1 false, i1 false}
!18 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 49, i32 2}
...
!22 = !{ptr @.str.14, !18, !"<string literal>", i1 false, i1 false}
!23 = !{ptr @ovly907e_format, !24, !"ovly907e_format", i1 false, i1 false}
!24 = !{!"../drivers/gpu/drm/nouveau/dispnv50/ovly907e.c", i32 80, i32 1}
