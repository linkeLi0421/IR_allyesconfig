; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/dispnv50/sor507d.c_pt.bc'
...
@sor507d = dso_local constant { %struct.nv50_outp_func, [24 x i8] } { %struct.nv50_outp_func { ptr @sor507d_ctrl, ptr @sor507d_get_caps }, [24 x i8] zeroinitializer }, align 32
@.str = internal constant { [43 x i8], [53 x i8] } { [43 x i8] c"drivers/gpu/drm/nouveau/dispnv50/sor507d.c\00", [53 x i8] zeroinitializer }, align 32
...
@__func__.sor507d_ctrl = private unnamed_addr constant [13 x i8] c"sor507d_ctrl\00", align 1
@.str.6 = internal constant { [54 x i8], [42 x i8] } { [54 x i8] c"[%s/%08x:%s] %08x: %08x-> NV507D_SOR_SET_CONTROL(or)\0A\00", [42 x i8] zeroinitializer }, align 32
@___asan_gen_.7 = private unnamed_addr constant [8 x i8] c"sor507d\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.26, i32 56, i32 1 }
@___asan_gen_.25 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.26 = private constant [46 x i8] c"../drivers/gpu/drm/nouveau/dispnv50/sor507d.c\00", align 1
@___asan_gen_.27 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.26, i32 45, i32 2 }
@llvm.compiler.used = appending global [7 x ptr] [ptr @sor507d, ptr @.str, ptr @.str.1, ptr @.str.3, ptr @.str.4, ptr @.str.5, ptr @.str.6], section "llvm.metadata"
@0 = internal global [7 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @sor507d to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 43, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 5, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.5 to i32), i32 50, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.6 to i32), i32 54, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sor507d_ctrl(ptr nocapture noundef readonly %core, i32 noundef %or, i32 noundef %ctrl, ptr noundef readonly %asyh) #0 align 64 {
entry:
...
if.end160:                                        ; preds = %do.end154, %if.end122.if.end160_crit_edge
  ...
  tail call void (ptr, ptr, ...) %33(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %37, i32 noundef %39, ptr noundef %41, i32 noundef %sub.ptr.sub, i32 noundef %15, i32 noundef %add, i32 noundef 1, ptr noundef nonnull @__func__.sor507d_ctrl) #3
...
define internal void @sor507d_get_caps(ptr nocapture noundef readnone %core, ptr nocapture noundef %outp, i32 noundef %or) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
!0 = !{ptr @sor507d, !1, !"sor507d", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/dispnv50/sor507d.c", i32 56, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/dispnv50/sor507d.c", i32 45, i32 2}
...
!9 = !{ptr @__func__.sor507d_ctrl, !3, !"<string literal>", i1 false, i1 false}
