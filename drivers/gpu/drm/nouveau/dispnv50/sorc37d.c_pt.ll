; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/dispnv50/sorc37d.c_pt.bc'
...
@sorc37d = dso_local constant { %struct.nv50_outp_func, [24 x i8] } { %struct.nv50_outp_func { ptr @sorc37d_ctrl, ptr @sorc37d_get_caps }, [24 x i8] zeroinitializer }, align 32
@.str = internal constant { [43 x i8], [53 x i8] } { [43 x i8] c"drivers/gpu/drm/nouveau/dispnv50/sorc37d.c\00", [53 x i8] zeroinitializer }, align 32
...
@__func__.sorc37d_ctrl = private unnamed_addr constant [13 x i8] c"sorc37d_ctrl\00", align 1
@.str.6 = internal constant { [54 x i8], [42 x i8] } { [54 x i8] c"[%s/%08x:%s] %08x: %08x-> NVC37D_SOR_SET_CONTROL(or)\0A\00", [42 x i8] zeroinitializer }, align 32
@___asan_gen_.7 = private unnamed_addr constant [8 x i8] c"sorc37d\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.26, i32 51, i32 1 }
@___asan_gen_.25 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.26 = private constant [46 x i8] c"../drivers/gpu/drm/nouveau/dispnv50/sorc37d.c\00", align 1
@___asan_gen_.27 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.26, i32 38, i32 2 }
@llvm.compiler.used = appending global [7 x ptr] [ptr @sorc37d, ptr @.str, ptr @.str.1, ptr @.str.3, ptr @.str.4, ptr @.str.5, ptr @.str.6], section "llvm.metadata"
@0 = internal global [7 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @sorc37d to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 43, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 5, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.5 to i32), i32 50, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.6 to i32), i32 54, i32 96, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @sorc37d_ctrl(ptr nocapture noundef readonly %core, i32 noundef %or, i32 noundef %ctrl, ptr nocapture noundef readnone %asyh) #0 align 64 {
entry:
...
do.body3:                                         ; preds = %if.then.i.do.body3_crit_edge, %entry.do.body3_crit_edge
  ...
  %tobool4.not = icmp ult i32 %add, 16384
...
if.end131:                                        ; preds = %do.end125, %if.end93.if.end131_crit_edge
  ...
  tail call void (ptr, ptr, ...) %30(ptr noundef %mem, ptr noundef nonnull @.str.5, ptr noundef %34, i32 noundef %36, ptr noundef %38, i32 noundef %sub.ptr.sub, i32 noundef %12, i32 noundef %add, i32 noundef 1, ptr noundef nonnull @__func__.sorc37d_ctrl) #2
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @sorc37d_get_caps(ptr noundef %disp, ptr nocapture noundef %outp, i32 noundef %or) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %map = getelementptr inbounds %struct.nv50_disp, ptr %disp, i32 0, i32 2, i32 6
  %0 = ptrtoint ptr %map to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %map, align 8
  %tobool.not = icmp eq ptr %1, null
  br i1 %tobool.not, label %if.else, label %if.then, !prof !21
...
if.then:                                          ; preds = %entry
  ...
  %2 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #2, !srcloc !22
...
if.else:                                          ; preds = %entry
  ...
  %mul7 = shl i32 %or, 3
  %add8 = add i32 %mul7, 324
  %conv = sext i32 %add8 to i64
  %call9 = tail call i32 @nvif_object_rd(ptr noundef %caps, i32 noundef 4, i64 noundef %conv) #2
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %_data.0 = phi i32 [ %2, %if.then ], [ %call9, %if.else ]
  %caps16 = getelementptr inbounds %struct.nouveau_encoder, ptr %outp, i32 0, i32 13
  %3 = ptrtoint ptr %caps16 to i32
  call void @__asan_load1_noabort(i32 %3)
  %bf.load = load i8, ptr %caps16, align 4
  %sh.diff = lshr i32 %_data.0, 19
  %tr.sh.diff = trunc i32 %sh.diff to i8
  %bf.shl = and i8 %tr.sh.diff, -128
  %bf.clear = and i8 %bf.load, 127
  %bf.set = or i8 %bf.shl, %bf.clear
  store i8 %bf.set, ptr %caps16, align 4
  ret void
}
...
!0 = !{ptr @sorc37d, !1, !"sorc37d", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/dispnv50/sorc37d.c", i32 51, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/dispnv50/sorc37d.c", i32 38, i32 2}
...
!9 = !{ptr @__func__.sorc37d_ctrl, !3, !"<string literal>", i1 false, i1 false}
