; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nouveau_sgdma.c_pt.bc'
...
define dso_local void @nouveau_sgdma_destroy(ptr nocapture noundef readnone %bdev, ptr noundef %ttm) local_unnamed_addr #0 align 64 {
entry:
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @ttm_tt_fini(ptr noundef nonnull %ttm) #3
  tail call void @kfree(ptr noundef nonnull %ttm) #3
  br label %if.end
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nouveau_sgdma_bind(ptr nocapture noundef readonly %bdev, ptr noundef %ttm, ptr noundef %reg) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %mem2 = getelementptr inbounds %struct.nouveau_sgdma_be, ptr %ttm, i32 0, i32 1
  %0 = ptrtoint ptr %mem2 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %mem2, align 4
...
if.end:                                           ; preds = %entry
  %call4 = tail call i32 @nouveau_mem_host(ptr noundef %reg, ptr noundef %ttm) #3
...
if.then9:                                         ; preds = %if.end7
  %cli = getelementptr inbounds %struct.nouveau_mem, ptr %reg, i32 0, i32 1
  %4 = ptrtoint ptr %cli to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %cli, align 8
  %vmm10 = getelementptr inbounds %struct.nouveau_cli, ptr %5, i32 0, i32 5, i32 1
  %vma = getelementptr inbounds %struct.nouveau_mem, ptr %reg, i32 0, i32 5
  %call11 = tail call i32 @nouveau_mem_map(ptr noundef %reg, ptr noundef %vmm10, ptr noundef %vma) #3
...
if.then13:                                        ; preds = %if.then9
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @nouveau_mem_fini(ptr noundef %reg) #3
  br label %cleanup

if.end15:                                         ; preds = %if.then9.if.end15_crit_edge, %if.end7.if.end15_crit_edge
  %6 = ptrtoint ptr %mem2 to i32
  call void @__asan_store4_noabort(i32 %6)
  store ptr %reg, ptr %mem2, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end15, %if.then13, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %call11, %if.then13 ], [ 0, %if.end15 ], [ 0, %entry.cleanup_crit_edge ], [ %call4, %if.end.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nouveau_sgdma_unbind(ptr nocapture noundef readnone %bdev, ptr nocapture noundef %ttm) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %mem = getelementptr inbounds %struct.nouveau_sgdma_be, ptr %ttm, i32 0, i32 1
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @nouveau_mem_fini(ptr noundef nonnull %1) #3
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @nouveau_sgdma_create_ttm(ptr noundef %bo, i32 noundef %page_flags) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %force_coherent = getelementptr inbounds %struct.nouveau_bo, ptr %bo, i32 0, i32 5
  %0 = ptrtoint ptr %force_coherent to i32
  call void @__asan_load1_noabort(i32 %0)
  %1 = load i8, ptr %force_coherent, align 4, !range !9
...
if.else:                                          ; preds = %entry
  ...
  %agp = getelementptr i8, ptr %3, i32 -20
...
if.end5:                                          ; preds = %if.else, %entry.if.end5_crit_edge
  %caching.0 = phi i32 [ 0, %entry.if.end5_crit_edge ], [ %., %if.else ]
...
if.end9:                                          ; preds = %if.end5
  %call10 = tail call i32 @ttm_sg_tt_init(ptr noundef nonnull %call7.i.i, ptr noundef %bo, i32 noundef %page_flags, i32 noundef %caching.0) #3
...
cleanup:                                          ; preds = %if.then12, %if.end9.cleanup_crit_edge, %if.end5.cleanup_crit_edge
  %retval.0 = phi ptr [ null, %if.then12 ], [ null, %if.end5.cleanup_crit_edge ], [ %call7.i.i, %if.end9.cleanup_crit_edge ]
  ret ptr %retval.0
}
