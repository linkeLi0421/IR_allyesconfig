; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/disp/cursnv50.c_pt.bc'
...
@nv50_disp_curs_new_._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 44, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [60 x i8], [36 x i8] } { [60 x i8] c"\016nouveau: %s:%08x:%08x: ioctl: create disp cursor size %d\0A\00", [36 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [20 x i8], [44 x i8] } { [20 x i8] c"nv50_disp_curs_new_\00", [44 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [52 x i8], [44 x i8] } { [52 x i8] c"drivers/gpu/drm/nouveau/nvkm/engine/disp/cursnv50.c\00", [44 x i8] zeroinitializer }, align 32
@nv50_disp_curs_new_._entry_ptr = internal global ptr @nv50_disp_curs_new_._entry, section ".printk_index", align 4
@nv50_disp_curs_new_._entry.3 = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.4, ptr @.str.1, ptr @.str.2, i32 47, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [68 x i8], [60 x i8] } { [68 x i8] c"\016nouveau: %s:%08x:%08x: ioctl: create disp cursor vers %d head %d\0A\00", [60 x i8] zeroinitializer }, align 32
@nv50_disp_curs_new_._entry_ptr.5 = internal global ptr @nv50_disp_curs_new_._entry.3, section ".printk_index", align 4
@nv50_disp_pioc_func = external dso_local constant %struct.nv50_disp_chan_func, align 4
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 44, i32 2 }
@___asan_gen_.18 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.21 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.22 = private constant [55 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/disp/cursnv50.c\00", align 1
@___asan_gen_.23 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 46, i32 3 }
@llvm.compiler.used = appending global [8 x ptr] [ptr @nv50_disp_curs_new_._entry, ptr @nv50_disp_curs_new_._entry.3, ptr @nv50_disp_curs_new_._entry_ptr, ptr @nv50_disp_curs_new_._entry_ptr.5, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.4], section "llvm.metadata"
@0 = internal global [6 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv50_disp_curs_new_._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 60, i32 96, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 20, i32 64, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 52, i32 96, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv50_disp_curs_new_._entry.3 to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 68, i32 128, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv50_disp_curs_new_(ptr noundef %func, ptr noundef %disp, i32 noundef %ctrl, i32 noundef %user, ptr noundef %oclass, ptr nocapture noundef readonly %argv, i32 noundef %argc, ptr noundef %pobject) local_unnamed_addr #0 align 64 {
entry:
...
do.end33:                                         ; preds = %do.body23
  ...
  %head41 = getelementptr inbounds %struct.nv50_disp_cursor_v0, ptr %argv, i32 0, i32 1
  %22 = ptrtoint ptr %head41 to i32
  call void @__asan_load1_noabort(i32 %22)
  %23 = load i8, ptr %head41, align 1
  %conv42 = zext i8 %23 to i32
  %call43 = tail call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.4, ptr noundef %name35, i32 noundef %17, i32 noundef %19, i32 noundef %conv40, i32 noundef %conv42) #6
  br label %if.end44

if.end44:                                         ; preds = %do.end33, %do.body23.if.end44_crit_edge
  %base = getelementptr inbounds %struct.nv50_disp, ptr %disp, i32 0, i32 1
  %head47 = getelementptr inbounds %struct.nv50_disp_cursor_v0, ptr %argv, i32 0, i32 1
  %24 = ptrtoint ptr %head47 to i32
  call void @__asan_load1_noabort(i32 %24)
  %25 = load i8, ptr %head47, align 1
...
if.end52:                                         ; preds = %if.end44
  ...
  %add = add i32 %conv54, %ctrl
  %add56 = add i32 %conv54, %user
  %call57 = tail call i32 @nv50_disp_chan_new_(ptr noundef %func, ptr noundef null, ptr noundef %disp, i32 noundef %add, i32 noundef %add56, i32 noundef %conv54, ptr noundef %oclass, ptr noundef %pobject) #3
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv50_disp_curs_new(ptr noundef %oclass, ptr nocapture noundef readonly %argv, i32 noundef %argc, ptr noundef %disp, ptr noundef %pobject) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nv50_disp_curs_new_(ptr noundef nonnull @nv50_disp_pioc_func, ptr noundef %disp, i32 noundef 7, i32 noundef 7, ptr noundef %oclass, ptr noundef %argv, i32 noundef %argc, ptr noundef %pobject)
  ret i32 %call
}
...
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/disp/cursnv50.c", i32 44, i32 2}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @nv50_disp_curs_new_._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @nv50_disp_curs_new_._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.4, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/disp/cursnv50.c", i32 46, i32 3}
!8 = !{ptr @nv50_disp_curs_new_._entry.3, !7, !"_entry", i1 false, i1 false}
!9 = !{ptr @nv50_disp_curs_new_._entry_ptr.5, !7, !"_entry_ptr", i1 false, i1 false}
