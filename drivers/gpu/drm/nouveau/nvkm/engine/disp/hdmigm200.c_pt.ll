; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/disp/hdmigm200.c_pt.bc'
...
define dso_local void @gm200_hdmi_scdc(ptr nocapture noundef %ior, i8 noundef zeroext %scdc) local_unnamed_addr #0 align 64 {
entry:
  ...
  %add = add i32 %mul.i, 6407612
  %pri = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 11
  %7 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %pri, align 4
  %add.ptr = getelementptr i8, ptr %8, i32 %add
  %9 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #2, !srcloc !9
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr5, i32 %or) #2, !srcloc !12
  %tmds = getelementptr inbounds %struct.nvkm_ior, ptr %ior, i32 0, i32 10
  %and8 = lshr i8 %scdc, 1
  %and8.lobit = and i8 %and8, 1
  %12 = ptrtoint ptr %tmds to i32
  call void @__asan_store1_noabort(i32 %12)
  store i8 %and8.lobit, ptr %tmds, align 4
  ret void
}
