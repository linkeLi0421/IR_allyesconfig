; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/disp/headnv50.c_pt.bc'
...
@nv50_head = internal constant { %struct.nvkm_head_func, [44 x i8] } { %struct.nvkm_head_func { ptr @nv50_head_state, ptr @nv50_head_rgpos, ptr @nv50_head_rgclk, ptr @nv50_head_vblank_get, ptr @nv50_head_vblank_put }, [44 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [10 x i8] c"nv50_head\00", align 1
@___asan_gen_.2 = private constant [55 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/disp/headnv50.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 80, i32 1 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @nv50_head], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv50_head to i32), i32 20, i32 64, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nv50_head_rgpos(ptr nocapture noundef readonly %head, ptr nocapture noundef writeonly %hline, ptr nocapture noundef writeonly %vline) #0 align 64 {
entry:
  ...
  %add = add i32 %mul, 6382400
  %add.ptr = getelementptr i8, ptr %7, i32 %add
  %8 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #3, !srcloc !11
  ...
  %add4 = add i32 %mul, 6382404
  %add.ptr5 = getelementptr i8, ptr %11, i32 %add4
  %12 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr5) #3, !srcloc !11
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv50_head_new(ptr noundef %disp, i32 noundef %id) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_head_new_(ptr noundef nonnull @nv50_head, ptr noundef %disp, i32 noundef %id) #3
  ret i32 %call
}
...
define dso_local i32 @nv50_head_cnt(ptr nocapture noundef readnone %disp, ptr nocapture noundef writeonly %pmask) local_unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %pmask to i32
  call void @__asan_store4_noabort(i32 %0)
  store i32 3, ptr %pmask, align 4
  ret i32 2
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @nv50_head_state(ptr noundef readonly %head, ptr noundef writeonly %state) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %disp = getelementptr inbounds %struct.nvkm_head, ptr %head, i32 0, i32 1
  ...
  %mul2 = select i1 %cmp, i32 4, i32 0
  %add = or i32 %mul, %mul2
  %pri = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 11
  %6 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %pri, align 4
  %add3 = add i32 %add, 6359784
  ...
  %9 = ptrtoint ptr %vblanke to i32
  call void @__asan_store2_noabort(i32 %9)
  store i16 %conv4, ptr %vblanke, align 4
  %conv6 = trunc i32 %8 to i16
  %hblanke = getelementptr inbounds %struct.nvkm_head_state, ptr %state, i32 0, i32 2
  %10 = ptrtoint ptr %hblanke to i32
  call void @__asan_store2_noabort(i32 %10)
  store i16 %conv6, ptr %hblanke, align 4
  %11 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %pri, align 4
  %add9 = add i32 %add, 6359792
  %add.ptr10 = getelementptr i8, ptr %12, i32 %add9
  %13 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr10) #3, !srcloc !11
  ...
  %14 = ptrtoint ptr %vblanks to i32
  call void @__asan_store2_noabort(i32 %14)
  store i16 %conv15, ptr %vblanks, align 2
  %conv17 = trunc i32 %13 to i16
  %hblanks = getelementptr inbounds %struct.nvkm_head_state, ptr %state, i32 0, i32 3
  %15 = ptrtoint ptr %hblanks to i32
  call void @__asan_store2_noabort(i32 %15)
  store i16 %conv17, ptr %hblanks, align 2
  %16 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %pri, align 4
  %add20 = add i32 %add, 6359800
  %add.ptr21 = getelementptr i8, ptr %17, i32 %add20
  %18 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr21) #3, !srcloc !11
  ...
  %19 = ptrtoint ptr %vtotal to i32
  call void @__asan_store2_noabort(i32 %19)
  store i16 %conv26, ptr %vtotal, align 4
  ...
  %add31 = add i32 %add, 6359808
  %add.ptr32 = getelementptr i8, ptr %22, i32 %add31
  %23 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr32) #3, !srcloc !11
  ...
  %24 = ptrtoint ptr %vsynce to i32
  call void @__asan_store2_noabort(i32 %24)
  store i16 %conv37, ptr %vsynce, align 2
  %conv39 = trunc i32 %23 to i16
  %hsynce = getelementptr inbounds %struct.nvkm_head_state, ptr %state, i32 0, i32 1
  %25 = ptrtoint ptr %hsynce to i32
  call void @__asan_store2_noabort(i32 %25)
  store i16 %conv39, ptr %hsynce, align 2
  %26 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %pri, align 4
  %add42 = add i32 %add, 6359760
  %add.ptr43 = getelementptr i8, ptr %27, i32 %add42
  %28 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr43) #3, !srcloc !11
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #3, !srcloc !18
  %and46 = and i32 %28, 4194303
  %mul47 = mul nuw i32 %and46, 1000
  %hz = getelementptr inbounds %struct.nvkm_head_state, ptr %state, i32 0, i32 8
  %29 = ptrtoint ptr %hz to i32
  call void @__asan_store4_noabort(i32 %29)
  store i32 %mul47, ptr %hz, align 4
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @nv50_head_rgclk(ptr nocapture noundef readonly %head, i32 noundef %div) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %disp = getelementptr inbounds %struct.nvkm_head, ptr %head, i32 0, i32 1
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr3, i32 %or) #3, !srcloc !21
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @nv50_head_vblank_get(ptr nocapture noundef readonly %head) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %disp = getelementptr inbounds %struct.nvkm_head, ptr %head, i32 0, i32 1
  ...
  %add.ptr = getelementptr i8, ptr %5, i32 6357036
  ...
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %pri, align 4
  %add.ptr5 = getelementptr i8, ptr %10, i32 6357036
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr5, i32 %or) #3, !srcloc !21
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @nv50_head_vblank_put(ptr nocapture noundef readonly %head) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %disp = getelementptr inbounds %struct.nvkm_head, ptr %head, i32 0, i32 1
  ...
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %pri, align 4
  %add.ptr3 = getelementptr i8, ptr %10, i32 6357036
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr3, i32 %and) #3, !srcloc !21
  ret void
}
...
!0 = !{ptr @nv50_head, !1, !"nv50_head", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/disp/headnv50.c", i32 80, i32 1}
