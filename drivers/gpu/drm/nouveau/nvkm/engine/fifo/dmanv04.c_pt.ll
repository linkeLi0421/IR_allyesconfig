; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c_pt.bc'
...
@nv04_fifo_dma_func = dso_local constant { %struct.nvkm_fifo_chan_func, [52 x i8] } { %struct.nvkm_fifo_chan_func { ptr @nv04_fifo_dma_dtor, ptr @nv04_fifo_dma_init, ptr @nv04_fifo_dma_fini, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @nv04_fifo_dma_object_ctor, ptr @nv04_fifo_dma_object_dtor, ptr null }, [52 x i8] zeroinitializer }, align 32
@nv04_fifo_dma_oclass = dso_local constant { %struct.nvkm_fifo_chan_oclass, [40 x i8] } { %struct.nvkm_fifo_chan_oclass { ptr @nv04_fifo_dma_new, %struct.nvkm_sclass { i32 0, i32 0, i32 107, ptr null, ptr null } }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [51 x i8], [45 x i8] } { [51 x i8] c"drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c\00", [45 x i8] zeroinitializer }, align 32
@nv04_fifo_dma_new._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.1, ptr @.str.2, ptr @.str, i32 178, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [60 x i8], [36 x i8] } { [60 x i8] c"\016nouveau: %s:%08x:%08x: ioctl: create channel dma size %d\0A\00", [36 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [18 x i8], [46 x i8] } { [18 x i8] c"nv04_fifo_dma_new\00", [46 x i8] zeroinitializer }, align 32
@nv04_fifo_dma_new._entry_ptr = internal global ptr @nv04_fifo_dma_new._entry, section ".printk_index", align 4
@nv04_fifo_dma_new._entry.3 = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.4, ptr @.str.2, ptr @.str, i32 182, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
...
@nv04_fifo_dma_new._entry_ptr.5 = internal global ptr @nv04_fifo_dma_new._entry.3, section ".printk_index", align 4
@kmalloc_caches = external dso_local local_unnamed_addr global [4 x [14 x ptr]], align 4
@__sancov_gen_cov_switch_values = internal global [6 x i64] [i64 4, i64 32, i64 31, i64 33, i64 36, i64 48]
@___asan_gen_.6 = private unnamed_addr constant [19 x i8] c"nv04_fifo_dma_func\00", align 1
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.28, i32 156, i32 1 }
@___asan_gen_.9 = private unnamed_addr constant [21 x i8] c"nv04_fifo_dma_oclass\00", align 1
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.28, i32 221, i32 1 }
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.28, i32 62, i32 3 }
@___asan_gen_.23 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.28, i32 178, i32 2 }
@___asan_gen_.24 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.27 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.28 = private constant [54 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c\00", align 1
@___asan_gen_.29 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.28, i32 180, i32 3 }
@llvm.compiler.used = appending global [10 x ptr] [ptr @nv04_fifo_dma_new._entry, ptr @nv04_fifo_dma_new._entry.3, ptr @nv04_fifo_dma_new._entry_ptr, ptr @nv04_fifo_dma_new._entry_ptr.5, ptr @nv04_fifo_dma_func, ptr @nv04_fifo_dma_oclass, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.4], section "llvm.metadata"
@0 = internal global [8 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv04_fifo_dma_func to i32), i32 44, i32 96, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv04_fifo_dma_oclass to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 51, i32 96, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv04_fifo_dma_new._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 60, i32 96, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 18, i32 64, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv04_fifo_dma_new._entry.3 to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.29 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 85, i32 128, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 ptrtoint (ptr @___asan_gen_.28 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.29 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nv04_fifo_dma_object_dtor(ptr nocapture noundef readonly %base, i32 noundef %cookie) #0 align 64 {
entry:
  ...
  %6 = ptrtoint ptr %ramht to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %ramht, align 4
  tail call void @nvkm_ramht_remove(ptr noundef %7, i32 noundef %cookie) #4
  %8 = ptrtoint ptr %fifo to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %fifo, align 8
  %mutex7 = getelementptr inbounds %struct.nvkm_fifo, ptr %9, i32 0, i32 6
  tail call void @mutex_unlock(ptr noundef %mutex7) #4
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nv04_fifo_dma_fini(ptr nocapture noundef readonly %base) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %imem = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 32
  %4 = ptrtoint ptr %imem to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %imem, align 4
  %ramfc = getelementptr inbounds %struct.nvkm_instmem, ptr %5, i32 0, i32 10
  %6 = ptrtoint ptr %ramfc to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %ramfc, align 4
  %nr = getelementptr inbounds %struct.nvkm_fifo, ptr %1, i32 0, i32 3
  %8 = ptrtoint ptr %nr to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load i32, ptr %nr, align 4
  %sub = add i32 %9, -1
  %ramfc5 = getelementptr inbounds %struct.nv04_fifo_chan, ptr %base, i32 0, i32 2
  %10 = ptrtoint ptr %ramfc5 to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %ramfc5, align 4
  ...
  %add.ptr15 = getelementptr i8, ptr %13, i32 9472
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr15, i32 0) #4, !srcloc !25
  %14 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %pri, align 4
  %add.ptr17 = getelementptr i8, ptr %15, i32 12804
  %16 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr17) #4, !srcloc !26
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !27
  %and = and i32 %16, %sub
  %chid21 = getelementptr inbounds %struct.nvkm_fifo_chan, ptr %base, i32 0, i32 5
  %17 = ptrtoint ptr %chid21 to i32
  call void @__asan_load2_noabort(i32 %17)
  %18 = load i16, ptr %chid21, align 8
  %conv22 = zext i16 %18 to i32
  call void @__sanitizer_cov_trace_cmp4(i32 %and, i32 %conv22)
  %cmp23 = icmp eq i32 %and, %conv22
...
if.then:                                          ; preds = %entry
  ...
  %add.ptr27 = getelementptr i8, ptr %20, i32 12832
  %21 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr27) #4, !srcloc !26
  ...
  %add.ptr35 = getelementptr i8, ptr %23, i32 12832
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr35, i32 %and33) #4, !srcloc !25
  ...
  %add.ptr41 = getelementptr i8, ptr %25, i32 12800
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr41, i32 0) #4, !srcloc !25
  %26 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %pri, align 4
  %add.ptr47 = getelementptr i8, ptr %27, i32 12880
  %28 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr47) #4, !srcloc !26
  ...
  %add.ptr56 = getelementptr i8, ptr %30, i32 12880
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr56, i32 %and53) #4, !srcloc !25
  %ramfc58 = getelementptr inbounds %struct.nv04_fifo, ptr %1, i32 0, i32 1
  %31 = ptrtoint ptr %ramfc58 to i32
  call void @__asan_load4_noabort(i32 %31)
  %32 = load ptr, ptr %ramfc58, align 4
  %33 = ptrtoint ptr %7 to i32
  call void @__asan_load4_noabort(i32 %33)
  %34 = load ptr, ptr %7, align 4
  %acquire = getelementptr inbounds %struct.nvkm_memory_func, ptr %34, i32 0, i32 7
  %35 = ptrtoint ptr %acquire to i32
  call void @__asan_load4_noabort(i32 %35)
  %36 = load ptr, ptr %acquire, align 4
  %call59 = tail call ptr %36(ptr noundef %7) #4
  %ptrs = getelementptr inbounds %struct.nvkm_memory, ptr %7, i32 0, i32 1
  br label %do.body60

do.body60:                                        ; preds = %do.body60.do.body60_crit_edge, %if.then
  %c.0 = phi ptr [ %32, %if.then ], [ %incdec.ptr, %do.body60.do.body60_crit_edge ]
  %37 = ptrtoint ptr %c.0 to i32
  call void @__asan_load4_noabort(i32 %37)
  %bf.load = load i32, ptr %c.0, align 4
  %bf.lshr = lshr i32 %bf.load, 26
  %sh_prom = zext i32 %bf.lshr to i64
  %notmask = shl nsw i64 -1, %sh_prom
  %sub61 = xor i64 %notmask, -1
  %bf.lshr63 = lshr i32 %bf.load, 8
  %bf.clear = and i32 %bf.lshr63, 31
  %sh_prom64 = zext i32 %bf.clear to i64
  %shl65 = shl i64 %sub61, %sh_prom64
  %conv66 = trunc i64 %shl65 to i32
  %bf.lshr73 = lshr i32 %bf.load, 21
  %bf.clear74 = and i32 %bf.lshr73, 31
  %sh_prom75 = zext i32 %bf.clear74 to i64
  %shl76 = shl i64 %sub61, %sh_prom75
  %conv77 = trunc i64 %shl76 to i32
  %38 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %38)
  %39 = load ptr, ptr %pri, align 4
  %regp = getelementptr inbounds %struct.nv04_fifo_ramfc, ptr %c.0, i32 0, i32 1
  %40 = ptrtoint ptr %regp to i32
  call void @__asan_load4_noabort(i32 %40)
  %41 = load i32, ptr %regp, align 4
  %add.ptr80 = getelementptr i8, ptr %39, i32 %41
  %42 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr80) #4, !srcloc !26
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !33
  %and83 = and i32 %42, %conv66
  %43 = ptrtoint ptr %c.0 to i32
  call void @__asan_load4_noabort(i32 %43)
  %bf.load84 = load i32, ptr %c.0, align 4
  %bf.lshr85 = lshr i32 %bf.load84, 8
  %bf.clear86 = and i32 %bf.lshr85, 31
  %shr = lshr i32 %and83, %bf.clear86
  ...
  %bf.lshr88 = lshr i32 %bf.load84, 13
  %bf.clear89 = and i32 %bf.lshr88, 255
  %add = add i32 %bf.clear89, %11
  %conv90 = zext i32 %add to i64
  %call91 = tail call i32 %47(ptr noundef %7, i64 noundef %conv90) #4
  %neg = xor i32 %conv77, -1
  %and92 = and i32 %call91, %neg
  %48 = ptrtoint ptr %ptrs to i32
  call void @__asan_load4_noabort(i32 %48)
  %49 = load ptr, ptr %ptrs, align 4
  %wr32 = getelementptr inbounds %struct.nvkm_memory_ptrs, ptr %49, i32 0, i32 1
  %50 = ptrtoint ptr %wr32 to i32
  call void @__asan_load4_noabort(i32 %50)
  %51 = load ptr, ptr %wr32, align 4
  %52 = ptrtoint ptr %c.0 to i32
  call void @__asan_load4_noabort(i32 %52)
  %bf.load94 = load i32, ptr %c.0, align 4
  %bf.lshr95 = lshr i32 %bf.load94, 13
  %bf.clear96 = and i32 %bf.lshr95, 255
  %add97 = add i32 %bf.clear96, %11
  %conv98 = zext i32 %add97 to i64
  %bf.lshr100 = lshr i32 %bf.load94, 21
  %bf.clear101 = and i32 %bf.lshr100, 31
  %shl102 = shl i32 %shr, %bf.clear101
  %or103 = or i32 %shl102, %and92
  tail call void %51(ptr noundef %7, i64 noundef %conv98, i32 noundef %or103) #4
  %incdec.ptr = getelementptr %struct.nv04_fifo_ramfc, ptr %c.0, i32 1
  %53 = ptrtoint ptr %incdec.ptr to i32
  call void @__asan_load4_noabort(i32 %53)
  %bf.load105 = load i32, ptr %incdec.ptr, align 4
  %tobool.not = icmp ult i32 %bf.load105, 67108864
  br i1 %tobool.not, label %do.end107, label %do.body60.do.body60_crit_edge

do.body60.do.body60_crit_edge:                    ; preds = %do.body60
  call void @__sanitizer_cov_trace_pc() #6
  br label %do.body60

do.end107:                                        ; preds = %do.body60
  %54 = ptrtoint ptr %7 to i32
  call void @__asan_load4_noabort(i32 %54)
  %55 = load ptr, ptr %7, align 4
  %release = getelementptr inbounds %struct.nvkm_memory_func, ptr %55, i32 0, i32 8
  %56 = ptrtoint ptr %release to i32
  call void @__asan_load4_noabort(i32 %56)
  %57 = load ptr, ptr %release, align 4
  tail call void %57(ptr noundef %7) #4
  %58 = ptrtoint ptr %ramfc58 to i32
  call void @__asan_load4_noabort(i32 %58)
  %59 = load ptr, ptr %ramfc58, align 4
  br label %do.body110

do.body110:                                       ; preds = %do.body110.do.body110_crit_edge, %do.end107
  %c.1 = phi ptr [ %59, %do.end107 ], [ %incdec.ptr118, %do.body110.do.body110_crit_edge ]
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !34
  tail call void @arm_heavy_mb() #4
  %60 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %60)
  %61 = load ptr, ptr %pri, align 4
  %regp115 = getelementptr inbounds %struct.nv04_fifo_ramfc, ptr %c.1, i32 0, i32 1
  %62 = ptrtoint ptr %regp115 to i32
  call void @__asan_load4_noabort(i32 %62)
  %63 = load i32, ptr %regp115, align 4
  %add.ptr116 = getelementptr i8, ptr %61, i32 %63
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr116, i32 0) #4, !srcloc !25
  %incdec.ptr118 = getelementptr %struct.nv04_fifo_ramfc, ptr %c.1, i32 1
  %64 = ptrtoint ptr %incdec.ptr118 to i32
  call void @__asan_load4_noabort(i32 %64)
  %bf.load119 = load i32, ptr %incdec.ptr118, align 4
  %tobool121.not = icmp ult i32 %bf.load119, 67108864
  br i1 %tobool121.not, label %do.body123, label %do.body110.do.body110_crit_edge

do.body110.do.body110_crit_edge:                  ; preds = %do.body110
  call void @__sanitizer_cov_trace_pc() #6
  br label %do.body110

do.body123:                                       ; preds = %do.body110
  call void @__sanitizer_cov_trace_pc() #6
  ...
  %add.ptr127 = getelementptr i8, ptr %66, i32 12912
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr127, i32 0) #4, !srcloc !25
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !36
  tail call void @arm_heavy_mb() #4
  %67 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %67)
  %68 = load ptr, ptr %pri, align 4
  %add.ptr132 = getelementptr i8, ptr %68, i32 12816
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr132, i32 0) #4, !srcloc !25
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !37
  tail call void @arm_heavy_mb() #4
  %69 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %69)
  %70 = load ptr, ptr %pri, align 4
  %add.ptr137 = getelementptr i8, ptr %70, i32 12804
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr137, i32 %sub) #4, !srcloc !25
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !38
  tail call void @arm_heavy_mb() #4
  %71 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %71)
  %72 = load ptr, ptr %pri, align 4
  %add.ptr142 = getelementptr i8, ptr %72, i32 12800
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr142, i32 1) #4, !srcloc !25
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #4, !srcloc !39
  tail call void @arm_heavy_mb() #4
  %73 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %73)
  %74 = load ptr, ptr %pri, align 4
  %add.ptr147 = getelementptr i8, ptr %74, i32 12880
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr147, i32 1) #4, !srcloc !25
  br label %if.end

if.end:                                           ; preds = %do.body123, %entry.if.end_crit_edge
  %75 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %75)
  %76 = load ptr, ptr %pri, align 4
  %add.ptr153 = getelementptr i8, ptr %76, i32 9476
  %77 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr153) #4, !srcloc !26
  ...
  tail call void @arm_heavy_mb() #4
  %78 = ptrtoint ptr %chid21 to i32
  call void @__asan_load2_noabort(i32 %78)
  %79 = load i16, ptr %chid21, align 8
  %conv161 = zext i16 %79 to i32
  %shl162 = shl nuw i32 1, %conv161
  %neg163 = xor i32 %shl162, -1
  %and164 = and i32 %77, %neg163
  %80 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %80)
  %81 = load ptr, ptr %pri, align 4
  %add.ptr167 = getelementptr i8, ptr %81, i32 9476
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr167, i32 %and164) #4, !srcloc !25
  ...
  %add.ptr173 = getelementptr i8, ptr %83, i32 9472
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr173, i32 1) #4, !srcloc !25
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @nv04_fifo_dma_init(ptr nocapture noundef readonly %base) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %fifo1 = getelementptr inbounds %struct.nv04_fifo_chan, ptr %base, i32 0, i32 1
  ...
  %add.ptr12 = getelementptr i8, ptr %7, i32 9476
  %8 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr12) #4, !srcloc !26
  ...
  %add.ptr19 = getelementptr i8, ptr %10, i32 9476
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr19, i32 %or) #4, !srcloc !25
  tail call void @_raw_spin_unlock_irqrestore(ptr noundef %lock, i32 noundef %call9) #4
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @nv04_fifo_dma_dtor(ptr noundef readonly returned %base) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %fifo1 = getelementptr inbounds %struct.nv04_fifo_chan, ptr %base, i32 0, i32 1
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %device, align 4
  %imem3 = getelementptr inbounds %struct.nvkm_device, ptr %3, i32 0, i32 32
  %4 = ptrtoint ptr %imem3 to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %imem3, align 4
  %ramfc = getelementptr inbounds %struct.nv04_fifo, ptr %1, i32 0, i32 1
  %6 = ptrtoint ptr %ramfc to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %ramfc, align 4
  %ramfc4 = getelementptr inbounds %struct.nvkm_instmem, ptr %5, i32 0, i32 10
  %8 = ptrtoint ptr %ramfc4 to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %ramfc4, align 4
  ...
  %call = tail call ptr %13(ptr noundef %9) #4
  %ramfc8 = getelementptr inbounds %struct.nv04_fifo_chan, ptr %base, i32 0, i32 2
  br label %do.body

do.body:                                          ; preds = %do.body.do.body_crit_edge, %entry
  %c.0 = phi ptr [ %7, %entry ], [ %incdec.ptr, %do.body.do.body_crit_edge ]
  %14 = ptrtoint ptr %ramfc4 to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %ramfc4, align 4
  ...
  %20 = ptrtoint ptr %ramfc8 to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load i32, ptr %ramfc8, align 4
  %22 = ptrtoint ptr %c.0 to i32
  call void @__asan_load4_noabort(i32 %22)
  %bf.load = load i32, ptr %c.0, align 4
  %bf.lshr = lshr i32 %bf.load, 13
  %bf.clear = and i32 %bf.lshr, 255
  %add = add i32 %bf.clear, %21
  %conv = zext i32 %add to i64
  tail call void %19(ptr noundef %15, i64 noundef %conv, i32 noundef 0) #4
  %incdec.ptr = getelementptr %struct.nv04_fifo_ramfc, ptr %c.0, i32 1
  %23 = ptrtoint ptr %incdec.ptr to i32
  call void @__asan_load4_noabort(i32 %23)
  %bf.load9 = load i32, ptr %incdec.ptr, align 4
  %tobool.not = icmp ult i32 %bf.load9, 67108864
...
do.end:                                           ; preds = %do.body
  call void @__sanitizer_cov_trace_pc() #6
  %24 = ptrtoint ptr %ramfc4 to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %ramfc4, align 4
  %26 = ptrtoint ptr %25 to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %25, align 4
  %release = getelementptr inbounds %struct.nvkm_memory_func, ptr %27, i32 0, i32 8
  %28 = ptrtoint ptr %release to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %release, align 4
  tail call void %29(ptr noundef %25) #4
  ret ptr %base
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @nv04_fifo_dma_object_ctor(ptr nocapture noundef readonly %base, ptr noundef %object) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %fifo = getelementptr inbounds %struct.nv04_fifo_chan, ptr %base, i32 0, i32 1
  ...
  switch i32 %13, label %do.end [
    ...
    i32 48, label %entry.sw.epilog_crit_edge49
    i32 33, label %sw.bb8
...
sw.epilog:                                        ; preds = %sw.bb10, %sw.bb8, %entry.sw.epilog_crit_edge, %entry.sw.epilog_crit_edge49
  %.sink = phi i32 [ -2147352576, %sw.bb10 ], [ -2147418112, %sw.bb8 ], [ -2147483648, %entry.sw.epilog_crit_edge ], [ -2147483648, %entry.sw.epilog_crit_edge49 ]
  %or11 = or i32 %shl, %.sink
  %mutex = getelementptr inbounds %struct.nvkm_fifo, ptr %1, i32 0, i32 6
  tail call void @mutex_lock_nested(ptr noundef %mutex, i32 noundef 0) #4
  %ramht = getelementptr inbounds %struct.nvkm_instmem, ptr %5, i32 0, i32 8
  ...
  %call = tail call i32 @nvkm_ramht_insert(ptr noundef %16, ptr noundef %object, i32 noundef %conv31, i32 noundef 4, i32 noundef %9, i32 noundef %or11) #4
  %19 = ptrtoint ptr %fifo to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load ptr, ptr %fifo, align 8
  %mutex34 = getelementptr inbounds %struct.nvkm_fifo, ptr %20, i32 0, i32 6
  tail call void @mutex_unlock(ptr noundef %mutex34) #4
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @nv04_fifo_dma_new(ptr noundef %base, ptr noundef %oclass, ptr nocapture noundef %data, i32 noundef %size, ptr nocapture noundef writeonly %pobject) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
...
do.end:                                           ; preds = %entry
  ...
  %call = tail call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.1, ptr noundef %name, i32 noundef %11, i32 noundef %13, i32 noundef %size) #7
  br label %land.lhs.true
...
!llvm.asan.globals = !{!0, !2, !4, !6, !8, !9, !10, !11, !13, !14}
!llvm.module.flags = !{!15, !16, !17, !18, !19, !20, !21, !22}
!llvm.ident = !{!23}

!0 = !{ptr @nv04_fifo_dma_func, !1, !"nv04_fifo_dma_func", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c", i32 156, i32 1}
!2 = !{ptr @nv04_fifo_dma_oclass, !3, !"nv04_fifo_dma_oclass", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c", i32 221, i32 1}
!4 = !{ptr @.str, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c", i32 62, i32 3}
!6 = !{ptr @.str.1, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c", i32 178, i32 2}
!8 = !{ptr @.str.2, !7, !"<string literal>", i1 false, i1 false}
!9 = !{ptr @nv04_fifo_dma_new._entry, !7, !"_entry", i1 false, i1 false}
!10 = !{ptr @nv04_fifo_dma_new._entry_ptr, !7, !"_entry_ptr", i1 false, i1 false}
!11 = !{ptr @.str.4, !12, !"<string literal>", i1 false, i1 false}
!12 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/dmanv04.c", i32 180, i32 3}
!13 = !{ptr @nv04_fifo_dma_new._entry.3, !12, !"_entry", i1 false, i1 false}
!14 = !{ptr @nv04_fifo_dma_new._entry_ptr.5, !12, !"_entry_ptr", i1 false, i1 false}
