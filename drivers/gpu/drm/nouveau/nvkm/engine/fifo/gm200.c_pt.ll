; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/fifo/gm200.c_pt.bc'
...
@gm200_fifo_pbdma = dso_local constant { %struct.gk104_fifo_pbdma_func, [20 x i8] } { %struct.gk104_fifo_pbdma_func { ptr @gm200_fifo_pbdma_nr, ptr @gk104_fifo_pbdma_init, ptr @gk208_fifo_pbdma_init_timeout }, [20 x i8] zeroinitializer }, align 32
@gm200_fifo = internal constant { %struct.gk104_fifo_func, [44 x i8] } { %struct.gk104_fifo_func { %struct.anon { ptr @gm107_fifo_intr_fault }, ptr @gm200_fifo_pbdma, %struct.anon.140 { ptr @gk104_fifo_fault_access, ptr @gm107_fifo_fault_engine, ptr @gk104_fifo_fault_reason, ptr @gk104_fifo_fault_hubclient, ptr @gk104_fifo_fault_gpcclient }, ptr @gm107_fifo_runlist, %struct.gk104_fifo_user_user zeroinitializer, %struct.gk104_fifo_chan_user { %struct.nvkm_sclass { i32 0, i32 0, i32 45167, ptr null, ptr null }, ptr @gk104_fifo_gpfifo_new }, i8 0 }, [44 x i8] zeroinitializer }, align 32
...
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"gm200_fifo_pbdma\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 37, i32 1 }
@___asan_gen_.4 = private unnamed_addr constant [11 x i8] c"gm200_fifo\00", align 1
@___asan_gen_.5 = private constant [52 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/gm200.c\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 44, i32 1 }
@llvm.compiler.used = appending global [2 x ptr] [ptr @gm200_fifo_pbdma, ptr @gm200_fifo], section "llvm.metadata"
@0 = internal global [2 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gm200_fifo_pbdma to i32), i32 12, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gm200_fifo to i32), i32 84, i32 128, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm200_fifo_pbdma_nr(ptr nocapture noundef readonly %fifo) #0 align 64 {
entry:
  ...
  %add.ptr = getelementptr i8, ptr %3, i32 8196
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm200_fifo_new(ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pfifo) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @gk104_fifo_new_(ptr noundef nonnull @gm200_fifo, ptr noundef %device, i32 noundef %type, i32 noundef %inst, i32 noundef 4096, ptr noundef %pfifo) #2
  ret i32 %call
}
...
!0 = !{ptr @gm200_fifo_pbdma, !1, !"gm200_fifo_pbdma", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/gm200.c", i32 37, i32 1}
!2 = !{ptr @gm200_fifo, !3, !"gm200_fifo", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/fifo/gm200.c", i32 44, i32 1}
