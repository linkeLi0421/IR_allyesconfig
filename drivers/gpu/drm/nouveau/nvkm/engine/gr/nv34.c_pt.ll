; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/gr/nv34.c_pt.bc'
...
@nv34_gr = internal constant { { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, %struct.anon.137, [19 x %struct.nvkm_sclass] }, [108 x i8] } { { ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, %struct.anon.137, [19 x %struct.nvkm_sclass] } { ptr @nv20_gr_dtor, ptr @nv20_gr_oneinit, ptr @nv30_gr_init, ptr null, ptr @nv20_gr_intr, ptr @nv20_gr_tile, ptr null, ptr @nv34_gr_chan_new, ptr null, ptr null, ptr null, %struct.anon.137 zeroinitializer, [19 x %struct.nvkm_sclass] [%struct.nvkm_sclass { i32 -1, i32 -1, i32 18, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 25, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 48, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 57, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 67, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 68, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 74, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 98, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 114, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 137, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 138, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 159, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 866, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 905, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 906, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 926, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 1431, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass { i32 -1, i32 -1, i32 1687, ptr @nv04_gr_object, ptr null }, %struct.nvkm_sclass zeroinitializer] }, [108 x i8] zeroinitializer }, align 32
@nv34_gr_chan = internal constant { %struct.nvkm_object_func, [36 x i8] } { %struct.nvkm_object_func { ptr @nv20_gr_chan_dtor, ptr @nv20_gr_chan_init, ptr @nv20_gr_chan_fini, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, [36 x i8] zeroinitializer }, align 32
@kmalloc_caches = external dso_local local_unnamed_addr global [4 x [14 x ptr]], align 4
@___asan_gen_.2 = private unnamed_addr constant [8 x i8] c"nv34_gr\00", align 1
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.6, i32 103, i32 1 }
@___asan_gen_.5 = private unnamed_addr constant [13 x i8] c"nv34_gr_chan\00", align 1
@___asan_gen_.6 = private constant [49 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/gr/nv34.c\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.6, i32 14, i32 1 }
@llvm.compiler.used = appending global [2 x ptr] [ptr @nv34_gr, ptr @nv34_gr_chan], section "llvm.metadata"
@0 = internal global [2 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv34_gr to i32), i32 436, i32 544, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nv34_gr_chan to i32), i32 60, i32 96, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv34_gr_new(ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pgr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nv20_gr_new_(ptr noundef nonnull @nv34_gr, ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pgr) #3
  ret i32 %call
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @nv34_gr_chan_new(ptr noundef %base, ptr nocapture noundef readonly %fifoch, ptr noundef %oclass, ptr nocapture noundef writeonly %pobject) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %entry
  tail call void @nvkm_object_ctor(ptr noundef nonnull @nv34_gr_chan, ptr noundef %oclass, ptr noundef nonnull %call7.i.i) #3
  ...
  %call5 = tail call i32 @nvkm_memory_new(ptr noundef %7, i32 noundef 0, i64 noundef 18140, i32 noundef 16, i1 noundef zeroext true, ptr noundef %inst) #3
...
if.end8:                                          ; preds = %if.end
  ...
  tail call void %27(ptr noundef %23, i64 noundef 1036, i32 noundef 16777473) #3
  ...
  tail call void %69(ptr noundef %65, i64 noundef 1152, i32 noundef -65536) #3
  ...
  tail call void %75(ptr noundef %71, i64 noundef 1236, i32 noundef 268369920) #3
  ...
  tail call void %81(ptr noundef %77, i64 noundef 1240, i32 noundef 268369920) #3
  ...
  tail call void %93(ptr noundef %89, i64 noundef 1276, i32 noundef 134152192) #3
  ...
  tail call void %99(ptr noundef %95, i64 noundef 1280, i32 noundef 134152192) #3
  ...
  tail call void %105(ptr noundef %101, i64 noundef 1284, i32 noundef 134152192) #3
  ...
  tail call void %111(ptr noundef %107, i64 noundef 1288, i32 noundef 134152192) #3
  ...
  tail call void %117(ptr noundef %113, i64 noundef 1292, i32 noundef 134152192) #3
  ...
  tail call void %123(ptr noundef %119, i64 noundef 1296, i32 noundef 134152192) #3
  ...
  tail call void %129(ptr noundef %125, i64 noundef 1300, i32 noundef 134152192) #3
  ...
  tail call void %135(ptr noundef %131, i64 noundef 1304, i32 noundef 134152192) #3
  ...
  tail call void %141(ptr noundef %137, i64 noundef 1308, i32 noundef 134152192) #3
  ...
  tail call void %147(ptr noundef %143, i64 noundef 1312, i32 noundef 134152192) #3
  ...
  tail call void %153(ptr noundef %149, i64 noundef 1316, i32 noundef 134152192) #3
  ...
  tail call void %159(ptr noundef %155, i64 noundef 1320, i32 noundef 134152192) #3
  ...
  tail call void %165(ptr noundef %161, i64 noundef 1324, i32 noundef 134152192) #3
  ...
  tail call void %171(ptr noundef %167, i64 noundef 1328, i32 noundef 134152192) #3
  ...
  tail call void %177(ptr noundef %173, i64 noundef 1332, i32 noundef 134152192) #3
  ...
  tail call void %183(ptr noundef %179, i64 noundef 1336, i32 noundef 134152192) #3
  ...
  tail call void %189(ptr noundef %185, i64 noundef 1348, i32 noundef 1266679807) #3
  ...
  tail call void %195(ptr noundef %191, i64 noundef 1404, i32 noundef 128) #3
  ...
  tail call void %201(ptr noundef %197, i64 noundef 1408, i32 noundef 807407616) #3
  ...
  tail call void %207(ptr noundef %203, i64 noundef 1412, i32 noundef 1885360192) #3
  ...
  tail call void %213(ptr noundef %209, i64 noundef 1416, i32 noundef -1196910456) #3
  ...
  tail call void %219(ptr noundef %215, i64 noundef 1420, i32 noundef -118957880) #3
  ...
  tail call void %225(ptr noundef %221, i64 noundef 1440, i32 noundef -1342177280) #3
  ...
  tail call void %231(ptr noundef %227, i64 noundef 1520, i32 noundef 66952) #3
  ...
  tail call void %237(ptr noundef %233, i64 noundef 1524, i32 noundef 66952) #3
  ...
  tail call void %243(ptr noundef %239, i64 noundef 1528, i32 noundef 66952) #3
  ...
  tail call void %249(ptr noundef %245, i64 noundef 1532, i32 noundef 66952) #3
  ...
  tail call void %255(ptr noundef %251, i64 noundef 1536, i32 noundef 66952) #3
  ...
  tail call void %261(ptr noundef %257, i64 noundef 1540, i32 noundef 66952) #3
  ...
  tail call void %267(ptr noundef %263, i64 noundef 1544, i32 noundef 66952) #3
  ...
  tail call void %273(ptr noundef %269, i64 noundef 1548, i32 noundef 66952) #3
  ...
  tail call void %279(ptr noundef %275, i64 noundef 1552, i32 noundef 66952) #3
  ...
  tail call void %285(ptr noundef %281, i64 noundef 1556, i32 noundef 66952) #3
  ...
  tail call void %291(ptr noundef %287, i64 noundef 1560, i32 noundef 66952) #3
  ...
  tail call void %297(ptr noundef %293, i64 noundef 1564, i32 noundef 66952) #3
  ...
  tail call void %303(ptr noundef %299, i64 noundef 1568, i32 noundef 66952) #3
  ...
  tail call void %309(ptr noundef %305, i64 noundef 1572, i32 noundef 66952) #3
  ...
  tail call void %315(ptr noundef %311, i64 noundef 1576, i32 noundef 66952) #3
  ...
  tail call void %321(ptr noundef %317, i64 noundef 1580, i32 noundef 66952) #3
  ...
  tail call void %327(ptr noundef %323, i64 noundef 1584, i32 noundef 197379) #3
  ...
  tail call void %333(ptr noundef %329, i64 noundef 1588, i32 noundef 197379) #3
  ...
  tail call void %339(ptr noundef %335, i64 noundef 1592, i32 noundef 197379) #3
  ...
  tail call void %345(ptr noundef %341, i64 noundef 1596, i32 noundef 197379) #3
  ...
  tail call void %351(ptr noundef %347, i64 noundef 1600, i32 noundef 197379) #3
  ...
  tail call void %357(ptr noundef %353, i64 noundef 1604, i32 noundef 197379) #3
  ...
  tail call void %363(ptr noundef %359, i64 noundef 1608, i32 noundef 197379) #3
  ...
  tail call void %369(ptr noundef %365, i64 noundef 1612, i32 noundef 197379) #3
  ...
  tail call void %375(ptr noundef %371, i64 noundef 1616, i32 noundef 197379) #3
  ...
  tail call void %381(ptr noundef %377, i64 noundef 1620, i32 noundef 197379) #3
  ...
  tail call void %387(ptr noundef %383, i64 noundef 1624, i32 noundef 197379) #3
  ...
  tail call void %393(ptr noundef %389, i64 noundef 1628, i32 noundef 197379) #3
  ...
  tail call void %399(ptr noundef %395, i64 noundef 1632, i32 noundef 197379) #3
  ...
  tail call void %405(ptr noundef %401, i64 noundef 1636, i32 noundef 197379) #3
  ...
  tail call void %411(ptr noundef %407, i64 noundef 1640, i32 noundef 197379) #3
  ...
  tail call void %417(ptr noundef %413, i64 noundef 1644, i32 noundef 197379) #3
  ...
  tail call void %423(ptr noundef %419, i64 noundef 1712, i32 noundef 568036) #3
  ...
  tail call void %429(ptr noundef %425, i64 noundef 1716, i32 noundef 568036) #3
  ...
  tail call void %435(ptr noundef %431, i64 noundef 1720, i32 noundef 568036) #3
  ...
  tail call void %441(ptr noundef %437, i64 noundef 1724, i32 noundef 568036) #3
  ...
  tail call void %447(ptr noundef %443, i64 noundef 1728, i32 noundef 568036) #3
  ...
  tail call void %453(ptr noundef %449, i64 noundef 1732, i32 noundef 568036) #3
  ...
  tail call void %459(ptr noundef %455, i64 noundef 1736, i32 noundef 568036) #3
  ...
  tail call void %465(ptr noundef %461, i64 noundef 1740, i32 noundef 568036) #3
  ...
  tail call void %471(ptr noundef %467, i64 noundef 1744, i32 noundef 568036) #3
  ...
  tail call void %477(ptr noundef %473, i64 noundef 1748, i32 noundef 568036) #3
  ...
  tail call void %483(ptr noundef %479, i64 noundef 1752, i32 noundef 568036) #3
  ...
  tail call void %489(ptr noundef %485, i64 noundef 1756, i32 noundef 568036) #3
  ...
  tail call void %495(ptr noundef %491, i64 noundef 1760, i32 noundef 568036) #3
  ...
  tail call void %501(ptr noundef %497, i64 noundef 1764, i32 noundef 568036) #3
  ...
  tail call void %507(ptr noundef %503, i64 noundef 1768, i32 noundef 568036) #3
  ...
  tail call void %513(ptr noundef %509, i64 noundef 1772, i32 noundef 568036) #3
  ...
  tail call void %519(ptr noundef %515, i64 noundef 1776, i32 noundef 16850944) #3
  ...
  tail call void %525(ptr noundef %521, i64 noundef 1780, i32 noundef 16850944) #3
  ...
  tail call void %531(ptr noundef %527, i64 noundef 1784, i32 noundef 16850944) #3
  ...
  tail call void %537(ptr noundef %533, i64 noundef 1788, i32 noundef 16850944) #3
  ...
  tail call void %543(ptr noundef %539, i64 noundef 1792, i32 noundef 16850944) #3
  ...
  tail call void %549(ptr noundef %545, i64 noundef 1796, i32 noundef 16850944) #3
  ...
  tail call void %555(ptr noundef %551, i64 noundef 1800, i32 noundef 16850944) #3
  ...
  tail call void %561(ptr noundef %557, i64 noundef 1804, i32 noundef 16850944) #3
  ...
  tail call void %567(ptr noundef %563, i64 noundef 1808, i32 noundef 16850944) #3
  ...
  tail call void %573(ptr noundef %569, i64 noundef 1812, i32 noundef 16850944) #3
  ...
  tail call void %579(ptr noundef %575, i64 noundef 1816, i32 noundef 16850944) #3
  ...
  tail call void %585(ptr noundef %581, i64 noundef 1820, i32 noundef 16850944) #3
  ...
  tail call void %591(ptr noundef %587, i64 noundef 1824, i32 noundef 16850944) #3
  ...
  tail call void %597(ptr noundef %593, i64 noundef 1828, i32 noundef 16850944) #3
  ...
  tail call void %603(ptr noundef %599, i64 noundef 1832, i32 noundef 16850944) #3
  ...
  tail call void %609(ptr noundef %605, i64 noundef 1836, i32 noundef 16850944) #3
  ...
  tail call void %615(ptr noundef %611, i64 noundef 1840, i32 noundef 524296) #3
  ...
  tail call void %621(ptr noundef %617, i64 noundef 1844, i32 noundef 524296) #3
  ...
  tail call void %627(ptr noundef %623, i64 noundef 1848, i32 noundef 524296) #3
  ...
  tail call void %633(ptr noundef %629, i64 noundef 1852, i32 noundef 524296) #3
  ...
  tail call void %639(ptr noundef %635, i64 noundef 1856, i32 noundef 524296) #3
  ...
  tail call void %645(ptr noundef %641, i64 noundef 1860, i32 noundef 524296) #3
  ...
  tail call void %651(ptr noundef %647, i64 noundef 1864, i32 noundef 524296) #3
  ...
  tail call void %657(ptr noundef %653, i64 noundef 1868, i32 noundef 524296) #3
  ...
  tail call void %663(ptr noundef %659, i64 noundef 1872, i32 noundef 524296) #3
  ...
  tail call void %669(ptr noundef %665, i64 noundef 1876, i32 noundef 524296) #3
  ...
  tail call void %675(ptr noundef %671, i64 noundef 1880, i32 noundef 524296) #3
  ...
  tail call void %681(ptr noundef %677, i64 noundef 1884, i32 noundef 524296) #3
  ...
  tail call void %687(ptr noundef %683, i64 noundef 1888, i32 noundef 524296) #3
  ...
  tail call void %693(ptr noundef %689, i64 noundef 1892, i32 noundef 524296) #3
  ...
  tail call void %699(ptr noundef %695, i64 noundef 1896, i32 noundef 524296) #3
  ...
  tail call void %705(ptr noundef %701, i64 noundef 1900, i32 noundef 524296) #3
  ...
  tail call void %711(ptr noundef %707, i64 noundef 2128, i32 noundef 262144) #3
  ...
  tail call void %717(ptr noundef %713, i64 noundef 2132, i32 noundef 65536) #3
  ...
  tail call void %723(ptr noundef %719, i64 noundef 2136, i32 noundef 262148) #3
  ...
  tail call void %729(ptr noundef %725, i64 noundef 2140, i32 noundef 262148) #3
  ...
  tail call void %735(ptr noundef %731, i64 noundef 2144, i32 noundef 262148) #3
  ...
  tail call void %741(ptr noundef %737, i64 noundef 2148, i32 noundef 262148) #3
  br label %for.body180

for.body180:                                      ; preds = %for.body180.for.body180_crit_edge, %if.end8
  %i.8392 = phi i32 [ %add200, %for.body180.for.body180_crit_edge ], [ 5548, %if.end8 ]
  ...
  %cmp178 = icmp ult i32 %i.8392, 9997
...
for.body205.preheader:                            ; preds = %for.body180
  ...
  tail call void %765(ptr noundef %761, i64 noundef 10060, i32 noundef 65535) #3
  ...
  tail call void %771(ptr noundef %767, i64 noundef 10064, i32 noundef 65535) #3
  ...
  tail call void %777(ptr noundef %773, i64 noundef 10068, i32 noundef 65535) #3
  ...
  tail call void %783(ptr noundef %779, i64 noundef 10072, i32 noundef 65535) #3
  ...
  tail call void %789(ptr noundef %785, i64 noundef 10976, i32 noundef 1065353216) #3
  ...
  tail call void %795(ptr noundef %791, i64 noundef 11932, i32 noundef 1065353216) #3
  ...
  tail call void %801(ptr noundef %797, i64 noundef 11952, i32 noundef 1065353216) #3
  ...
  tail call void %807(ptr noundef %803, i64 noundef 11996, i32 noundef 1073741824) #3
  ...
  tail call void %813(ptr noundef %809, i64 noundef 12000, i32 noundef 1065353216) #3
  ...
  tail call void %819(ptr noundef %815, i64 noundef 12004, i32 noundef 1056964608) #3
  ...
  tail call void %825(ptr noundef %821, i64 noundef 12012, i32 noundef 1073741824) #3
  ...
  tail call void %831(ptr noundef %827, i64 noundef 12016, i32 noundef 1065353216) #3
  ...
  tail call void %837(ptr noundef %833, i64 noundef 12024, i32 noundef -1082130432) #3
  ...
  tail call void %843(ptr noundef %839, i64 noundef 12032, i32 noundef -1082130432) #3
...
!0 = !{ptr @nv34_gr, !1, !"nv34_gr", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/gr/nv34.c", i32 103, i32 1}
!2 = !{ptr @nv34_gr_chan, !3, !"nv34_gr_chan", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/gr/nv34.c", i32 14, i32 1}
