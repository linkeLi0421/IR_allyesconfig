; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/engine/nvdec/base.c_pt.bc'
...
@nvkm_nvdec = internal constant { %struct.nvkm_engine_func, [44 x i8] } { %struct.nvkm_engine_func { ptr @nvkm_nvdec_dtor, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, %struct.anon.137 zeroinitializer, %struct.anon.138 zeroinitializer, ptr null, [0 x %struct.nvkm_sclass] zeroinitializer }, [44 x i8] zeroinitializer }, align 32
@.str = internal constant { [6 x i8], [26 x i8] } { [6 x i8] c"Nvdec\00", [26 x i8] zeroinitializer }, align 32
...
@___asan_gen_.3 = private unnamed_addr constant [11 x i8] c"nvkm_nvdec\00", align 1
@___asan_gen_.5 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.13, i32 34, i32 1 }
@___asan_gen_.12 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.13 = private constant [52 x i8] c"../drivers/gpu/drm/nouveau/nvkm/engine/nvdec/base.c\00", align 1
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.13, i32 53, i32 9 }
@llvm.compiler.used = appending global [4 x ptr] [ptr @nvkm_nvdec, ptr @.str, ptr @.str.1, ptr @.str.2], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @nvkm_nvdec to i32), i32 52, i32 96, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 6, i32 32, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 7, i32 32, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 10, i32 32, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvkm_nvdec_new_(ptr noundef %fwif, ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr nocapture noundef writeonly %pnvdec) local_unnamed_addr #0 align 64 {
entry:
  ...
  %1 = ptrtoint ptr %pnvdec to i32
  call void @__asan_store4_noabort(i32 %1)
  store ptr %call7.i.i, ptr %pnvdec, align 4
...
if.end:                                           ; preds = %entry
  %engine = getelementptr inbounds %struct.nvkm_nvdec, ptr %call7.i.i, i32 0, i32 1
  %call1 = tail call i32 @nvkm_engine_ctor(ptr noundef nonnull @nvkm_nvdec, ptr noundef %device, i32 noundef %type, i32 noundef %inst, i1 noundef zeroext true, ptr noundef %engine) #5
...
if.end4:                                          ; preds = %if.end
  %subdev = getelementptr inbounds %struct.nvkm_nvdec, ptr %call7.i.i, i32 0, i32 1, i32 1
  ...
  %device7 = getelementptr inbounds %struct.nvkm_nvdec, ptr %call7.i.i, i32 0, i32 1, i32 1, i32 1
...
land.rhs:                                         ; preds = %for.body.land.rhs_crit_edge, %if.end4.land.rhs_crit_edge
  ...
  %load = getelementptr inbounds %struct.nvkm_nvdec_fwif, ptr %_next.0135, i32 0, i32 1
...
for.body:                                         ; preds = %land.rhs
  ...
  %incdec.ptr = getelementptr %struct.nvkm_nvdec_fwif, ptr %_next.0135, i32 1
...
14:                                               ; preds = %13, %cond.end
  ...
  %load35136 = getelementptr inbounds %struct.nvkm_nvdec_fwif, ptr %15, i32 0, i32 1
...
for.inc50:                                        ; preds = %cond.end42
  %incdec.ptr51 = getelementptr %struct.nvkm_nvdec_fwif, ptr %_next.1138, i32 1
  %load35 = getelementptr %struct.nvkm_nvdec_fwif, ptr %_next.1138, i32 1, i32 1
...
if.end60:                                         ; preds = %if.end57
  call void @__sanitizer_cov_trace_pc() #7
  %func = getelementptr inbounds %struct.nvkm_nvdec_fwif, ptr %_fwif.4, i32 0, i32 2
  ...
  %name = getelementptr inbounds %struct.nvkm_nvdec, ptr %call7.i.i, i32 0, i32 1, i32 1, i32 4
  %falcon = getelementptr inbounds %struct.nvkm_nvdec, ptr %call7.i.i, i32 0, i32 2
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal ptr @nvkm_nvdec_dtor(ptr noundef %engine) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
...
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/nvdec/base.c", i32 53, i32 9}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @nvkm_nvdec, !5, !"nvkm_nvdec", i1 false, i1 false}
!5 = !{!"../drivers/gpu/drm/nouveau/nvkm/engine/nvdec/base.c", i32 34, i32 1}
