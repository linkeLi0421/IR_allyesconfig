; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/bios/M0205.c_pt.bc'
...
define dso_local i32 @nvbios_M0205Te(ptr noundef %bios, ptr nocapture noundef writeonly %ver, ptr nocapture noundef writeonly %hdr, ptr nocapture noundef writeonly %cnt, ptr nocapture noundef writeonly %len, ptr nocapture noundef writeonly %snr, ptr nocapture noundef writeonly %ssz) local_unnamed_addr #0 align 64 {
entry:
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvbios_M0205Tp(ptr noundef %bios, ptr nocapture noundef %ver, ptr nocapture noundef writeonly %hdr, ptr nocapture noundef writeonly %cnt, ptr nocapture noundef writeonly %len, ptr nocapture noundef writeonly %snr, ptr nocapture noundef writeonly %ssz, ptr nocapture noundef writeonly %info) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvbios_M0205Te(ptr noundef %bios, ptr noundef %ver, ptr noundef %hdr, ptr noundef %cnt, ptr noundef %len, ptr noundef %snr, ptr noundef %ssz)
  %0 = ptrtoint ptr %info to i32
  call void @__asan_store2_noabort(i32 %0)
  store i16 0, ptr %info, align 2
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call)
  ...
  %cond8 = icmp eq i8 %2, 16
  %cond = select i1 %tobool.not, i1 %cond8, i1 false
...
sw.bb:                                            ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  %add = add i32 %call, 6
  %call2 = tail call zeroext i16 @nvbios_rd16(ptr noundef %bios, i32 noundef %add) #3
  %3 = ptrtoint ptr %info to i32
  call void @__asan_store2_noabort(i32 %3)
  store i16 %call2, ptr %info, align 2
  br label %sw.epilog
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvbios_M0205Ee(ptr noundef %bios, i32 noundef %idx, ptr nocapture noundef writeonly %ver, ptr nocapture noundef %hdr, ptr nocapture noundef %cnt, ptr nocapture noundef %len) local_unnamed_addr #0 align 64 {
entry:
  ...
  %call = call i32 @nvbios_M0205Te(ptr noundef %bios, ptr noundef %ver, ptr noundef %hdr, ptr noundef %cnt, ptr noundef %len, ptr noundef nonnull %snr, ptr noundef nonnull %ssz)
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call)
  %tobool.not = icmp eq i32 %call, 0
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvbios_M0205Ep(ptr noundef %bios, i32 noundef %idx, ptr nocapture noundef %ver, ptr nocapture noundef %hdr, ptr nocapture noundef %cnt, ptr nocapture noundef %len, ptr nocapture noundef writeonly %info) local_unnamed_addr #0 align 64 {
entry:
  ...
  %call.i = call i32 @nvbios_M0205Te(ptr noundef %bios, ptr noundef %ver, ptr noundef %hdr, ptr noundef %cnt, ptr noundef %len, ptr noundef nonnull %snr.i, ptr noundef nonnull %ssz.i) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i)
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %entry.nvbios_M0205Ee.exit.thread_crit_edge, label %land.lhs.true.i

entry.nvbios_M0205Ee.exit.thread_crit_edge:       ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  br label %nvbios_M0205Ee.exit.thread
...
land.lhs.true.i:                                  ; preds = %entry
  ...
  br i1 %cmp.i, label %nvbios_M0205Ee.exit, label %land.lhs.true.i.nvbios_M0205Ee.exit.thread_crit_edge

land.lhs.true.i.nvbios_M0205Ee.exit.thread_crit_edge: ; preds = %land.lhs.true.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %nvbios_M0205Ee.exit.thread

nvbios_M0205Ee.exit.thread:                       ; preds = %land.lhs.true.i.nvbios_M0205Ee.exit.thread_crit_edge, %entry.nvbios_M0205Ee.exit.thread_crit_edge
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %ssz.i) #3
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %snr.i) #3
  br label %cleanup.sink.split

nvbios_M0205Ee.exit:                              ; preds = %land.lhs.true.i
  %4 = ptrtoint ptr %hdr to i32
  call void @__asan_load1_noabort(i32 %4)
  %5 = load i8, ptr %hdr, align 1
  ...
  %cond10 = icmp eq i8 %15, 16
  %cond = select i1 %tobool.not, i1 %cond10, i1 false
  br i1 %cond, label %sw.bb, label %nvbios_M0205Ee.exit.cleanup_crit_edge

nvbios_M0205Ee.exit.cleanup_crit_edge:            ; preds = %nvbios_M0205Ee.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

sw.bb:                                            ; preds = %nvbios_M0205Ee.exit
  call void @__sanitizer_cov_trace_pc() #5
  %call2 = tail call zeroext i8 @nvbios_rd08(ptr noundef %bios, i32 noundef %add8.i) #3
  %16 = and i8 %call2, 15
  br label %cleanup.sink.split

cleanup.sink.split:                               ; preds = %sw.bb, %nvbios_M0205Ee.exit.thread
  %.sink = phi i8 [ 0, %nvbios_M0205Ee.exit.thread ], [ %16, %sw.bb ]
  %retval.0.ph = phi i32 [ 0, %nvbios_M0205Ee.exit.thread ], [ %add8.i, %sw.bb ]
  %17 = ptrtoint ptr %info to i32
  call void @__asan_store1_noabort(i32 %17)
  store i8 %.sink, ptr %info, align 1
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %nvbios_M0205Ee.exit.cleanup_crit_edge
  %retval.0 = phi i32 [ 0, %nvbios_M0205Ee.exit.cleanup_crit_edge ], [ %retval.0.ph, %cleanup.sink.split ]
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvbios_M0205Se(ptr noundef %bios, i32 noundef %ent, i32 noundef %idx, ptr nocapture noundef writeonly %ver, ptr nocapture noundef %hdr) local_unnamed_addr #0 align 64 {
entry:
  %snr.i = alloca i8, align 1
  %ssz.i = alloca i8, align 1
  ...
  store i8 -1, ptr %ssz.i, align 1, !annotation !9
  %call.i = call i32 @nvbios_M0205Te(ptr noundef %bios, ptr noundef %ver, ptr noundef %hdr, ptr noundef nonnull %cnt, ptr noundef nonnull %len, ptr noundef nonnull %snr.i, ptr noundef nonnull %ssz.i) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i)
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %entry.nvbios_M0205Ee.exit.thread_crit_edge, label %land.lhs.true.i
...
nvbios_M0205Ee.exit:                              ; preds = %land.lhs.true.i
  ...
  br i1 %tobool.not, label %nvbios_M0205Ee.exit.cleanup_crit_edge, label %land.lhs.true

nvbios_M0205Ee.exit.cleanup_crit_edge:            ; preds = %nvbios_M0205Ee.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

land.lhs.true:                                    ; preds = %nvbios_M0205Ee.exit
  %15 = ptrtoint ptr %cnt to i32
...
cleanup:                                          ; preds = %if.then, %land.lhs.true.cleanup_crit_edge, %nvbios_M0205Ee.exit.cleanup_crit_edge, %nvbios_M0205Ee.exit.thread
  %retval.0 = phi i32 [ %add4, %if.then ], [ 0, %land.lhs.true.cleanup_crit_edge ], [ 0, %nvbios_M0205Ee.exit.cleanup_crit_edge ], [ 0, %nvbios_M0205Ee.exit.thread ]
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nvbios_M0205Sp(ptr noundef %bios, i32 noundef %ent, i32 noundef %idx, ptr nocapture noundef %ver, ptr nocapture noundef %hdr, ptr nocapture noundef writeonly %info) local_unnamed_addr #0 align 64 {
entry:
  ...
  %2 = ptrtoint ptr %snr.i.i to i32
  call void @__asan_store1_noabort(i32 %2)
  store i8 -1, ptr %snr.i.i, align 1, !annotation !9
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %ssz.i.i) #3
  %3 = ptrtoint ptr %ssz.i.i to i32
  call void @__asan_store1_noabort(i32 %3)
  store i8 -1, ptr %ssz.i.i, align 1, !annotation !9
  %call.i.i = call i32 @nvbios_M0205Te(ptr noundef %bios, ptr noundef %ver, ptr noundef %hdr, ptr noundef nonnull %cnt.i, ptr noundef nonnull %len.i, ptr noundef nonnull %snr.i.i, ptr noundef nonnull %ssz.i.i) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i.i)
  %tobool.not.i.i = icmp eq i32 %call.i.i, 0
  br i1 %tobool.not.i.i, label %entry.nvbios_M0205Ee.exit.thread.i_crit_edge, label %land.lhs.true.i.i

entry.nvbios_M0205Ee.exit.thread.i_crit_edge:     ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  br label %nvbios_M0205Ee.exit.thread.i
...
land.lhs.true.i.i:                                ; preds = %entry
  ...
  br i1 %cmp.i.i, label %nvbios_M0205Ee.exit.i, label %land.lhs.true.i.i.nvbios_M0205Ee.exit.thread.i_crit_edge

land.lhs.true.i.i.nvbios_M0205Ee.exit.thread.i_crit_edge: ; preds = %land.lhs.true.i.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %nvbios_M0205Ee.exit.thread.i

nvbios_M0205Ee.exit.thread.i:                     ; preds = %land.lhs.true.i.i.nvbios_M0205Ee.exit.thread.i_crit_edge, %entry.nvbios_M0205Ee.exit.thread.i_crit_edge
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %ssz.i.i) #3
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %snr.i.i) #3
  br label %nvbios_M0205Se.exit.thread

nvbios_M0205Ee.exit.i:                            ; preds = %land.lhs.true.i.i
  %6 = ptrtoint ptr %hdr to i32
  call void @__asan_load1_noabort(i32 %6)
  %7 = load i8, ptr %hdr, align 1
  ...
  %10 = ptrtoint ptr %snr.i.i to i32
  call void @__asan_load1_noabort(i32 %10)
  %11 = load i8, ptr %snr.i.i, align 1
  %conv4.i.i = zext i8 %11 to i32
  %12 = ptrtoint ptr %ssz.i.i to i32
  call void @__asan_load1_noabort(i32 %12)
  %13 = load i8, ptr %ssz.i.i, align 1
  ...
  br i1 %or.cond, label %nvbios_M0205Se.exit, label %nvbios_M0205Ee.exit.i.nvbios_M0205Se.exit.thread_crit_edge

nvbios_M0205Ee.exit.i.nvbios_M0205Se.exit.thread_crit_edge: ; preds = %nvbios_M0205Ee.exit.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %nvbios_M0205Se.exit.thread

nvbios_M0205Se.exit.thread:                       ; preds = %nvbios_M0205Ee.exit.i.nvbios_M0205Se.exit.thread_crit_edge, %nvbios_M0205Ee.exit.thread.i
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %len.i) #3
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %cnt.i) #3
  br label %cleanup.sink.split

nvbios_M0205Se.exit:                              ; preds = %nvbios_M0205Ee.exit.i
  ...
  %cond9 = icmp eq i8 %17, 16
  %cond = select i1 %tobool.not, i1 %cond9, i1 false
  br i1 %cond, label %sw.bb, label %nvbios_M0205Se.exit.cleanup_crit_edge

nvbios_M0205Se.exit.cleanup_crit_edge:            ; preds = %nvbios_M0205Se.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

sw.bb:                                            ; preds = %nvbios_M0205Se.exit
  call void @__sanitizer_cov_trace_pc() #5
  %call2 = tail call zeroext i8 @nvbios_rd08(ptr noundef %bios, i32 noundef %add4.i) #3
  br label %cleanup.sink.split

cleanup.sink.split:                               ; preds = %sw.bb, %nvbios_M0205Se.exit.thread
  %.sink = phi i8 [ 0, %nvbios_M0205Se.exit.thread ], [ %call2, %sw.bb ]
  %retval.0.ph = phi i32 [ 0, %nvbios_M0205Se.exit.thread ], [ %add4.i, %sw.bb ]
  %18 = ptrtoint ptr %info to i32
  call void @__asan_store1_noabort(i32 %18)
  store i8 %.sink, ptr %info, align 1
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %nvbios_M0205Se.exit.cleanup_crit_edge
  %retval.0 = phi i32 [ 0, %nvbios_M0205Se.exit.cleanup_crit_edge ], [ %retval.0.ph, %cleanup.sink.split ]
  ret i32 %retval.0
}
