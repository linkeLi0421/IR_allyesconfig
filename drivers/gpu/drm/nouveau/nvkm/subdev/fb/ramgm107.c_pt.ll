; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramgm107.c_pt.bc'
...
@gm107_ram = internal constant { %struct.nvkm_ram_func, [56 x i8] } { %struct.nvkm_ram_func { i64 68719476736, ptr @gm107_ram_probe_fbp, ptr @gf108_ram_probe_fbp_amount, ptr @gf100_ram_probe_fbpa_amount, ptr @gk104_ram_dtor, ptr @gk104_ram_init, ptr @gk104_ram_calc, ptr @gk104_ram_prog, ptr @gk104_ram_tidy }, [56 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [10 x i8] c"gm107_ram\00", align 1
@___asan_gen_.2 = private constant [53 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramgm107.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 35, i32 1 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @gm107_ram], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gm107_ram to i32), i32 40, i32 96, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm107_ram_probe_fbp(ptr noundef %func, ptr noundef %device, i32 noundef %fbp, ptr noundef %pltcs) #0 align 64 {
entry:
  ...
  %add.ptr = getelementptr i8, ptr %1, i32 138260
  ...
  %call1 = tail call i32 %4(ptr noundef %func, i32 noundef %2, ptr noundef %device, i32 noundef %fbp, ptr noundef %pltcs) #2
  ret i32 %call1
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm107_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @gk104_ram_new_(ptr noundef nonnull @gm107_ram, ptr noundef %fb, ptr noundef %pram) #2
  ret i32 %call
}
...
!0 = !{ptr @gm107_ram, !1, !"gm107_ram", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramgm107.c", i32 35, i32 1}
