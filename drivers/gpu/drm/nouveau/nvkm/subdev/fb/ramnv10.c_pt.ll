; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv10.c_pt.bc'
...
define dso_local i32 @nv10_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  ...
  %add.ptr4 = getelementptr i8, ptr %6, i32 1049088
  ...
  %call8 = tail call i32 @nvkm_ram_new_(ptr noundef nonnull @nv04_ram_func, ptr noundef %fb, i32 noundef %., i64 noundef %conv, ptr noundef %pram) #2
  ret i32 %call8
}
