; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv20.c_pt.bc'
...
@switch.table.nv20_ram_new = internal constant { [4 x i32], [16 x i8] } { [4 x i32] [i32 3, i32 4, i32 8, i32 7], [16 x i8] zeroinitializer }, align 32
@___asan_gen_ = private constant [52 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv20.c\00", align 1
@___asan_gen_.1 = private unnamed_addr constant [26 x i8] c"switch.table.nv20_ram_new\00", align 1
@llvm.compiler.used = appending global [1 x ptr] [ptr @switch.table.nv20_ram_new], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @switch.table.nv20_ram_new to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_ to i32), i32 0, i32 0, i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv20_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  ...
  %and7 = lshr i32 %4, 8
  %8 = and i32 %and7, 3
  %switch.gep = getelementptr inbounds [4 x i32], ptr @switch.table.nv20_ram_new, i32 0, i32 %8
  %9 = ptrtoint ptr %switch.gep to i32
  call void @__asan_load4_noabort(i32 %9)
  %switch.load = load i32, ptr %switch.gep, align 4
  %conv = zext i32 %and to i64
  %call11 = tail call i32 @nvkm_ram_new_(ptr noundef nonnull @nv04_ram_func, ptr noundef %fb, i32 noundef %switch.load, i64 noundef %conv, ptr noundef %pram) #2
...
if.end:                                           ; preds = %entry
  ...
  %add.ptr14 = getelementptr i8, ptr %11, i32 1049088
  %12 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr14) #2, !srcloc !9
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #2, !srcloc !12
  %and17 = and i32 %12, 3
  %add = add nuw nsw i32 %and17, 1
  %13 = ptrtoint ptr %pram to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load ptr, ptr %pram, align 4
  %parts = getelementptr inbounds %struct.nvkm_ram, ptr %14, i32 0, i32 8
