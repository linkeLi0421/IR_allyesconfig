; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv44.c_pt.bc'
...
define dso_local i32 @nv44_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  ...
  %spec.store.select17 = select i1 %tobool9.not, i32 %8, i32 5
  %and12 = and i32 %7, 1
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and12)
  %tobool13.not = icmp eq i32 %and12, 0
  %spec.store.select18 = select i1 %tobool13.not, i32 %spec.store.select17, i32 4
  %conv = zext i32 %and to i64
  %call16 = tail call i32 @nv40_ram_new_(ptr noundef %fb, i32 noundef %spec.store.select18, i64 noundef %conv, ptr noundef %pram) #2
  ret i32 %call16
}
