; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv49.c_pt.bc'
...
@switch.table.nv49_ram_new = internal constant { [3 x i32], [20 x i8] } { [3 x i32] [i32 4, i32 5, i32 8], [20 x i8] zeroinitializer }, align 32
@___asan_gen_ = private constant [52 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv49.c\00", align 1
@___asan_gen_.1 = private unnamed_addr constant [26 x i8] c"switch.table.nv49_ram_new\00", align 1
@llvm.compiler.used = appending global [1 x ptr] [ptr @switch.table.nv49_ram_new], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @switch.table.nv49_ram_new to i32), i32 12, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_ to i32), i32 0, i32 0, i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @nv49_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  ...
  %add.ptr4 = getelementptr i8, ptr %6, i32 1050900
...
switch.lookup:                                    ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %switch.gep = getelementptr inbounds [3 x i32], ptr @switch.table.nv49_ram_new, i32 0, i32 %and7
...
sw.epilog:                                        ; preds = %switch.lookup, %entry.sw.epilog_crit_edge
  %type.0 = phi i32 [ 0, %entry.sw.epilog_crit_edge ], [ %switch.load, %switch.lookup ]
  %conv = zext i32 %and to i64
  %call10 = tail call i32 @nv40_ram_new_(ptr noundef %fb, i32 noundef %type.0, i64 noundef %conv, ptr noundef %pram) #2
...
if.end:                                           ; preds = %sw.epilog
  ...
  %add.ptr13 = getelementptr i8, ptr %10, i32 1049088
  %11 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr13) #2, !srcloc !9
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 4", "r,~{memory}"(i32 0) #2, !srcloc !12
  %and16 = and i32 %11, 3
  %add = add nuw nsw i32 %and16, 1
