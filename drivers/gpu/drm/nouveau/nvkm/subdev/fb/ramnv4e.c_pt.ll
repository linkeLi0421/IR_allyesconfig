; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/fb/ramnv4e.c_pt.bc'
...
define dso_local i32 @nv4e_ram_new(ptr noundef %fb, ptr noundef %pram) local_unnamed_addr #0 align 64 {
entry:
  ...
  %call2 = tail call i32 @nvkm_ram_new_(ptr noundef nonnull @nv04_ram_func, ptr noundef %fb, i32 noundef 0, i64 noundef %conv, ptr noundef %pram) #2
  ret i32 %call2
}
