; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/gpio/gf119.c_pt.bc'
...
@gf119_gpio = internal constant { %struct.nvkm_gpio_func, [40 x i8] } { %struct.nvkm_gpio_func { i32 32, ptr @g94_gpio_intr_stat, ptr @g94_gpio_intr_mask, ptr @gf119_gpio_drive, ptr @gf119_gpio_sense, ptr @gf119_gpio_reset }, [40 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [11 x i8] c"gf119_gpio\00", align 1
@___asan_gen_.2 = private constant [52 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/gpio/gf119.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 73, i32 1 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @gf119_gpio], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gf119_gpio to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @gf119_gpio_reset(ptr noundef %gpio, i8 noundef zeroext %match) #0 align 64 {
entry:
  ...
  store i8 -1, ptr %len, align 1, !annotation !11
...
if.end:                                           ; preds = %while.body
  ...
  %add = add nuw nsw i32 %mul, 54800
  %10 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %pri, align 4
  %add.ptr = getelementptr i8, ptr %11, i32 %add
  %12 = call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #3, !srcloc !12
  ...
  call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr34, i32 %or) #3, !srcloc !15
...
if.then37:                                        ; preds = %if.end
  ...
  %17 = call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr46) #3, !srcloc !12
  ...
  call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr56, i32 %or54) #3, !srcloc !15
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gf119_gpio_drive(ptr nocapture noundef readonly %gpio, i32 noundef %line, i32 noundef %dir, i32 noundef %out) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %device1 = getelementptr inbounds %struct.nvkm_gpio, ptr %gpio, i32 0, i32 1, i32 1
  ...
  %4 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #3, !srcloc !12
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr5, i32 %or3) #3, !srcloc !15
  %7 = ptrtoint ptr %pri to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %pri, align 4
  %add.ptr12 = getelementptr i8, ptr %8, i32 54788
  %9 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr12) #3, !srcloc !12
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr21, i32 %or19) #3, !srcloc !15
  ret i32 0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gf119_gpio_sense(ptr nocapture noundef readonly %gpio, i32 noundef %line) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %device1 = getelementptr inbounds %struct.nvkm_gpio, ptr %gpio, i32 0, i32 1, i32 1
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gf119_gpio_new(ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pgpio) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_gpio_new_(ptr noundef nonnull @gf119_gpio, ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pgpio) #3
  ret i32 %call
}
...
!0 = !{ptr @gf119_gpio, !1, !"gf119_gpio", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/gpio/gf119.c", i32 73, i32 1}
