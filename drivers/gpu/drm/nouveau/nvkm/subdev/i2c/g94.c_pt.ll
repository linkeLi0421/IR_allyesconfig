; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/i2c/g94.c_pt.bc'
...
@g94_i2c = internal constant { %struct.nvkm_i2c_func, [40 x i8] } { %struct.nvkm_i2c_func { ptr @g94_i2c_pad_x_new, ptr @g94_i2c_pad_s_new, i32 4, ptr @g94_aux_stat, ptr @g94_aux_mask, ptr null }, [40 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [8 x i8] c"g94_i2c\00", align 1
@___asan_gen_.2 = private constant [49 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/g94.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 60, i32 1 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @g94_i2c], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @g94_i2c to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @g94_aux_stat(ptr nocapture noundef readonly %i2c, ptr nocapture noundef %hi, ptr nocapture noundef %lo, ptr nocapture noundef %rq, ptr nocapture noundef %tx) #0 align 64 {
entry:
  ...
  %add.ptr = getelementptr i8, ptr %3, i32 57452
  ...
  %add.ptr4 = getelementptr i8, ptr %6, i32 57448
...
do.body:                                          ; preds = %for.inc
  ...
  %add.ptr34 = getelementptr i8, ptr %21, i32 57452
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @g94_aux_mask(ptr nocapture noundef readonly %i2c, i32 noundef %type, i32 noundef %mask, i32 noundef %data) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %device1 = getelementptr inbounds %struct.nvkm_i2c, ptr %i2c, i32 0, i32 1, i32 1
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %pri, align 4
  %add.ptr = getelementptr i8, ptr %3, i32 57448
  %4 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #2, !srcloc !11
...
for.inc.7:                                        ; preds = %if.then5.7, %if.end.7, %for.inc.6.for.inc.7_crit_edge
  ...
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %pri, align 4
  %add.ptr12 = getelementptr i8, ptr %6, i32 57448
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr12, i32 %temp.1.7) #2, !srcloc !15
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @g94_i2c_new(ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pi2c) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_i2c_new_(ptr noundef nonnull @g94_i2c, ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pi2c) #2
  ret i32 %call
}
...
!0 = !{ptr @g94_i2c, !1, !"g94_i2c", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/g94.c", i32 60, i32 1}
