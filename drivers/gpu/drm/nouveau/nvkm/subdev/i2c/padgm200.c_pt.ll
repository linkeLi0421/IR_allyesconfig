; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c_pt.bc'
...
@gm200_i2c_pad_s_func = internal constant { %struct.nvkm_i2c_pad_func, [16 x i8] } { %struct.nvkm_i2c_pad_func { ptr null, ptr @gf119_i2c_bus_new, ptr @gm200_i2c_aux_new, ptr @gm200_i2c_pad_mode }, [16 x i8] zeroinitializer }, align 32
@gm200_i2c_pad_x_func = internal constant { %struct.nvkm_i2c_pad_func, [16 x i8] } { %struct.nvkm_i2c_pad_func { ptr null, ptr @gf119_i2c_bus_new, ptr @gm200_i2c_aux_new, ptr null }, [16 x i8] zeroinitializer }, align 32
@.str = internal constant { [51 x i8], [45 x i8] } { [51 x i8] c"drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c\00", [45 x i8] zeroinitializer }, align 32
@__sancov_gen_cov_switch_values = internal global [5 x i64] [i64 3, i64 32, i64 0, i64 1, i64 2]
@___asan_gen_.1 = private unnamed_addr constant [21 x i8] c"gm200_i2c_pad_s_func\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 54, i32 1 }
@___asan_gen_.4 = private unnamed_addr constant [21 x i8] c"gm200_i2c_pad_x_func\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 67, i32 1 }
@___asan_gen_.7 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.8 = private constant [54 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 48, i32 3 }
@llvm.compiler.used = appending global [3 x ptr] [ptr @gm200_i2c_pad_s_func, ptr @gm200_i2c_pad_x_func, ptr @.str], section "llvm.metadata"
@0 = internal global [3 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gm200_i2c_pad_s_func to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gm200_i2c_pad_x_func to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 51, i32 96, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm200_i2c_pad_s_new(ptr noundef %i2c, i32 noundef %id, ptr noundef %ppad) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_i2c_pad_new_(ptr noundef nonnull @gm200_i2c_pad_s_func, ptr noundef %i2c, i32 noundef %id, ptr noundef %ppad) #2
  ret i32 %call
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gm200_i2c_pad_x_new(ptr noundef %i2c, i32 noundef %id, ptr noundef %ppad) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_i2c_pad_new_(ptr noundef nonnull @gm200_i2c_pad_x_func, ptr noundef %i2c, i32 noundef %id, ptr noundef %ppad) #2
  ret i32 %call
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @gm200_i2c_pad_mode(ptr nocapture noundef readonly %pad, i32 noundef %mode) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
...
!0 = !{ptr @gm200_i2c_pad_s_func, !1, !"gm200_i2c_pad_s_func", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c", i32 54, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c", i32 48, i32 3}
!4 = !{ptr @gm200_i2c_pad_x_func, !5, !"gm200_i2c_pad_x_func", i1 false, i1 false}
!5 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/i2c/padgm200.c", i32 67, i32 1}
