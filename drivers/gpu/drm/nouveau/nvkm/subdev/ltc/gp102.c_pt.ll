; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/ltc/gp102.c_pt.bc'
...
@gp102_ltc = internal constant { %struct.nvkm_ltc_func, [52 x i8] } { %struct.nvkm_ltc_func { ptr @gp100_ltc_oneinit, ptr @gp100_ltc_init, ptr @gp100_ltc_intr, ptr @gm107_ltc_cbc_clear, ptr @gm107_ltc_cbc_wait, i32 16, ptr @gm107_ltc_zbc_clear_color, ptr @gm107_ltc_zbc_clear_depth, ptr @gp102_ltc_zbc_clear_stencil, ptr @gf100_ltc_invalidate, ptr @gf100_ltc_flush }, [52 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [10 x i8] c"gp102_ltc\00", align 1
@___asan_gen_.2 = private constant [51 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/ltc/gp102.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 33, i32 1 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @gp102_ltc], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gp102_ltc to i32), i32 44, i32 96, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @gp102_ltc_zbc_clear_stencil(ptr nocapture noundef readonly %ltc, i32 noundef %i, i32 noundef %stencil) #0 align 64 {
entry:
  ...
  %add.ptr9 = getelementptr i8, ptr %8, i32 1565188
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr9, i32 %stencil) #2, !srcloc !14
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @gp102_ltc_new(ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pltc) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @nvkm_ltc_new_(ptr noundef nonnull @gp102_ltc, ptr noundef %device, i32 noundef %type, i32 noundef %inst, ptr noundef %pltc) #2
  ret i32 %call
}
...
!0 = !{ptr @gp102_ltc, !1, !"gp102_ltc", i1 false, i1 false}
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/ltc/gp102.c", i32 33, i32 1}
