; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/nouveau/nvkm/subdev/therm/fannil.c_pt.bc'
...
@.str = internal constant { [16 x i8], [16 x i8] } { [16 x i8] c"none / external\00", [16 x i8] zeroinitializer }, align 32
@kmalloc_caches = external dso_local local_unnamed_addr global [4 x [14 x ptr]], align 4
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private constant [54 x i8] c"../drivers/gpu/drm/nouveau/nvkm/subdev/therm/fannil.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 48, i32 15 }
...
define dso_local i32 @nvkm_fannil_create(ptr nocapture noundef writeonly %therm) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds ([4 x [14 x ptr]], ptr @kmalloc_caches, i32 0, i32 0, i32 8) to i32))
  %0 = load ptr, ptr getelementptr inbounds ([4 x [14 x ptr]], ptr @kmalloc_caches, i32 0, i32 0, i32 8), align 4
  %call7.i.i = tail call noalias align 8 ptr @kmem_cache_alloc_trace(ptr noundef %0, i32 noundef 3520, i32 noundef 256) #6
  %fan = getelementptr inbounds %struct.nvkm_therm, ptr %therm, i32 0, i32 9
  %1 = ptrtoint ptr %fan to i32
  call void @__asan_store4_noabort(i32 %1)
  store ptr %call7.i.i, ptr %fan, align 8
...
define internal i32 @nvkm_fannil_get(ptr nocapture noundef readnone %therm) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ret i32 -19
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid readnone sanitize_address sspstrong willreturn uwtable(sync)
define internal i32 @nvkm_fannil_set(ptr nocapture noundef readnone %therm, i32 noundef %percent) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ret i32 -19
...
!1 = !{!"../drivers/gpu/drm/nouveau/nvkm/subdev/therm/fannil.c", i32 48, i32 15}
