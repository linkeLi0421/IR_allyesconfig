; ModuleID = '/llk/IR_all_yes/drivers/gpu/drm/r128/r128_irq.c_pt.bc'
source_filename = "../drivers/gpu/drm/r128/r128_irq.c"
...
@.str = internal constant { [18 x i8], [46 x i8] } { [18 x i8] c"%s:  bad crtc %u\0A\00", [46 x i8] zeroinitializer }, align 32
@__func__.r128_enable_vblank = private unnamed_addr constant [19 x i8] c"r128_enable_vblank\00", align 1
@__func__.r128_disable_vblank = private unnamed_addr constant [20 x i8] c"r128_disable_vblank\00", align 1
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private constant [35 x i8] c"../drivers/gpu/drm/r128/r128_irq.c\00", align 1
...
define dso_local i32 @r128_get_vblank_counter(ptr nocapture noundef readonly %dev, i32 noundef %pipe) local_unnamed_addr #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %vbl_received = getelementptr inbounds %struct.drm_r128_private, ptr %1, i32 0, i32 15
  %call.i.i = tail call zeroext i1 @__kasan_check_read(ptr noundef %vbl_received, i32 noundef 4) #4
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @r128_driver_irq_handler(i32 noundef %irq, ptr noundef %arg) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %6 = tail call i32 asm sideeffect "ldr $0, $1", "=r,*Qo"(ptr elementtype(i32) %add.ptr) #4, !srcloc !14
...
do.body:                                          ; preds = %entry
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr4, i32 16777216) #4, !srcloc !17
  %vbl_received = getelementptr inbounds %struct.drm_r128_private, ptr %1, i32 0, i32 15
  %call.i.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %vbl_received, i32 noundef 4) #4
  tail call void @llvm.prefetch.p0(ptr %vbl_received, i32 1, i32 3, i32 1) #4
  %12 = tail call { i32, i32 } asm sideeffect "@ atomic_add\0A1:\09ldrex\09$0, [$3]\0A\09add\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %vbl_received, ptr %vbl_received, i32 1, ptr elementtype(i32) %vbl_received) #4, !srcloc !18
  %call5 = tail call zeroext i1 @drm_handle_vblank(ptr noundef %arg, i32 noundef 0) #4
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @r128_enable_vblank(ptr nocapture noundef readonly %dev, i32 noundef %pipe) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %pipe)
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (ptr, ...) @__drm_err(ptr noundef nonnull @.str, ptr noundef nonnull @__func__.r128_enable_vblank, i32 noundef %pipe) #4
  br label %cleanup
...
do.body:                                          ; preds = %entry
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr, i32 16777216) #4, !srcloc !17
  br label %cleanup

cleanup:                                          ; preds = %do.body, %if.then
  %retval.0 = phi i32 [ -22, %if.then ], [ 0, %do.body ]
  ret i32 %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @r128_disable_vblank(ptr nocapture noundef readnone %dev, i32 noundef %pipe) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %pipe)
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (ptr, ...) @__drm_err(ptr noundef nonnull @.str, ptr noundef nonnull @__func__.r128_disable_vblank, i32 noundef %pipe) #4
  br label %if.end
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @r128_driver_irq_preinstall(ptr nocapture noundef readonly %dev) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %dev_private = getelementptr inbounds %struct.drm_device, ptr %dev, i32 0, i32 5
  ...
  %5 = load ptr, ptr %handle, align 4
  %add.ptr = getelementptr i8, ptr %5, i32 64
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr, i32 0) #4, !srcloc !17
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr6, i32 16777216) #4, !srcloc !17
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid readnone sanitize_address sspstrong willreturn uwtable(sync)
define dso_local i32 @r128_driver_irq_postinstall(ptr nocapture noundef readnone %dev) local_unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  ret i32 0
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @r128_driver_irq_uninstall(ptr nocapture noundef readonly %dev) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %dev_private = getelementptr inbounds %struct.drm_device, ptr %dev, i32 0, i32 5
...
!1 = !{!"../drivers/gpu/drm/r128/r128_irq.c", i32 73, i32 3}
!2 = !{ptr @__func__.r128_enable_vblank, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @__func__.r128_disable_vblank, !4, !"<string literal>", i1 false, i1 false}
!4 = !{!"../drivers/gpu/drm/r128/r128_irq.c", i32 84, i32 3}
...
!16 = !{i64 2154721662}
!17 = !{i64 6494899}
!18 = !{i64 2148490827, i64 2148490853, i64 2148490882, i64 2148490916, i64 2148490947, i64 2148490970}
!19 = !{i64 2154722312}
!20 = !{i64 2154722933}
!21 = !{i64 2154723490}
!22 = !{i64 2154724045}
