; ModuleID = '/llk/IR_all_yes/drivers/gpu/host1x/hw/host1x05.c_pt.bc'
...
@___asan_gen_ = private constant [36 x i8] c"../drivers/gpu/host1x/hw/host1x05.c\00", align 1
...
define dso_local i32 @host1x05_init(ptr nocapture noundef writeonly %host) local_unnamed_addr #0 align 64 {
entry:
...
if.end11:                                         ; preds = %if.end
  tail call void @host1x_ch_writel(ptr noundef %1, i32 noundef 4, i32 noundef 152) #13
...
if.then.i:                                        ; preds = %for.body.i
  ...
  tail call void @host1x_cdma_push_wide(ptr noundef %cdma1.i, i32 noundef 5111877, i32 noundef %threshold.0.i, i32 noundef %61, i32 noundef %shl1.i.i.i) #13
...
if.end:                                           ; preds = %land.lhs.true.if.end_crit_edge, %entry.if.end_crit_edge
  ...
  %add.i = add nuw nsw i32 %mul.i, 3936
...
entry:
  ...
  %add.i = add nuw nsw i32 %mul.i, 3872
...
entry:
  ...
  %0 = lshr i32 %id, 3
  %mul.i = and i32 %0, 536870908
  %add.i = add nuw nsw i32 %mul.i, 3840
  tail call void @host1x_sync_writel(ptr noundef %host, i32 noundef %shl, i32 noundef %add.i) #13
  %add.i11 = add nuw nsw i32 %mul.i, 3712
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %entry.for.body_crit_edge
  ...
  %add.i9 = add nuw nsw i32 %mul.i, 3712
...
for.body:                                         ; preds = %for.inc10.for.body_crit_edge, %for.body.lr.ph
  ...
  %add.i = add nuw nsw i32 %mul.i, 3712
...
do.body:                                          ; preds = %if.end30.do.body_crit_edge, %if.end
  ...
  %shl.i85 = and i32 %and.i84, 983040
  %and.i86 = and i32 %rd_ptr.0, 1023
...
!174 = !{i64 2148738152, i64 2148738157, i64 2148738170, i64 2148738214, i64 2148738248, i64 2148738269}
!175 = !{i64 2154673960}
!176 = !{i64 2154674257}
!177 = !{i64 2149967565}
!178 = !{i64 2149968601}
...
!182 = !{i64 2154651979}
!183 = !{i64 2148266773}
!184 = !{i64 648686, i64 648710, i64 648731, i64 648748, i64 648765}
!185 = !{i64 2148266999}
!186 = !{i64 2154374305}
!187 = !{i64 2154818545}
!188 = !{!"auto-init"}
