; ModuleID = '/llk/IR_all_yes/drivers/hid/hid-lcpower.c_pt.bc'
source_filename = "../drivers/hid/hid-lcpower.c"
...
@__initcall__kmod_hid_lcpower__223_54_ts_driver_init6 = internal global ptr @ts_driver_init, section ".initcall6.init", align 4
...
@__UNIQUE_ID_file224 = internal constant [41 x i8] c"hid_lcpower.file=drivers/hid/hid-lcpower\00", section ".modinfo", align 1
@__UNIQUE_ID_license225 = internal constant [24 x i8] c"hid_lcpower.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [12 x i8], [20 x i8] } { [12 x i8] c"hid_lcpower\00", [20 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [13 x i8], [19 x i8] } { [13 x i8] c"LC RC1000MCE\00", [19 x i8] zeroinitializer }, align 32
@ts_devices = internal constant { [2 x %struct.hid_device_id], [32 x i8] } { [2 x %struct.hid_device_id] [%struct.hid_device_id { i16 3, i16 0, i32 4673, i32 63335, i32 0 }, %struct.hid_device_id zeroinitializer], [32 x i8] zeroinitializer }, align 32
...
@__sancov_gen_cov_switch_values = internal global [10 x i64] [i64 8, i64 16, i64 13, i64 36, i64 37, i64 70, i64 71, i64 72, i64 73, i64 74]
@___asan_gen_.5 = private unnamed_addr constant [10 x i8] c"ts_driver\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 49, i32 26 }
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 54, i32 1 }
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 50, i32 10 }
@___asan_gen_.14 = private unnamed_addr constant [11 x i8] c"ts_devices\00", align 1
@___asan_gen_.15 = private constant [29 x i8] c"../drivers/hid/hid-lcpower.c\00", align 1
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 43, i32 35 }
...
define internal i32 @ts_input_mapping(ptr nocapture noundef readnone %hdev, ptr nocapture noundef readonly %hi, ptr nocapture noundef readnone %field, ptr nocapture noundef %usage, ptr nocapture noundef writeonly %bit, ptr nocapture noundef writeonly %max) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
sw.bb:                                            ; preds = %if.end
  ...
  store i16 400, ptr %code.i.i, align 2
  br label %return.sink.split

sw.bb3:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i40 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %7 = ptrtoint ptr %input1.i.i40 to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %input1.i.i40, align 4
  %keybit.i.i41 = getelementptr inbounds %struct.input_dev, ptr %8, i32 0, i32 6
  %type19.i.i42 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %9 = ptrtoint ptr %type19.i.i42 to i32
  call void @__asan_store1_noabort(i32 %9)
  store i8 1, ptr %type19.i.i42, align 4
  %code.i.i43 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %10 = ptrtoint ptr %code.i.i43 to i32
  call void @__asan_store2_noabort(i32 %10)
  store i16 399, ptr %code.i.i43, align 2
  br label %return.sink.split

sw.bb4:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i45 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %11 = ptrtoint ptr %input1.i.i45 to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %input1.i.i45, align 4
  %keybit.i.i46 = getelementptr inbounds %struct.input_dev, ptr %12, i32 0, i32 6
  %type19.i.i47 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %13 = ptrtoint ptr %type19.i.i47 to i32
  call void @__asan_store1_noabort(i32 %13)
  store i8 1, ptr %type19.i.i47, align 4
  %code.i.i48 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %14 = ptrtoint ptr %code.i.i48 to i32
  call void @__asan_store2_noabort(i32 %14)
  store i16 401, ptr %code.i.i48, align 2
  br label %return.sink.split

sw.bb5:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i50 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %15 = ptrtoint ptr %input1.i.i50 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %input1.i.i50, align 4
  %keybit.i.i51 = getelementptr inbounds %struct.input_dev, ptr %16, i32 0, i32 6
  %type19.i.i52 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %17 = ptrtoint ptr %type19.i.i52 to i32
  call void @__asan_store1_noabort(i32 %17)
  store i8 1, ptr %type19.i.i52, align 4
  %code.i.i53 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %18 = ptrtoint ptr %code.i.i53 to i32
  call void @__asan_store2_noabort(i32 %18)
  store i16 398, ptr %code.i.i53, align 2
  br label %return.sink.split

sw.bb6:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i55 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %19 = ptrtoint ptr %input1.i.i55 to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load ptr, ptr %input1.i.i55, align 4
  %keybit.i.i56 = getelementptr inbounds %struct.input_dev, ptr %20, i32 0, i32 6
  %type19.i.i57 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %21 = ptrtoint ptr %type19.i.i57 to i32
  call void @__asan_store1_noabort(i32 %21)
  store i8 1, ptr %type19.i.i57, align 4
  %code.i.i58 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %22 = ptrtoint ptr %code.i.i58 to i32
  call void @__asan_store2_noabort(i32 %22)
  store i16 102, ptr %code.i.i58, align 2
  br label %return.sink.split

sw.bb7:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i60 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %23 = ptrtoint ptr %input1.i.i60 to i32
  call void @__asan_load4_noabort(i32 %23)
  %24 = load ptr, ptr %input1.i.i60, align 4
  %keybit.i.i61 = getelementptr inbounds %struct.input_dev, ptr %24, i32 0, i32 6
  %type19.i.i62 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %25 = ptrtoint ptr %type19.i.i62 to i32
  call void @__asan_store1_noabort(i32 %25)
  store i8 1, ptr %type19.i.i62, align 4
  %code.i.i63 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %26 = ptrtoint ptr %code.i.i63 to i32
  call void @__asan_store2_noabort(i32 %26)
  store i16 377, ptr %code.i.i63, align 2
  br label %return.sink.split

sw.bb8:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i65 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %27 = ptrtoint ptr %input1.i.i65 to i32
  call void @__asan_load4_noabort(i32 %27)
  %28 = load ptr, ptr %input1.i.i65, align 4
  %keybit.i.i66 = getelementptr inbounds %struct.input_dev, ptr %28, i32 0, i32 6
  %type19.i.i67 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %29 = ptrtoint ptr %type19.i.i67 to i32
  call void @__asan_store1_noabort(i32 %29)
  store i8 1, ptr %type19.i.i67, align 4
  %code.i.i68 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %30 = ptrtoint ptr %code.i.i68 to i32
  call void @__asan_store2_noabort(i32 %30)
  store i16 379, ptr %code.i.i68, align 2
  br label %return.sink.split

sw.bb9:                                           ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  %input1.i.i70 = getelementptr inbounds %struct.hid_input, ptr %hi, i32 0, i32 2
  %31 = ptrtoint ptr %input1.i.i70 to i32
  call void @__asan_load4_noabort(i32 %31)
  %32 = load ptr, ptr %input1.i.i70, align 4
  %keybit.i.i71 = getelementptr inbounds %struct.input_dev, ptr %32, i32 0, i32 6
  %type19.i.i72 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 6
  %33 = ptrtoint ptr %type19.i.i72 to i32
  call void @__asan_store1_noabort(i32 %33)
  store i8 1, ptr %type19.i.i72, align 4
  %code.i.i73 = getelementptr inbounds %struct.hid_usage, ptr %usage, i32 0, i32 5
  %34 = ptrtoint ptr %code.i.i73 to i32
  call void @__asan_store2_noabort(i32 %34)
  store i16 139, ptr %code.i.i73, align 2
  br label %return.sink.split

return.sink.split:                                ; preds = %sw.bb9, %sw.bb8, %sw.bb7, %sw.bb6, %sw.bb5, %sw.bb4, %sw.bb3, %sw.bb
  %keybit.i.i.sink75 = phi ptr [ %keybit.i.i, %sw.bb ], [ %keybit.i.i41, %sw.bb3 ], [ %keybit.i.i46, %sw.bb4 ], [ %keybit.i.i51, %sw.bb5 ], [ %keybit.i.i56, %sw.bb6 ], [ %keybit.i.i61, %sw.bb7 ], [ %keybit.i.i66, %sw.bb8 ], [ %keybit.i.i71, %sw.bb9 ]
  %code.i.i.sink = phi ptr [ %code.i.i, %sw.bb ], [ %code.i.i43, %sw.bb3 ], [ %code.i.i48, %sw.bb4 ], [ %code.i.i53, %sw.bb5 ], [ %code.i.i58, %sw.bb6 ], [ %code.i.i63, %sw.bb7 ], [ %code.i.i68, %sw.bb8 ], [ %code.i.i73, %sw.bb9 ]
  %35 = ptrtoint ptr %max to i32
  call void @__asan_store4_noabort(i32 %35)
  store i32 767, ptr %max, align 4
  %36 = ptrtoint ptr %bit to i32
  call void @__asan_store4_noabort(i32 %36)
  store ptr %keybit.i.i.sink75, ptr %bit, align 4
  %37 = ptrtoint ptr %code.i.i.sink to i32
  call void @__asan_load2_noabort(i32 %37)
  %38 = load i16, ptr %code.i.i.sink, align 2
  %conv1.i = zext i16 %38 to i32
  tail call void @_clear_bit(i32 noundef %conv1.i, ptr noundef nonnull %keybit.i.i.sink75) #3
  br label %return
...
!0 = !{ptr @__initcall__kmod_hid_lcpower__223_54_ts_driver_init6, !1, !"__initcall__kmod_hid_lcpower__223_54_ts_driver_init6", i1 false, i1 false}
!1 = !{!"../drivers/hid/hid-lcpower.c", i32 54, i32 1}
...
!4 = !{!"../drivers/hid/hid-lcpower.c", i32 56, i32 1}
...
!8 = !{!"../drivers/hid/hid-lcpower.c", i32 50, i32 10}
!9 = !{ptr @ts_driver, !10, !"ts_driver", i1 false, i1 false}
!10 = !{!"../drivers/hid/hid-lcpower.c", i32 49, i32 26}
!11 = !{ptr @ts_devices, !12, !"ts_devices", i1 false, i1 false}
!12 = !{!"../drivers/hid/hid-lcpower.c", i32 43, i32 35}
