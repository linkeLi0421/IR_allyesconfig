; ModuleID = '/llk/IR_all_yes/drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c_pt.bc'
source_filename = "../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c"
...
@__initcall__kmod_inv_icm42600_spi__305_96_inv_icm42600_driver_init6 = internal global ptr @inv_icm42600_driver_init, section ".initcall6.init", align 4
@inv_icm42600_driver = internal global { %struct.spi_driver, [36 x i8] } { %struct.spi_driver { ptr null, ptr @inv_icm42600_probe, ptr null, ptr null, %struct.device_driver { ptr @.str, ptr null, ptr null, ptr null, i8 0, i32 0, ptr @inv_icm42600_of_matches, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @inv_icm42600_pm_ops, ptr null, ptr null } }, [36 x i8] zeroinitializer }, align 32
@__exitcall_inv_icm42600_driver_exit = internal global ptr @inv_icm42600_driver_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_author306 = internal constant [41 x i8] c"inv_icm42600_spi.author=InvenSense, Inc.\00", section ".modinfo", align 1
@__UNIQUE_ID_description307 = internal constant [61 x i8] c"inv_icm42600_spi.description=InvenSense ICM-426xx SPI driver\00", section ".modinfo", align 1
@__UNIQUE_ID_file308 = internal constant [68 x i8] c"inv_icm42600_spi.file=drivers/iio/imu/inv_icm42600/inv-icm42600-spi\00", section ".modinfo", align 1
@__UNIQUE_ID_license309 = internal constant [29 x i8] c"inv_icm42600_spi.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [17 x i8], [47 x i8] } { [17 x i8] c"inv-icm42600-spi\00", [47 x i8] zeroinitializer }, align 32
...
@.str.1 = internal constant { [56 x i8], [40 x i8] } { [56 x i8] c"inv_icm42600_spi:62:(&inv_icm42600_regmap_config)->lock\00", [40 x i8] zeroinitializer }, align 32
@___asan_gen_.2 = private unnamed_addr constant [20 x i8] c"inv_icm42600_driver\00", align 1
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 88, i32 26 }
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 90, i32 11 }
@___asan_gen_.8 = private unnamed_addr constant [24 x i8] c"inv_icm42600_of_matches\00", align 1
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 70, i32 34 }
@___asan_gen_.11 = private unnamed_addr constant [5 x i8] c"_key\00", align 1
@___asan_gen_.14 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.15 = private constant [51 x i8] c"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c\00", align 1
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 62, i32 11 }
@llvm.compiler.used = appending global [12 x ptr] [ptr @__UNIQUE_ID_author306, ptr @__UNIQUE_ID_description307, ptr @__UNIQUE_ID_file308, ptr @__UNIQUE_ID_license309, ptr @__exitcall_inv_icm42600_driver_exit, ptr @__initcall__kmod_inv_icm42600_spi__305_96_inv_icm42600_driver_init6, ptr @inv_icm42600_driver_exit, ptr @inv_icm42600_driver, ptr @.str, ptr @inv_icm42600_of_matches, ptr @inv_icm42600_probe._key, ptr @.str.1], section "llvm.metadata"
@0 = internal global [5 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @inv_icm42600_driver to i32), i32 92, i32 128, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 17, i32 64, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @inv_icm42600_of_matches to i32), i32 980, i32 1216, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @inv_icm42600_probe._key to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 56, i32 96, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }]
...
entry:
  ...
  %call = tail call i32 @__spi_register_driver(ptr noundef null, ptr noundef nonnull @inv_icm42600_driver) #3
  ret i32 %call
}
...
entry:
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @driver_unregister(ptr noundef getelementptr inbounds (%struct.spi_driver, ptr @inv_icm42600_driver, i32 0, i32 4)) #3
  ret void
}
...
define internal i32 @inv_icm42600_probe(ptr noundef %spi) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call ptr @device_get_match_data(ptr noundef %spi) #3
...
if.end:                                           ; preds = %entry
  %call1 = tail call ptr @__devm_regmap_init_spi(ptr noundef %spi, ptr noundef nonnull @inv_icm42600_regmap_config, ptr noundef nonnull @inv_icm42600_probe._key, ptr noundef nonnull @.str.1) #3
...
if.end5:                                          ; preds = %if.end
  ...
  %call6 = tail call i32 @inv_icm42600_core_probe(ptr noundef %call1, i32 noundef %1, i32 noundef %3, ptr noundef nonnull @inv_icm42600_spi_bus_setup) #3
  br label %cleanup

cleanup:                                          ; preds = %if.end5, %if.then3, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %0, %if.then3 ], [ %call6, %if.end5 ], [ -22, %entry.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @inv_icm42600_spi_bus_setup(ptr nocapture noundef readonly %st) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call.i = tail call i32 @regmap_update_bits_base(ptr noundef %1, i32 noundef 4220, i32 noundef 31, i32 noundef 19, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #3
...
if.end:                                           ; preds = %entry
  ...
  %call.i68 = tail call i32 @regmap_update_bits_base(ptr noundef %3, i32 noundef 4218, i32 noundef 64, i32 noundef 0, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i68)
  %tobool3.not = icmp eq i32 %call.i68, 0
...
if.end5:                                          ; preds = %if.end
  ...
  %call.i69 = tail call i32 @regmap_update_bits_base(ptr noundef %5, i32 noundef 19, i32 noundef 63, i32 noundef 5, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #3
...
if.end38:                                         ; preds = %if.end5
  ...
  %call.i70 = tail call i32 @regmap_update_bits_base(ptr noundef %7, i32 noundef 76, i32 noundef 3, i32 noundef 3, ptr noundef null, i1 noundef zeroext false, i1 noundef zeroext false) #3
  br label %cleanup

cleanup:                                          ; preds = %if.end38, %if.end5.cleanup_crit_edge, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %call.i70, %if.end38 ], [ %call.i, %entry.cleanup_crit_edge ], [ %call.i68, %if.end.cleanup_crit_edge ], [ %call.i69, %if.end5.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
!0 = !{ptr @__initcall__kmod_inv_icm42600_spi__305_96_inv_icm42600_driver_init6, !1, !"__initcall__kmod_inv_icm42600_spi__305_96_inv_icm42600_driver_init6", i1 false, i1 false}
!1 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 96, i32 1}
...
!4 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 98, i32 1}
!5 = !{ptr @__UNIQUE_ID_description307, !6, !"__UNIQUE_ID_description307", i1 false, i1 false}
!6 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 99, i32 1}
!7 = !{ptr @__UNIQUE_ID_file308, !8, !"__UNIQUE_ID_file308", i1 false, i1 false}
!8 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 100, i32 1}
!9 = !{ptr @__UNIQUE_ID_license309, !8, !"__UNIQUE_ID_license309", i1 false, i1 false}
!10 = !{ptr @.str, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 90, i32 11}
!12 = !{ptr @inv_icm42600_driver, !13, !"inv_icm42600_driver", i1 false, i1 false}
!13 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 88, i32 26}
!14 = !{ptr @inv_icm42600_probe._key, !15, !"_key", i1 false, i1 false}
!15 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 62, i32 11}
!16 = !{ptr @.str.1, !15, !"<string literal>", i1 false, i1 false}
!17 = !{ptr @inv_icm42600_of_matches, !18, !"inv_icm42600_of_matches", i1 false, i1 false}
!18 = !{!"../drivers/iio/imu/inv_icm42600/inv_icm42600_spi.c", i32 70, i32 34}
