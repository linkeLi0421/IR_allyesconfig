; ModuleID = '/llk/IR_all_yes/drivers/media/platform/qcom/camss/camss-vfe-4-8.c_pt.bc'
source_filename = "../drivers/media/platform/qcom/camss/camss-vfe-4-8.c"
...
@vfe_ops_4_8 = dso_local constant { %struct.vfe_hw_ops, [40 x i8] } { %struct.vfe_hw_ops { ptr null, ptr @vfe_global_reset, ptr @vfe_hw_version, ptr @vfe_isr, ptr @vfe_isr_read, ptr @vfe_pm_domain_off, ptr @vfe_pm_domain_on, ptr @vfe_reg_update, ptr @vfe_reg_update_clear, ptr @vfe_subdev_init, ptr @vfe_gen1_disable, ptr @vfe_gen1_enable, ptr @vfe_gen1_halt, ptr @vfe_violation_read }, [40 x i8] zeroinitializer }, align 32
@vfe_hw_version.__UNIQUE_ID_ddebug298 = internal global { ptr, ptr, ptr, ptr, i8, i8, i8, i8, { { { %struct.atomic_t, { ptr } } } }, [4 x i8] } { ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, i8 0, i8 63, i8 -128, i8 0, { { { %struct.atomic_t, { ptr } } } } zeroinitializer, [4 x i8] undef }, section "__dyndbg", align 8
...
@.str.2 = internal constant { [50 x i8], [46 x i8] } { [50 x i8] c"drivers/media/platform/qcom/camss/camss-vfe-4-8.c\00", [46 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [25 x i8], [39 x i8] } { [25 x i8] c"VFE HW Version = 0x%08x\0A\00", [39 x i8] zeroinitializer }, align 32
@vfe_isr.__UNIQUE_ID_ddebug299 = internal global { ptr, ptr, ptr, ptr, i8, i8, i8, i8, { { { %struct.atomic_t, { ptr } } } }, [4 x i8] } { ptr @.str, ptr @.str.4, ptr @.str.2, ptr @.str.5, i8 0, i8 -10, i8 -128, i8 0, { { { %struct.atomic_t, { ptr } } } } zeroinitializer, [4 x i8] undef }, section "__dyndbg", align 8
...
@vfe_pm_domain_on._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.6, ptr @.str.7, ptr @.str.2, i32 1120, ptr @.str.8, ptr @.str.9 }, [40 x i8] zeroinitializer }, align 32
...
@vfe_violation_read._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.13, ptr @__func__.vfe_violation_read, ptr @.str.2, i32 1131, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
...
@___asan_gen_.17 = private unnamed_addr constant [12 x i8] c"vfe_ops_4_8\00", align 1
@___asan_gen_.19 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 1180, i32 25 }
@___asan_gen_.31 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 254, i32 2 }
@___asan_gen_.37 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 985, i32 2 }
@___asan_gen_.52 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 1120, i32 3 }
@___asan_gen_.53 = private unnamed_addr constant [17 x i8] c"vfe_ops_gen1_4_8\00", align 1
@___asan_gen_.55 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 1134, i32 37 }
@___asan_gen_.64 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 965, i32 3 }
...
@___asan_gen_.75 = private constant [53 x i8] c"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c\00", align 1
@___asan_gen_.76 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.75, i32 1131, i32 2 }
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @vfe_pm_domain_off(ptr nocapture noundef readonly %vfe) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #10
  call void @llvm.arm.gnu.eabi.mcount()
...
entry:
  ...
  call void @__asan_store4_noabort(i32 %1)
  store ptr @vfe_ops_gen1_4_8, ptr %ops_gen1, align 8
...
entry:
  ...
  tail call void @__might_sleep(ptr noundef nonnull @.str.2, i32 noundef 963) #8
  %base = getelementptr inbounds %struct.vfe_device, ptr %vfe, i32 0, i32 2
  %0 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %base, align 8
...
entry:
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr, i32 286379212) #8, !srcloc !42
  %2 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %base, align 8
  %add.ptr2 = getelementptr i8, ptr %3, i32 1064
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr2, i32 286379212) #8, !srcloc !42
  %4 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %base, align 8
  %add.ptr4 = getelementptr i8, ptr %5, i32 1068
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr4, i32 286379212) #8, !srcloc !42
  %6 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %base, align 8
  %add.ptr6 = getelementptr i8, ptr %7, i32 1072
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr6, i32 286379212) #8, !srcloc !42
  %8 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %base, align 8
  %add.ptr8 = getelementptr i8, ptr %9, i32 1076
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr8, i32 286379212) #8, !srcloc !42
  %10 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %base, align 8
  %add.ptr10 = getelementptr i8, ptr %11, i32 1080
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr10, i32 286379212) #8, !srcloc !42
  %12 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %base, align 8
  %add.ptr12 = getelementptr i8, ptr %13, i32 1084
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr12, i32 286379212) #8, !srcloc !42
  %14 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %base, align 8
  %add.ptr14 = getelementptr i8, ptr %15, i32 1088
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr14, i32 286379212) #8, !srcloc !42
  %16 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %base, align 8
  %add.ptr16 = getelementptr i8, ptr %17, i32 1092
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr16, i32 286379212) #8, !srcloc !42
  %18 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load ptr, ptr %base, align 8
  %add.ptr18 = getelementptr i8, ptr %19, i32 1096
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr18, i32 286379212) #8, !srcloc !42
  %20 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %base, align 8
  %add.ptr20 = getelementptr i8, ptr %21, i32 1100
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr20, i32 286379212) #8, !srcloc !42
  %22 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %base, align 8
  %add.ptr22 = getelementptr i8, ptr %23, i32 1104
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr22, i32 286379212) #8, !srcloc !42
  %24 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %base, align 8
  %add.ptr24 = getelementptr i8, ptr %25, i32 1108
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr24, i32 286379212) #8, !srcloc !42
  %26 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %base, align 8
  %add.ptr26 = getelementptr i8, ptr %27, i32 1112
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr26, i32 286379212) #8, !srcloc !42
  %28 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %base, align 8
  %add.ptr28 = getelementptr i8, ptr %29, i32 1116
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr28, i32 286379212) #8, !srcloc !42
  %30 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load ptr, ptr %base, align 8
  %add.ptr30 = getelementptr i8, ptr %31, i32 1120
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr30, i32 286379212) #8, !srcloc !42
  %32 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load ptr, ptr %base, align 8
  %add.ptr32 = getelementptr i8, ptr %33, i32 1124
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr32, i32 268500992) #8, !srcloc !42
  ret void
}
...
entry:
  ...
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr, i32 -1515543126) #8, !srcloc !42
  %2 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %base, align 8
  %add.ptr2 = getelementptr i8, ptr %3, i32 1032
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr2, i32 -1515543126) #8, !srcloc !42
  %4 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %base, align 8
  %add.ptr4 = getelementptr i8, ptr %5, i32 1036
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr4, i32 -1515543126) #8, !srcloc !42
  %6 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %base, align 8
  %add.ptr6 = getelementptr i8, ptr %7, i32 1040
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr6, i32 -1515563606) #8, !srcloc !42
  %8 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %base, align 8
  %add.ptr8 = getelementptr i8, ptr %9, i32 1044
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr8, i32 1437226410) #8, !srcloc !42
  %10 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %base, align 8
  %add.ptr10 = getelementptr i8, ptr %11, i32 1048
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr10, i32 1437226410) #8, !srcloc !42
  %12 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %base, align 8
  %add.ptr12 = getelementptr i8, ptr %13, i32 1052
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr12, i32 1437226410) #8, !srcloc !42
  %14 = ptrtoint ptr %base to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %base, align 8
  %add.ptr14 = getelementptr i8, ptr %15, i32 1056
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr14, i32 1437205760) #8, !srcloc !42
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  call void @__asan_load4_noabort(i32 %1)
  %2 = load ptr, ptr %base, align 8
  %add.ptr = getelementptr i8, ptr %2, i32 3308
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr, i32 %0) #8, !srcloc !42
  br label %do.body

if.else:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #10
  %shl3 = shl nuw i32 1, %mul2
  %3 = tail call i32 @llvm.bswap.i32(i32 %shl3)
  %base4 = getelementptr inbounds %struct.vfe_device, ptr %vfe, i32 0, i32 2
  %4 = ptrtoint ptr %base4 to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %base4, align 8
  %add.ptr5 = getelementptr i8, ptr %5, i32 3308
  tail call void asm sideeffect "str $1, $0", "*Qo,r"(ptr elementtype(i32) %add.ptr5, i32 %3) #8, !srcloc !42
  br label %do.body
...
!0 = !{ptr @vfe_ops_4_8, !1, !"vfe_ops_4_8", i1 false, i1 false}
!1 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 1180, i32 25}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 254, i32 2}
!4 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.2, !3, !"<string literal>", i1 false, i1 false}
!6 = !{ptr @.str.3, !3, !"<string literal>", i1 false, i1 false}
!7 = !{ptr @vfe_hw_version.__UNIQUE_ID_ddebug298, !3, !"__UNIQUE_ID_ddebug298", i1 false, i1 false}
!8 = !{ptr @.str.4, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 985, i32 2}
!10 = !{ptr @.str.5, !9, !"<string literal>", i1 false, i1 false}
!11 = !{ptr @vfe_isr.__UNIQUE_ID_ddebug299, !9, !"__UNIQUE_ID_ddebug299", i1 false, i1 false}
!12 = !{ptr @.str.6, !13, !"<string literal>", i1 false, i1 false}
!13 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 1120, i32 3}
...
!19 = !{ptr @vfe_ops_gen1_4_8, !20, !"vfe_ops_gen1_4_8", i1 false, i1 false}
!20 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 1134, i32 37}
!21 = !{ptr @.str.10, !22, !"<string literal>", i1 false, i1 false}
!22 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 965, i32 3}
...
!27 = !{!"../drivers/media/platform/qcom/camss/camss-vfe-4-8.c", i32 1131, i32 2}
...
!43 = !{i64 2156459611}
!44 = !{i64 4894355}
!45 = !{i64 2148312684, i64 2148312689, i64 2148312702, i64 2148312746, i64 2148312780, i64 2148312801}
!46 = !{!"auto-init"}
!47 = !{i64 2156495344}
!48 = !{i64 2156471500}
!49 = !{i64 2156471865}
