; ModuleID = '/llk/IR_all_yes/drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c_pt.bc'
source_filename = "../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c"
...
@pvr2_cs53l32a_subdev_update._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 54, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
...
@.str.1 = internal constant { [28 x i8], [36 x i8] } { [28 x i8] c"pvr2_cs53l32a_subdev_update\00", [36 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [45 x i8], [51 x i8] } { [45 x i8] c"drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c\00", [51 x i8] zeroinitializer }, align 32
@pvr2_cs53l32a_subdev_update._entry_ptr = internal global ptr @pvr2_cs53l32a_subdev_update._entry, section ".printk_index", align 4
@routing_schemes = internal constant { [3 x ptr], [20 x i8] } { [3 x ptr] [ptr null, ptr null, ptr @routing_def1], [20 x i8] zeroinitializer }, align 32
@pvr2_cs53l32a_subdev_update._entry.3 = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.4, ptr @.str.1, ptr @.str.2, i32 62, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
...
@pvr2_cs53l32a_subdev_update._entry_ptr.5 = internal global ptr @pvr2_cs53l32a_subdev_update._entry.3, section ".printk_index", align 4
...
@routing_scheme1 = internal constant { [5 x i32], [44 x i8] } { [5 x i32] [i32 2, i32 0, i32 0, i32 0, i32 2], [44 x i8] zeroinitializer }, align 32
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.31, i32 53, i32 3 }
@___asan_gen_.18 = private unnamed_addr constant [16 x i8] c"routing_schemes\00", align 1
@___asan_gen_.20 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.31, i32 42, i32 37 }
@___asan_gen_.21 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.24 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.26 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.31, i32 60, i32 4 }
@___asan_gen_.27 = private unnamed_addr constant [13 x i8] c"routing_def1\00", align 1
@___asan_gen_.29 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.31, i32 37, i32 36 }
@___asan_gen_.30 = private unnamed_addr constant [16 x i8] c"routing_scheme1\00", align 1
@___asan_gen_.31 = private constant [48 x i8] c"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c\00", align 1
@___asan_gen_.32 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.31, i32 30, i32 18 }
@llvm.compiler.used = appending global [11 x ptr] [ptr @pvr2_cs53l32a_subdev_update._entry, ptr @pvr2_cs53l32a_subdev_update._entry.3, ptr @pvr2_cs53l32a_subdev_update._entry_ptr, ptr @pvr2_cs53l32a_subdev_update._entry_ptr.5, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @routing_schemes, ptr @.str.4, ptr @routing_def1, ptr @routing_scheme1], section "llvm.metadata"
@0 = internal global [9 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @pvr2_cs53l32a_subdev_update._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 38, i32 96, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 28, i32 64, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 45, i32 96, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @routing_schemes to i32), i32 12, i32 32, i32 ptrtoint (ptr @___asan_gen_.18 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @pvr2_cs53l32a_subdev_update._entry.3 to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 97, i32 160, i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.26 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @routing_def1 to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.27 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.29 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @routing_scheme1 to i32), i32 20, i32 64, i32 ptrtoint (ptr @___asan_gen_.30 to i32), i32 ptrtoint (ptr @___asan_gen_.31 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.32 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @pvr2_cs53l32a_subdev_update(ptr nocapture noundef readonly %hdw, ptr noundef %sd) local_unnamed_addr #0 align 64 {
entry:
...
cond.end:                                         ; preds = %do.end6
  ...
  %.not = icmp eq i8 %7, 2
  br i1 %.not, label %lor.lhs.false10, label %cond.end.do.body19_crit_edge
...
if.end32:                                         ; preds = %lor.lhs.false14
  ...
  %audio = getelementptr inbounds %struct.v4l2_subdev_ops, ptr %25, i32 0, i32 2
  %26 = ptrtoint ptr %audio to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %audio, align 4
  %s_routing = getelementptr inbounds %struct.v4l2_subdev_audio_ops, ptr %27, i32 0, i32 2
  %28 = ptrtoint ptr %s_routing to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %s_routing, align 4
...
!1 = !{!"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c", i32 53, i32 3}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @pvr2_cs53l32a_subdev_update._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @pvr2_cs53l32a_subdev_update._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.4, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c", i32 60, i32 4}
!8 = !{ptr @pvr2_cs53l32a_subdev_update._entry.3, !7, !"_entry", i1 false, i1 false}
!9 = !{ptr @pvr2_cs53l32a_subdev_update._entry_ptr.5, !7, !"_entry_ptr", i1 false, i1 false}
!10 = !{ptr @routing_schemes, !11, !"routing_schemes", i1 false, i1 false}
!11 = !{!"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c", i32 42, i32 37}
!12 = !{ptr @routing_def1, !13, !"routing_def1", i1 false, i1 false}
!13 = !{!"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c", i32 37, i32 36}
!14 = !{ptr @routing_scheme1, !15, !"routing_scheme1", i1 false, i1 false}
!15 = !{!"../drivers/media/usb/pvrusb2/pvrusb2-cs53l32a.c", i32 30, i32 18}
