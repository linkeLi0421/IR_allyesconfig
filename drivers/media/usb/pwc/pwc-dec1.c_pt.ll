; ModuleID = '/llk/IR_all_yes/drivers/media/usb/pwc/pwc-dec1.c_pt.bc'
source_filename = "../drivers/media/usb/pwc/pwc-dec1.c"
...
define dso_local void @pwc_dec1_init(ptr nocapture noundef %pdev, ptr nocapture noundef readnone %cmd) local_unnamed_addr #0 align 64 {
entry:
  ...
  %2 = load i32, ptr %release, align 4
