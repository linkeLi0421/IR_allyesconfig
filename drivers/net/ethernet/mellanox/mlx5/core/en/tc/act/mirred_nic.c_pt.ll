; ModuleID = '/llk/IR_all_yes/drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c_pt.bc'
source_filename = "../drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c"
...
@mlx5e_tc_act_mirred_nic = dso_local global { %struct.mlx5e_tc_act, [20 x i8] } { %struct.mlx5e_tc_act { ptr @tc_act_can_offload_mirred_nic, ptr @tc_act_parse_mirred_nic, ptr null }, [20 x i8] zeroinitializer }, align 32
@tc_act_can_offload_mirred_nic.__msg = internal constant { [71 x i8], [57 x i8] } { [71 x i8] c"mlx5_core: devices are not on same switch HW, can't offload forwarding\00", [57 x i8] zeroinitializer }, align 32
@.str = internal constant { [63 x i8], [33 x i8] } { [63 x i8] c"devices %s %s not on same switch HW, can't offload forwarding\0A\00", [33 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [21 x i8], [43 x i8] } { [21 x i8] c"(unnamed net_device)\00", [43 x i8] zeroinitializer }, align 32
@___asan_gen_.2 = private unnamed_addr constant [24 x i8] c"mlx5e_tc_act_mirred_nic\00", align 1
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.9, i32 48, i32 21 }
@___asan_gen_.5 = private unnamed_addr constant [6 x i8] c"__msg\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.9, i32 22, i32 3 }
@___asan_gen_.9 = private constant [66 x i8] c"../drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c\00", align 1
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.9, i32 25, i32 8 }
@___asan_gen_.11 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.12 = private unnamed_addr constant [29 x i8] c"../include/linux/netdevice.h\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 4963, i32 10 }
@llvm.compiler.used = appending global [4 x ptr] [ptr @mlx5e_tc_act_mirred_nic, ptr @tc_act_can_offload_mirred_nic.__msg, ptr @.str, ptr @.str.1], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @mlx5e_tc_act_mirred_nic to i32), i32 12, i32 32, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 0 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @tc_act_can_offload_mirred_nic.__msg to i32), i32 71, i32 128, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 63, i32 96, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 21, i32 64, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal zeroext i1 @tc_act_can_offload_mirred_nic(ptr nocapture noundef readonly %parse_state, ptr nocapture noundef readonly %act, i32 noundef %act_index) #0 align 64 {
entry:
  ...
  %9 = ptrtoint ptr %act to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load i32, ptr %act, align 8
...
if.end:                                           ; preds = %entry
  ...
  %netdev_ops = getelementptr inbounds %struct.net_device, ptr %12, i32 0, i32 16
  %13 = ptrtoint ptr %netdev_ops to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load ptr, ptr %netdev_ops, align 8
  %netdev_ops4 = getelementptr inbounds %struct.net_device, ptr %6, i32 0, i32 16
  %15 = ptrtoint ptr %netdev_ops4 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %netdev_ops4, align 8
  %cmp5.not = icmp eq ptr %14, %16
  br i1 %cmp5.not, label %lor.lhs.false, label %if.end.do.body_crit_edge
...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %call6 = tail call zeroext i1 @mlx5e_same_hw_devs(ptr noundef %8, ptr noundef %add.ptr.i) #4
  br i1 %call6, label %lor.lhs.false.cleanup_crit_edge, label %lor.lhs.false.do.body_crit_edge
...
do.body:                                          ; preds = %lor.lhs.false.do.body_crit_edge, %if.end.do.body_crit_edge
  tail call void @do_trace_netlink_extack(ptr noundef nonnull @tc_act_can_offload_mirred_nic.__msg) #4
  %tobool.not = icmp eq ptr %1, null
  br i1 %tobool.not, label %do.body.if.end9_crit_edge, label %if.then8
...
if.then8:                                         ; preds = %do.body
  ...
  store ptr @tc_act_can_offload_mirred_nic.__msg, ptr %1, align 4
  br label %if.end9
...
if.end9:                                          ; preds = %if.then8, %do.body.if.end9_crit_edge
  ...
  br i1 %tobool.not.i, label %if.end9.netdev_name.exit_crit_edge, label %lor.lhs.false.i

if.end9.netdev_name.exit_crit_edge:               ; preds = %if.end9
  call void @__sanitizer_cov_trace_pc() #6
  br label %netdev_name.exit

lor.lhs.false.i:                                  ; preds = %if.end9
  call void @__sanitizer_cov_trace_pc() #6
  %call.i = tail call ptr @strchr(ptr noundef %19, i32 noundef 37) #4
  %tobool2.not.i = icmp eq ptr %call.i, null
  %spec.select.i = select i1 %tobool2.not.i, ptr %19, ptr @.str.1
  br label %netdev_name.exit

netdev_name.exit:                                 ; preds = %lor.lhs.false.i, %if.end9.netdev_name.exit_crit_edge
  %retval.0.i = phi ptr [ @.str.1, %if.end9.netdev_name.exit_crit_edge ], [ %spec.select.i, %lor.lhs.false.i ]
  tail call void (ptr, ptr, ...) @netdev_warn(ptr noundef %19, ptr noundef nonnull @.str, ptr noundef %retval.0.i, ptr noundef %6) #7
  br label %cleanup

cleanup:                                          ; preds = %netdev_name.exit, %lor.lhs.false.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i1 [ false, %netdev_name.exit ], [ false, %entry.cleanup_crit_edge ], [ true, %lor.lhs.false.cleanup_crit_edge ]
  ret i1 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @tc_act_parse_mirred_nic(ptr nocapture noundef readonly %parse_state, ptr nocapture noundef readonly %act, ptr nocapture noundef readnone %priv, ptr nocapture noundef %attr) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %5 = ptrtoint ptr %parse_attr to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %parse_attr, align 4
  %mirred_ifindex = getelementptr inbounds %struct.mlx5e_tc_flow_parse_attr, ptr %6, i32 0, i32 5
  %7 = ptrtoint ptr %mirred_ifindex to i32
  call void @__asan_store4_noabort(i32 %7)
  store i32 %4, ptr %mirred_ifindex, align 4
  ...
  tail call void @_set_bit(i32 noundef 6, ptr noundef %flags.i) #4
...
declare dso_local zeroext i1 @mlx5e_same_hw_devs(ptr noundef, ptr noundef) local_unnamed_addr #1
...
!0 = !{ptr @mlx5e_tc_act_mirred_nic, !1, !"mlx5e_tc_act_mirred_nic", i1 false, i1 false}
!1 = !{!"../drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c", i32 48, i32 21}
!2 = !{ptr @tc_act_can_offload_mirred_nic.__msg, !3, !"__msg", i1 false, i1 false}
!3 = !{!"../drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c", i32 22, i32 3}
!4 = !{ptr @.str, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/net/ethernet/mellanox/mlx5/core/en/tc/act/mirred_nic.c", i32 25, i32 8}
!6 = !{ptr @.str.1, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../include/linux/netdevice.h", i32 4963, i32 10}
