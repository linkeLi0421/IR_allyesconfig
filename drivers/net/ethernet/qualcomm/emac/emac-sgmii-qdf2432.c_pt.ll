; ModuleID = '/llk/IR_all_yes/drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c_pt.bc'
source_filename = "../drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c"
...
@sgmii_laned = internal constant { [23 x %struct.emac_reg_write], [40 x i8] } { [23 x %struct.emac_reg_write] [%struct.emac_reg_write { i32 380, i32 138 }, %struct.emac_reg_write { i32 392, i32 0 }, %struct.emac_reg_write { i32 404, i32 76 }, %struct.emac_reg_write { i32 672, i32 192 }, %struct.emac_reg_write { i32 12, i32 17 }, %struct.emac_reg_write { i32 24, i32 1 }, %struct.emac_reg_write { i32 28, i32 89 }, %struct.emac_reg_write { i32 32, i32 64 }, %struct.emac_reg_write { i32 36, i32 64 }, %struct.emac_reg_write { i32 184, i32 9 }, %struct.emac_reg_write { i32 208, i32 49 }, %struct.emac_reg_write { i32 308, i32 31 }, %struct.emac_reg_write { i32 548, i32 33 }, %struct.emac_reg_write { i32 552, i32 128 }, %struct.emac_reg_write { i32 556, i32 8 }, %struct.emac_reg_write { i32 684, i32 0 }, %struct.emac_reg_write { i32 700, i32 20 }, %struct.emac_reg_write { i32 120, i32 1 }, %struct.emac_reg_write { i32 96, i32 2 }, %struct.emac_reg_write { i32 412, i32 3 }, %struct.emac_reg_write { i32 100, i32 26 }, %struct.emac_reg_write { i32 440, i32 96 }, %struct.emac_reg_write { i32 496, i32 3 }], [40 x i8] zeroinitializer }, align 32
...
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 115, i32 36 }
@___asan_gen_.4 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.5 = private constant [59 x i8] c"../drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 189, i32 28 }
@llvm.compiler.used = appending global [2 x ptr] [ptr @sgmii_laned, ptr @.str], section "llvm.metadata"
@0 = internal global [2 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @sgmii_laned to i32), i32 184, i32 224, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 23, i32 64, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @emac_sgmii_init_qdf2432(ptr nocapture noundef readonly %adpt) local_unnamed_addr #0 align 64 {
entry:
...
!1 = !{!"../drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c", i32 189, i32 28}
!2 = distinct !{null, !3, !"physical_coding_sublayer_programming", i1 false, i1 false}
!3 = !{!"../drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c", i32 153, i32 36}
!4 = !{ptr @sgmii_laned, !5, !"sgmii_laned", i1 false, i1 false}
!5 = !{!"../drivers/net/ethernet/qualcomm/emac/emac-sgmii-qdf2432.c", i32 115, i32 36}
