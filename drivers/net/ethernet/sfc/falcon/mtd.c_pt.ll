; ModuleID = '/llk/IR_all_yes/drivers/net/ethernet/sfc/falcon/mtd.c_pt.bc'
source_filename = "../drivers/net/ethernet/sfc/falcon/mtd.c"
...
@.str = internal constant { [38 x i8], [58 x i8] } { [38 x i8] c"drivers/net/ethernet/sfc/falcon/mtd.c\00", [58 x i8] zeroinitializer }, align 32
@ef4_mtd_rename.__already_done = internal unnamed_addr global i1 false, section ".data.once", align 1
@.str.1 = internal constant { [35 x i8], [61 x i8] } { [35 x i8] c"RTNL: assertion failed at %s (%d)\0A\00", [61 x i8] zeroinitializer }, align 32
@ef4_mtd_sync._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.2, ptr @.str.3, ptr @.str, i32 37, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [27 x i8], [37 x i8] } { [27 x i8] c"\013%s: %s sync failed (%d)\0A\00", [37 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [13 x i8], [19 x i8] } { [13 x i8] c"ef4_mtd_sync\00", [19 x i8] zeroinitializer }, align 32
@ef4_mtd_sync._entry_ptr = internal global ptr @ef4_mtd_sync._entry, section ".printk_index", align 4
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %mtd_list = getelementptr inbounds %struct.ef4_nic, ptr %efx, i32 0, i32 62
  %prev.i = getelementptr inbounds %struct.ef4_nic, ptr %efx, i32 0, i32 62, i32 1
  br label %for.body

for.body:                                         ; preds = %list_add_tail.exit.for.body_crit_edge, %for.body.lr.ph
  %i.041 = phi i32 [ 0, %for.body.lr.ph ], [ %inc, %list_add_tail.exit.for.body_crit_edge ]
  %mul = mul i32 %i.041, %sizeof_part
  %add.ptr = getelementptr i8, ptr %parts, i32 %mul
  %mtd = getelementptr inbounds %struct.ef4_mtd_partition, ptr %add.ptr, i32 0, i32 1
  ...
  %name = getelementptr inbounds %struct.ef4_mtd_partition, ptr %add.ptr, i32 0, i32 4
  %name4 = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 13
  ...
  %4 = ptrtoint ptr %_erase to i32
  call void @__asan_store4_noabort(i32 %4)
  store ptr @ef4_mtd_erase, ptr %_erase, align 8
  %5 = ptrtoint ptr %type to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %type, align 4
  %mtd_read = getelementptr inbounds %struct.ef4_nic_type, ptr %6, i32 0, i32 73
  %7 = ptrtoint ptr %mtd_read to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %mtd_read, align 4
  %_read = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 24
  %9 = ptrtoint ptr %_read to i32
  call void @__asan_store4_noabort(i32 %9)
  store ptr %8, ptr %_read, align 4
  %10 = load ptr, ptr %type, align 4
  %mtd_write = getelementptr inbounds %struct.ef4_nic_type, ptr %10, i32 0, i32 75
  %11 = ptrtoint ptr %mtd_write to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %mtd_write, align 4
  %_write = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 25
  %13 = ptrtoint ptr %_write to i32
  call void @__asan_store4_noabort(i32 %13)
  store ptr %12, ptr %_write, align 8
  %_sync = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 37
  %14 = ptrtoint ptr %_sync to i32
  call void @__asan_store4_noabort(i32 %14)
  store ptr @ef4_mtd_sync, ptr %_sync, align 8
  %15 = load ptr, ptr %type, align 4
  %mtd_rename = getelementptr inbounds %struct.ef4_nic_type, ptr %15, i32 0, i32 72
  %16 = ptrtoint ptr %mtd_rename to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %mtd_rename, align 8
  tail call void %17(ptr noundef %add.ptr) #3
...
while.cond.preheader:                             ; preds = %for.body
  ...
  %tobool12.not42 = icmp eq i32 %i.041, 0
  br i1 %tobool12.not42, label %while.cond.preheader.cleanup_crit_edge, label %while.cond.preheader.while.body_crit_edge
...
if.end:                                           ; preds = %for.body
  ...
  %call.i.i = tail call zeroext i1 @__list_add_valid(ptr noundef %add.ptr, ptr noundef %19, ptr noundef %mtd_list) #3
...
if.end.i.i:                                       ; preds = %if.end
  ...
  store volatile ptr %add.ptr, ptr %19, align 4
  br label %list_add_tail.exit
...
while.body:                                       ; preds = %ef4_mtd_remove_partition.exit.while.body_crit_edge, %while.cond.preheader.while.body_crit_edge
  %i.143 = phi i32 [ %dec, %ef4_mtd_remove_partition.exit.while.body_crit_edge ], [ %i.041, %while.cond.preheader.while.body_crit_edge ]
  %dec = add i32 %i.143, -1
  %mul13 = mul i32 %dec, %sizeof_part
  %add.ptr14 = getelementptr i8, ptr %parts, i32 %mul13
  %mtd.i = getelementptr inbounds %struct.ef4_mtd_partition, ptr %add.ptr14, i32 0, i32 1
  br label %for.cond.i
...
if.end15.i:                                       ; preds = %do.end.i, %for.cond.i.if.end15.i_crit_edge
  %call.i.i.i = tail call zeroext i1 @__list_del_entry_valid(ptr noundef %add.ptr14) #3
  br i1 %call.i.i.i, label %if.end.i.i.i, label %if.end15.i.ef4_mtd_remove_partition.exit_crit_edge

if.end15.i.ef4_mtd_remove_partition.exit_crit_edge: ; preds = %if.end15.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %ef4_mtd_remove_partition.exit

if.end.i.i.i:                                     ; preds = %if.end15.i
  call void @__sanitizer_cov_trace_pc() #5
  %prev.i.i.i = getelementptr inbounds %struct.list_head, ptr %add.ptr14, i32 0, i32 1
  %25 = ptrtoint ptr %prev.i.i.i to i32
  call void @__asan_load4_noabort(i32 %25)
  %26 = load ptr, ptr %prev.i.i.i, align 4
  %27 = ptrtoint ptr %add.ptr14 to i32
  call void @__asan_load4_noabort(i32 %27)
  %28 = load ptr, ptr %add.ptr14, align 4
...
ef4_mtd_remove_partition.exit:                    ; preds = %if.end.i.i.i, %if.end15.i.ef4_mtd_remove_partition.exit_crit_edge
  %31 = ptrtoint ptr %add.ptr14 to i32
  call void @__asan_store4_noabort(i32 %31)
  store ptr inttoptr (i32 256 to ptr), ptr %add.ptr14, align 4
  %prev.i.i = getelementptr inbounds %struct.list_head, ptr %add.ptr14, i32 0, i32 1
  %32 = ptrtoint ptr %prev.i.i to i32
  call void @__asan_store4_noabort(i32 %32)
  store ptr inttoptr (i32 290 to ptr), ptr %prev.i.i, align 4
  %tobool12.not = icmp eq i32 %dec, 0
  br i1 %tobool12.not, label %ef4_mtd_remove_partition.exit.cleanup_crit_edge, label %ef4_mtd_remove_partition.exit.while.body_crit_edge

ef4_mtd_remove_partition.exit.while.body_crit_edge: ; preds = %ef4_mtd_remove_partition.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %while.body

ef4_mtd_remove_partition.exit.cleanup_crit_edge:  ; preds = %ef4_mtd_remove_partition.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

cleanup:                                          ; preds = %ef4_mtd_remove_partition.exit.cleanup_crit_edge, %list_add_tail.exit.cleanup_crit_edge, %while.cond.preheader.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ -12, %while.cond.preheader.cleanup_crit_edge ], [ 0, %entry.cleanup_crit_edge ], [ -12, %ef4_mtd_remove_partition.exit.cleanup_crit_edge ], [ 0, %list_add_tail.exit.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @ef4_mtd_erase(ptr noundef %mtd, ptr nocapture noundef readonly %erase) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 54
  ...
  %mtd_erase = getelementptr inbounds %struct.ef4_nic_type, ptr %3, i32 0, i32 74
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @ef4_mtd_sync(ptr noundef %mtd) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.mtd_info, ptr %mtd, i32 0, i32 54
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %type, align 4
  %mtd_sync = getelementptr inbounds %struct.ef4_nic_type, ptr %3, i32 0, i32 76
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @ef4_mtd_remove(ptr noundef %efx) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
do.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 99, i32 noundef 9, ptr noundef null) #3
  br label %if.end
...
for.body:                                         ; preds = %ef4_mtd_remove_partition.exit.for.body_crit_edge, %if.end.for.body_crit_edge
  %part.058 = phi ptr [ %next.0, %ef4_mtd_remove_partition.exit.for.body_crit_edge ], [ %4, %if.end.for.body_crit_edge ]
  %5 = ptrtoint ptr %part.058 to i32
  call void @__asan_load4_noabort(i32 %5)
  %next.0 = load ptr, ptr %part.058, align 8
  %mtd.i = getelementptr inbounds %struct.ef4_mtd_partition, ptr %part.058, i32 0, i32 1
  br label %for.cond.i
...
ef4_mtd_remove_partition.exit:                    ; preds = %if.end.i.i.i, %if.end15.i.ef4_mtd_remove_partition.exit_crit_edge
  ...
  br i1 %cmp.not, label %for.end, label %ef4_mtd_remove_partition.exit.for.body_crit_edge

ef4_mtd_remove_partition.exit.for.body_crit_edge: ; preds = %ef4_mtd_remove_partition.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %for.body

for.end:                                          ; preds = %ef4_mtd_remove_partition.exit
  call void @__sanitizer_cov_trace_pc() #5
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @ef4_mtd_rename(ptr noundef readonly %efx) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
land.rhs:                                         ; preds = %entry
  %.b52 = load i1, ptr @ef4_mtd_rename.__already_done, align 1
...
if.then:                                          ; preds = %land.rhs
  call void @__sanitizer_cov_trace_pc() #5
  store i1 true, ptr @ef4_mtd_rename.__already_done, align 1
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 117, i32 noundef 9, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str, i32 noundef 117) #3
  br label %if.end29
...
if.end29:                                         ; preds = %if.then, %land.rhs.if.end29_crit_edge, %entry.if.end29_crit_edge
  ...
  call void @__asan_load4_noabort(i32 %0)
  %part.053 = load ptr, ptr %mtd_list, align 4
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %for.body.lr.ph
  ...
  %mtd_rename = getelementptr inbounds %struct.ef4_nic_type, ptr %2, i32 0, i32 72
  ...
  call void @__asan_load4_noabort(i32 %5)
  %part.0 = load ptr, ptr %part.055, align 4
...
!1 = !{!"../drivers/net/ethernet/sfc/falcon/mtd.c", i32 99, i32 2}
!2 = distinct !{null, !3, !"__already_done", i1 false, i1 false}
!3 = !{!"../drivers/net/ethernet/sfc/falcon/mtd.c", i32 117, i32 2}
!4 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.2, !6, !"<string literal>", i1 false, i1 false}
!6 = !{!"../drivers/net/ethernet/sfc/falcon/mtd.c", i32 36, i32 3}
!7 = !{ptr @.str.3, !6, !"<string literal>", i1 false, i1 false}
!8 = !{ptr @ef4_mtd_sync._entry, !6, !"_entry", i1 false, i1 false}
!9 = !{ptr @ef4_mtd_sync._entry_ptr, !6, !"_entry_ptr", i1 false, i1 false}
