; ModuleID = '/llk/IR_all_yes/drivers/net/team/team_mode_random.c_pt.bc'
source_filename = "../drivers/net/team/team_mode_random.c"
...
@rnd_mode = internal constant { %struct.team_mode, [40 x i8] } { %struct.team_mode { ptr @.str, ptr null, i32 0, i32 0, ptr @rnd_mode_ops, i32 1 }, [40 x i8] zeroinitializer }, align 32
@__initcall__kmod_team_mode_random__373_58_rnd_init_module6 = internal global ptr @rnd_init_module, section ".initcall6.init", align 4
@__exitcall_rnd_cleanup_module = internal global ptr @rnd_cleanup_module, section ".exitcall.exit", align 4
@__UNIQUE_ID_file374 = internal constant [56 x i8] c"team_mode_random.file=drivers/net/team/team_mode_random\00", section ".modinfo", align 1
@__UNIQUE_ID_license375 = internal constant [32 x i8] c"team_mode_random.license=GPL v2\00", section ".modinfo", align 1
@__UNIQUE_ID_author376 = internal constant [54 x i8] c"team_mode_random.author=Jiri Pirko <jiri@resnulli.us>\00", section ".modinfo", align 1
@__UNIQUE_ID_description377 = internal constant [50 x i8] c"team_mode_random.description=Random mode for team\00", section ".modinfo", align 1
@__UNIQUE_ID_alias378 = internal constant [40 x i8] c"team_mode_random.alias=team-mode-random\00", section ".modinfo", align 1
@.str = internal constant { [7 x i8], [25 x i8] } { [7 x i8] c"random\00", [25 x i8] zeroinitializer }, align 32
@rnd_mode_ops = internal constant { %struct.team_mode_ops, [60 x i8] } { %struct.team_mode_ops { ptr null, ptr null, ptr null, ptr @rnd_transmit, ptr @team_modeop_port_enter, ptr null, ptr @team_modeop_port_change_dev_addr, ptr null, ptr null }, [60 x i8] zeroinitializer }, align 32
...
@___asan_gen_.3 = private unnamed_addr constant [9 x i8] c"rnd_mode\00", align 1
@___asan_gen_.5 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 41, i32 31 }
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 42, i32 11 }
@___asan_gen_.9 = private unnamed_addr constant [13 x i8] c"rnd_mode_ops\00", align 1
@___asan_gen_.10 = private constant [39 x i8] c"../drivers/net/team/team_mode_random.c\00", align 1
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.10, i32 35, i32 35 }
...
@llvm.compiler.used = appending global [13 x ptr] [ptr @__UNIQUE_ID_alias378, ptr @__UNIQUE_ID_author376, ptr @__UNIQUE_ID_description377, ptr @__UNIQUE_ID_file374, ptr @__UNIQUE_ID_license375, ptr @__exitcall_rnd_cleanup_module, ptr @__initcall__kmod_team_mode_random__373_58_rnd_init_module6, ptr @rnd_cleanup_module, ptr @rnd_mode, ptr @.str, ptr @rnd_mode_ops, ptr @.str.1, ptr @.str.2], section "llvm.metadata"
@0 = internal global [5 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @rnd_mode to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 7, i32 32, i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @rnd_mode_ops to i32), i32 36, i32 96, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 42, i32 96, i32 ptrtoint (ptr @___asan_gen_.15 to i32), i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal void @rnd_cleanup_module() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @team_mode_unregister(ptr noundef nonnull @rnd_mode) #3
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @rnd_init_module() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @team_mode_register(ptr noundef nonnull @rnd_mode) #3
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal zeroext i1 @rnd_transmit(ptr noundef %team, ptr noundef %skb) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %en_port_count = getelementptr inbounds %struct.team, ptr %team, i32 0, i32 3
  %0 = ptrtoint ptr %en_port_count to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load i32, ptr %en_port_count, align 4
  %call.i = tail call i32 @prandom_u32() #3
  %conv.i = zext i32 %call.i to i64
  %conv1.i = zext i32 %1 to i64
  %mul.i = mul nuw i64 %conv.i, %conv1.i
  %shr.i = lshr i64 %mul.i, 32
  %conv2.i = trunc i64 %shr.i to i32
  %and.i.i = and i32 %conv2.i, 15
...
for.body.i:                                       ; preds = %for.inc.i.for.body.i_crit_edge, %do.end.i.for.body.i_crit_edge
  ...
  call void @__sanitizer_cov_trace_cmp4(i32 %5, i32 %conv2.i)
...
if.end:                                           ; preds = %for.body.i
  ...
  %8 = ptrtoint ptr %linkup.i.i to i32
  call void @__asan_load1_noabort(i32 %8)
  %9 = load i8, ptr %linkup.i.i, align 4, !range !34
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %9)
  %tobool.not.i.i = icmp eq i8 %9, 0
  br i1 %tobool.not.i.i, label %if.end.if.end.i_crit_edge, label %team_port_txable.exit.i, !prof !35
...
team_port_txable.exit.i:                          ; preds = %if.end
  ...
  %10 = ptrtoint ptr %index.i.le to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %index.i.le, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 -1, i32 %11)
  %cmp.i.i.not.i = icmp eq i32 %11, -1
  br i1 %cmp.i.i.not.i, label %team_port_txable.exit.i.if.end.i_crit_edge, label %team_port_txable.exit.i.if.end16_crit_edge, !prof !36

team_port_txable.exit.i.if.end16_crit_edge:       ; preds = %team_port_txable.exit.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %if.end16

team_port_txable.exit.i.if.end.i_crit_edge:       ; preds = %team_port_txable.exit.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %if.end.i

if.end.i:                                         ; preds = %team_port_txable.exit.i.if.end.i_crit_edge, %if.end.if.end.i_crit_edge
  ...
  br i1 %cmp.not90.i, label %if.end.i.do.body16.i_crit_edge, label %if.end.i.for.body.i29_crit_edge

if.end.i.for.body.i29_crit_edge:                  ; preds = %if.end.i
  br label %for.body.i29

if.end.i.do.body16.i_crit_edge:                   ; preds = %if.end.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %do.body16.i

for.body.i29:                                     ; preds = %for.cond.backedge.i.for.body.i29_crit_edge, %if.end.i.for.body.i29_crit_edge
  %.pn91.i = phi ptr [ %.pn.i, %for.cond.backedge.i.for.body.i29_crit_edge ], [ %.pn89.i, %if.end.i.for.body.i29_crit_edge ]
  %linkup.i74.i = getelementptr i8, ptr %.pn91.i, i32 16
  %13 = ptrtoint ptr %linkup.i74.i to i32
  call void @__asan_load1_noabort(i32 %13)
  %14 = load i8, ptr %linkup.i74.i, align 4, !range !34
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %14)
  %tobool.not.i75.i = icmp eq i8 %14, 0
  br i1 %tobool.not.i75.i, label %for.body.i29.for.cond.backedge.i_crit_edge, label %land.rhs.i78.i

for.body.i29.for.cond.backedge.i_crit_edge:       ; preds = %for.body.i29
  call void @__sanitizer_cov_trace_pc() #5
  br label %for.cond.backedge.i

land.rhs.i78.i:                                   ; preds = %for.body.i29
  %index.i.i76.i = getelementptr i8, ptr %.pn91.i, i32 12
  %15 = ptrtoint ptr %index.i.i76.i to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load i32, ptr %index.i.i76.i, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 -1, i32 %16)
  %cmp.i.i77.not.i = icmp eq i32 %16, -1
...
for.cond.backedge.i:                              ; preds = %land.rhs.i78.i.for.cond.backedge.i_crit_edge, %for.body.i29.for.cond.backedge.i_crit_edge
  %17 = ptrtoint ptr %.pn91.i to i32
  call void @__asan_load4_noabort(i32 %17)
  %.pn.i = load volatile ptr, ptr %.pn91.i, align 4
  %cmp.not.i = icmp eq ptr %.pn.i, %port_list.i
  br i1 %cmp.not.i, label %for.cond.backedge.i.do.body16.i_crit_edge, label %for.cond.backedge.i.for.body.i29_crit_edge

for.cond.backedge.i.for.body.i29_crit_edge:       ; preds = %for.cond.backedge.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %for.body.i29
...
do.body16.i:                                      ; preds = %for.cond.backedge.i.do.body16.i_crit_edge, %if.end.i.do.body16.i_crit_edge
  %call17.i = tail call i32 @rcu_read_lock_any_held() #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call17.i)
  %tobool18.not.i = icmp eq i32 %call17.i, 0
  br i1 %tobool18.not.i, label %land.lhs.true.i30, label %do.body16.i.do.end26.i_crit_edge

do.body16.i.do.end26.i_crit_edge:                 ; preds = %do.body16.i
  call void @__sanitizer_cov_trace_pc() #5
  br label %do.end26.i

land.lhs.true.i30:                                ; preds = %do.body16.i
  %call19.i = tail call i32 @debug_lockdep_rcu_enabled() #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call19.i)
  %tobool20.not.i = icmp eq i32 %call19.i, 0
  br i1 %tobool20.not.i, label %land.lhs.true.i30.do.end26.i_crit_edge, label %land.lhs.true21.i

land.lhs.true.i30.do.end26.i_crit_edge:           ; preds = %land.lhs.true.i30
  call void @__sanitizer_cov_trace_pc() #5
  br label %do.end26.i

land.lhs.true21.i:                                ; preds = %land.lhs.true.i30
...
do.end26.i:                                       ; preds = %if.then23.i, %land.lhs.true21.i.do.end26.i_crit_edge, %land.lhs.true.i30.do.end26.i_crit_edge, %do.body16.i.do.end26.i_crit_edge
  %18 = ptrtoint ptr %port_list.i to i32
...
if.end43.i:                                       ; preds = %for.cond36.backedge.i.if.end43.i_crit_edge, %do.end26.i.if.end43.i_crit_edge
  ...
  %19 = ptrtoint ptr %linkup.i80.i to i32
  call void @__asan_load1_noabort(i32 %19)
  %20 = load i8, ptr %linkup.i80.i, align 4, !range !34
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %20)
  %tobool.not.i81.i = icmp eq i8 %20, 0
...
land.rhs.i84.i:                                   ; preds = %if.end43.i
  ...
  %21 = ptrtoint ptr %index.i.i82.i to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load i32, ptr %index.i.i82.i, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 -1, i32 %22)
  %cmp.i.i83.not.i = icmp eq i32 %22, -1
...
for.cond36.backedge.i:                            ; preds = %land.rhs.i84.i.for.cond36.backedge.i_crit_edge, %if.end43.i.for.cond36.backedge.i_crit_edge
  %23 = ptrtoint ptr %.pn7297.i to i32
...
team_get_first_port_txable_rcu.exit:              ; preds = %cleanup.loopexit86.i, %land.rhs.i84.i.team_get_first_port_txable_rcu.exit_crit_edge
  %retval.0.i = phi ptr [ %cur.0.le.i, %cleanup.loopexit86.i ], [ %cur.198.i, %land.rhs.i84.i.team_get_first_port_txable_rcu.exit_crit_edge ]
  %tobool6.not = icmp eq ptr %retval.0.i, null
  br i1 %tobool6.not, label %team_get_first_port_txable_rcu.exit.drop_crit_edge, label %team_get_first_port_txable_rcu.exit.if.end16_crit_edge, !prof !36

team_get_first_port_txable_rcu.exit.if.end16_crit_edge: ; preds = %team_get_first_port_txable_rcu.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %if.end16
...
if.end16:                                         ; preds = %team_get_first_port_txable_rcu.exit.if.end16_crit_edge, %team_port_txable.exit.i.if.end16_crit_edge
  %retval.0.i42 = phi ptr [ %retval.0.i, %team_get_first_port_txable_rcu.exit.if.end16_crit_edge ], [ %port.044.i, %team_port_txable.exit.i.if.end16_crit_edge ]
  %slave_dev_queue_mapping.i = getelementptr inbounds %struct.sk_buff, ptr %skb, i32 0, i32 3, i32 4
  %24 = ptrtoint ptr %slave_dev_queue_mapping.i to i32
  call void @__asan_load2_noabort(i32 %24)
  %25 = load i16, ptr %slave_dev_queue_mapping.i, align 4
  ...
  store i16 %25, ptr %queue_mapping1.i.i, align 8
  %27 = ptrtoint ptr %retval.0.i42 to i32
  call void @__asan_load4_noabort(i32 %27)
  %28 = load ptr, ptr %retval.0.i42, align 4
  %29 = getelementptr inbounds %struct.anon.44, ptr %skb, i32 0, i32 2
  %30 = ptrtoint ptr %29 to i32
  call void @__asan_store4_noabort(i32 %30)
  store ptr %28, ptr %29, align 8
  %31 = tail call i32 asm sideeffect "\09mrs\09$0, cpsr\09@ local_save_flags", "=r,~{memory},~{cc}"() #3, !srcloc !37
  %and.i.i.i = and i32 %31, 128
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and.i.i.i)
  %tobool.i.not.i = icmp eq i32 %and.i.i.i, 0
  br i1 %tobool.i.not.i, label %if.end.i32, label %if.then.i31, !prof !38

if.then.i31:                                      ; preds = %if.end16
  call void @__sanitizer_cov_trace_pc() #5
  %np.i.i = getelementptr inbounds %struct.team_port, ptr %retval.0.i42, i32 0, i32 11
  %32 = ptrtoint ptr %np.i.i to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load ptr, ptr %np.i.i, align 4
  %call.i.i = tail call i32 @netpoll_send_skb(ptr noundef %33, ptr noundef %skb) #3
  br label %cleanup
...
cleanup:                                          ; preds = %drop, %if.end.i32, %if.then.i31
  %retval.0 = phi i1 [ false, %drop ], [ true, %if.then.i31 ], [ %phi.cmp, %if.end.i32 ]
  ret i1 %retval.0
}
...
!0 = !{ptr @__initcall__kmod_team_mode_random__373_58_rnd_init_module6, !1, !"__initcall__kmod_team_mode_random__373_58_rnd_init_module6", i1 false, i1 false}
!1 = !{!"../drivers/net/team/team_mode_random.c", i32 58, i32 1}
!2 = !{ptr @__exitcall_rnd_cleanup_module, !3, !"__exitcall_rnd_cleanup_module", i1 false, i1 false}
!3 = !{!"../drivers/net/team/team_mode_random.c", i32 59, i32 1}
!4 = !{ptr @__UNIQUE_ID_file374, !5, !"__UNIQUE_ID_file374", i1 false, i1 false}
!5 = !{!"../drivers/net/team/team_mode_random.c", i32 61, i32 1}
...
!8 = !{!"../drivers/net/team/team_mode_random.c", i32 62, i32 1}
!9 = !{ptr @__UNIQUE_ID_description377, !10, !"__UNIQUE_ID_description377", i1 false, i1 false}
!10 = !{!"../drivers/net/team/team_mode_random.c", i32 63, i32 1}
!11 = !{ptr @__UNIQUE_ID_alias378, !12, !"__UNIQUE_ID_alias378", i1 false, i1 false}
!12 = !{!"../drivers/net/team/team_mode_random.c", i32 64, i32 1}
!13 = !{ptr @.str, !14, !"<string literal>", i1 false, i1 false}
!14 = !{!"../drivers/net/team/team_mode_random.c", i32 42, i32 11}
!15 = !{ptr @rnd_mode, !16, !"rnd_mode", i1 false, i1 false}
!16 = !{!"../drivers/net/team/team_mode_random.c", i32 41, i32 31}
!17 = !{ptr @rnd_mode_ops, !18, !"rnd_mode_ops", i1 false, i1 false}
!18 = !{!"../drivers/net/team/team_mode_random.c", i32 35, i32 35}
...
!34 = !{i8 0, i8 2}
!35 = !{!"branch_weights", i32 1073205, i32 2146410443}
