; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/ath/wil6210/debug.c_pt.bc'
source_filename = "../drivers/net/wireless/ath/wil6210/debug.c"
...
@wil_dbg_ratelimited.__UNIQUE_ID_ddebug374 = internal global { ptr, ptr, ptr, ptr, i8, i8, i8, i8, { { { %struct.atomic_t, { ptr } } } }, [4 x i8] } { ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str, i8 0, i8 12, i8 -128, i8 0, { { { %struct.atomic_t, { ptr } } } } zeroinitializer, [4 x i8] undef }, section "__dyndbg", align 8
@.str.1 = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"wil6210\00", [24 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [20 x i8], [44 x i8] } { [20 x i8] c"wil_dbg_ratelimited\00", [44 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"drivers/net/wireless/ath/wil6210/debug.c\00", [55 x i8] zeroinitializer }, align 32
@__tracepoint_wil6210_log_err = external dso_local global %struct.tracepoint, align 4
@.str.4 = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"drivers/net/wireless/ath/wil6210/trace.h\00", [55 x i8] zeroinitializer }, align 32
@trace_wil6210_log_err.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@__tracepoint_wil6210_log_dbg = external dso_local global %struct.tracepoint, align 4
@trace_wil6210_log_dbg.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
@__tracepoint_wil6210_log_info = external dso_local global %struct.tracepoint, align 4
@trace_wil6210_log_info.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.17, i32 18, i32 29 }
@___asan_gen_.17 = private constant [44 x i8] c"../drivers/net/wireless/ath/wil6210/debug.c\00", align 1
@___asan_gen_.18 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.17, i32 50, i32 2 }
@___asan_gen_.23 = private unnamed_addr constant [44 x i8] c"../drivers/net/wireless/ath/wil6210/trace.h\00", align 1
@___asan_gen_.24 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.23, i32 84, i32 1 }
@___asan_gen_.25 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.26 = private unnamed_addr constant [27 x i8] c"../include/linux/cpumask.h\00", align 1
@___asan_gen_.27 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.26, i32 108, i32 2 }
...
define dso_local void @__wil_err(ptr nocapture noundef readonly %wil, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  ...
  call void (ptr, ptr, ...) @netdev_err(ptr noundef %5, ptr noundef nonnull @.str, ptr noundef nonnull %vaf) #10
  call fastcc void @trace_wil6210_log_err(ptr noundef nonnull %vaf)
...
define internal fastcc void @trace_wil6210_log_err(ptr noundef %vaf) unnamed_addr #4 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #9
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_err, i32 0, i32 1), ptr blockaddress(@trace_wil6210_log_err, %do.body)) #7
          to label %if.end48 [label %do.body], !srcloc !32
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_wil6210_log_err(ptr noundef null, ptr noundef %vaf) #7
  tail call void asm sideeffect "", "~{memory}"() #7, !srcloc !35
  %13 = tail call i32 @llvm.read_register.i32(metadata !21) #7
...
if.end48:                                         ; preds = %cleanup.thread, %entry
  %17 = tail call i32 @llvm.read_register.i32(metadata !21) #7
...
if.then52:                                        ; preds = %cpu_online.exit85
  %26 = tail call i32 @llvm.read_register.i32(metadata !21) #7
  ...
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_err, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_err, i32 0, i32 7), align 4
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_wil6210_log_err.__warned, align 1
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #9
  store i1 true, ptr @trace_wil6210_log_err.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.4, i32 noundef 87, ptr noundef nonnull @.str.5) #7
  br label %do.end67

do.end67:                                         ; preds = %if.then64, %land.lhs.true62.do.end67_crit_edge, %land.lhs.true.do.end67_crit_edge, %if.then52.do.end67_crit_edge
  tail call void asm sideeffect "", "~{memory}"() #7, !srcloc !37
  %31 = tail call i32 @llvm.read_register.i32(metadata !21) #7
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @__wil_err_ratelimited(ptr nocapture noundef readonly %wil, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  %vaf = alloca %struct.va_format, align 4
  %args = alloca %struct.__va_list, align 4
  call void @__sanitizer_cov_trace_pc() #9
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @wil_dbg_ratelimited(ptr nocapture noundef readonly %wil, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  %vaf = alloca %struct.va_format, align 4
  %args = alloca %struct.__va_list, align 4
  call void @__sanitizer_cov_trace_pc() #9
...
if.end:                                           ; preds = %entry
  ...
  call void @__asan_store4_noabort(i32 %3)
  store ptr %args, ptr %1, align 4
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds ({ ptr, ptr, ptr, ptr, i8, i8, i8, i8, { { { %struct.atomic_t, { ptr } } } }, [4 x i8] }, ptr @wil_dbg_ratelimited.__UNIQUE_ID_ddebug374, i32 0, i32 8, i32 0, i32 0, i32 0, i32 0), ptr blockaddress(@wil_dbg_ratelimited, %if.then7)) #7
          to label %do.end10 [label %if.then7], !srcloc !32
...
if.then7:                                         ; preds = %if.end
  ...
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %main_ndev, align 4
  call void (ptr, ptr, ptr, ...) @__dynamic_netdev_dbg(ptr noundef nonnull @wil_dbg_ratelimited.__UNIQUE_ID_ddebug374, ptr noundef %5, ptr noundef nonnull @.str, ptr noundef nonnull %vaf) #7
  br label %do.end10

do.end10:                                         ; preds = %if.then7, %if.end
  call fastcc void @trace_wil6210_log_dbg(ptr noundef nonnull %vaf)
  call void @llvm.va_end(ptr nonnull %args)
  br label %cleanup
...
; Function Attrs: inlinehint nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal fastcc void @trace_wil6210_log_dbg(ptr noundef %vaf) unnamed_addr #4 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #9
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_dbg, i32 0, i32 1), ptr blockaddress(@trace_wil6210_log_dbg, %do.body)) #7
          to label %if.end48 [label %do.body], !srcloc !32
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_wil6210_log_dbg(ptr noundef null, ptr noundef %vaf) #7
...
if.then52:                                        ; preds = %cpu_online.exit85
  ...
  store volatile i32 %add.i.i, ptr %preempt_count.i.i.i, align 4
  tail call void asm sideeffect "", "~{memory}"() #7, !srcloc !36
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_dbg, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_dbg, i32 0, i32 7), align 4
  %call58 = tail call i32 @rcu_read_lock_sched_held() #7
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call58)
  %tobool59.not = icmp eq i32 %call58, 0
  br i1 %tobool59.not, label %land.lhs.true, label %if.then52.do.end67_crit_edge
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_wil6210_log_dbg.__warned, align 1
  br i1 %.b72, label %land.lhs.true62.do.end67_crit_edge, label %if.then64
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #9
  store i1 true, ptr @trace_wil6210_log_dbg.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.4, i32 noundef 97, ptr noundef nonnull @.str.5) #7
  br label %do.end67
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @__wil_info(ptr nocapture noundef readonly %wil, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  %vaf = alloca %struct.va_format, align 4
  %args = alloca %struct.__va_list, align 4
  call void @__sanitizer_cov_trace_pc() #9
  ...
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %main_ndev, align 4
  call void (ptr, ptr, ...) @netdev_info(ptr noundef %5, ptr noundef nonnull @.str, ptr noundef nonnull %vaf) #10
  call fastcc void @trace_wil6210_log_info(ptr noundef nonnull %vaf)
  call void @llvm.va_end(ptr nonnull %args)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %args) #7
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %vaf) #7
  ret void
...
; Function Attrs: inlinehint nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal fastcc void @trace_wil6210_log_info(ptr noundef %vaf) unnamed_addr #4 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #9
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_info, i32 0, i32 1), ptr blockaddress(@trace_wil6210_log_info, %do.body)) #7
          to label %if.end48 [label %do.body], !srcloc !32
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_wil6210_log_info(ptr noundef null, ptr noundef %vaf) #7
...
if.then52:                                        ; preds = %cpu_online.exit85
  ...
  store volatile i32 %add.i.i, ptr %preempt_count.i.i.i, align 4
  tail call void asm sideeffect "", "~{memory}"() #7, !srcloc !36
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_info, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_wil6210_log_info, i32 0, i32 7), align 4
  %call58 = tail call i32 @rcu_read_lock_sched_held() #7
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call58)
  %tobool59.not = icmp eq i32 %call58, 0
  br i1 %tobool59.not, label %land.lhs.true, label %if.then52.do.end67_crit_edge
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_wil6210_log_info.__warned, align 1
  br i1 %.b72, label %land.lhs.true62.do.end67_crit_edge, label %if.then64
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #9
  store i1 true, ptr @trace_wil6210_log_info.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.4, i32 noundef 92, ptr noundef nonnull @.str.5) #7
  br label %do.end67
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @wil_dbg_trace(ptr nocapture noundef readnone %wil, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  %vaf = alloca %struct.va_format, align 4
  %args = alloca %struct.__va_list, align 4
  call void @__sanitizer_cov_trace_pc() #9
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_wil6210_log_err(ptr noundef, ptr noundef) local_unnamed_addr #5
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_wil6210_log_dbg(ptr noundef, ptr noundef) local_unnamed_addr #5

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_wil6210_log_info(ptr noundef, ptr noundef) local_unnamed_addr #5
...
!llvm.asan.globals = !{!0, !2, !4, !5, !6, !7, !9, !10, !11, !12, !14, !15, !17, !18, !20}
!llvm.named.register.sp = !{!21}
!llvm.module.flags = !{!22, !23, !24, !25, !26, !27, !28, !29}
!llvm.ident = !{!30}

!0 = !{ptr @.str, !1, !"<string literal>", i1 false, i1 false}
!1 = !{!"../drivers/net/wireless/ath/wil6210/debug.c", i32 18, i32 29}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/net/wireless/ath/wil6210/debug.c", i32 50, i32 2}
!4 = !{ptr @.str.2, !3, !"<string literal>", i1 false, i1 false}
!5 = !{ptr @.str.3, !3, !"<string literal>", i1 false, i1 false}
!6 = !{ptr @wil_dbg_ratelimited.__UNIQUE_ID_ddebug374, !3, !"__UNIQUE_ID_ddebug374", i1 false, i1 false}
!7 = distinct !{null, !8, !"__already_done", i1 false, i1 false}
!8 = !{!"../drivers/net/wireless/ath/wil6210/trace.h", i32 84, i32 1}
...
!16 = !{!"../drivers/net/wireless/ath/wil6210/trace.h", i32 94, i32 1}
!17 = distinct !{null, !16, !"__warned", i1 false, i1 false}
!18 = distinct !{null, !19, !"__already_done", i1 false, i1 false}
!19 = !{!"../drivers/net/wireless/ath/wil6210/trace.h", i32 89, i32 1}
...
!31 = !{!"auto-init"}
!32 = !{i64 2148898946, i64 2148898951, i64 2148898964, i64 2148899008, i64 2148899042, i64 2148899063}
