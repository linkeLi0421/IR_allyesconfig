; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/mediatek/mt76/mt76x2/pci_main.c_pt.bc'
source_filename = "../drivers/net/wireless/mediatek/mt76/mt76x2/pci_main.c"
...
@mt76x2_ops = dso_local constant { %struct.ieee80211_ops, [124 x i8] } { %struct.ieee80211_ops { ptr @mt76x02_tx, ptr @mt76x2_start, ptr @mt76x2_stop, ptr null, ptr null, ptr null, ptr @mt76x02_add_interface, ptr null, ptr @mt76x02_remove_interface, ptr @mt76x2_config, ptr @mt76x02_bss_info_changed, ptr null, ptr null, ptr null, ptr @mt76x02_configure_filter, ptr null, ptr @mt76_set_tim, ptr @mt76x02_set_key, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76_sw_scan, ptr @mt76x02_sw_scan_complete, ptr null, ptr null, ptr null, ptr @mt76x02_set_rts_threshold, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76_sta_state, ptr @mt76_sta_pre_rcu_remove, ptr null, ptr @mt76x02_sta_rate_tbl_update, ptr null, ptr @mt76x02_conf_tx, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76x02_ampdu_action, ptr @mt76_get_survey, ptr null, ptr @mt76x02_set_coverage_class, ptr null, ptr null, ptr @mt76x2_flush, ptr null, ptr @mt76x2_set_antenna, ptr @mt76_get_antenna, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76_release_buffered_frames, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76x02_reconfig_complete, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76_get_txpower, ptr null, ptr null, ptr null, ptr @mt76_wake_tx_queue, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @mt76x2_set_sar_specs, ptr null, ptr null, ptr null, ptr null, ptr null }, [124 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [11 x i8] c"mt76x2_ops\00", align 1
@___asan_gen_.2 = private constant [56 x i8] c"../drivers/net/wireless/mediatek/mt76/mt76x2/pci_main.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 134, i32 28 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @mt76x2_ops], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @mt76x2_ops to i32), i32 452, i32 576, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 0 }]
...
define internal i32 @mt76x2_start(ptr nocapture noundef readonly %hw) #1 align 64 {
entry:
  ...
  tail call void @mt76x02_mac_start(ptr noundef %1) #4
  %call = tail call i32 @mt76x2_phy_start(ptr noundef %1) #4
  ...
  %wdt_work = getelementptr inbounds %struct.mt76x02_dev, ptr %1, i32 0, i32 10
  tail call void @ieee80211_queue_delayed_work(ptr noundef %5, ptr noundef %wdt_work, i32 noundef 10) #4
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @mt76x2_stop(ptr nocapture noundef readonly %hw) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
  ...
  tail call void @mt76x2_stop_hardware(ptr noundef %1) #4
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @mt76x2_config(ptr noundef %hw, i32 noundef %changed) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
if.then:                                          ; preds = %entry
  ...
  tail call void %11(ptr noundef %1, i32 noundef 5120, i32 noundef %and5.sink) #4
  br label %if.end7
...
if.then10:                                        ; preds = %if.end7
  ...
  %call = tail call i32 @mt76_get_sar_power(ptr noundef %1, ptr noundef %16, i32 noundef %mul) #4
  %sub = add i32 %call, -6
  ...
  br i1 %tobool16.not, label %if.then10.if.end20_crit_edge, label %if.then17
...
if.then17:                                        ; preds = %if.then10
  call void @__sanitizer_cov_trace_pc() #6
  tail call void @mt76x2_phy_set_txpower(ptr noundef %1) #4
  %21 = ptrtoint ptr %txpower_conf to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load i32, ptr %txpower_conf, align 64
  %conv = trunc i32 %22 to i8
  tail call void @mt76x02_tx_set_txpwr_auto(ptr noundef %1, i8 noundef signext %conv) #4
  br label %if.end20

if.end20:                                         ; preds = %if.then17, %if.then10.if.end20_crit_edge, %if.end7.if.end20_crit_edge
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  %and22 = and i32 %changed, 64
...
if.then24:                                        ; preds = %if.end20
  ...
  %chandef26 = getelementptr inbounds %struct.ieee80211_conf, ptr %hw, i32 0, i32 7
  ...
  %23 = tail call { i32, i32 } asm sideeffect "@ atomic_add\0A1:\09ldrex\09$0, [$3]\0A\09add\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %count.i.i.i, ptr %count.i.i.i, i32 1, ptr elementtype(i32) %count.i.i.i) #4, !srcloc !11
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !12
  tail call void @tasklet_unlock_wait(ptr noundef %pre_tbtt_tasklet.i) #4
  ...
  %count.i.i22.i = getelementptr inbounds %struct.mt76x02_dev, ptr %1, i32 0, i32 27, i32 10, i32 2
  %call.i.i.i.i23.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %count.i.i22.i, i32 noundef 4) #4
  tail call void @llvm.prefetch.p0(ptr %count.i.i22.i, i32 1, i32 3, i32 1) #4
  %24 = tail call { i32, i32 } asm sideeffect "@ atomic_add\0A1:\09ldrex\09$0, [$3]\0A\09add\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %count.i.i22.i, ptr %count.i.i22.i, i32 1, ptr elementtype(i32) %count.i.i22.i) #4, !srcloc !11
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !12
  ...
  tail call void @_set_bit(i32 noundef 7, ptr noundef %state.i) #4
  tail call void @mt76_set_channel(ptr noundef %1) #4
  tail call void @mt76x2_mac_stop(ptr noundef %1, i1 noundef zeroext true) #4
  %call1.i = tail call i32 @mt76x2_phy_set_channel(ptr noundef %1, ptr noundef %chandef26) #4
  tail call void @mt76x02_mac_cc_reset(ptr noundef %1) #4
  ...
  tail call void %28(ptr noundef %1, i32 noundef 4100, i32 noundef 12) #4
  tail call void @_clear_bit(i32 noundef 7, ptr noundef %state.i) #4
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !14
  %call.i.i.i.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %count.i.i22.i, i32 noundef 4) #4
  tail call void @llvm.prefetch.p0(ptr %count.i.i22.i, i32 1, i32 3, i32 1) #4
  %29 = tail call { i32, i32 } asm sideeffect "@ atomic_sub\0A1:\09ldrex\09$0, [$3]\0A\09sub\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %count.i.i22.i, ptr %count.i.i22.i, i32 1, ptr elementtype(i32) %count.i.i22.i) #4, !srcloc !15
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #4, !srcloc !14
  %call.i.i.i25.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %count.i.i.i, i32 noundef 4) #4
  tail call void @llvm.prefetch.p0(ptr %count.i.i.i, i32 1, i32 3, i32 1) #4
  %30 = tail call { i32, i32 } asm sideeffect "@ atomic_sub\0A1:\09ldrex\09$0, [$3]\0A\09sub\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %count.i.i.i, ptr %count.i.i.i, i32 1, ptr elementtype(i32) %count.i.i.i) #4, !srcloc !15
  tail call void @mt76_txq_schedule_all(ptr noundef %1) #4
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @mt76x02_set_rts_threshold(ptr noundef, i32 noundef) #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_set_coverage_class(ptr noundef, i16 noundef signext) #0

; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid readnone sanitize_address sspstrong willreturn uwtable(sync)
define internal void @mt76x2_flush(ptr nocapture noundef %hw, ptr nocapture noundef %vif, i32 noundef %queues, i1 noundef zeroext %drop) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  ret void
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @mt76x2_set_antenna(ptr nocapture noundef readonly %hw, i32 noundef %tx_ant, i32 noundef %rx_ant) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = add i32 %tx_ant, -1
  ...
  %cmp2.not = icmp eq i32 %tx_ant, %rx_ant
  %or.cond15 = and i1 %1, %cmp2.not
...
if.end:                                           ; preds = %entry
  ...
  tail call void @mutex_lock_nested(ptr noundef %mutex, i32 noundef 0) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 3, i32 %tx_ant)
  %cmp3 = icmp eq i32 %tx_ant, 3
  %conv = select i1 %cmp3, i16 514, i16 257
  %chainmask = getelementptr inbounds %struct.mt76_phy, ptr %3, i32 0, i32 16
  %4 = ptrtoint ptr %chainmask to i32
  call void @__asan_store2_noabort(i32 %4)
  store i16 %conv, ptr %chainmask, align 2
  %conv4 = trunc i32 %tx_ant to i8
  %antenna_mask = getelementptr inbounds %struct.mt76_phy, ptr %3, i32 0, i32 15
  %5 = ptrtoint ptr %antenna_mask to i32
  call void @__asan_store1_noabort(i32 %5)
  store i8 %conv4, ptr %antenna_mask, align 8
  tail call void @mt76_set_stream_caps(ptr noundef %3, i1 noundef zeroext true) #4
  tail call void @mt76x2_phy_set_antenna(ptr noundef %3) #4
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  br label %cleanup
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_reconfig_complete(ptr noundef, i32 noundef) #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_mac_start(ptr noundef) local_unnamed_addr #0

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @mt76x2_phy_start(ptr noundef) local_unnamed_addr #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x2_stop_hardware(ptr noundef) local_unnamed_addr #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_tx_set_txpwr_auto(ptr noundef, i8 noundef signext) local_unnamed_addr #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @mt76x2_phy_set_channel(ptr noundef, ptr noundef) local_unnamed_addr #0

; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_mac_cc_reset(ptr noundef) local_unnamed_addr #0

; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x02_dfs_init_params(ptr noundef) local_unnamed_addr #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76_set_stream_caps(ptr noundef, i1 noundef zeroext) local_unnamed_addr #0

; Function Attrs: null_pointer_is_valid
declare dso_local void @mt76x2_phy_set_antenna(ptr noundef) local_unnamed_addr #0
...
!0 = !{ptr @mt76x2_ops, !1, !"mt76x2_ops", i1 false, i1 false}
!1 = !{!"../drivers/net/wireless/mediatek/mt76/mt76x2/pci_main.c", i32 134, i32 28}
...
!11 = !{i64 2148468805, i64 2148468831, i64 2148468860, i64 2148468894, i64 2148468925, i64 2148468948}
!12 = !{i64 2155242476}
!13 = !{i64 2155243118}
!14 = !{i64 2155243465}
!15 = !{i64 2148471270, i64 2148471296, i64 2148471325, i64 2148471359, i64 2148471390, i64 2148471413}
