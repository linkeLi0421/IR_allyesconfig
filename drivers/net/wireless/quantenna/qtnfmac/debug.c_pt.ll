; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/quantenna/qtnfmac/debug.c_pt.bc'
source_filename = "../drivers/net/wireless/quantenna/qtnfmac/debug.c"
...
define dso_local void @qtnf_debugfs_init(ptr nocapture noundef writeonly %bus, ptr noundef %name) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call ptr @qtnf_get_debugfs_dir() #2
  %call1 = tail call ptr @debugfs_create_dir(ptr noundef %name, ptr noundef %call) #2
  %dbg_dir = getelementptr inbounds %struct.qtnf_bus, ptr %bus, i32 0, i32 16
  %0 = ptrtoint ptr %dbg_dir to i32
  call void @__asan_store4_noabort(i32 %0)
  store ptr %call1, ptr %dbg_dir, align 4
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local ptr @qtnf_get_debugfs_dir() local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local ptr @debugfs_create_dir(ptr noundef, ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @qtnf_debugfs_remove(ptr nocapture noundef %bus) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %dbg_dir = getelementptr inbounds %struct.qtnf_bus, ptr %bus, i32 0, i32 16
  ...
  %1 = load ptr, ptr %dbg_dir, align 4
  tail call void @debugfs_remove(ptr noundef %1) #2
  %2 = ptrtoint ptr %dbg_dir to i32
  call void @__asan_store4_noabort(i32 %2)
  store ptr null, ptr %dbg_dir, align 4
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @qtnf_debugfs_add_entry(ptr nocapture noundef readonly %bus, ptr noundef %name, ptr noundef %fn) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %3 = load ptr, ptr %dbg_dir, align 4
  tail call void @debugfs_create_devm_seqfile(ptr noundef %1, ptr noundef %name, ptr noundef %3, ptr noundef %fn) #2
  ret void
}
