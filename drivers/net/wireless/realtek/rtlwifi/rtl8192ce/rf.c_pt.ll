; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c_pt.bc'
source_filename = "../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c"
...
@rtl92ce_phy_rf6052_set_bandwidth._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 32, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [37 x i8], [59 x i8] } { [37 x i8] c"\013rtl8192ce: unknown bandwidth: %#X\0A\00", [59 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [33 x i8], [63 x i8] } { [33 x i8] c"rtl92ce_phy_rf6052_set_bandwidth\00", [63 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [52 x i8], [44 x i8] } { [52 x i8] c"drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c\00", [44 x i8] zeroinitializer }, align 32
@rtl92ce_phy_rf6052_set_bandwidth._entry_ptr = internal global ptr @rtl92ce_phy_rf6052_set_bandwidth._entry, section ".printk_index", align 4
...
@.str.20 = internal constant { [6 x i8], [26 x i8] } { [6 x i8] c"<---\0A\00", [26 x i8] zeroinitializer }, align 32
@switch.table.rtl92ce_phy_rf6052_config = internal constant { [4 x i32], [16 x i8] } { [4 x i32] [i32 16, i32 1048576, i32 16, i32 1048576], [16 x i8] zeroinitializer }, align 32
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl92ce_phy_rf6052_set_cck_txpower(ptr noundef %hw, ptr nocapture noundef readonly %ppowerlevel) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl92ce_phy_rf6052_set_ofdm_txpower(ptr noundef %hw, ptr nocapture noundef readonly %ppowerlevel, i8 noundef zeroext %channel) local_unnamed_addr #0 align 64 {
entry:
...
rtl92c_phy_get_power_base.exit:                   ; preds = %if.then.1.i, %if.end.i.rtl92c_phy_get_power_base.exit_crit_edge
  ...
  %spec.select379.i = select i1 %cmp48.i, i8 1, i8 2
  %chnlgroup.2.i = select i1 %cmp40.i, i8 0, i8 %spec.select379.i
  br label %for.body
...
for.body:                                         ; preds = %_rtl92c_write_ofdm_power_reg.exit.for.body_crit_edge, %rtl92c_phy_get_power_base.exit
  ...
  %current_chan_bw102.i = getelementptr inbounds %struct.rtl_priv, ptr %28, i32 0, i32 14, i32 5
  %mcs_offset129.i = getelementptr inbounds %struct.rtl_priv, ptr %28, i32 0, i32 14, i32 41
  call void @__sanitizer_cov_trace_const_cmp4(i32 2, i32 %indvars.iv)
  %cmp208.i = icmp ult i32 %indvars.iv, 2
  %powerbase0.powerbase1377.i = select i1 %cmp208.i, ptr %powerbase0, ptr %powerbase1
...
for.body.i:                                       ; preds = %if.end255.i.for.body.i_crit_edge, %for.body
  %rf.0382.i = phi i32 [ 0, %for.body ], [ %inc257.i, %if.end255.i.for.body.i_crit_edge ]
  %chnlgroup.0381.i = phi i8 [ 0, %for.body ], [ %chnlgroup.4.i, %if.end255.i.for.body.i_crit_edge ]
  ...
  switch i8 %30, label %sw.default.i [
    ...
    i8 3, label %sw.bb101.i
  ]

sw.bb.i:                                          ; preds = %for.body.i
  call void @__sanitizer_cov_trace_pc() #7
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %tobool.not.i = icmp eq i32 %rf.0382.i, 0
  %cond.i = select i1 %tobool.not.i, i32 0, i32 8
  %add.i14 = add nuw nsw i32 %cond.i, %indvars.iv
  %arrayidx3.i = getelementptr [16 x i32], ptr %mcs_offset129.i, i32 0, i32 %add.i14
  %32 = ptrtoint ptr %arrayidx3.i to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load i32, ptr %arrayidx3.i, align 4
  %cond9.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
...
sw.bb14.i:                                        ; preds = %for.body.i
  %35 = ptrtoint ptr %current_chan_bw102.i to i32
  call void @__asan_load1_noabort(i32 %35)
  %36 = load i8, ptr %current_chan_bw102.i, align 2
...
if.then.i15:                                      ; preds = %sw.bb14.i
  call void @__sanitizer_cov_trace_pc() #7
  %cond26.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
  %37 = ptrtoint ptr %cond26.in.i to i32
  call void @__asan_load4_noabort(i32 %37)
  %cond26.i = load i32, ptr %cond26.in.i, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %cmp27.i = icmp eq i32 %rf.0382.i, 0
...
if.else.i:                                        ; preds = %sw.bb14.i
  ...
  %spec.select.i = select i1 %cmp31.i, i8 0, i8 %chnlgroup.0381.i
  ...
  %cmp61.i = icmp eq i8 %39, 4
  %inc.i = zext i1 %cmp61.i to i8
  %spec.select374.i = add nuw nsw i8 %chnlgroup.2.i, %inc.i
  %chnlgroup.3.i = select i1 %cmp36.i, i8 %spec.select374.i, i8 %spec.select.i
  %idxprom67.i = zext i8 %chnlgroup.3.i to i32
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %tobool70.not.i = icmp eq i32 %rf.0382.i, 0
  %cond71.i = select i1 %tobool70.not.i, i32 0, i32 8
  %add72.i = add nuw nsw i32 %cond71.i, %indvars.iv
  %arrayidx73.i = getelementptr %struct.rtl_priv, ptr %28, i32 0, i32 14, i32 41, i32 %idxprom67.i, i32 %add72.i
  %40 = ptrtoint ptr %arrayidx73.i to i32
  call void @__asan_load4_noabort(i32 %40)
  %41 = load i32, ptr %arrayidx73.i, align 4
  %cond82.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
  %42 = ptrtoint ptr %cond82.in.i to i32
  call void @__asan_load4_noabort(i32 %42)
  %cond82.i = load i32, ptr %cond82.in.i, align 4
  %add83.i = add i32 %cond82.i, %41
  %cond86.i = select i1 %tobool70.not.i, i32 65, i32 66
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull @.str.11, i32 noundef %cond86.i, i32 noundef %add83.i) #5
  br label %sw.epilog.i

sw.bb88.i:                                        ; preds = %for.body.i
  call void @__sanitizer_cov_trace_pc() #7
  %cond97.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
  %43 = ptrtoint ptr %cond97.in.i to i32
  call void @__asan_load4_noabort(i32 %43)
  %cond97.i = load i32, ptr %cond97.in.i, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %cmp98.i = icmp eq i32 %rf.0382.i, 0
  %cond100.i = select i1 %cmp98.i, i32 65, i32 66
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull @.str.12, i32 noundef %cond100.i, i32 noundef %cond97.i) #5
  br label %sw.epilog.i

sw.bb101.i:                                       ; preds = %for.body.i
  %44 = ptrtoint ptr %current_chan_bw102.i to i32
  call void @__asan_load1_noabort(i32 %44)
  %45 = load i8, ptr %current_chan_bw102.i, align 2
  call void @__sanitizer_cov_trace_const_cmp1(i8 1, i8 %45)
  %cmp104.i = icmp eq i8 %45, 1
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %cmp107.i = icmp eq i32 %rf.0382.i, 0
  %cond109.i = select i1 %cmp107.i, i32 65, i32 66
  %arrayidx121.i = getelementptr %struct.rtl_priv, ptr %28, i32 0, i32 17, i32 36, i32 %rf.0382.i, i32 %sub.i
  %arrayidx112.i = getelementptr %struct.rtl_priv, ptr %28, i32 0, i32 17, i32 37, i32 %rf.0382.i, i32 %sub.i
  %arrayidx121.sink.i = select i1 %cmp104.i, ptr %arrayidx112.i, ptr %arrayidx121.i
  %.str.14.sink.i = select i1 %cmp104.i, ptr @.str.13, ptr @.str.14
  %46 = ptrtoint ptr %arrayidx121.sink.i to i32
  call void @__asan_load1_noabort(i32 %46)
  %47 = load i8, ptr %arrayidx121.sink.i, align 1
  %conv122.i = zext i8 %47 to i32
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull %.str.14.sink.i, i32 noundef %cond109.i, i32 noundef %conv122.i) #5
  %cond134.i = select i1 %cmp107.i, i32 0, i32 8
  %add135.i = add nuw nsw i32 %cond134.i, %indvars.iv
  %arrayidx136.i = getelementptr [16 x i32], ptr %mcs_offset129.i, i32 0, i32 %add135.i
  %48 = ptrtoint ptr %arrayidx136.i to i32
  call void @__asan_load4_noabort(i32 %48)
  %49 = load i32, ptr %arrayidx136.i, align 4
  %50 = ptrtoint ptr %current_chan_bw102.i to i32
  call void @__asan_load1_noabort(i32 %50)
  %51 = load i8, ptr %current_chan_bw102.i, align 2
  call void @__sanitizer_cov_trace_const_cmp1(i8 1, i8 %51)
  %cmp145.i = icmp eq i8 %51, 1
  %and.i = and i32 %49, 127
  %conv140.i = trunc i32 %and.i to i8
  br i1 %cmp145.i, label %if.then147.i, label %if.else168.i

if.then147.i:                                     ; preds = %sw.bb101.i
  call void @__sanitizer_cov_trace_pc() #7
  %52 = ptrtoint ptr %arrayidx112.i to i32
  call void @__asan_load1_noabort(i32 %52)
  %53 = load i8, ptr %arrayidx112.i, align 1
  %conv156.i = zext i8 %53 to i32
  call void @__sanitizer_cov_trace_cmp4(i32 %and.i, i32 %conv156.i)
  %cmp157.i = icmp ugt i32 %and.i, %conv156.i
  %spec.select418.i = select i1 %cmp157.i, i8 %53, i8 %conv140.i
  %and.1386.i = lshr i32 %49, 8
  %shr.1387.i = and i32 %and.1386.i, 127
  %conv140.1388.i = trunc i32 %shr.1387.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.1387.i, i32 %conv156.i)
  %cmp157.1.i = icmp ugt i32 %shr.1387.i, %conv156.i
  %pwr_diff_limit.sroa.7.0.ph.i = select i1 %cmp157.1.i, i8 %53, i8 %conv140.1388.i
  %and.2395.i = lshr i32 %49, 16
  %shr.2396.i = and i32 %and.2395.i, 127
  %conv140.2397.i = trunc i32 %shr.2396.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.2396.i, i32 %conv156.i)
  %cmp157.2.i = icmp ugt i32 %shr.2396.i, %conv156.i
  %pwr_diff_limit.sroa.12.0.ph.i = select i1 %cmp157.2.i, i8 %53, i8 %conv140.2397.i
  %and.3407.i = lshr i32 %49, 24
  %shr.3408.i = and i32 %and.3407.i, 127
  %conv140.3409.i = trunc i32 %shr.3408.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.3408.i, i32 %conv156.i)
  %cmp157.3.i = icmp ugt i32 %shr.3408.i, %conv156.i
  %spec.select420.i = select i1 %cmp157.3.i, i8 %53, i8 %conv140.3409.i
  br label %for.inc.3.i

if.else168.i:                                     ; preds = %sw.bb101.i
  call void @__sanitizer_cov_trace_pc() #7
  %54 = ptrtoint ptr %arrayidx121.i to i32
  call void @__asan_load1_noabort(i32 %54)
  %55 = load i8, ptr %arrayidx121.i, align 1
  %conv177.i = zext i8 %55 to i32
  call void @__sanitizer_cov_trace_cmp4(i32 %and.i, i32 %conv177.i)
  %cmp178.i = icmp ugt i32 %and.i, %conv177.i
  %spec.select419.i = select i1 %cmp178.i, i8 %55, i8 %conv140.i
  %and.1.i = lshr i32 %49, 8
  %shr.1.i = and i32 %and.1.i, 127
  %conv140.1.i = trunc i32 %shr.1.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.1.i, i32 %conv177.i)
  %cmp178.1.i = icmp ugt i32 %shr.1.i, %conv177.i
  %pwr_diff_limit.sroa.7.0.i = select i1 %cmp178.1.i, i8 %55, i8 %conv140.1.i
  %and.2.i = lshr i32 %49, 16
  %shr.2.i = and i32 %and.2.i, 127
  %conv140.2.i = trunc i32 %shr.2.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.2.i, i32 %conv177.i)
  %cmp178.2.i = icmp ugt i32 %shr.2.i, %conv177.i
  %pwr_diff_limit.sroa.12.0.i = select i1 %cmp178.2.i, i8 %55, i8 %conv140.2.i
  %and.3.i = lshr i32 %49, 24
  %shr.3.i = and i32 %and.3.i, 127
  %conv140.3.i = trunc i32 %shr.3.i to i8
  call void @__sanitizer_cov_trace_cmp4(i32 %shr.3.i, i32 %conv177.i)
  %cmp178.3.i = icmp ugt i32 %shr.3.i, %conv177.i
  %spec.select421.i = select i1 %cmp178.3.i, i8 %55, i8 %conv140.3.i
  br label %for.inc.3.i

for.inc.3.i:                                      ; preds = %if.else168.i, %if.then147.i
  %pwr_diff_limit.sroa.12.0414.i = phi i8 [ %pwr_diff_limit.sroa.12.0.i, %if.else168.i ], [ %pwr_diff_limit.sroa.12.0.ph.i, %if.then147.i ]
  %pwr_diff_limit.sroa.0.0389398412.i = phi i8 [ %spec.select419.i, %if.else168.i ], [ %spec.select418.i, %if.then147.i ]
  %pwr_diff_limit.sroa.7.0400410.i = phi i8 [ %pwr_diff_limit.sroa.7.0.i, %if.else168.i ], [ %pwr_diff_limit.sroa.7.0.ph.i, %if.then147.i ]
  %pwr_diff_limit.sroa.17.0.i = phi i8 [ %spec.select421.i, %if.else168.i ], [ %spec.select420.i, %if.then147.i ]
  %conv192.i = zext i8 %pwr_diff_limit.sroa.17.0.i to i32
  %shl193.i = shl nuw i32 %conv192.i, 24
  %conv195.i = zext i8 %pwr_diff_limit.sroa.12.0414.i to i32
  %shl196.i = shl nuw nsw i32 %conv195.i, 16
  %or.i16 = or i32 %shl193.i, %shl196.i
  %conv198.i = zext i8 %pwr_diff_limit.sroa.7.0400410.i to i32
  %shl199.i = shl nuw nsw i32 %conv198.i, 8
  %or200.i = or i32 %or.i16, %shl199.i
  %conv202.i = zext i8 %pwr_diff_limit.sroa.0.0389398412.i to i32
  %or203.i = or i32 %or200.i, %conv202.i
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull @.str.15, i32 noundef %cond109.i, i32 noundef %or203.i) #5
  %cond215.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
  %56 = ptrtoint ptr %cond215.in.i to i32
  call void @__asan_load4_noabort(i32 %56)
  %cond215.i = load i32, ptr %cond215.in.i, align 4
  %add216.i = add i32 %or203.i, %cond215.i
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull @.str.16, i32 noundef %cond109.i, i32 noundef %add216.i) #5
  br label %sw.epilog.i

sw.default.i:                                     ; preds = %for.body.i
  call void @__sanitizer_cov_trace_pc() #7
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %rf.0382.i)
  %tobool224.not.i = icmp eq i32 %rf.0382.i, 0
  %cond225.i = select i1 %tobool224.not.i, i32 0, i32 8
  %add226.i = add nuw nsw i32 %cond225.i, %indvars.iv
  %arrayidx227.i = getelementptr [16 x i32], ptr %mcs_offset129.i, i32 0, i32 %add226.i
  %57 = ptrtoint ptr %arrayidx227.i to i32
  call void @__asan_load4_noabort(i32 %57)
  %58 = load i32, ptr %arrayidx227.i, align 4
  %cond236.in.i = getelementptr i32, ptr %powerbase0.powerbase1377.i, i32 %rf.0382.i
  %59 = ptrtoint ptr %cond236.in.i to i32
  call void @__asan_load4_noabort(i32 %59)
  %cond236.i = load i32, ptr %cond236.in.i, align 4
  %add237.i = add i32 %cond236.i, %58
  %cond240.i = select i1 %tobool224.not.i, i32 65, i32 66
  tail call void (ptr, i64, i32, ptr, ...) @_rtl_dbg_print(ptr noundef %28, i64 noundef 9, i32 noundef 256, ptr noundef nonnull @.str.17, i32 noundef %cond240.i, i32 noundef %add237.i) #5
  br label %sw.epilog.i

sw.epilog.i:                                      ; preds = %sw.default.i, %for.inc.3.i, %sw.bb88.i, %if.else.i, %if.then.i15, %sw.bb.i
  %chnlgroup.4.i = phi i8 [ 0, %sw.default.i ], [ 0, %for.inc.3.i ], [ %chnlgroup.0381.i, %sw.bb88.i ], [ %chnlgroup.0381.i, %if.then.i15 ], [ %chnlgroup.3.i, %if.else.i ], [ 0, %sw.bb.i ]
  %writeval.0.i = phi i32 [ %add237.i, %sw.default.i ], [ %add216.i, %for.inc.3.i ], [ %cond97.i, %sw.bb88.i ], [ %cond26.i, %if.then.i15 ], [ %add83.i, %if.else.i ], [ %add10.i, %sw.bb.i ]
  ...
  switch i8 %61, label %sw.epilog.i.if.end255.i_crit_edge [
    i8 3, label %if.then244.i
    i8 4, label %if.then252.i
  ]

sw.epilog.i.if.end255.i_crit_edge:                ; preds = %sw.epilog.i
  call void @__sanitizer_cov_trace_pc() #7
  br label %if.end255.i

if.then244.i:                                     ; preds = %sw.epilog.i
  call void @__sanitizer_cov_trace_pc() #7
  %sub245.i = add i32 %writeval.0.i, -101058054
  br label %if.end255.i

if.then252.i:                                     ; preds = %sw.epilog.i
  call void @__sanitizer_cov_trace_pc() #7
  %sub253.i = add i32 %writeval.0.i, -202116108
  br label %if.end255.i

if.end255.i:                                      ; preds = %if.then252.i, %if.then244.i, %sw.epilog.i.if.end255.i_crit_edge
  %writeval.1.i = phi i32 [ %sub245.i, %if.then244.i ], [ %sub253.i, %if.then252.i ], [ %writeval.0.i, %sw.epilog.i.if.end255.i_crit_edge ]
  %add.ptr.i = getelementptr i32, ptr %writeval, i32 %rf.0382.i
  %63 = ptrtoint ptr %add.ptr.i to i32
  call void @__asan_store4_noabort(i32 %63)
  store i32 %writeval.1.i, ptr %add.ptr.i, align 4
  %inc257.i = add nuw nsw i32 %rf.0382.i, 1
  %exitcond.not.i = icmp eq i32 %inc257.i, 2
  br i1 %exitcond.not.i, label %_rtl92c_get_txpower_writeval_by_regulatory.exit, label %if.end255.i.for.body.i_crit_edge

if.end255.i.for.body.i_crit_edge:                 ; preds = %if.end255.i
  call void @__sanitizer_cov_trace_pc() #7
  br label %for.body.i

_rtl92c_get_txpower_writeval_by_regulatory.exit:  ; preds = %if.end255.i
...
for.body.i24:                                     ; preds = %for.inc101.i.for.body.i24_crit_edge, %_rtl92c_get_txpower_writeval_by_regulatory.exit
  %indvars.iv.i = phi i32 [ 0, %_rtl92c_get_txpower_writeval_by_regulatory.exit ], [ %indvars.iv.next.i, %for.inc101.i.for.body.i24_crit_edge ]
...
for.inc101.i:                                     ; preds = %if.then.i.2.i, %rtl_write_byte.exit.1.i.for.inc101.i_crit_edge, %land.lhs.true58.i.for.inc101.i_crit_edge, %land.lhs.true.i.for.inc101.i_crit_edge
  ...
  br i1 %exitcond.not.i26, label %_rtl92c_write_ofdm_power_reg.exit, label %for.inc101.i.for.body.i24_crit_edge

for.inc101.i.for.body.i24_crit_edge:              ; preds = %for.inc101.i
  call void @__sanitizer_cov_trace_pc() #7
  br label %for.body.i24

_rtl92c_write_ofdm_power_reg.exit:                ; preds = %for.inc101.i
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @rtl92ce_phy_rf6052_config(ptr noundef %hw) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
switch.lookup:                                    ; preds = %for.body.i
  ...
  %switch.gep = getelementptr inbounds [4 x i32], ptr @switch.table.rtl92ce_phy_rf6052_config, i32 0, i32 %12
...
sw.epilog16.thread.i:                             ; preds = %sw.epilog.i
  %call11.i = tail call zeroext i1 @rtl92c_phy_config_rf_with_headerfile(ptr noundef %hw, i32 noundef %indvars.iv.i) #5
...
sw.epilog16.thread94.i:                           ; preds = %sw.epilog.i
  %call14.i = tail call zeroext i1 @rtl92c_phy_config_rf_with_headerfile(ptr noundef %hw, i32 noundef %indvars.iv.i) #5
...
if.then.i:                                        ; preds = %sw.epilog16.thread94.i.if.then.i_crit_edge, %sw.epilog16.thread.i.if.then.i_crit_edge
  ...
  br label %_rtl92ce_phy_rf6052_config_parafile.exit
...
_rtl92ce_phy_rf6052_config_parafile.exit:         ; preds = %for.end.i, %if.then.i
  %cmp101.i = phi i1 [ true, %for.end.i ], [ false, %if.then.i ]
  ret i1 %cmp101.i
}

; Function Attrs: null_pointer_is_valid
declare dso_local zeroext i1 @rtl92c_phy_config_rf_with_headerfile(ptr noundef, i32 noundef) local_unnamed_addr #3
...
!1 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 32, i32 3}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @rtl92ce_phy_rf6052_set_bandwidth._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @rtl92ce_phy_rf6052_set_bandwidth._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 95, i32 2}
!8 = !{ptr @.str.4, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 105, i32 2}
!10 = !{ptr @.str.5, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 112, i32 2}
!12 = !{ptr @.str.6, !13, !"<string literal>", i1 false, i1 false}
!13 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 119, i32 2}
!14 = !{ptr @.str.7, !15, !"<string literal>", i1 false, i1 false}
!15 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 143, i32 3}
!16 = !{ptr @.str.8, !17, !"<string literal>", i1 false, i1 false}
!17 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 159, i32 3}
!18 = !{ptr @.str.9, !19, !"<string literal>", i1 false, i1 false}
!19 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 186, i32 4}
!20 = !{ptr @.str.10, !21, !"<string literal>", i1 false, i1 false}
!21 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 195, i32 5}
!22 = !{ptr @.str.11, !23, !"<string literal>", i1 false, i1 false}
!23 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 217, i32 5}
!24 = !{ptr @.str.12, !25, !"<string literal>", i1 false, i1 false}
!25 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 226, i32 4}
!26 = !{ptr @.str.13, !27, !"<string literal>", i1 false, i1 false}
!27 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 234, i32 5}
!28 = !{ptr @.str.14, !29, !"<string literal>", i1 false, i1 false}
!29 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 240, i32 5}
!30 = !{ptr @.str.15, !31, !"<string literal>", i1 false, i1 false}
!31 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 274, i32 4}
!32 = !{ptr @.str.16, !33, !"<string literal>", i1 false, i1 false}
!33 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 281, i32 4}
!34 = !{ptr @.str.17, !35, !"<string literal>", i1 false, i1 false}
!35 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 291, i32 4}
!36 = !{ptr @.str.18, !37, !"<string literal>", i1 false, i1 false}
!37 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 344, i32 3}
!38 = !{ptr @.str.19, !39, !"<string literal>", i1 false, i1 false}
!39 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 473, i32 4}
!40 = !{ptr @.str.20, !41, !"<string literal>", i1 false, i1 false}
!41 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ce/rf.c", i32 480, i32 2}
