; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c_pt.bc'
source_filename = "../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c"
...
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 28, i32 3 }
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 40, i32 4 }
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 45, i32 4 }
@___asan_gen_.19 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 52, i32 3 }
@___asan_gen_.22 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 59, i32 3 }
@___asan_gen_.25 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 65, i32 3 }
@___asan_gen_.28 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 69, i32 3 }
@___asan_gen_.29 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.30 = private constant [55 x i8] c"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c\00", align 1
@___asan_gen_.31 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.30, i32 74, i32 3 }
...
define dso_local void @rtl92cu_dm_dynamic_txpower(ptr noundef %hw) local_unnamed_addr #0 align 64 {
entry:
...
if.end54:                                         ; preds = %if.end54.sink.split, %if.else46.if.end54_crit_edge
  ...
  br i1 %cmp61.not, label %if.end54.if.end89_crit_edge, label %if.then63
...
if.then63:                                        ; preds = %if.end54
  ...
  switch i8 %34, label %if.then63.if.end89_crit_edge [
    i8 0, label %if.then71
    i8 1, label %if.then78
    i8 2, label %if.then85
  ]

if.then63.if.end89_crit_edge:                     ; preds = %if.then63
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.end89

if.then71:                                        ; preds = %if.then63
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @dm_restorepowerindex(ptr noundef %hw) #2
  br label %if.end89

if.then78:                                        ; preds = %if.then63
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @dm_writepowerindex(ptr noundef %hw, i8 noundef zeroext 20) #2
  br label %if.end89

if.then85:                                        ; preds = %if.then63
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @dm_writepowerindex(ptr noundef %hw, i8 noundef zeroext 16) #2
  br label %if.end89

if.end89:                                         ; preds = %if.then85, %if.then78, %if.then71, %if.then63.if.end89_crit_edge, %if.end54.if.end89_crit_edge
  %36 = ptrtoint ptr %dynamic_txhighpower_lvl56 to i32
  call void @__asan_load1_noabort(i32 %36)
  %37 = load i8, ptr %dynamic_txhighpower_lvl56, align 1
  %38 = ptrtoint ptr %last_dtp_lvl59 to i32
  call void @__asan_store1_noabort(i32 %38)
  store i8 %37, ptr %last_dtp_lvl59, align 1
  br label %cleanup

cleanup:                                          ; preds = %if.end89, %if.then11, %if.then4, %entry.cleanup_crit_edge
  ret void
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @dm_restorepowerindex(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @dm_writepowerindex(ptr noundef, i8 noundef zeroext) local_unnamed_addr #1
...
!1 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 28, i32 3}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 40, i32 4}
!4 = !{ptr @.str.2, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 45, i32 4}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 52, i32 3}
!8 = !{ptr @.str.4, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 59, i32 3}
!10 = !{ptr @.str.5, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 65, i32 3}
!12 = !{ptr @.str.6, !13, !"<string literal>", i1 false, i1 false}
!13 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 69, i32 3}
!14 = !{ptr @.str.7, !15, !"<string literal>", i1 false, i1 false}
!15 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192cu/dm.c", i32 74, i32 3}
