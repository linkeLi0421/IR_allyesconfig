; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c_pt.bc'
source_filename = "../drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c"
...
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.13, i32 41, i32 3 }
@___asan_gen_.12 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.13 = private constant [56 x i8] c"../drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c\00", align 1
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.13, i32 121, i32 2 }
...
define dso_local void @rtl92ee_sw_led_on(ptr nocapture noundef readonly %hw, ptr nocapture noundef %pled) local_unnamed_addr #0 align 64 {
entry:
  ...
  switch i32 %5, label %sw.default [
    ...
    i32 1, label %sw.bb
    i32 2, label %entry.sw.epilog_crit_edge15
  ]
...
sw.bb:                                            ; preds = %entry
  ...
  %call.i = tail call i32 %8(ptr noundef %1, i32 noundef 68) #3
  %and = and i32 %call.i, -538976257
  %or = or i32 %and, 2097152
  %write32_async.i = getelementptr inbounds %struct.rtl_priv, ptr %1, i32 0, i32 13, i32 7
  %9 = ptrtoint ptr %write32_async.i to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %write32_async.i, align 4
  tail call void %10(ptr noundef %1, i32 noundef 68, i32 noundef %or) #3
  ...
  %14 = load i8, ptr %write_readback.i, align 1, !range !15
...
if.then.i:                                        ; preds = %sw.bb
  ...
  %call.i14 = tail call i32 %16(ptr noundef %1, i32 noundef 68) #3
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %sw.default, %if.then.i, %sw.bb.sw.epilog_crit_edge, %entry.sw.epilog_crit_edge, %entry.sw.epilog_crit_edge15
  %ledon = getelementptr inbounds %struct.rtl_led, ptr %pled, i32 0, i32 2
  %17 = ptrtoint ptr %ledon to i32
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl92ee_sw_led_off(ptr nocapture noundef readonly %hw, ptr nocapture noundef %pled) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
  ...
  switch i32 %5, label %sw.default [
    i32 0, label %entry.sw.epilog_crit_edge
    i32 1, label %sw.bb
    i32 2, label %entry.sw.epilog_crit_edge13
  ]
...
sw.bb:                                            ; preds = %entry
  ...
  %8 = load ptr, ptr %read32_sync.i, align 4
  %call.i = tail call i32 %8(ptr noundef %1, i32 noundef 68) #3
  %or = and i32 %call.i, 2097152
  %and = or i32 %or, -538968065
  %write32_async.i = getelementptr inbounds %struct.rtl_priv, ptr %1, i32 0, i32 13, i32 7
  %9 = ptrtoint ptr %write32_async.i to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %write32_async.i, align 4
  tail call void %10(ptr noundef %1, i32 noundef 68, i32 noundef %and) #3
  %cfg.i = getelementptr inbounds %struct.rtl_priv, ptr %1, i32 0, i32 32
  %11 = ptrtoint ptr %cfg.i to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %cfg.i, align 8
...
if.then.i:                                        ; preds = %sw.bb
  ...
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %read32_sync.i, align 4
  %call.i12 = tail call i32 %16(ptr noundef %1, i32 noundef 68) #3
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %sw.default, %if.then.i, %sw.bb.sw.epilog_crit_edge, %entry.sw.epilog_crit_edge, %entry.sw.epilog_crit_edge13
  %ledon = getelementptr inbounds %struct.rtl_led, ptr %pled, i32 0, i32 2
  %17 = ptrtoint ptr %ledon to i32
  call void @__asan_store1_noabort(i32 %17)
...
define dso_local void @rtl92ee_init_sw_leds(ptr noundef %hw) local_unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl92ee_led_control(ptr nocapture noundef readonly %hw, i32 noundef %ledaction) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
sw.bb.i:                                          ; preds = %if.end.sw.bb.i_crit_edge, %if.end.sw.bb.i_crit_edge31, %if.end.sw.bb.i_crit_edge32
  tail call void @rtl92ee_sw_led_on(ptr noundef %hw, ptr noundef %sw_led0.i) #3
  br label %cleanup

sw.bb1.i:                                         ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @rtl92ee_sw_led_off(ptr noundef %hw, ptr noundef %sw_led0.i) #3
  br label %cleanup
...
!1 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c", i32 22, i32 2}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c", i32 41, i32 3}
!4 = !{ptr @.str.2, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8192ee/led.c", i32 121, i32 2}
