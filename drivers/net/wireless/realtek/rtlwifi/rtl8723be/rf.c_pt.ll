; ModuleID = '/llk/IR_all_yes/drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c_pt.bc'
source_filename = "../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c"
...
@rtl8723be_phy_rf6052_set_bandwidth._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 32, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [37 x i8], [59 x i8] } { [37 x i8] c"\013rtl8723be: unknown bandwidth: %#X\0A\00", [59 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [35 x i8], [61 x i8] } { [35 x i8] c"rtl8723be_phy_rf6052_set_bandwidth\00", [61 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [52 x i8], [44 x i8] } { [52 x i8] c"drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c\00", [44 x i8] zeroinitializer }, align 32
@rtl8723be_phy_rf6052_set_bandwidth._entry_ptr = internal global ptr @rtl8723be_phy_rf6052_set_bandwidth._entry, section ".printk_index", align 4
...
@__const._rtl8723be_write_ofdm_power_reg.regoffset_a = private unnamed_addr constant [6 x i16] [i16 3584, i16 3588, i16 3600, i16 3604, i16 3608, i16 3612], align 2
@__const._rtl8723be_write_ofdm_power_reg.regoffset_b = private unnamed_addr constant [6 x i16] [i16 2096, i16 2100, i16 2108, i16 2120, i16 2124, i16 2152], align 2
...
@switch.table.rtl8723be_phy_rf6052_config = internal constant { [4 x i32], [16 x i8] } { [4 x i32] [i32 16, i32 1048576, i32 16, i32 1048576], [16 x i8] zeroinitializer }, align 32
...
@___asan_gen_.39 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.86, i32 106, i32 2 }
@___asan_gen_.42 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.86, i32 116, i32 2 }
@___asan_gen_.45 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.86, i32 123, i32 2 }
@___asan_gen_.48 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.86, i32 130, i32 2 }
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl8723be_phy_rf6052_set_cck_txpower(ptr noundef %hw, ptr nocapture noundef readonly %ppowerlevel) local_unnamed_addr #0 align 64 {
entry:
...
if.end98.3.1:                                     ; preds = %if.end81, %if.then4.if.end98.3.1_crit_edge
  ...
  call void @rtl8723be_dm_txpower_track_adjust(ptr noundef %hw, i8 noundef zeroext 1, ptr noundef nonnull %direction, ptr noundef nonnull %pwrtrac_value) #5
...
declare dso_local void @rtl8723be_dm_txpower_track_adjust(ptr noundef, i8 noundef zeroext, ptr noundef, ptr noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local void @_rtl_dbg_print(ptr noundef, i64 noundef, i32 noundef, ptr noundef, ...) local_unnamed_addr #3

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtl8723be_phy_rf6052_set_ofdm_txpower(ptr noundef %hw, ptr nocapture noundef readonly %ppowerlevel_ofdm, ptr nocapture noundef readonly %ppowerlevel_bw20, ptr nocapture noundef readonly %ppowerlevel_bw40, i8 noundef zeroext %channel) local_unnamed_addr #0 align 64 {
entry:
...
if.end250.i:                                      ; preds = %if.then247.i, %if.then239.i, %sw.epilog.i.if.end250.i_crit_edge
  ...
  br i1 %exitcond.not.i, label %_rtl8723be_get_txpower_writeval_by_regulatory.exit, label %if.end250.i.for.body.i_crit_edge

if.end250.i.for.body.i_crit_edge:                 ; preds = %if.end250.i
  call void @__sanitizer_cov_trace_pc() #7
  br label %for.body.i

_rtl8723be_get_txpower_writeval_by_regulatory.exit: ; preds = %if.end250.i
  ...
  switch i8 %59, label %_rtl8723be_get_txpower_writeval_by_regulatory.exit.if.end19_crit_edge [
    i8 1, label %if.then
    i8 2, label %if.then15
  ]

_rtl8723be_get_txpower_writeval_by_regulatory.exit.if.end19_crit_edge: ; preds = %_rtl8723be_get_txpower_writeval_by_regulatory.exit
  call void @__sanitizer_cov_trace_pc() #7
  br label %if.end19

if.then:                                          ; preds = %_rtl8723be_get_txpower_writeval_by_regulatory.exit
  call void @__sanitizer_cov_trace_pc() #7
...
if.then15:                                        ; preds = %_rtl8723be_get_txpower_writeval_by_regulatory.exit
  call void @__sanitizer_cov_trace_pc() #7
...
if.end19:                                         ; preds = %if.end19.sink.split, %_rtl8723be_get_txpower_writeval_by_regulatory.exit.if.end19_crit_edge
  %74 = ptrtoint ptr %priv.i to i32
  call void @__asan_load4_noabort(i32 %74)
  %75 = load ptr, ptr %priv.i, align 8
  %arrayidx38.i = getelementptr [6 x i16], ptr @__const._rtl8723be_write_ofdm_power_reg.regoffset_a, i32 0, i32 %indvars.iv
  %arrayidx40.i = getelementptr [6 x i16], ptr @__const._rtl8723be_write_ofdm_power_reg.regoffset_b, i32 0, i32 %indvars.iv
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @rtl8723be_phy_rf6052_config(ptr noundef %hw) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %priv = getelementptr inbounds %struct.ieee80211_hw, ptr %hw, i32 0, i32 3
...
switch.lookup:                                    ; preds = %for.body.i
  ...
  %switch.gep = getelementptr inbounds [4 x i32], ptr @switch.table.rtl8723be_phy_rf6052_config, i32 0, i32 %12
...
sw.epilog16.thread.i:                             ; preds = %sw.epilog.i
  %call11.i = tail call zeroext i1 @rtl8723be_phy_config_rf_with_headerfile(ptr noundef %hw, i32 noundef %indvars.iv.i) #5
...
sw.epilog16.thread94.i:                           ; preds = %sw.epilog.i
  %call14.i = tail call zeroext i1 @rtl8723be_phy_config_rf_with_headerfile(ptr noundef %hw, i32 noundef %indvars.iv.i) #5
...
if.then.i:                                        ; preds = %sw.epilog16.thread94.i.if.then.i_crit_edge, %sw.epilog16.thread.i.if.then.i_crit_edge
  ...
  br label %_rtl8723be_phy_rf6052_config_parafile.exit
...
_rtl8723be_phy_rf6052_config_parafile.exit:       ; preds = %for.end.i, %if.then.i
  %cmp101.i = phi i1 [ true, %for.end.i ], [ false, %if.then.i ]
  ret i1 %cmp101.i
}

; Function Attrs: null_pointer_is_valid
declare dso_local zeroext i1 @rtl8723be_phy_config_rf_with_headerfile(ptr noundef, i32 noundef) local_unnamed_addr #3
...
!1 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 32, i32 3}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @rtl8723be_phy_rf6052_set_bandwidth._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @rtl8723be_phy_rf6052_set_bandwidth._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 106, i32 2}
!8 = !{ptr @.str.4, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 116, i32 2}
!10 = !{ptr @.str.5, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 123, i32 2}
!12 = !{ptr @.str.6, !13, !"<string literal>", i1 false, i1 false}
!13 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 130, i32 2}
!14 = !{ptr @.str.7, !15, !"<string literal>", i1 false, i1 false}
!15 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 153, i32 3}
!16 = !{ptr @.str.8, !17, !"<string literal>", i1 false, i1 false}
!17 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 170, i32 3}
!18 = !{ptr @.str.9, !19, !"<string literal>", i1 false, i1 false}
!19 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 199, i32 4}
!20 = !{ptr @.str.10, !21, !"<string literal>", i1 false, i1 false}
!21 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 227, i32 4}
!22 = !{ptr @.str.11, !23, !"<string literal>", i1 false, i1 false}
!23 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 236, i32 4}
!24 = !{ptr @.str.12, !25, !"<string literal>", i1 false, i1 false}
!25 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 244, i32 5}
!26 = !{ptr @.str.13, !27, !"<string literal>", i1 false, i1 false}
!27 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 250, i32 5}
!28 = !{ptr @.str.14, !29, !"<string literal>", i1 false, i1 false}
!29 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 292, i32 4}
!30 = !{ptr @.str.15, !31, !"<string literal>", i1 false, i1 false}
!31 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 300, i32 4}
!32 = !{ptr @.str.16, !33, !"<string literal>", i1 false, i1 false}
!33 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 311, i32 4}
!34 = !{ptr @.str.17, !35, !"<string literal>", i1 false, i1 false}
!35 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 362, i32 3}
!36 = !{ptr @.str.18, !37, !"<string literal>", i1 false, i1 false}
!37 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 481, i32 4}
!38 = !{ptr @.str.19, !39, !"<string literal>", i1 false, i1 false}
!39 = !{!"../drivers/net/wireless/realtek/rtlwifi/rtl8723be/rf.c", i32 487, i32 2}
