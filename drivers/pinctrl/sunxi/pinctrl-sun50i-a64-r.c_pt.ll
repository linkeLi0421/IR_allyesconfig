; ModuleID = '/llk/IR_all_yes/drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c_pt.bc'
source_filename = "../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c"
...
@__initcall__kmod_pinctrl_sun50i_a64_r__210_125_sun50i_a64_r_pinctrl_driver_init6 = internal global ptr @sun50i_a64_r_pinctrl_driver_init, section ".initcall6.init", align 4
@sun50i_a64_r_pinctrl_driver = internal global { %struct.platform_driver, [56 x i8] } { %struct.platform_driver { ptr @sun50i_a64_r_pinctrl_probe, ptr null, ptr null, ptr null, ptr null, %struct.device_driver { ptr @.str, ptr null, ptr null, ptr null, i8 0, i32 0, ptr @sun50i_a64_r_pinctrl_match, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, ptr null, i8 0 }, [56 x i8] zeroinitializer }, align 32
@.str = internal constant { [21 x i8], [43 x i8] } { [21 x i8] c"sun50i-a64-r-pinctrl\00", [43 x i8] zeroinitializer }, align 32
@sun50i_a64_r_pinctrl_match = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"allwinner,sun50i-a64-r-pinctrl\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
@sun50i_a64_r_pinctrl_data = internal constant { %struct.sunxi_pinctrl_desc, [36 x i8] } { %struct.sunxi_pinctrl_desc { ptr @sun50i_a64_r_pins, i32 13, i32 352, i32 1, ptr null, i8 0, i8 0, i32 0 }, [36 x i8] zeroinitializer }, align 32
@sun50i_a64_r_pins = internal constant { [13 x %struct.sunxi_desc_pin], [92 x i8] } { [13 x %struct.sunxi_desc_pin] [%struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 352, ptr @.str.1, ptr null }, i32 0, ptr @.compoundliteral }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 353, ptr @.str.7, ptr null }, i32 0, ptr @.compoundliteral.8 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 354, ptr @.str.9, ptr null }, i32 0, ptr @.compoundliteral.11 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 355, ptr @.str.12, ptr null }, i32 0, ptr @.compoundliteral.13 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 356, ptr @.str.14, ptr null }, i32 0, ptr @.compoundliteral.16 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 357, ptr @.str.17, ptr null }, i32 0, ptr @.compoundliteral.18 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 358, ptr @.str.19, ptr null }, i32 0, ptr @.compoundliteral.20 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 359, ptr @.str.21, ptr null }, i32 0, ptr @.compoundliteral.22 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 360, ptr @.str.23, ptr null }, i32 0, ptr @.compoundliteral.24 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 361, ptr @.str.25, ptr null }, i32 0, ptr @.compoundliteral.26 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 362, ptr @.str.27, ptr null }, i32 0, ptr @.compoundliteral.29 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 363, ptr @.str.30, ptr null }, i32 0, ptr @.compoundliteral.32 }, %struct.sunxi_desc_pin { %struct.pinctrl_pin_desc { i32 364, ptr @.str.33, ptr null }, i32 0, ptr @.compoundliteral.34 }], [92 x i8] zeroinitializer }, align 32
...
define internal i32 @sun50i_a64_r_pinctrl_probe(ptr noundef %pdev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @sunxi_pinctrl_init_with_variant(ptr noundef %pdev, ptr noundef nonnull @sun50i_a64_r_pinctrl_data, i32 noundef 0) #3
  ret i32 %call
}
...
!llvm.asan.globals = !{!0, !2, !4, !6, !8, !10, !11, !12, !13, !14, !15, !17, !19, !20, !22, !24, !25, !27, !29, !31, !33, !35, !37, !38, !40, !41, !43, !45}
!llvm.module.flags = !{!47, !48, !49, !50, !51, !52, !53, !54}
!llvm.ident = !{!55}

!0 = !{ptr @__initcall__kmod_pinctrl_sun50i_a64_r__210_125_sun50i_a64_r_pinctrl_driver_init6, !1, !"__initcall__kmod_pinctrl_sun50i_a64_r__210_125_sun50i_a64_r_pinctrl_driver_init6", i1 false, i1 false}
!1 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 125, i32 1}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 121, i32 12}
!4 = !{ptr @sun50i_a64_r_pinctrl_driver, !5, !"sun50i_a64_r_pinctrl_driver", i1 false, i1 false}
!5 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 118, i32 31}
!6 = !{ptr @sun50i_a64_r_pinctrl_data, !7, !"sun50i_a64_r_pinctrl_data", i1 false, i1 false}
!7 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 100, i32 40}
!8 = !{ptr @.str.1, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 32, i32 2}
...
!16 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 38, i32 2}
!17 = !{ptr @.str.9, !18, !"<string literal>", i1 false, i1 false}
!18 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 44, i32 2}
!19 = !{ptr @.str.10, !18, !"<string literal>", i1 false, i1 false}
!20 = !{ptr @.str.12, !21, !"<string literal>", i1 false, i1 false}
!21 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 49, i32 2}
!22 = !{ptr @.str.14, !23, !"<string literal>", i1 false, i1 false}
!23 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 54, i32 2}
!24 = !{ptr @.str.15, !23, !"<string literal>", i1 false, i1 false}
!25 = !{ptr @.str.17, !26, !"<string literal>", i1 false, i1 false}
!26 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 59, i32 2}
!27 = !{ptr @.str.19, !28, !"<string literal>", i1 false, i1 false}
!28 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 64, i32 2}
!29 = !{ptr @.str.21, !30, !"<string literal>", i1 false, i1 false}
!30 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 69, i32 2}
!31 = !{ptr @.str.23, !32, !"<string literal>", i1 false, i1 false}
!32 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 74, i32 2}
!33 = !{ptr @.str.25, !34, !"<string literal>", i1 false, i1 false}
!34 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 79, i32 2}
!35 = !{ptr @.str.27, !36, !"<string literal>", i1 false, i1 false}
!36 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 84, i32 2}
!37 = !{ptr @.str.28, !36, !"<string literal>", i1 false, i1 false}
!38 = !{ptr @.str.30, !39, !"<string literal>", i1 false, i1 false}
!39 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 89, i32 2}
!40 = !{ptr @.str.31, !39, !"<string literal>", i1 false, i1 false}
!41 = !{ptr @.str.33, !42, !"<string literal>", i1 false, i1 false}
!42 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 94, i32 2}
!43 = !{ptr @sun50i_a64_r_pins, !44, !"sun50i_a64_r_pins", i1 false, i1 false}
!44 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 31, i32 36}
!45 = !{ptr @sun50i_a64_r_pinctrl_match, !46, !"sun50i_a64_r_pinctrl_match", i1 false, i1 false}
!46 = !{!"../drivers/pinctrl/sunxi/pinctrl-sun50i-a64-r.c", i32 113, i32 34}
