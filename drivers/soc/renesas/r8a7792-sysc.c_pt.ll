; ModuleID = '/llk/IR_all_yes/drivers/soc/renesas/r8a7792-sysc.c_pt.bc'
...
@.str.5 = internal constant { [4 x i8], [28 x i8] } { [4 x i8] c"imp\00", [28 x i8] zeroinitializer }, align 32
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 16, i32 4 }
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 17, i32 4 }
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 19, i32 4 }
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 21, i32 4 }
@___asan_gen_.20 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 23, i32 4 }
@___asan_gen_.21 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.22 = private constant [38 x i8] c"../drivers/soc/renesas/r8a7792-sysc.c\00", align 1
@___asan_gen_.23 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 24, i32 4 }
...
!0 = !{ptr @r8a7792_sysc_info, !1, !"r8a7792_sysc_info", i1 false, i1 false}
!1 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 27, i32 29}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 16, i32 4}
!4 = !{ptr @.str.1, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 17, i32 4}
!6 = !{ptr @.str.2, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 19, i32 4}
!8 = !{ptr @.str.3, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 21, i32 4}
!10 = !{ptr @.str.4, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 23, i32 4}
!12 = !{ptr @.str.5, !13, !"<string literal>", i1 false, i1 false}
!13 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 24, i32 4}
!14 = !{ptr @r8a7792_areas, !15, !"r8a7792_areas", i1 false, i1 false}
!15 = !{!"../drivers/soc/renesas/r8a7792-sysc.c", i32 15, i32 36}
