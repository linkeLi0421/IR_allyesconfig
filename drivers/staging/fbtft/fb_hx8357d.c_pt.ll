; ModuleID = '/llk/IR_all_yes/drivers/staging/fbtft/fb_hx8357d.c_pt.bc'
source_filename = "../drivers/staging/fbtft/fb_hx8357d.c"
...
@__initcall__kmod_fb_hx8357d__303_192_fbtft_driver_module_init6 = internal global ptr @fbtft_driver_module_init, section ".initcall6.init", align 4
@__exitcall_fbtft_driver_module_exit = internal global ptr @fbtft_driver_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_alias304 = internal constant [32 x i8] c"fb_hx8357d.alias=spi:fb_hx8357d\00", section ".modinfo", align 1
@__UNIQUE_ID_alias305 = internal constant [37 x i8] c"fb_hx8357d.alias=platform:fb_hx8357d\00", section ".modinfo", align 1
@__UNIQUE_ID_alias306 = internal constant [29 x i8] c"fb_hx8357d.alias=spi:hx8357d\00", section ".modinfo", align 1
@__UNIQUE_ID_alias307 = internal constant [34 x i8] c"fb_hx8357d.alias=platform:hx8357d\00", section ".modinfo", align 1
@__UNIQUE_ID_description308 = internal constant [64 x i8] c"fb_hx8357d.description=FB driver for the HX8357D LCD Controller\00", section ".modinfo", align 1
@__UNIQUE_ID_author309 = internal constant [47 x i8] c"fb_hx8357d.author=Sean Cross <xobs@kosagi.com>\00", section ".modinfo", align 1
@__UNIQUE_ID_file310 = internal constant [49 x i8] c"fb_hx8357d.file=drivers/staging/fbtft/fb_hx8357d\00", section ".modinfo", align 1
@__UNIQUE_ID_license311 = internal constant [23 x i8] c"fb_hx8357d.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"fb_hx8357d\00", [21 x i8] zeroinitializer }, align 32
@dt_ids = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"himax,hx8357d\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
@display = internal global { %struct.fbtft_display, [40 x i8] } { %struct.fbtft_display { i32 320, i32 480, i32 8, i32 0, i32 0, %struct.fbtft_ops { ptr null, ptr null, ptr null, ptr null, ptr @set_addr_win, ptr null, ptr null, ptr null, ptr @init_display, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @set_var, ptr null }, i32 0, i32 0, i32 0, ptr null, ptr null, i32 2, i32 14, i32 0 }, [40 x i8] zeroinitializer }, align 32
...
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 192, i32 1 }
@___asan_gen_.13 = private unnamed_addr constant [8 x i8] c"display\00", align 1
@___asan_gen_.14 = private constant [38 x i8] c"../drivers/staging/fbtft/fb_hx8357d.c\00", align 1
@___asan_gen_.15 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 179, i32 29 }
@llvm.compiler.used = appending global [16 x ptr] [ptr @__UNIQUE_ID_alias304, ptr @__UNIQUE_ID_alias305, ptr @__UNIQUE_ID_alias306, ptr @__UNIQUE_ID_alias307, ptr @__UNIQUE_ID_author309, ptr @__UNIQUE_ID_description308, ptr @__UNIQUE_ID_file310, ptr @__UNIQUE_ID_license311, ptr @__exitcall_fbtft_driver_module_exit, ptr @__initcall__kmod_fb_hx8357d__303_192_fbtft_driver_module_init6, ptr @fbtft_driver_module_exit, ptr @fbtft_driver_spi_driver, ptr @fbtft_driver_platform_driver, ptr @.str, ptr @dt_ids, ptr @display], section "llvm.metadata"
...
entry:
  ...
  tail call void @usleep_range_state(i32 noundef 5000, i32 noundef 7000, i32 noundef 2) #3
  %4 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %5(ptr noundef %par, i32 noundef 4, i32 noundef 185, i32 noundef 255, i32 noundef 131, i32 noundef 87) #3
  tail call void @msleep(i32 noundef 150) #3
  %6 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %7(ptr noundef %par, i32 noundef 5, i32 noundef 179, i32 noundef 0, i32 noundef 0, i32 noundef 6, i32 noundef 6) #3
  %8 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %9(ptr noundef %par, i32 noundef 2, i32 noundef 182, i32 noundef 37) #3
  %10 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %11(ptr noundef %par, i32 noundef 2, i32 noundef 176, i32 noundef 104) #3
  %12 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %13(ptr noundef %par, i32 noundef 2, i32 noundef 204, i32 noundef 5) #3
  %14 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %15(ptr noundef %par, i32 noundef 7, i32 noundef 177, i32 noundef 0, i32 noundef 21, i32 noundef 28, i32 noundef 28, i32 noundef 131, i32 noundef 170) #3
  %16 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %17(ptr noundef %par, i32 noundef 7, i32 noundef 192, i32 noundef 80, i32 noundef 80, i32 noundef 1, i32 noundef 60, i32 noundef 30, i32 noundef 8) #3
  %18 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %19(ptr noundef %par, i32 noundef 8, i32 noundef 180, i32 noundef 2, i32 noundef 64, i32 noundef 0, i32 noundef 42, i32 noundef 42, i32 noundef 13, i32 noundef 120) #3
  %20 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %21(ptr noundef %par, i32 noundef 35, i32 noundef 224, i32 noundef 2, i32 noundef 10, i32 noundef 17, i32 noundef 29, i32 noundef 35, i32 noundef 53, i32 noundef 65, i32 noundef 75, i32 noundef 75, i32 noundef 66, i32 noundef 58, i32 noundef 39, i32 noundef 27, i32 noundef 8, i32 noundef 9, i32 noundef 3, i32 noundef 2, i32 noundef 10, i32 noundef 17, i32 noundef 29, i32 noundef 35, i32 noundef 53, i32 noundef 65, i32 noundef 75, i32 noundef 75, i32 noundef 66, i32 noundef 58, i32 noundef 39, i32 noundef 27, i32 noundef 8, i32 noundef 9, i32 noundef 3, i32 noundef 0, i32 noundef 1) #3
  %22 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %23(ptr noundef %par, i32 noundef 2, i32 noundef 58, i32 noundef 85) #3
  %24 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %25(ptr noundef %par, i32 noundef 2, i32 noundef 54, i32 noundef 192) #3
  %26 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %27(ptr noundef %par, i32 noundef 2, i32 noundef 53, i32 noundef 0) #3
  %28 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %29(ptr noundef %par, i32 noundef 3, i32 noundef 68, i32 noundef 0, i32 noundef 2) #3
  %30 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %31(ptr noundef %par, i32 noundef 1, i32 noundef 17) #3
  tail call void @msleep(i32 noundef 150) #3
  %32 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %33(ptr noundef %par, i32 noundef 1, i32 noundef 41) #3
  tail call void @usleep_range_state(i32 noundef 5000, i32 noundef 7000, i32 noundef 2) #3
  ret i32 0
}
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb2, %sw.bb1, %entry.sw.epilog_crit_edge
  %val.0 = phi i32 [ 192, %sw.default ], [ 160, %sw.bb2 ], [ 0, %sw.bb1 ], [ 96, %entry.sw.epilog_crit_edge ]
  ...
  tail call void (ptr, i32, ...) %8(ptr noundef %par, i32 noundef 2, i32 noundef 54, i32 noundef %or) #3
  ret i32 0
}
...
!0 = !{ptr @__initcall__kmod_fb_hx8357d__303_192_fbtft_driver_module_init6, !1, !"__initcall__kmod_fb_hx8357d__303_192_fbtft_driver_module_init6", i1 false, i1 false}
!1 = !{!"../drivers/staging/fbtft/fb_hx8357d.c", i32 192, i32 1}
...
!21 = !{!"../drivers/staging/fbtft/fb_hx8357d.c", i32 179, i32 29}
