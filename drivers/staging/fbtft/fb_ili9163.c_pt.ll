; ModuleID = '/llk/IR_all_yes/drivers/staging/fbtft/fb_ili9163.c_pt.bc'
source_filename = "../drivers/staging/fbtft/fb_ili9163.c"
...
@__initcall__kmod_fb_ili9163__303_251_fbtft_driver_module_init6 = internal global ptr @fbtft_driver_module_init, section ".initcall6.init", align 4
@__exitcall_fbtft_driver_module_exit = internal global ptr @fbtft_driver_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_alias304 = internal constant [32 x i8] c"fb_ili9163.alias=spi:fb_ili9163\00", section ".modinfo", align 1
@__UNIQUE_ID_alias305 = internal constant [37 x i8] c"fb_ili9163.alias=platform:fb_ili9163\00", section ".modinfo", align 1
@__UNIQUE_ID_alias306 = internal constant [29 x i8] c"fb_ili9163.alias=spi:ili9163\00", section ".modinfo", align 1
@__UNIQUE_ID_alias307 = internal constant [34 x i8] c"fb_ili9163.alias=platform:ili9163\00", section ".modinfo", align 1
@__UNIQUE_ID_description308 = internal constant [64 x i8] c"fb_ili9163.description=FB driver for the ILI9163 LCD Controller\00", section ".modinfo", align 1
@__UNIQUE_ID_author309 = internal constant [38 x i8] c"fb_ili9163.author=Kozhevnikov Anatoly\00", section ".modinfo", align 1
@__UNIQUE_ID_file310 = internal constant [49 x i8] c"fb_ili9163.file=drivers/staging/fbtft/fb_ili9163\00", section ".modinfo", align 1
@__UNIQUE_ID_license311 = internal constant [23 x i8] c"fb_ili9163.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"fb_ili9163\00", [21 x i8] zeroinitializer }, align 32
@dt_ids = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"ilitek,ili9163\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
@display = internal global { %struct.fbtft_display, [40 x i8] } { %struct.fbtft_display { i32 128, i32 128, i32 8, i32 0, i32 0, %struct.fbtft_ops { ptr null, ptr null, ptr null, ptr null, ptr @set_addr_win, ptr null, ptr null, ptr null, ptr @init_display, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @set_var, ptr null }, i32 16, i32 30, i32 0, ptr null, ptr null, i32 0, i32 0, i32 0 }, [40 x i8] zeroinitializer }, align 32
...
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 251, i32 1 }
@___asan_gen_.14 = private unnamed_addr constant [8 x i8] c"display\00", align 1
@___asan_gen_.15 = private constant [38 x i8] c"../drivers/staging/fbtft/fb_ili9163.c\00", align 1
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.15, i32 230, i32 29 }
@llvm.compiler.used = appending global [16 x ptr] [ptr @__UNIQUE_ID_alias304, ptr @__UNIQUE_ID_alias305, ptr @__UNIQUE_ID_alias306, ptr @__UNIQUE_ID_alias307, ptr @__UNIQUE_ID_author309, ptr @__UNIQUE_ID_description308, ptr @__UNIQUE_ID_file310, ptr @__UNIQUE_ID_license311, ptr @__exitcall_fbtft_driver_module_exit, ptr @__initcall__kmod_fb_ili9163__303_251_fbtft_driver_module_init6, ptr @fbtft_driver_module_exit, ptr @fbtft_driver_spi_driver, ptr @fbtft_driver_platform_driver, ptr @.str, ptr @dt_ids, ptr @display], section "llvm.metadata"
...
entry:
  ...
  switch i32 %3, label %sw.default [
    ...
    i32 180, label %entry.sw.bb29_crit_edge
    i32 270, label %entry.sw.bb29_crit_edge82
  ]

entry.sw.bb29_crit_edge82:                        ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  br label %sw.bb29
...
sw.bb:                                            ; preds = %entry
  ...
  %shr1 = ashr i32 %xe, 8
  %and2 = and i32 %xe, 255
  tail call void (ptr, i32, ...) %6(ptr noundef %par, i32 noundef 5, i32 noundef 42, i32 noundef %shr, i32 noundef %and, i32 noundef %shr1, i32 noundef %and2) #3
  ...
  %and7 = and i32 %ys, 255
  %shr9 = ashr i32 %ye, 8
  %and11 = and i32 %ye, 255
  tail call void (ptr, i32, ...) %8(ptr noundef %par, i32 noundef 5, i32 noundef 43, i32 noundef %shr5, i32 noundef %and7, i32 noundef %shr9, i32 noundef %and11) #3
  br label %sw.epilog

sw.bb12:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  %write_register14 = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 9, i32 3
  %9 = ptrtoint ptr %write_register14 to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %write_register14, align 4
  %shr16 = ashr i32 %xs, 8
  %and18 = and i32 %xs, 255
  %shr20 = ashr i32 %xe, 8
  %and22 = and i32 %xe, 255
  tail call void (ptr, i32, ...) %10(ptr noundef %par, i32 noundef 5, i32 noundef 42, i32 noundef %shr16, i32 noundef %and18, i32 noundef %shr20, i32 noundef %and22) #3
  %11 = ptrtoint ptr %write_register14 to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %write_register14, align 4
  %shr25 = ashr i32 %ys, 8
  %and26 = and i32 %ys, 255
  %shr27 = ashr i32 %ye, 8
  %and28 = and i32 %ye, 255
  tail call void (ptr, i32, ...) %12(ptr noundef %par, i32 noundef 5, i32 noundef 43, i32 noundef %shr25, i32 noundef %and26, i32 noundef %shr27, i32 noundef %and28) #3
  br label %sw.epilog

sw.bb29:                                          ; preds = %entry.sw.bb29_crit_edge, %entry.sw.bb29_crit_edge82
  %write_register31 = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 9, i32 3
  %13 = ptrtoint ptr %write_register31 to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load ptr, ptr %write_register31, align 4
  %shr32 = ashr i32 %xs, 8
  %and33 = and i32 %xs, 255
  %shr34 = ashr i32 %xe, 8
  %and35 = and i32 %xe, 255
  tail call void (ptr, i32, ...) %14(ptr noundef %par, i32 noundef 5, i32 noundef 42, i32 noundef %shr32, i32 noundef %and33, i32 noundef %shr34, i32 noundef %and35) #3
  %15 = ptrtoint ptr %write_register31 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %write_register31, align 4
  %shr38 = ashr i32 %ys, 8
  %and39 = and i32 %ys, 255
  %shr40 = ashr i32 %ye, 8
  %and41 = and i32 %ye, 255
  tail call void (ptr, i32, ...) %16(ptr noundef %par, i32 noundef 5, i32 noundef 43, i32 noundef %shr38, i32 noundef %and39, i32 noundef %shr40, i32 noundef %and41) #3
  br label %sw.epilog

sw.default:                                       ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  %17 = ptrtoint ptr %rotate to i32
  call void @__asan_store4_noabort(i32 %17)
  store i32 0, ptr %rotate, align 4
  br label %sw.epilog

sw.epilog:                                        ; preds = %sw.default, %sw.bb29, %sw.bb12, %sw.bb
  %write_register46 = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 9, i32 3
  %18 = ptrtoint ptr %write_register46 to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load ptr, ptr %write_register46, align 4
  tail call void (ptr, i32, ...) %19(ptr noundef %par, i32 noundef 1, i32 noundef 44) #3
  ret void
}
...
while.body:                                       ; preds = %while.body.while.body_crit_edge, %entry
  %__ms.071 = phi i32 [ 500, %entry ], [ %dec, %while.body.while.body_crit_edge ]
  %dec = add nsw i32 %__ms.071, -1
...
while.end:                                        ; preds = %while.body
  ...
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %6(ptr noundef %par, i32 noundef 1, i32 noundef 17) #3
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.arm_delay_ops, ptr @arm_delay_ops, i32 0, i32 1) to i32))
  ...
  tail call void (ptr, i32, ...) %13(ptr noundef %par, i32 noundef 2, i32 noundef 58, i32 noundef 5) #3
  %14 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %15(ptr noundef %par, i32 noundef 2, i32 noundef 38, i32 noundef 2) #3
  %16 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %17(ptr noundef %par, i32 noundef 1, i32 noundef 19) #3
  %18 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %19(ptr noundef %par, i32 noundef 3, i32 noundef 182, i32 noundef 255, i32 noundef 6) #3
  %20 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %21(ptr noundef %par, i32 noundef 3, i32 noundef 177, i32 noundef 8, i32 noundef 2) #3
  %22 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %23(ptr noundef %par, i32 noundef 2, i32 noundef 180, i32 noundef 7) #3
  %24 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %25(ptr noundef %par, i32 noundef 3, i32 noundef 192, i32 noundef 10, i32 noundef 2) #3
  %26 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %27(ptr noundef %par, i32 noundef 2, i32 noundef 193, i32 noundef 2) #3
  %28 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %29(ptr noundef %par, i32 noundef 3, i32 noundef 197, i32 noundef 80, i32 noundef 99) #3
  %30 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %31(ptr noundef %par, i32 noundef 2, i32 noundef 199, i32 noundef 0) #3
  %32 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %33(ptr noundef %par, i32 noundef 5, i32 noundef 42, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 128) #3
  %34 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %34)
  %35 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %35(ptr noundef %par, i32 noundef 5, i32 noundef 43, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 128) #3
  %36 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %36)
  %37 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %37(ptr noundef %par, i32 noundef 1, i32 noundef 41) #3
  %38 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %38)
  %39 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %39(ptr noundef %par, i32 noundef 1, i32 noundef 44) #3
  ret i32 0
}
...
sw.epilog:                                        ; preds = %sw.bb3, %sw.bb2, %sw.bb1, %sw.bb, %entry.sw.epilog_crit_edge
  %mactrl_data.0 = phi i8 [ 0, %entry.sw.epilog_crit_edge ], [ 104, %sw.bb3 ], [ -88, %sw.bb2 ], [ -56, %sw.bb1 ], [ 8, %sw.bb ]
  %bgr = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 19
  %5 = ptrtoint ptr %bgr to i32
  call void @__asan_load1_noabort(i32 %5)
  %6 = load i8, ptr %bgr, align 8, !range !33
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %6)
  %tobool.not = icmp eq i8 %6, 0
  %7 = or i8 %mactrl_data.0, 4
  %spec.select = select i1 %tobool.not, i8 %mactrl_data.0, i8 %7
  %write_register = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 9, i32 3
  %8 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %write_register, align 4
  %conv5 = zext i8 %spec.select to i32
  tail call void (ptr, i32, ...) %9(ptr noundef %par, i32 noundef 2, i32 noundef 54, i32 noundef %conv5) #3
  %10 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %11(ptr noundef %par, i32 noundef 1, i32 noundef 44) #3
  ret i32 0
}
...
!0 = !{ptr @__initcall__kmod_fb_ili9163__303_251_fbtft_driver_module_init6, !1, !"__initcall__kmod_fb_ili9163__303_251_fbtft_driver_module_init6", i1 false, i1 false}
!1 = !{!"../drivers/staging/fbtft/fb_ili9163.c", i32 251, i32 1}
...
!21 = !{!"../drivers/staging/fbtft/fb_ili9163.c", i32 230, i32 29}
