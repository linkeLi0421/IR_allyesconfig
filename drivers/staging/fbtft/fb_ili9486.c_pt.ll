; ModuleID = '/llk/IR_all_yes/drivers/staging/fbtft/fb_ili9486.c_pt.bc'
source_filename = "../drivers/staging/fbtft/fb_ili9486.c"
...
@__initcall__kmod_fb_ili9486__303_94_fbtft_driver_module_init6 = internal global ptr @fbtft_driver_module_init, section ".initcall6.init", align 4
@__exitcall_fbtft_driver_module_exit = internal global ptr @fbtft_driver_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_alias304 = internal constant [32 x i8] c"fb_ili9486.alias=spi:fb_ili9486\00", section ".modinfo", align 1
@__UNIQUE_ID_alias305 = internal constant [37 x i8] c"fb_ili9486.alias=platform:fb_ili9486\00", section ".modinfo", align 1
@__UNIQUE_ID_alias306 = internal constant [29 x i8] c"fb_ili9486.alias=spi:ili9486\00", section ".modinfo", align 1
@__UNIQUE_ID_alias307 = internal constant [34 x i8] c"fb_ili9486.alias=platform:ili9486\00", section ".modinfo", align 1
@__UNIQUE_ID_description308 = internal constant [64 x i8] c"fb_ili9486.description=FB driver for the ILI9486 LCD Controller\00", section ".modinfo", align 1
@__UNIQUE_ID_author309 = internal constant [33 x i8] c"fb_ili9486.author=Noralf Tronnes\00", section ".modinfo", align 1
@__UNIQUE_ID_file310 = internal constant [49 x i8] c"fb_ili9486.file=drivers/staging/fbtft/fb_ili9486\00", section ".modinfo", align 1
@__UNIQUE_ID_license311 = internal constant [23 x i8] c"fb_ili9486.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"fb_ili9486\00", [21 x i8] zeroinitializer }, align 32
@dt_ids = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"ilitek,ili9486\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
...
@default_init_sequence = internal constant { [75 x i16], [42 x i8] } { [75 x i16] [i16 -1, i16 176, i16 0, i16 -1, i16 17, i16 -2, i16 250, i16 -1, i16 58, i16 85, i16 -1, i16 194, i16 68, i16 -1, i16 197, i16 0, i16 0, i16 0, i16 0, i16 -1, i16 224, i16 15, i16 31, i16 28, i16 12, i16 15, i16 8, i16 72, i16 152, i16 55, i16 10, i16 19, i16 4, i16 17, i16 13, i16 0, i16 -1, i16 225, i16 15, i16 50, i16 46, i16 11, i16 13, i16 5, i16 71, i16 117, i16 55, i16 6, i16 16, i16 3, i16 36, i16 32, i16 0, i16 -1, i16 226, i16 15, i16 50, i16 46, i16 11, i16 13, i16 5, i16 71, i16 117, i16 55, i16 6, i16 16, i16 3, i16 36, i16 32, i16 0, i16 -1, i16 17, i16 -1, i16 41, i16 -3], [42 x i8] zeroinitializer }, align 32
...
@___asan_gen_.17 = private constant [38 x i8] c"../drivers/staging/fbtft/fb_ili9486.c\00", align 1
@___asan_gen_.18 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.17, i32 20, i32 18 }
@llvm.compiler.used = appending global [17 x ptr] [ptr @__UNIQUE_ID_alias304, ptr @__UNIQUE_ID_alias305, ptr @__UNIQUE_ID_alias306, ptr @__UNIQUE_ID_alias307, ptr @__UNIQUE_ID_author309, ptr @__UNIQUE_ID_description308, ptr @__UNIQUE_ID_file310, ptr @__UNIQUE_ID_license311, ptr @__exitcall_fbtft_driver_module_exit, ptr @__initcall__kmod_fb_ili9486__303_94_fbtft_driver_module_init6, ptr @fbtft_driver_module_exit, ptr @fbtft_driver_spi_driver, ptr @fbtft_driver_platform_driver, ptr @.str, ptr @dt_ids, ptr @display, ptr @default_init_sequence], section "llvm.metadata"
...
sw.epilog.sink.split:                             ; preds = %sw.bb17, %sw.bb9, %sw.bb1, %entry.sw.epilog.sink.split_crit_edge
  %.sink39 = phi i8 [ -32, %sw.bb17 ], [ 64, %sw.bb9 ], [ 32, %sw.bb1 ], [ -128, %entry.sw.epilog.sink.split_crit_edge ]
...
!0 = !{ptr @__initcall__kmod_fb_ili9486__303_94_fbtft_driver_module_init6, !1, !"__initcall__kmod_fb_ili9486__303_94_fbtft_driver_module_init6", i1 false, i1 false}
!1 = !{!"../drivers/staging/fbtft/fb_ili9486.c", i32 94, i32 1}
...
!21 = !{!"../drivers/staging/fbtft/fb_ili9486.c", i32 83, i32 29}
!22 = !{ptr @default_init_sequence, !23, !"default_init_sequence", i1 false, i1 false}
!23 = !{!"../drivers/staging/fbtft/fb_ili9486.c", i32 20, i32 18}
