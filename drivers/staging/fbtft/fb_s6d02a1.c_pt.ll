; ModuleID = '/llk/IR_all_yes/drivers/staging/fbtft/fb_s6d02a1.c_pt.bc'
source_filename = "../drivers/staging/fbtft/fb_s6d02a1.c"
...
@__initcall__kmod_fb_s6d02a1__303_157_fbtft_driver_module_init6 = internal global ptr @fbtft_driver_module_init, section ".initcall6.init", align 4
@__exitcall_fbtft_driver_module_exit = internal global ptr @fbtft_driver_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_alias304 = internal constant [32 x i8] c"fb_s6d02a1.alias=spi:fb_s6d02a1\00", section ".modinfo", align 1
@__UNIQUE_ID_alias305 = internal constant [37 x i8] c"fb_s6d02a1.alias=platform:fb_s6d02a1\00", section ".modinfo", align 1
@__UNIQUE_ID_alias306 = internal constant [29 x i8] c"fb_s6d02a1.alias=spi:s6d02a1\00", section ".modinfo", align 1
@__UNIQUE_ID_alias307 = internal constant [34 x i8] c"fb_s6d02a1.alias=platform:s6d02a1\00", section ".modinfo", align 1
@__UNIQUE_ID_description308 = internal constant [64 x i8] c"fb_s6d02a1.description=FB driver for the S6D02A1 LCD Controller\00", section ".modinfo", align 1
@__UNIQUE_ID_author309 = internal constant [35 x i8] c"fb_s6d02a1.author=WOLFGANG BUENING\00", section ".modinfo", align 1
@__UNIQUE_ID_file310 = internal constant [49 x i8] c"fb_s6d02a1.file=drivers/staging/fbtft/fb_s6d02a1\00", section ".modinfo", align 1
@__UNIQUE_ID_license311 = internal constant [23 x i8] c"fb_s6d02a1.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"fb_s6d02a1\00", [21 x i8] zeroinitializer }, align 32
@dt_ids = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"samsung,s6d02a1\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
...
@default_init_sequence = internal constant { [246 x i16], [116 x i8] } { [246 x i16] [i16 -1, i16 240, i16 90, i16 90, i16 -1, i16 252, i16 90, i16 90, i16 -1, i16 250, i16 2, i16 31, i16 0, i16 16, i16 34, i16 48, i16 56, i16 58, i16 58, i16 58, i16 58, i16 58, i16 61, i16 2, i16 1, i16 -1, i16 251, i16 33, i16 0, i16 2, i16 4, i16 7, i16 10, i16 11, i16 12, i16 12, i16 22, i16 30, i16 48, i16 63, i16 1, i16 2, i16 -1, i16 253, i16 0, i16 0, i16 0, i16 23, i16 16, i16 0, i16 1, i16 1, i16 0, i16 31, i16 31, i16 -1, i16 244, i16 0, i16 0, i16 0, i16 0, i16 0, i16 63, i16 63, i16 7, i16 0, i16 60, i16 54, i16 0, i16 60, i16 54, i16 0, i16 -1, i16 245, i16 0, i16 112, i16 102, i16 0, i16 0, i16 0, i16 0, i16 0, i16 0, i16 0, i16 109, i16 102, i16 6, i16 -1, i16 246, i16 2, i16 0, i16 63, i16 0, i16 0, i16 0, i16 2, i16 0, i16 6, i16 1, i16 0, i16 -1, i16 242, i16 0, i16 1, i16 3, i16 8, i16 8, i16 4, i16 0, i16 0, i16 0, i16 0, i16 0, i16 1, i16 0, i16 0, i16 4, i16 8, i16 8, i16 -1, i16 248, i16 17, i16 -1, i16 247, i16 200, i16 32, i16 0, i16 0, i16 -1, i16 243, i16 0, i16 0, i16 -1, i16 17, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 1, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 3, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 7, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 15, i16 -2, i16 50, i16 -1, i16 244, i16 0, i16 4, i16 0, i16 0, i16 0, i16 63, i16 63, i16 7, i16 0, i16 60, i16 54, i16 0, i16 60, i16 54, i16 0, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 31, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 127, i16 -2, i16 50, i16 -1, i16 243, i16 0, i16 255, i16 -2, i16 50, i16 -1, i16 253, i16 0, i16 0, i16 0, i16 23, i16 16, i16 0, i16 0, i16 1, i16 0, i16 22, i16 22, i16 -1, i16 244, i16 0, i16 9, i16 0, i16 0, i16 0, i16 63, i16 63, i16 7, i16 0, i16 60, i16 54, i16 0, i16 60, i16 54, i16 0, i16 -1, i16 54, i16 8, i16 -1, i16 53, i16 0, i16 -1, i16 58, i16 5, i16 -1, i16 38, i16 1, i16 -2, i16 150, i16 -1, i16 41, i16 -1, i16 44, i16 -3], [116 x i8] zeroinitializer }, align 32
...
!0 = !{ptr @__initcall__kmod_fb_s6d02a1__303_157_fbtft_driver_module_init6, !1, !"__initcall__kmod_fb_s6d02a1__303_157_fbtft_driver_module_init6", i1 false, i1 false}
!1 = !{!"../drivers/staging/fbtft/fb_s6d02a1.c", i32 157, i32 1}
...
!21 = !{!"../drivers/staging/fbtft/fb_s6d02a1.c", i32 146, i32 29}
!22 = !{ptr @default_init_sequence, !23, !"default_init_sequence", i1 false, i1 false}
!23 = !{!"../drivers/staging/fbtft/fb_s6d02a1.c", i32 18, i32 18}
