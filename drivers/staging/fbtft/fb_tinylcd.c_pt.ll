; ModuleID = '/llk/IR_all_yes/drivers/staging/fbtft/fb_tinylcd.c_pt.bc'
source_filename = "../drivers/staging/fbtft/fb_tinylcd.c"
...
@__initcall__kmod_fb_tinylcd__303_96_fbtft_driver_module_init6 = internal global ptr @fbtft_driver_module_init, section ".initcall6.init", align 4
@__exitcall_fbtft_driver_module_exit = internal global ptr @fbtft_driver_module_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_alias304 = internal constant [32 x i8] c"fb_tinylcd.alias=spi:fb_tinylcd\00", section ".modinfo", align 1
@__UNIQUE_ID_alias305 = internal constant [29 x i8] c"fb_tinylcd.alias=spi:tinylcd\00", section ".modinfo", align 1
@__UNIQUE_ID_description306 = internal constant [64 x i8] c"fb_tinylcd.description=Custom FB driver for tinylcd.com display\00", section ".modinfo", align 1
@__UNIQUE_ID_author307 = internal constant [33 x i8] c"fb_tinylcd.author=Noralf Tronnes\00", section ".modinfo", align 1
@__UNIQUE_ID_file308 = internal constant [49 x i8] c"fb_tinylcd.file=drivers/staging/fbtft/fb_tinylcd\00", section ".modinfo", align 1
@__UNIQUE_ID_license309 = internal constant [23 x i8] c"fb_tinylcd.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"fb_tinylcd\00", [21 x i8] zeroinitializer }, align 32
@dt_ids = internal constant { [2 x %struct.of_device_id], [120 x i8] } { [2 x %struct.of_device_id] [%struct.of_device_id { [32 x i8] zeroinitializer, [32 x i8] zeroinitializer, [128 x i8] c"neosec,tinylcd\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", ptr null }, %struct.of_device_id zeroinitializer], [120 x i8] zeroinitializer }, align 32
...
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 96, i32 1 }
@___asan_gen_.13 = private unnamed_addr constant [8 x i8] c"display\00", align 1
@___asan_gen_.14 = private constant [38 x i8] c"../drivers/staging/fbtft/fb_tinylcd.c\00", align 1
@___asan_gen_.15 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 85, i32 29 }
@llvm.compiler.used = appending global [14 x ptr] [ptr @__UNIQUE_ID_alias304, ptr @__UNIQUE_ID_alias305, ptr @__UNIQUE_ID_author307, ptr @__UNIQUE_ID_description306, ptr @__UNIQUE_ID_file308, ptr @__UNIQUE_ID_license309, ptr @__exitcall_fbtft_driver_module_exit, ptr @__initcall__kmod_fb_tinylcd__303_96_fbtft_driver_module_init6, ptr @fbtft_driver_module_exit, ptr @fbtft_driver_spi_driver, ptr @fbtft_driver_platform_driver, ptr @.str, ptr @dt_ids, ptr @display], section "llvm.metadata"
...
entry:
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %3(ptr noundef %par, i32 noundef 2, i32 noundef 176, i32 noundef 128) #3
  %4 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %5(ptr noundef %par, i32 noundef 3, i32 noundef 192, i32 noundef 10, i32 noundef 10) #3
  %6 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %6)
  %7 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %7(ptr noundef %par, i32 noundef 3, i32 noundef 193, i32 noundef 69, i32 noundef 7) #3
  %8 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %9(ptr noundef %par, i32 noundef 2, i32 noundef 194, i32 noundef 51) #3
  %10 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %11(ptr noundef %par, i32 noundef 4, i32 noundef 197, i32 noundef 0, i32 noundef 66, i32 noundef 128) #3
  %12 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %13(ptr noundef %par, i32 noundef 3, i32 noundef 177, i32 noundef 208, i32 noundef 17) #3
  %14 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %15(ptr noundef %par, i32 noundef 2, i32 noundef 180, i32 noundef 2) #3
  %16 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %17(ptr noundef %par, i32 noundef 4, i32 noundef 182, i32 noundef 0, i32 noundef 34, i32 noundef 59) #3
  %18 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %18)
  %19 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %19(ptr noundef %par, i32 noundef 2, i32 noundef 183, i32 noundef 7) #3
  %20 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %21(ptr noundef %par, i32 noundef 2, i32 noundef 54, i32 noundef 88) #3
  %22 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %23(ptr noundef %par, i32 noundef 4, i32 noundef 240, i32 noundef 54, i32 noundef 165, i32 noundef 211) #3
  %24 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %25(ptr noundef %par, i32 noundef 2, i32 noundef 229, i32 noundef 128) #3
  %26 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %27(ptr noundef %par, i32 noundef 2, i32 noundef 229, i32 noundef 1) #3
  %28 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %29(ptr noundef %par, i32 noundef 2, i32 noundef 179, i32 noundef 0) #3
  %30 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %31(ptr noundef %par, i32 noundef 2, i32 noundef 229, i32 noundef 0) #3
  %32 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %33(ptr noundef %par, i32 noundef 4, i32 noundef 240, i32 noundef 54, i32 noundef 165, i32 noundef 83) #3
  %34 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %34)
  %35 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %35(ptr noundef %par, i32 noundef 13, i32 noundef 224, i32 noundef 0, i32 noundef 53, i32 noundef 51, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 0, i32 noundef 53, i32 noundef 51, i32 noundef 0, i32 noundef 0, i32 noundef 0) #3
  %36 = ptrtoint ptr %write_register to i32
  call void @__asan_load4_noabort(i32 %36)
  %37 = load ptr, ptr %write_register, align 4
  tail call void (ptr, i32, ...) %37(ptr noundef %par, i32 noundef 2, i32 noundef 58, i32 noundef 85) #3
  ...
  tail call void %40(i32 noundef 53687000) #3
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb8, %sw.bb3, %entry.sw.epilog_crit_edge
  %.sink34 = phi i32 [ 34, %sw.default ], [ 34, %sw.bb8 ], [ 34, %sw.bb3 ], [ 2, %entry.sw.epilog_crit_edge ]
  %.sink = phi i32 [ 8, %sw.default ], [ 56, %sw.bb8 ], [ 88, %sw.bb3 ], [ 40, %entry.sw.epilog_crit_edge ]
  %write_register14 = getelementptr inbounds %struct.fbtft_par, ptr %par, i32 0, i32 9, i32 3
  %5 = ptrtoint ptr %write_register14 to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %write_register14, align 4
  tail call void (ptr, i32, ...) %6(ptr noundef %par, i32 noundef 4, i32 noundef 182, i32 noundef 0, i32 noundef %.sink34, i32 noundef 59) #3
  %7 = ptrtoint ptr %write_register14 to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %write_register14, align 4
  tail call void (ptr, i32, ...) %8(ptr noundef %par, i32 noundef 2, i32 noundef 54, i32 noundef %.sink) #3
  ret i32 0
}
...
!llvm.asan.globals = !{!0, !2, !3, !5, !7, !9, !11, !13, !14, !15, !16, !18, !19}
!llvm.module.flags = !{!20, !21, !22, !23, !24, !25, !26, !27}
!llvm.ident = !{!28}

!0 = !{ptr @__initcall__kmod_fb_tinylcd__303_96_fbtft_driver_module_init6, !1, !"__initcall__kmod_fb_tinylcd__303_96_fbtft_driver_module_init6", i1 false, i1 false}
!1 = !{!"../drivers/staging/fbtft/fb_tinylcd.c", i32 96, i32 1}
...
!17 = !{!"../drivers/staging/fbtft/fb_tinylcd.c", i32 85, i32 29}
!18 = !{ptr @dt_ids, !1, !"dt_ids", i1 false, i1 false}
!19 = !{ptr @fbtft_driver_platform_driver, !1, !"fbtft_driver_platform_driver", i1 false, i1 false}
