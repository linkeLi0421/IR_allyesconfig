; ModuleID = '/llk/IR_all_yes/drivers/staging/r8188eu/core/rtw_efuse.c_pt.bc'
source_filename = "../drivers/staging/r8188eu/core/rtw_efuse.c"
...
define dso_local void @ReadEFuseByte(ptr noundef %Adapter, i16 noundef zeroext %_offset, ptr nocapture noundef writeonly %pbuf) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %conv1 = trunc i16 %_offset to i8
  %call = tail call i32 @rtw_write8(ptr noundef %Adapter, i32 noundef 49, i8 noundef zeroext %conv1) #2
  %call2 = tail call zeroext i8 @rtw_read8(ptr noundef %Adapter, i32 noundef 50) #2
  %0 = lshr i16 %_offset, 8
  %1 = trunc i16 %0 to i8
  %and4 = and i8 %1, 3
  %2 = and i8 %call2, -4
  %or = or i8 %2, %and4
  %call8 = tail call i32 @rtw_write8(ptr noundef %Adapter, i32 noundef 50, i8 noundef zeroext %or) #2
  %call9 = tail call zeroext i8 @rtw_read8(ptr noundef %Adapter, i32 noundef 51) #2
  %3 = and i8 %call9, 127
  %call13 = tail call i32 @rtw_write8(ptr noundef %Adapter, i32 noundef 51, i8 noundef zeroext %3) #2
  %call14 = tail call i32 @rtw_read32(ptr noundef %Adapter, i32 noundef 48) #2
  call void @__sanitizer_cov_trace_const_cmp4(i32 -1, i32 %call14)
  %tobool.not35 = icmp sgt i32 %call14, -1
  br i1 %tobool.not35, label %entry.while.body_crit_edge, label %entry.while.end_crit_edge
...
while.body:                                       ; preds = %while.body.while.body_crit_edge, %entry.while.body_crit_edge
  %retry.036 = phi i16 [ %inc, %while.body.while.body_crit_edge ], [ 0, %entry.while.body_crit_edge ]
  %call20 = tail call i32 @rtw_read32(ptr noundef %Adapter, i32 noundef 48) #2
  %inc = add nuw nsw i16 %retry.036, 1
  call void @__sanitizer_cov_trace_const_cmp4(i32 -1, i32 %call20)
  %tobool.not = icmp sgt i32 %call20, -1
  call void @__sanitizer_cov_trace_const_cmp2(i16 9999, i16 %retry.036)
  %cmp = icmp ult i16 %retry.036, 9999
...
while.end:                                        ; preds = %while.body.while.end_crit_edge, %entry.while.end_crit_edge
  ...
  tail call void %4(i32 noundef 10737400) #2
  %call21 = tail call i32 @rtw_read32(ptr noundef %Adapter, i32 noundef 48) #2
  %conv23 = trunc i32 %call21 to i8
  %5 = ptrtoint ptr %pbuf to i32
  call void @__asan_store1_noabort(i32 %5)
  store i8 %conv23, ptr %pbuf, align 1
  ret void
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @EFUSE_ShadowMapUpdate(ptr noundef %pAdapter) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %efuse_eeprom_data = getelementptr inbounds %struct.adapter, ptr %pAdapter, i32 0, i32 15, i32 8
  %2 = call ptr @memset(ptr %efuse_eeprom_data, i32 255, i32 512)
  br label %cleanup

if.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @rtl8188e_EfusePowerSwitch(ptr noundef %pAdapter, i8 noundef zeroext 1) #2
  %efuse_eeprom_data1 = getelementptr inbounds %struct.adapter, ptr %pAdapter, i32 0, i32 15, i32 8
  tail call void @rtl8188e_ReadEFuse(ptr noundef %pAdapter, i16 noundef zeroext 0, i16 noundef zeroext 512, ptr noundef %efuse_eeprom_data1) #2
  tail call void @rtl8188e_EfusePowerSwitch(ptr noundef %pAdapter, i8 noundef zeroext 0) #2
  br label %cleanup
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @rtl8188e_EfusePowerSwitch(ptr noundef, i8 noundef zeroext) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @rtl8188e_ReadEFuse(ptr noundef, i16 noundef zeroext, i16 noundef zeroext, ptr noundef) local_unnamed_addr #1
