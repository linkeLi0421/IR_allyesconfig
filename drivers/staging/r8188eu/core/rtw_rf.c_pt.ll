; ModuleID = '/llk/IR_all_yes/drivers/staging/r8188eu/core/rtw_rf.c_pt.bc'
source_filename = "../drivers/staging/r8188eu/core/rtw_rf.c"
...
@___asan_gen_.2 = private constant [41 x i8] c"../drivers/staging/r8188eu/core/rtw_rf.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 16, i32 23 }
...
!0 = distinct !{null, !1, !"ch_freq_map_num", i1 false, i1 false}
!1 = !{!"../drivers/staging/r8188eu/core/rtw_rf.c", i32 38, i32 12}
!2 = !{ptr @ch_freq_map, !3, !"ch_freq_map", i1 false, i1 false}
!3 = !{!"../drivers/staging/r8188eu/core/rtw_rf.c", i32 16, i32 23}
