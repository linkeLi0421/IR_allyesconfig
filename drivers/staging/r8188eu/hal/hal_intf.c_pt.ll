; ModuleID = '/llk/IR_all_yes/drivers/staging/r8188eu/hal/hal_intf.c_pt.bc'
source_filename = "../drivers/staging/r8188eu/hal/hal_intf.c"
...
@rtw_hal_init._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 24, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"\016R8188EU: rtw_hal_init: hal__init fail\0A\00", [55 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [13 x i8], [19 x i8] } { [13 x i8] c"rtw_hal_init\00", [19 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [39 x i8], [57 x i8] } { [39 x i8] c"drivers/staging/r8188eu/hal/hal_intf.c\00", [57 x i8] zeroinitializer }, align 32
@rtw_hal_init._entry_ptr = internal global ptr @rtw_hal_init._entry, section ".printk_index", align 4
@rtw_hal_deinit._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.3, ptr @.str.4, ptr @.str.2, i32 39, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [44 x i8], [52 x i8] } { [44 x i8] c"\016R8188EU: \0A rtw_hal_deinit: hal_init fail\0A\00", [52 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [15 x i8], [17 x i8] } { [15 x i8] c"rtw_hal_deinit\00", [17 x i8] zeroinitializer }, align 32
@rtw_hal_deinit._entry_ptr = internal global ptr @rtw_hal_deinit._entry, section ".printk_index", align 4
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.24, i32 24, i32 3 }
@___asan_gen_.17 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.23 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.24 = private constant [42 x i8] c"../drivers/staging/r8188eu/hal/hal_intf.c\00", align 1
@___asan_gen_.25 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.24, i32 39, i32 3 }
@llvm.compiler.used = appending global [9 x ptr] [ptr @rtw_hal_deinit._entry, ptr @rtw_hal_deinit._entry_ptr, ptr @rtw_hal_init._entry, ptr @rtw_hal_init._entry_ptr, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str.4], section "llvm.metadata"
@0 = internal global [7 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @rtw_hal_init._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 41, i32 96, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 13, i32 32, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 39, i32 96, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @rtw_hal_deinit._entry to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 44, i32 96, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.4 to i32), i32 15, i32 32, i32 ptrtoint (ptr @___asan_gen_.23 to i32), i32 ptrtoint (ptr @___asan_gen_.24 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.25 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_hal_init(ptr noundef %adapt) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %hw_init_completed = getelementptr inbounds %struct.adapter, ptr %adapt, i32 0, i32 26
  %0 = ptrtoint ptr %hw_init_completed to i32
  call void @__asan_store1_noabort(i32 %0)
  store i8 0, ptr %hw_init_completed, align 1
  %call = tail call i32 @rtl8188eu_hal_init(ptr noundef %adapt) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 1, i32 %call)
  %cmp = icmp eq i32 %call, 1
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %1 = ptrtoint ptr %hw_init_completed to i32
  call void @__asan_store1_noabort(i32 %1)
  store i8 1, ptr %hw_init_completed, align 1
  %notch_filter = getelementptr inbounds %struct.adapter, ptr %adapt, i32 0, i32 13, i32 58
  %2 = ptrtoint ptr %notch_filter to i32
  call void @__asan_load1_noabort(i32 %2)
  %3 = load i8, ptr %notch_filter, align 1
  call void @__sanitizer_cov_trace_const_cmp1(i8 1, i8 %3)
  %cmp2 = icmp eq i8 %3, 1
  br i1 %cmp2, label %if.then4, label %if.then.if.end14_crit_edge
...
if.then4:                                         ; preds = %if.then
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @hal_notch_filter_8188e(ptr noundef %adapt, i1 noundef zeroext true) #3
  br label %if.end14
...
if.else:                                          ; preds = %entry
  ...
  br i1 %cmp6, label %do.end, label %if.else.if.end14_crit_edge
...
if.end14:                                         ; preds = %do.end, %if.else.if.end14_crit_edge, %if.then4, %if.then.if.end14_crit_edge
  ret i32 %call
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @rtl8188eu_hal_init(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @hal_notch_filter_8188e(ptr noundef, i1 noundef zeroext) local_unnamed_addr #1

; Function Attrs: cold null_pointer_is_valid
declare dso_local i32 @_printk(ptr noundef, ...) local_unnamed_addr #2

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_hal_deinit(ptr noundef %adapt) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @rtl8188eu_hal_deinit(ptr noundef %adapt) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 1, i32 %call)
  %cmp = icmp eq i32 %call, 1
...
do.end:                                           ; preds = %do.body
  call void @__sanitizer_cov_trace_pc() #5
  %call4 = tail call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.3) #6
  br label %if.end7
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @rtl8188eu_hal_deinit(ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_hal_update_ra_mask(ptr noundef %adapt, i32 noundef %mac_id, i8 noundef zeroext %rssi_level) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %fw_state.i = getelementptr inbounds %struct.adapter, ptr %adapt, i32 0, i32 4, i32 1
...
if.then:                                          ; preds = %entry
  ...
  %cmp = icmp ugt i32 %mac_id, 1
  br i1 %cmp, label %if.end, label %if.then.if.end6_crit_edge
...
if.end:                                           ; preds = %if.then
  %sub2 = add i32 %mac_id, -2
  %arrayidx = getelementptr %struct.adapter, ptr %adapt, i32 0, i32 11, i32 18, i32 %sub2
...
if.then4:                                         ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @add_RATid(ptr noundef %adapt, ptr noundef nonnull %4, i8 noundef zeroext 0) #3
  br label %if.end6

if.else:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  tail call void @UpdateHalRAMask8188EUsb(ptr noundef %adapt, i32 noundef %mac_id, i8 noundef zeroext %rssi_level) #3
  br label %if.end6

if.end6:                                          ; preds = %if.else, %if.then4, %if.end.if.end6_crit_edge, %if.then.if.end6_crit_edge
  ret void
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @UpdateHalRAMask8188EUsb(ptr noundef, i32 noundef, i8 noundef zeroext) local_unnamed_addr #1
...
!1 = !{!"../drivers/staging/r8188eu/hal/hal_intf.c", i32 24, i32 3}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @rtw_hal_init._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @rtw_hal_init._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/staging/r8188eu/hal/hal_intf.c", i32 39, i32 3}
!8 = !{ptr @.str.4, !7, !"<string literal>", i1 false, i1 false}
!9 = !{ptr @rtw_hal_deinit._entry, !7, !"_entry", i1 false, i1 false}
!10 = !{ptr @rtw_hal_deinit._entry_ptr, !7, !"_entry_ptr", i1 false, i1 false}
