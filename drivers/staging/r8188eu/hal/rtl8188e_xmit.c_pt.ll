; ModuleID = '/llk/IR_all_yes/drivers/staging/r8188eu/hal/rtl8188e_xmit.c_pt.bc'
source_filename = "../drivers/staging/r8188eu/hal/rtl8188e_xmit.c"
...
define dso_local void @handle_txrpt_ccx_88e(ptr noundef %adapter, ptr nocapture noundef readonly %buf) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %buf to i32
  call void @__asan_loadN_noabort(i32 %0, i32 3)
  %bf.load = load i24, ptr %buf, align 1
  %1 = and i24 %bf.load, 65536
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %xmitpriv7 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 9
  %2 = lshr i24 %bf.load, 6
  %3 = and i24 %2, 8
  %4 = xor i24 %3, 8
  %5 = zext i24 %4 to i32
  tail call void @rtw_ack_tx_done(ptr noundef %xmitpriv7, i32 noundef %5) #2
  br label %if.end8
...
declare dso_local void @rtw_ack_tx_done(ptr noundef, i32 noundef) local_unnamed_addr #1
