; ModuleID = '/llk/IR_all_yes/drivers/staging/rtl8723bs/core/rtw_btcoex.c_pt.bc'
source_filename = "../drivers/staging/rtl8723bs/core/rtw_btcoex.c"
...
@.str = internal constant { [7 x i8], [25 x i8] } { [7 x i8] c"BTCOEX\00", [25 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.2 = private constant [47 x i8] c"../drivers/staging/rtl8723bs/core/rtw_btcoex.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 63, i32 52 }
...
define dso_local void @rtw_btcoex_MediaStatusNotify(ptr noundef %padapter, i8 noundef zeroext %mediaStatus) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  call void @__sanitizer_cov_trace_const_cmp1(i8 1, i8 %mediaStatus)
  %cmp = icmp eq i8 %mediaStatus, 1
...
if.then:                                          ; preds = %land.lhs.true
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @rtw_hal_set_hwreg(ptr noundef %padapter, i8 noundef zeroext 89, ptr noundef null) #2
  br label %if.end

if.end:                                           ; preds = %if.then, %land.lhs.true.if.end_crit_edge, %entry.if.end_crit_edge
  tail call void @hal_btcoex_MediaStatusNotify(ptr noundef %padapter, i8 noundef zeroext %mediaStatus) #2
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @rtw_hal_set_hwreg(ptr noundef, i8 noundef zeroext, ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @hal_btcoex_MediaStatusNotify(ptr noundef, i8 noundef zeroext) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_btcoex_HaltNotify(ptr noundef %padapter) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end3:                                          ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @hal_btcoex_HaltNotify(ptr noundef %padapter) #2
  br label %return
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @hal_btcoex_HaltNotify(ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_btcoex_RejectApAggregatedPacket(ptr noundef %padapter, i8 noundef zeroext %enable) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call1 = tail call ptr @rtw_get_stainfo(ptr noundef %stapriv, ptr noundef %mac_address.i) #2
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %enable)
  %tobool.not = icmp eq i8 %enable, 0
  %accept_addba_req5 = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 5, i32 18, i32 31
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %0 = ptrtoint ptr %accept_addba_req5 to i32
  call void @__asan_store1_noabort(i32 %0)
  store i8 0, ptr %accept_addba_req5, align 1
...
if.then3:                                         ; preds = %if.then
  call void @__sanitizer_cov_trace_pc() #4
  %hwaddr = getelementptr inbounds %struct.sta_info, ptr %call1, i32 0, i32 12
  %call4 = tail call i32 @send_delba(ptr noundef %padapter, i8 noundef zeroext 0, ptr noundef %hwaddr) #2
  br label %if.end6

if.else:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  %1 = ptrtoint ptr %accept_addba_req5 to i32
  call void @__asan_store1_noabort(i32 %1)
  store i8 1, ptr %accept_addba_req5, align 1
  br label %if.end6
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @send_delba(ptr noundef, i8 noundef zeroext, ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_btcoex_LPS_Enter(ptr noundef %padapter) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %2 = ptrtoint ptr %bpower_saving to i32
  call void @__asan_store1_noabort(i32 %2)
  store i8 1, ptr %bpower_saving, align 4
  %call = tail call zeroext i8 @hal_btcoex_LpsVal(ptr noundef %padapter) #2
  tail call void @rtw_set_ps_mode(ptr noundef %padapter, i8 noundef zeroext 1, i8 noundef zeroext 0, i8 noundef zeroext %call, ptr noundef nonnull @.str) #2
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local zeroext i8 @hal_btcoex_LpsVal(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @rtw_set_ps_mode(ptr noundef, i8 noundef zeroext, i8 noundef zeroext, i8 noundef zeroext, ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_btcoex_LPS_Leave(ptr noundef %padapter) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %dvobj = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 3
...
if.then:                                          ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #4
  tail call void @rtw_set_ps_mode(ptr noundef %padapter, i8 noundef zeroext 0, i8 noundef zeroext 0, i8 noundef zeroext 0, ptr noundef nonnull @.str) #2
  %call = tail call i32 @LPS_RF_ON_check(ptr noundef %padapter, i32 noundef 100) #2
  %bpower_saving = getelementptr inbounds %struct.dvobj_priv, ptr %1, i32 0, i32 22, i32 14
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @LPS_RF_ON_check(ptr noundef, i32 noundef) local_unnamed_addr #1
...
!1 = !{!"../drivers/staging/rtl8723bs/core/rtw_btcoex.c", i32 63, i32 52}
