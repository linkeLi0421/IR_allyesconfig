; ModuleID = '/llk/IR_all_yes/drivers/staging/rtl8723bs/core/rtw_io.c_pt.bc'
source_filename = "../drivers/staging/rtl8723bs/core/rtw_io.c"
...
define dso_local zeroext i8 @rtw_read8(ptr noundef %adapter, i32 noundef %addr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %io_ops = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2
  %0 = ptrtoint ptr %io_ops to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %io_ops, align 4
  %call = tail call zeroext i8 %1(ptr noundef %intf, i32 noundef %addr) #3
  ret i8 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i16 @rtw_read16(ptr noundef %adapter, i32 noundef %addr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_read161 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 1
  %0 = ptrtoint ptr %_read161 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_read161, align 4
  %call = tail call zeroext i16 %1(ptr noundef %intf, i32 noundef %addr) #3
  ret i16 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_read32(ptr noundef %adapter, i32 noundef %addr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_read321 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 2
  %0 = ptrtoint ptr %_read321 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_read321, align 4
  %call = tail call i32 %1(ptr noundef %intf, i32 noundef %addr) #3
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_write8(ptr noundef %adapter, i32 noundef %addr, i8 noundef zeroext %val) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_write81 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 3
  %0 = ptrtoint ptr %_write81 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_write81, align 4
  %call = tail call i32 %1(ptr noundef %intf, i32 noundef %addr, i8 noundef zeroext %val) #3
  %call2 = tail call i32 @RTW_STATUS_CODE(i32 noundef %call) #3
  ret i32 %call2
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @RTW_STATUS_CODE(i32 noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_write16(ptr noundef %adapter, i32 noundef %addr, i16 noundef zeroext %val) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_write161 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 4
  %0 = ptrtoint ptr %_write161 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_write161, align 4
  %call = tail call i32 %1(ptr noundef %intf, i32 noundef %addr, i16 noundef zeroext %val) #3
  %call2 = tail call i32 @RTW_STATUS_CODE(i32 noundef %call) #3
  ret i32 %call2
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_write32(ptr noundef %adapter, i32 noundef %addr, i32 noundef %val) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_write321 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 5
  %0 = ptrtoint ptr %_write321 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_write321, align 4
  %call = tail call i32 %1(ptr noundef %intf, i32 noundef %addr, i32 noundef %val) #3
  %call2 = tail call i32 @RTW_STATUS_CODE(i32 noundef %call) #3
  ret i32 %call2
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_write_port(ptr noundef %adapter, i32 noundef %addr, i32 noundef %cnt, ptr noundef %pmem) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %intf = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1
  %_write_port1 = getelementptr inbounds %struct.adapter, ptr %adapter, i32 0, i32 8, i32 1, i32 2, i32 15
  %0 = ptrtoint ptr %_write_port1 to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %_write_port1, align 4
  %call = tail call i32 %1(ptr noundef %intf, i32 noundef %addr, i32 noundef %cnt, ptr noundef %pmem) #3
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_init_io_priv(ptr noundef %padapter, ptr noundef readonly %set_intf_ops) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %tobool.not = icmp eq ptr %set_intf_ops, null
...
if.end:                                           ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #5
  %iopriv = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 8
  %intf = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 8, i32 1
  %0 = ptrtoint ptr %iopriv to i32
  call void @__asan_store4_noabort(i32 %0)
  store ptr %padapter, ptr %iopriv, align 4
  %1 = ptrtoint ptr %intf to i32
  call void @__asan_store4_noabort(i32 %1)
  store ptr %padapter, ptr %intf, align 4
  ...
  %pintf_dev = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 8, i32 1, i32 1
  %4 = ptrtoint ptr %pintf_dev to i32
  call void @__asan_store4_noabort(i32 %4)
  store ptr %3, ptr %pintf_dev, align 4
  %io_ops = getelementptr inbounds %struct.adapter, ptr %padapter, i32 0, i32 8, i32 1, i32 2
  tail call void %set_intf_ops(ptr noundef %padapter, ptr noundef %io_ops) #3
  br label %cleanup
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @rtw_inc_and_chk_continual_io_error(ptr noundef %dvobj) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %continual_io_error = getelementptr inbounds %struct.dvobj_priv, ptr %dvobj, i32 0, i32 20
  %call.i.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %continual_io_error, i32 noundef 4) #3
  tail call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #3, !srcloc !9
  tail call void @llvm.prefetch.p0(ptr %continual_io_error, i32 1, i32 3, i32 1) #3
  %0 = tail call { i32, i32 } asm sideeffect "@ atomic_add_return\0A1:\09ldrex\09$0, [$3]\0A\09add\09$0, $0, $4\0A\09strex\09$1, $0, [$3]\0A\09teq\09$1, #0\0A\09bne\091b", "=&r,=&r,=*Qo,r,Ir,*Qo,~{cc}"(ptr elementtype(i32) %continual_io_error, ptr %continual_io_error, i32 1, ptr elementtype(i32) %continual_io_error) #3, !srcloc !10
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @rtw_reset_continual_io_error(ptr noundef %dvobj) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %continual_io_error = getelementptr inbounds %struct.dvobj_priv, ptr %dvobj, i32 0, i32 20
  %call.i.i = tail call zeroext i1 @__kasan_check_write(ptr noundef %continual_io_error, i32 noundef 4) #3
  %0 = ptrtoint ptr %continual_io_error to i32
  call void @__asan_store4_noabort(i32 %0)
  store volatile i32 0, ptr %continual_io_error, align 4
  ret void
}
...
!9 = !{i64 2148417538}
!10 = !{i64 2148332823, i64 2148332855, i64 2148332884, i64 2148332918, i64 2148332949, i64 2148332972}
!11 = !{i64 2148417767}
