; ModuleID = '/llk/IR_all_yes/drivers/video/display_timing.c_pt.bc'
source_filename = "../drivers/video/display_timing.c"
target datalayout = "E-m:e-p:32:32-Fi8-i64:64-v128:64:128-a:0:32-n32-S64"
target triple = "armebv6k-unknown-linux-gnueabi"

module asm ".syntax unified"
module asm "\09.section \22___kcrctab_gpl+display_timings_release\22, \22a\22\09"
module asm "\09.weak\09__crc_display_timings_release\09\09\09\09"
module asm "\09.long\09__crc_display_timings_release\09\09\09\09"
...
define dso_local void @display_timings_release(ptr noundef %disp) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %timings = getelementptr inbounds %struct.display_timings, ptr %disp, i32 0, i32 2
...
if.end:                                           ; preds = %for.end, %entry.if.end_crit_edge
  tail call void @kfree(ptr noundef %disp) #2
  ret void
}
...
!0 = !{ptr @__ksymtab_display_timings_release, !1, !"__ksymtab_display_timings_release", i1 false, i1 false}
!1 = !{!"../drivers/video/display_timing.c", i32 23, i32 1}
