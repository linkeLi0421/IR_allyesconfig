; ModuleID = '/llk/IR_all_yes/drivers/video/fbdev/via/via_aux_vt1621.c_pt.bc'
source_filename = "../drivers/video/fbdev/via/via_aux_vt1621.c"
...
@__const.via_aux_vt1621_probe.drv = private unnamed_addr constant { %struct.list_head, ptr, i8, [3 x i8], ptr, ptr, ptr, ptr } { %struct.list_head { ptr inttoptr (i32 -1 to ptr), ptr inttoptr (i32 -1 to ptr) }, ptr inttoptr (i32 -1 to ptr), i8 -1, [3 x i8] c"\FF\FF\FF", ptr inttoptr (i32 -1 to ptr), ptr inttoptr (i32 -1 to ptr), ptr inttoptr (i32 -1 to ptr), ptr inttoptr (i32 -1 to ptr) }, align 4
@via_aux_vt1621_probe._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str, ptr @.str.1, ptr @.str.2, i32 27, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str = internal constant { [19 x i8], [45 x i8] } { [19 x i8] c"\016viafb: Found %s\0A\00", [45 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [21 x i8], [43 x i8] } { [21 x i8] c"via_aux_vt1621_probe\00", [43 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"drivers/video/fbdev/via/via_aux_vt1621.c\00", [55 x i8] zeroinitializer }, align 32
@via_aux_vt1621_probe._entry_ptr = internal global ptr @via_aux_vt1621_probe._entry, section ".printk_index", align 4
@.str.3 = internal constant { [21 x i8], [43 x i8] } { [21 x i8] c"VT1621(M) TV Encoder\00", [43 x i8] zeroinitializer }, align 32
...
entry:
  ...
  store i8 27, ptr %start.addr.i, align 1
  ...
  br i1 %cmp.i, label %lor.lhs.false, label %entry.cleanup6_crit_edge
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %cmp.not = icmp eq i8 %15, 2
  br i1 %cmp.not, label %do.end, label %lor.lhs.false.cleanup6_crit_edge

lor.lhs.false.cleanup6_crit_edge:                 ; preds = %lor.lhs.false
  call void @__sanitizer_cov_trace_pc() #7
  br label %cleanup6

do.end:                                           ; preds = %lor.lhs.false
  %call4 = call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str, ptr noundef nonnull @.str.3) #8
  ...
  br i1 %tobool.not.i, label %do.end.cleanup6_crit_edge, label %if.end.i

do.end.cleanup6_crit_edge:                        ; preds = %do.end
  call void @__sanitizer_cov_trace_pc() #7
  br label %cleanup6
...
if.end.i:                                         ; preds = %do.end
  ...
  store i8 32, ptr %drv.sroa.7.0.call7.i.i.sroa_idx, align 4
  %drv.sroa.9.0.call7.i.i.sroa_idx = getelementptr inbounds i8, ptr %call7.i.i, i32 13
  %20 = call ptr @memcpy(ptr %drv.sroa.9.0.call7.i.i.sroa_idx, ptr getelementptr inbounds ({ %struct.list_head, ptr, i8, [3 x i8], ptr, ptr, ptr, ptr }, ptr @__const.via_aux_vt1621_probe.drv, i32 0, i32 3, i32 0), i32 3)
  %drv.sroa.912.0.call7.i.i.sroa_idx = getelementptr inbounds i8, ptr %call7.i.i, i32 16
  %21 = ptrtoint ptr %drv.sroa.912.0.call7.i.i.sroa_idx to i32
  call void @__asan_store4_noabort(i32 %21)
  store ptr @.str.3, ptr %drv.sroa.912.0.call7.i.i.sroa_idx, align 8
  ...
  br i1 %call.i.i.i, label %if.end.i.i.i, label %if.end.i.cleanup6_crit_edge
...
cleanup6:                                         ; preds = %if.end.i.i.i, %if.end.i.cleanup6_crit_edge, %do.end.cleanup6_crit_edge, %lor.lhs.false.cleanup6_crit_edge, %entry.cleanup6_crit_edge
...
!1 = !{!"../drivers/video/fbdev/via/via_aux_vt1621.c", i32 27, i32 2}
!2 = !{ptr @.str.1, !1, !"<string literal>", i1 false, i1 false}
!3 = !{ptr @.str.2, !1, !"<string literal>", i1 false, i1 false}
!4 = !{ptr @via_aux_vt1621_probe._entry, !1, !"_entry", i1 false, i1 false}
!5 = !{ptr @via_aux_vt1621_probe._entry_ptr, !1, !"_entry_ptr", i1 false, i1 false}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../drivers/video/fbdev/via/via_aux_vt1621.c", i32 13, i32 27}
!8 = distinct !{null, !9, !"name", i1 false, i1 false}
!9 = !{!"../drivers/video/fbdev/via/via_aux_vt1621.c", i32 13, i32 20}
