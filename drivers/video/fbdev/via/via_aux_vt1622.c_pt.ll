; ModuleID = '/llk/IR_all_yes/drivers/video/fbdev/via/via_aux_vt1622.c_pt.bc'
source_filename = "../drivers/video/fbdev/via/via_aux_vt1622.c"
...
@.str.2 = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"drivers/video/fbdev/via/via_aux_vt1622.c\00", [55 x i8] zeroinitializer }, align 32
@probe._entry_ptr = internal global ptr @probe._entry, section ".printk_index", align 4
@.str.3 = internal constant { [29 x i8], [35 x i8] } { [29 x i8] c"VT1622(M) Digital TV Encoder\00", [35 x i8] zeroinitializer }, align 32
...
@___asan_gen_.17 = private constant [44 x i8] c"../drivers/video/fbdev/via/via_aux_vt1622.c\00", align 1
...
define dso_local void @via_aux_vt1622_probe(ptr noundef %bus) local_unnamed_addr #0 align 64 {
entry:
...
!1 = !{!"../drivers/video/fbdev/via/via_aux_vt1622.c", i32 27, i32 2}
...
!7 = !{!"../drivers/video/fbdev/via/via_aux_vt1622.c", i32 13, i32 27}
!8 = distinct !{null, !9, !"name", i1 false, i1 false}
!9 = !{!"../drivers/video/fbdev/via/via_aux_vt1622.c", i32 13, i32 20}
