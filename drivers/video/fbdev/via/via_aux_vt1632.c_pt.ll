; ModuleID = '/llk/IR_all_yes/drivers/video/fbdev/via/via_aux_vt1632.c_pt.bc'
source_filename = "../drivers/video/fbdev/via/via_aux_vt1632.c"
...
@.str.2 = internal constant { [41 x i8], [55 x i8] } { [41 x i8] c"drivers/video/fbdev/via/via_aux_vt1632.c\00", [55 x i8] zeroinitializer }, align 32
@probe._entry_ptr = internal global ptr @probe._entry, section ".printk_index", align 4
@.str.3 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"VT1632 DVI Transmitter\00", [41 x i8] zeroinitializer }, align 32
...
@___asan_gen_.17 = private constant [44 x i8] c"../drivers/video/fbdev/via/via_aux_vt1632.c\00", align 1
...
define dso_local void @via_aux_vt1632_probe(ptr noundef %bus) local_unnamed_addr #0 align 64 {
entry:
...
for.body:                                         ; preds = %probe.exit.for.body_crit_edge, %entry
  %indvars.iv = phi i32 [ 8, %entry ], [ %indvars.iv.next, %probe.exit.for.body_crit_edge ]
...
lor.lhs.false.i:                                  ; preds = %for.body
  ...
  call void @__sanitizer_cov_trace_const_cmp4(i32 101814833, i32 %rhsv.i)
  %.not.i = icmp eq i32 %rhsv.i, 101814833
...
!1 = !{!"../drivers/video/fbdev/via/via_aux_vt1632.c", i32 29, i32 2}
...
!7 = !{!"../drivers/video/fbdev/via/via_aux_vt1632.c", i32 13, i32 27}
!8 = distinct !{null, !9, !"name", i1 false, i1 false}
!9 = !{!"../drivers/video/fbdev/via/via_aux_vt1632.c", i32 13, i32 20}
