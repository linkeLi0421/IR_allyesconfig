; ModuleID = '/llk/IR_all_yes/fs/autofs/symlink.c_pt.bc'
...
@autofs_symlink_inode_operations = dso_local local_unnamed_addr constant %struct.inode_operations { ptr null, ptr @autofs_get_link, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, [36 x i8] undef }, align 128
@jiffies = external dso_local global i32, section ".data..cacheline_aligned", align 128
@llvm.used = appending global [1 x ptr] [ptr @asan.module_ctor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]

; Function Attrs: mustprogress nofree nounwind null_pointer_is_valid sanitize_address sspstrong willreturn uwtable(sync)
define internal ptr @autofs_get_link(ptr noundef readonly %dentry, ptr nocapture noundef readnone %inode, ptr nocapture noundef readnone %done) #0 align 64 {
entry:
...
land.lhs.true:                                    ; preds = %if.end
  ...
  br i1 %tobool.not.i, label %autofs_oz_mode.exit, label %land.lhs.true.if.end7_crit_edge

land.lhs.true.if.end7_crit_edge:                  ; preds = %land.lhs.true
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.end7

autofs_oz_mode.exit:                              ; preds = %land.lhs.true
  %8 = tail call i32 @llvm.read_register.i32(metadata !2) #2
  ...
  br i1 %cmp.i.not, label %autofs_oz_mode.exit.if.end7_crit_edge, label %if.then6

autofs_oz_mode.exit.if.end7_crit_edge:            ; preds = %autofs_oz_mode.exit
  call void @__sanitizer_cov_trace_pc() #4
  br label %if.end7

if.then6:                                         ; preds = %autofs_oz_mode.exit
  call void @__sanitizer_cov_trace_pc() #4
  call void @__asan_load4_noabort(i32 ptrtoint (ptr @jiffies to i32))
  %18 = load volatile i32, ptr @jiffies, align 128
  %last_used = getelementptr inbounds %struct.autofs_info, ptr %5, i32 0, i32 7
  %19 = ptrtoint ptr %last_used to i32
  call void @__asan_store4_noabort(i32 %19)
  store i32 %18, ptr %last_used, align 4
  br label %if.end7

if.end7:                                          ; preds = %if.then6, %autofs_oz_mode.exit.if.end7_crit_edge, %land.lhs.true.if.end7_crit_edge, %if.end.if.end7_crit_edge
  %d_inode.i = getelementptr inbounds %struct.dentry, ptr %dentry, i32 0, i32 5
  %20 = ptrtoint ptr %d_inode.i to i32
  call void @__asan_load4_noabort(i32 %20)
  %21 = load ptr, ptr %d_inode.i, align 8
  %i_private = getelementptr inbounds %struct.inode, ptr %21, i32 0, i32 54
  %22 = ptrtoint ptr %i_private to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %i_private, align 4
  br label %cleanup

cleanup:                                          ; preds = %if.end7, %entry.cleanup_crit_edge
  %retval.0 = phi ptr [ %23, %if.end7 ], [ inttoptr (i32 -10 to ptr), %entry.cleanup_crit_edge ]
  ret ptr %retval.0
}
...
!0 = !{ptr @autofs_symlink_inode_operations, !1, !"autofs_symlink_inode_operations", i1 false, i1 false}
!1 = !{!"../fs/autofs/symlink.c", i32 24, i32 31}
!2 = !{!"sp"}
