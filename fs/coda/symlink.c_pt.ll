; ModuleID = '/llk/IR_all_yes/fs/coda/symlink.c_pt.bc'
source_filename = "../fs/coda/symlink.c"
...
@___asan_gen_.4 = private unnamed_addr constant [18 x i8] c"coda_symlink_aops\00", align 1
@___asan_gen_.5 = private constant [21 x i8] c"../fs/coda/symlink.c\00", align 1
...
entry:
  ...
  %call2 = call i32 @venus_readlink(ptr noundef %6, ptr noundef %add.ptr.i, ptr noundef %call, ptr noundef nonnull %len) #3
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call2)
  %tobool.not = icmp eq i32 %call2, 0
  br i1 %tobool.not, label %if.end, label %fail

if.end:                                           ; preds = %entry
  call void asm sideeffect "mcr p15, 0, $0, c7, c10, 5", "r,~{memory}"(i32 0) #3, !srcloc !18
...
if.then.i.i.i:                                    ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  call void @dump_page(ptr noundef %page, ptr noundef nonnull @.str) #3
...
SetPageUptodate.exit:                             ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #5
  call void @_set_bit(i32 noundef 2, ptr noundef %page) #3
  br label %cleanup
...
if.then.i:                                        ; preds = %fail
  call void @__sanitizer_cov_trace_pc() #5
  call void @dump_page(ptr noundef %page, ptr noundef nonnull @.str.2) #3
...
_compound_head.exit38.i:                          ; preds = %if.end.i36.i, %if.then.i35.i
  ...
  call void @dump_page(ptr noundef %22, ptr noundef nonnull @.str.3) #3
...
SetPageError.exit:                                ; preds = %if.end.i43.i, %if.then.i42.i
  ...
  call void @_set_bit(i32 noundef 8, ptr noundef %24) #3
  br label %cleanup

cleanup:                                          ; preds = %SetPageError.exit, %SetPageUptodate.exit
  call void @unlock_page(ptr noundef %page) #3
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @venus_readlink(ptr noundef, ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #2
...
!0 = !{ptr @coda_symlink_aops, !1, !"coda_symlink_aops", i1 false, i1 false}
!1 = !{!"../fs/coda/symlink.c", i32 46, i32 39}
...
!20 = !{i64 2150560168, i64 2150560659, i64 2150560205, i64 2150560261, i64 2150560295, i64 2150560319, i64 2150560360, i64 2150560381, i64 2150560409, i64 2150560443}
!21 = !{i64 2150621758, i64 2150621931, i64 2150621946, i64 2150621998, i64 2150622057, i64 2150622081, i64 2150622122, i64 2150622143, i64 2150622171, i64 2150622203}
!22 = !{!"branch_weights", i32 1, i32 2000}
!23 = !{i64 2150622633, i64 2150622806, i64 2150622821, i64 2150622873, i64 2150622932, i64 2150622956, i64 2150622997, i64 2150623018, i64 2150623046, i64 2150623078}
