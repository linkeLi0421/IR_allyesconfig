; ModuleID = '/llk/IR_all_yes/fs/hfs/sysdep.c_pt.bc'
source_filename = "../fs/hfs/sysdep.c"
...
@hfs_dentry_operations = dso_local local_unnamed_addr constant %struct.dentry_operations { ptr @hfs_revalidate_dentry, ptr null, ptr @hfs_hash_dentry, ptr @hfs_compare_dentry, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, [76 x i8] undef }, align 128
...
define internal i32 @hfs_revalidate_dentry(ptr nocapture noundef readonly %dentry, i32 noundef %flags) #0 align 64 {
entry:
...
if.end3:                                          ; preds = %if.end
  ...
  %mul = mul i32 %2, 60
  %tz_secondswest = getelementptr i8, ptr %1, i32 -248
  %3 = ptrtoint ptr %tz_secondswest to i32
  call void @__asan_load4_noabort(i32 %3)
  %4 = load i32, ptr %tz_secondswest, align 8
  call void @__sanitizer_cov_trace_cmp4(i32 %mul, i32 %4)
  %tobool4.not = icmp eq i32 %mul, %4
...
if.then5:                                         ; preds = %if.end3
  ...
  %add = add i64 %6, %conv
  store i64 %add, ptr %i_ctime, align 8
  %i_atime = getelementptr inbounds %struct.inode, ptr %1, i32 0, i32 15
  %7 = ptrtoint ptr %i_atime to i32
  call void @__asan_load8_noabort(i32 %7)
  %8 = load i64, ptr %i_atime, align 8
  %add8 = add i64 %8, %conv
  store i64 %add8, ptr %i_atime, align 8
  ...
  %add11 = add i64 %10, %conv
  store i64 %add11, ptr %i_mtime, align 8
  %11 = ptrtoint ptr %tz_secondswest to i32
...
cleanup:                                          ; preds = %if.then5, %if.end3.cleanup_crit_edge, %if.end.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ -10, %entry.cleanup_crit_edge ], [ 1, %if.end.cleanup_crit_edge ], [ 1, %if.then5 ], [ 1, %if.end3.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @hfs_hash_dentry(ptr noundef, ptr noundef) #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @hfs_compare_dentry(ptr noundef, i32 noundef, ptr noundef, ptr noundef) #1
...
!0 = !{ptr @hfs_dentry_operations, !1, !"hfs_dentry_operations", i1 false, i1 false}
!1 = !{!"../fs/hfs/sysdep.c", i32 39, i32 32}
