; ModuleID = '/llk/IR_all_yes/fs/lockd/procfs.c_pt.bc'
...
@.str = internal constant { [9 x i8], [23 x i8] } { [9 x i8] c"fs/lockd\00", [23 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [14 x i8], [18 x i8] } { [14 x i8] c"nlm_end_grace\00", [18 x i8] zeroinitializer }, align 32
@lockd_end_grace_proc_ops = internal constant { %struct.proc_ops, [52 x i8] } { %struct.proc_ops { i32 0, ptr null, ptr @nlm_end_grace_read, ptr null, ptr @nlm_end_grace_write, ptr @default_llseek, ptr @simple_transaction_release, ptr null, ptr null, ptr null, ptr null }, [52 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"fs/lockd/nlm_end_grace\00", [41 x i8] zeroinitializer }, align 32
...
@__sancov_gen_cov_switch_values = internal global [5 x i64] [i64 3, i64 8, i64 49, i64 89, i64 121]
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.18, i32 75, i32 21 }
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.18, i32 78, i32 22 }
@___asan_gen_.14 = private unnamed_addr constant [25 x i8] c"lockd_end_grace_proc_ops\00", align 1
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.18, i32 63, i32 30 }
@___asan_gen_.18 = private constant [21 x i8] c"../fs/lockd/procfs.c\00", align 1
@___asan_gen_.19 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.18, i32 90, i32 20 }
...
if.end:                                           ; preds = %entry
  %call2 = tail call ptr @proc_create(ptr noundef nonnull @.str.1, i16 noundef zeroext 420, ptr noundef nonnull %call, ptr noundef nonnull @lockd_end_grace_proc_ops) #6
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define dso_local void @lockd_remove_procfs() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  tail call void @remove_proc_entry(ptr noundef nonnull @.str.2, ptr noundef null) #6
  tail call void @remove_proc_entry(ptr noundef nonnull @.str, ptr noundef null) #6
  ret void
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @nlm_end_grace_read(ptr nocapture noundef readnone %file, ptr noundef %buf, i32 noundef %size, ptr noundef %pos) #3 align 64 {
entry:
  ...
  %8 = load i32, ptr @lockd_net_id, align 4
  %call1 = tail call fastcc ptr @net_generic(ptr noundef %7, i32 noundef %8)
  call void @llvm.lifetime.start.p0(i64 3, ptr nonnull %resp) #6
  %9 = getelementptr inbounds [3 x i8], ptr %resp, i32 0, i32 1
  %10 = getelementptr inbounds [3 x i8], ptr %resp, i32 0, i32 2
  %lockd_manager = getelementptr inbounds %struct.lockd_net, ptr %call1, i32 0, i32 4
  %11 = ptrtoint ptr %lockd_manager to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load volatile ptr, ptr %lockd_manager, align 4
  %cmp.i.not = icmp eq ptr %12, %lockd_manager
  %conv = select i1 %cmp.i.not, i8 89, i8 78
  %13 = ptrtoint ptr %resp to i32
  call void @__asan_store1_noabort(i32 %13)
  store i8 %conv, ptr %resp, align 1
  ...
  %call5 = call i32 @simple_read_from_buffer(ptr noundef %buf, i32 noundef %size, ptr noundef %pos, ptr noundef nonnull %resp, i32 noundef 3) #6
  call void @llvm.lifetime.end.p0(i64 3, ptr nonnull %resp) #6
  ret i32 %call5
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @nlm_end_grace_write(ptr noundef %file, ptr noundef %buf, i32 noundef %size, ptr nocapture noundef readnone %pos) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = tail call i32 @llvm.read_register.i32(metadata !19) #6
...
if.end:                                           ; preds = %entry
  %call2 = tail call ptr @simple_transaction_get(ptr noundef %file, ptr noundef %buf, i32 noundef %size) #6
...
if.end6:                                          ; preds = %if.end
  ...
  switch i8 %11, label %if.end6.cleanup_crit_edge [
    i8 89, label %if.end6.sw.bb_crit_edge
    i8 121, label %if.end6.sw.bb_crit_edge12
    i8 49, label %if.end6.sw.bb_crit_edge13
  ]

if.end6.sw.bb_crit_edge13:                        ; preds = %if.end6
  call void @__sanitizer_cov_trace_pc() #8
  br label %sw.bb

if.end6.sw.bb_crit_edge12:                        ; preds = %if.end6
  call void @__sanitizer_cov_trace_pc() #8
  br label %sw.bb
...
sw.bb:                                            ; preds = %if.end6.sw.bb_crit_edge, %if.end6.sw.bb_crit_edge12, %if.end6.sw.bb_crit_edge13
  %lockd_manager = getelementptr inbounds %struct.lockd_net, ptr %call1, i32 0, i32 4
  tail call void @locks_end_grace(ptr noundef %lockd_manager) #6
  br label %cleanup

cleanup:                                          ; preds = %sw.bb, %if.end6.cleanup_crit_edge, %if.then4, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %9, %if.then4 ], [ %size, %sw.bb ], [ -22, %entry.cleanup_crit_edge ], [ -22, %if.end6.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
!llvm.asan.globals = !{!0, !2, !4, !6, !8, !10, !11, !12, !14, !15, !16, !18}
!llvm.named.register.sp = !{!19}
!llvm.module.flags = !{!20, !21, !22, !23, !24, !25, !26, !27}
!llvm.ident = !{!28}

!0 = !{ptr @.str, !1, !"<string literal>", i1 false, i1 false}
!1 = !{!"../fs/lockd/procfs.c", i32 75, i32 21}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../fs/lockd/procfs.c", i32 78, i32 22}
!4 = !{ptr @.str.2, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../fs/lockd/procfs.c", i32 90, i32 20}
!6 = !{ptr @lockd_end_grace_proc_ops, !7, !"lockd_end_grace_proc_ops", i1 false, i1 false}
!7 = !{!"../fs/lockd/procfs.c", i32 63, i32 30}
