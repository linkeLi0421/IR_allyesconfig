; ModuleID = '/llk/IR_all_yes/fs/lockd/xdr.c_pt.bc'
...
define dso_local zeroext i1 @nlmsvc_decode_void(ptr nocapture noundef readnone %rqstp, ptr nocapture noundef readnone %xdr) local_unnamed_addr #0 align 64 {
entry:
...
define dso_local zeroext i1 @nlmsvc_decode_testargs(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %if.end3.i
  ...
  br i1 %tobool.not.i.i47, label %if.end.cleanup_crit_edge, label %if.end.i48, !prof !9
...
if.end.i48:                                       ; preds = %if.end
  ...
  %cmp1.not.i = icmp eq i32 %5, 32
  br i1 %cmp1.not.i, label %if.end3.i51, label %if.end.i48.cleanup_crit_edge
...
if.end3.i51:                                      ; preds = %if.end.i48
  %call4.i49 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 32) #3
  %tobool.not.i50 = icmp eq ptr %call4.i49, null
  br i1 %tobool.not.i50, label %if.end3.i51.cleanup_crit_edge, label %if.end5

if.end3.i51.cleanup_crit_edge:                    ; preds = %if.end3.i51
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end5:                                          ; preds = %if.end3.i51
  %6 = ptrtoint ptr %fh to i32
  call void @__asan_store2_noabort(i32 %6)
  store i16 32, ptr %fh, align 2
  %data.i = getelementptr inbounds %struct.nlm_lock, ptr %lock, i32 0, i32 2, i32 1
  %7 = call ptr @memcpy(ptr %data.i, ptr %call4.i49, i32 32)
  %add.ptr.i = getelementptr %struct.nlm_lock, ptr %lock, i32 0, i32 2, i32 1, i32 32
  %8 = call ptr @memset(ptr %add.ptr.i, i32 0, i32 96)
  %oh = getelementptr inbounds %struct.nlm_lock, ptr %lock, i32 0, i32 3
  %call.i.i54 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i.i55 = icmp eq ptr %call.i.i54, null
  br i1 %tobool.not.i.i55, label %if.end5.cleanup_crit_edge, label %if.end.i57, !prof !9
...
if.end.i57:                                       ; preds = %if.end5
  %9 = ptrtoint ptr %call.i.i54 to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load i32, ptr %call.i.i54, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 1024, i32 %10)
  %cmp1.i56 = icmp ugt i32 %10, 1024
  br i1 %cmp1.i56, label %if.end.i57.cleanup_crit_edge, label %if.end3.i60
...
if.end3.i60:                                      ; preds = %if.end.i57
  %call4.i58 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef %10) #3
  %tobool.not.i59 = icmp eq ptr %call4.i58, null
  br i1 %tobool.not.i59, label %if.end3.i60.cleanup_crit_edge, label %if.end8

if.end3.i60.cleanup_crit_edge:                    ; preds = %if.end3.i60
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end8:                                          ; preds = %if.end3.i60
  %11 = ptrtoint ptr %oh to i32
  call void @__asan_store4_noabort(i32 %11)
  store i32 %10, ptr %oh, align 4
  %data.i61 = getelementptr inbounds %struct.nlm_lock, ptr %lock, i32 0, i32 3, i32 1
  %12 = ptrtoint ptr %data.i61 to i32
  call void @__asan_store4_noabort(i32 %12)
  store ptr %call4.i58, ptr %data.i61, align 4
  %call.i = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i64 = icmp eq ptr %call.i, null
  br i1 %tobool.not.i64, label %if.end8.cleanup_crit_edge, label %if.end11, !prof !9
...
if.end11:                                         ; preds = %if.end8
  ...
  %call.i67 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i68 = icmp eq ptr %call.i67, null
  br i1 %tobool.not.i68, label %if.end11.cleanup_crit_edge, label %if.end15, !prof !9
...
if.end15:                                         ; preds = %if.end11
  %16 = ptrtoint ptr %call.i67 to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load i32, ptr %call.i67, align 4
  %call.i72 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
...
if.end19:                                         ; preds = %if.end15
  ...
  %19 = load i32, ptr %call.i72, align 4
  ...
  store i64 %conv.i, ptr %fl_start, align 8
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %19)
  %cmp21 = icmp eq i32 %19, 0
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %sub)
  %cmp22 = icmp slt i32 %sub, 0
  %or.cond = select i1 %cmp21, i1 true, i1 %cmp22
  %conv.i7790 = zext i32 %sub to i64
  %.sink = select i1 %or.cond, i64 9223372036854775807, i64 %conv.i7790
  %fl_end = getelementptr inbounds %struct.nlm_lock, ptr %lock, i32 0, i32 5, i32 13
  %23 = ptrtoint ptr %fl_end to i32
  call void @__asan_store8_noabort(i32 %23)
  store i64 %.sink, ptr %fl_end, align 8
  br label %cleanup

cleanup:                                          ; preds = %if.end19, %if.end15.cleanup_crit_edge, %if.end11.cleanup_crit_edge, %if.end8.cleanup_crit_edge, %if.end3.i60.cleanup_crit_edge, %if.end.i57.cleanup_crit_edge, %if.end5.cleanup_crit_edge, %if.end3.i51.cleanup_crit_edge, %if.end.i48.cleanup_crit_edge, %if.end.cleanup_crit_edge, %if.end3.i.cleanup_crit_edge, %if.end.i.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i1 [ false, %if.end.i.cleanup_crit_edge ], [ false, %if.end3.i.cleanup_crit_edge ], [ false, %entry.cleanup_crit_edge ], [ false, %if.end.i48.cleanup_crit_edge ], [ false, %if.end3.i51.cleanup_crit_edge ], [ false, %if.end.cleanup_crit_edge ], [ false, %if.end.i57.cleanup_crit_edge ], [ false, %if.end3.i60.cleanup_crit_edge ], [ false, %if.end5.cleanup_crit_edge ], [ false, %if.end8.cleanup_crit_edge ], [ false, %if.end11.cleanup_crit_edge ], [ false, %if.end15.cleanup_crit_edge ], [ true, %if.end19 ]
  ret i1 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_lockargs(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_cancargs(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_unlockargs(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_res(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_reboot(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_shareargs(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
if.end4:                                          ; preds = %if.end3.i38
  ...
  br i1 %tobool.not.i.i41, label %if.end4.cleanup_crit_edge, label %if.end.i42, !prof !9

if.end4.cleanup_crit_edge:                        ; preds = %if.end4
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end.i42:                                       ; preds = %if.end4
  ...
  %cmp1.not.i = icmp eq i32 %15, 32
  br i1 %cmp1.not.i, label %if.end3.i45, label %if.end.i42.cleanup_crit_edge

if.end.i42.cleanup_crit_edge:                     ; preds = %if.end.i42
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end3.i45:                                      ; preds = %if.end.i42
  %call4.i43 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 32) #3
  %tobool.not.i44 = icmp eq ptr %call4.i43, null
  br i1 %tobool.not.i44, label %if.end3.i45.cleanup_crit_edge, label %if.end7

if.end3.i45.cleanup_crit_edge:                    ; preds = %if.end3.i45
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end7:                                          ; preds = %if.end3.i45
  %16 = ptrtoint ptr %fh to i32
  call void @__asan_store2_noabort(i32 %16)
  store i16 32, ptr %fh, align 2
  %data.i = getelementptr inbounds %struct.nlm_args, ptr %1, i32 0, i32 1, i32 2, i32 1
  %17 = call ptr @memcpy(ptr %data.i, ptr %call4.i43, i32 32)
  %add.ptr.i = getelementptr %struct.nlm_args, ptr %1, i32 0, i32 1, i32 2, i32 1, i32 32
  %18 = call ptr @memset(ptr %add.ptr.i, i32 0, i32 96)
  %oh = getelementptr inbounds %struct.nlm_args, ptr %1, i32 0, i32 1, i32 3
  %call.i.i48 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i.i49 = icmp eq ptr %call.i.i48, null
  br i1 %tobool.not.i.i49, label %if.end7.cleanup_crit_edge, label %if.end.i51, !prof !9
...
if.end.i51:                                       ; preds = %if.end7
  %19 = ptrtoint ptr %call.i.i48 to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load i32, ptr %call.i.i48, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 1024, i32 %20)
  %cmp1.i50 = icmp ugt i32 %20, 1024
  br i1 %cmp1.i50, label %if.end.i51.cleanup_crit_edge, label %if.end3.i54
...
if.end3.i54:                                      ; preds = %if.end.i51
  %call4.i52 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef %20) #3
  %tobool.not.i53 = icmp eq ptr %call4.i52, null
  br i1 %tobool.not.i53, label %if.end3.i54.cleanup_crit_edge, label %if.end10

if.end3.i54.cleanup_crit_edge:                    ; preds = %if.end3.i54
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end10:                                         ; preds = %if.end3.i54
  %21 = ptrtoint ptr %oh to i32
  call void @__asan_store4_noabort(i32 %21)
  store i32 %20, ptr %oh, align 4
  %data.i55 = getelementptr inbounds %struct.nlm_args, ptr %1, i32 0, i32 1, i32 3, i32 1
  %22 = ptrtoint ptr %data.i55 to i32
  call void @__asan_store4_noabort(i32 %22)
  store ptr %call4.i52, ptr %data.i55, align 4
  %call.i = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i58 = icmp eq ptr %call.i, null
  br i1 %tobool.not.i58, label %if.end10.cleanup_crit_edge, label %if.end13, !prof !9
...
if.end13:                                         ; preds = %if.end10
  ...
  %call.i61 = tail call ptr @xdr_inline_decode(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i62 = icmp eq ptr %call.i61, null
  br i1 %tobool.not.i62, label %if.end13.cleanup_crit_edge, label %xdr_stream_decode_u32.exit65, !prof !9

if.end13.cleanup_crit_edge:                       ; preds = %if.end13
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

xdr_stream_decode_u32.exit65:                     ; preds = %if.end13
  call void @__sanitizer_cov_trace_pc() #5
  %fsm_access = getelementptr inbounds %struct.nlm_args, ptr %1, i32 0, i32 6
  %26 = ptrtoint ptr %call.i61 to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load i32, ptr %call.i61, align 4
  %28 = ptrtoint ptr %fsm_access to i32
  call void @__asan_store4_noabort(i32 %28)
  store i32 %27, ptr %fsm_access, align 4
  br label %cleanup

cleanup:                                          ; preds = %xdr_stream_decode_u32.exit65, %if.end13.cleanup_crit_edge, %if.end10.cleanup_crit_edge, %if.end3.i54.cleanup_crit_edge, %if.end.i51.cleanup_crit_edge, %if.end7.cleanup_crit_edge, %if.end3.i45.cleanup_crit_edge, %if.end.i42.cleanup_crit_edge, %if.end4.cleanup_crit_edge, %if.end3.i38.cleanup_crit_edge, %if.end.i36.cleanup_crit_edge, %if.end.cleanup_crit_edge, %if.end5.i.cleanup_crit_edge, %if.end.i.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i1 [ true, %xdr_stream_decode_u32.exit65 ], [ false, %if.end13.cleanup_crit_edge ], [ false, %if.end.i.cleanup_crit_edge ], [ false, %if.end5.i.cleanup_crit_edge ], [ false, %entry.cleanup_crit_edge ], [ false, %if.end.i36.cleanup_crit_edge ], [ false, %if.end3.i38.cleanup_crit_edge ], [ false, %if.end.cleanup_crit_edge ], [ false, %if.end.i42.cleanup_crit_edge ], [ false, %if.end3.i45.cleanup_crit_edge ], [ false, %if.end4.cleanup_crit_edge ], [ false, %if.end.i51.cleanup_crit_edge ], [ false, %if.end3.i54.cleanup_crit_edge ], [ false, %if.end7.cleanup_crit_edge ], [ false, %if.end10.cleanup_crit_edge ]
  ret i1 %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_decode_notify(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_argp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 35
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind null_pointer_is_valid readnone sanitize_address sspstrong willreturn uwtable(sync)
define dso_local zeroext i1 @nlmsvc_encode_void(ptr nocapture noundef readnone %rqstp, ptr nocapture noundef readnone %xdr) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ret i1 true
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_encode_testres(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end12.i.i:                                     ; preds = %svcxdr_encode_owner.exit.i.i
  ...
  call void @__sanitizer_cov_trace_const_cmp8(i64 2147483646, i64 %27)
  %cmp.i49.i.i = icmp sgt i64 %27, 2147483646
  call void @__sanitizer_cov_trace_const_cmp8(i64 -2147483646, i64 %27)
  %cmp1.i.i.i = icmp slt i64 %27, -2147483646
  %conv.i.i.i = trunc i64 %27 to i32
  %spec.select.i.i.i = select i1 %cmp1.i.i.i, i32 -2147483647, i32 %conv.i.i.i
  %res.0.i.i.i = select i1 %cmp.i49.i.i, i32 2147483647, i32 %spec.select.i.i.i
...
if.else.i.i:                                      ; preds = %if.end12.i.i
  ...
  call void @__sanitizer_cov_trace_const_cmp8(i64 2147483646, i64 %add.i.i)
  %cmp.i50.i.i = icmp sgt i64 %add.i.i, 2147483646
  call void @__sanitizer_cov_trace_const_cmp8(i64 -2147483646, i64 %add.i.i)
  %cmp1.i51.i.i = icmp slt i64 %add.i.i, -2147483646
  %conv.i52.i.i = trunc i64 %add.i.i to i32
  %spec.select.i53.i.i = select i1 %cmp1.i51.i.i, i32 -2147483647, i32 %conv.i52.i.i
  %res.0.i54.i.i = select i1 %cmp.i50.i.i, i32 2147483647, i32 %spec.select.i53.i.i
  br label %if.end20.i.i

if.end20.i.i:                                     ; preds = %if.else.i.i, %if.end12.i.i.if.end20.i.i_crit_edge
  %len.0.i.i = phi i32 [ %res.0.i54.i.i, %if.else.i.i ], [ 0, %if.end12.i.i.if.end20.i.i_crit_edge ]
  %call.i55.i.i = tail call ptr @xdr_reserve_space(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i56.i.i = icmp eq ptr %call.i55.i.i, null
  br i1 %tobool.not.i56.i.i, label %if.end20.i.i.land.end_crit_edge, label %if.end25.i.i, !prof !9
...
if.end25.i.i:                                     ; preds = %if.end20.i.i
  %30 = ptrtoint ptr %call.i55.i.i to i32
  call void @__asan_store4_noabort(i32 %30)
  store i32 %res.0.i.i.i, ptr %call.i55.i.i, align 4
  %call.i60.i.i = tail call ptr @xdr_reserve_space(ptr noundef %xdr, i32 noundef 4) #3
  %tobool.not.i61.i.i = icmp eq ptr %call.i60.i.i, null
  br i1 %tobool.not.i61.i.i, label %if.end25.i.i.land.end_crit_edge, label %svcxdr_encode_holder.exit.i, !prof !9
...
svcxdr_encode_holder.exit.i:                      ; preds = %if.end25.i.i
  call void @__sanitizer_cov_trace_pc() #5
  %31 = ptrtoint ptr %call.i60.i.i to i32
  call void @__asan_store4_noabort(i32 %31)
  store i32 %len.0.i.i, ptr %call.i60.i.i, align 4
  br label %land.end
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_encode_res(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_resp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 36
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local zeroext i1 @nlmsvc_encode_shareres(ptr nocapture noundef readonly %rqstp, ptr noundef %xdr) local_unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  %rq_resp = getelementptr inbounds %struct.svc_rqst, ptr %rqstp, i32 0, i32 36
