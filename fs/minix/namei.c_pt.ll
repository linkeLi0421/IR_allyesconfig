; ModuleID = '/llk/IR_all_yes/fs/minix/namei.c_pt.bc'
source_filename = "../fs/minix/namei.c"
...
@minix_dir_inode_operations = dso_local local_unnamed_addr constant %struct.inode_operations { ptr @minix_lookup, ptr null, ptr null, ptr null, ptr null, ptr @minix_create, ptr @minix_link, ptr @minix_unlink, ptr @minix_symlink, ptr @minix_mkdir, ptr @minix_rmdir, ptr @minix_mknod, ptr @minix_rename, ptr null, ptr @minix_getattr, ptr null, ptr null, ptr null, ptr null, ptr @minix_tmpfile, ptr null, ptr null, ptr null, [36 x i8] undef }, align 128
...
@___asan_gen_ = private constant [20 x i8] c"../fs/minix/namei.c\00", align 1
...
define internal ptr @minix_lookup(ptr nocapture noundef readonly %dir, ptr noundef %dentry, i32 noundef %flags) #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  %call2 = tail call i32 @minix_inode_by_name(ptr noundef %dentry) #5
...
if.then3:                                         ; preds = %if.end
  ...
  %call5 = tail call ptr @minix_iget(ptr noundef %9, i32 noundef %call2) #5
  br label %if.end6

if.end6:                                          ; preds = %if.then3, %if.end.if.end6_crit_edge
  %inode.0 = phi ptr [ %call5, %if.then3 ], [ null, %if.end.if.end6_crit_edge ]
  %call7 = tail call ptr @d_splice_alias(ptr noundef %inode.0, ptr noundef %dentry) #5
  br label %cleanup

cleanup:                                          ; preds = %if.end6, %entry.cleanup_crit_edge
  %retval.0 = phi ptr [ %call7, %if.end6 ], [ inttoptr (i32 -36 to ptr), %entry.cleanup_crit_edge ]
  ret ptr %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_create(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dir, ptr noundef %dentry, i16 noundef zeroext %mode, i1 noundef zeroext %excl) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @minix_mknod(ptr noundef %mnt_userns, ptr noundef %dir, ptr noundef %dentry, i16 noundef zeroext %mode, i32 noundef 0)
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_link(ptr nocapture noundef readonly %old_dentry, ptr nocapture noundef readnone %dir, ptr noundef %dentry) #0 align 64 {
entry:
  ...
  %call.i = call i32 @minix_add_link(ptr noundef %dentry, ptr noundef %1) #5
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_unlink(ptr nocapture noundef readonly %dir, ptr noundef %dentry) #0 align 64 {
entry:
  ...
  %call1 = call ptr @minix_find_entry(ptr noundef %dentry, ptr noundef nonnull %page) #5
  %tobool.not = icmp eq ptr %call1, null
  br i1 %tobool.not, label %entry.end_unlink_crit_edge, label %if.end

entry.end_unlink_crit_edge:                       ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #7
  br label %end_unlink
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 @minix_delete_entry(ptr noundef nonnull %call1, ptr noundef %4) #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call2)
  %tobool3.not = icmp eq i32 %call2, 0
  br i1 %tobool3.not, label %if.end5, label %if.end.end_unlink_crit_edge

if.end.end_unlink_crit_edge:                      ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #7
  br label %end_unlink
...
end_unlink:                                       ; preds = %if.end5, %if.end.end_unlink_crit_edge, %entry.end_unlink_crit_edge
  %err.0 = phi i32 [ %call2, %if.end.end_unlink_crit_edge ], [ 0, %if.end5 ], [ -2, %entry.end_unlink_crit_edge ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %page) #5
  ret i32 %err.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_symlink(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dir, ptr noundef %dentry, ptr noundef %symname) #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  %call1 = call ptr @minix_new_inode(ptr noundef %dir, i16 noundef zeroext -24065, ptr noundef nonnull %err) #5
  %tobool.not = icmp eq ptr %call1, null
...
if.end3:                                          ; preds = %if.end
  call void @minix_set_inode(ptr noundef nonnull %call1, i32 noundef 0) #5
  %call4 = call i32 @page_symlink(ptr noundef nonnull %call1, ptr noundef %symname, i32 noundef %add) #5
  %5 = ptrtoint ptr %err to i32
  call void @__asan_store4_noabort(i32 %5)
  store i32 %call4, ptr %err, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call4)
  %tobool5.not = icmp eq i32 %call4, 0
  br i1 %tobool5.not, label %if.end7, label %out_fail

if.end7:                                          ; preds = %if.end3
  %call.i = call i32 @minix_add_link(ptr noundef %dentry, ptr noundef nonnull %call1) #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i)
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %if.then.i, label %if.end.i
...
if.then.i:                                        ; preds = %if.end7
  call void @__sanitizer_cov_trace_pc() #7
  call void @d_instantiate(ptr noundef %dentry, ptr noundef nonnull %call1) #5
  br label %add_nondir.exit

if.end.i:                                         ; preds = %if.end7
  call void @__sanitizer_cov_trace_pc() #7
  call void @drop_nlink(ptr noundef nonnull %call1) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call1, i32 noundef 7) #5
  call void @iput(ptr noundef nonnull %call1) #5
  br label %add_nondir.exit
...
out:                                              ; preds = %out_fail, %add_nondir.exit, %if.end.out_crit_edge, %entry.out_crit_edge
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_mkdir(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dir, ptr noundef %dentry, i16 noundef zeroext %mode) #0 align 64 {
entry:
  %err = alloca i32, align 4
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %1 = or i16 %mode, 16384
  %call = call ptr @minix_new_inode(ptr noundef %dir, i16 noundef zeroext %1, ptr noundef nonnull %err) #5
  %tobool.not = icmp eq ptr %call, null
  br i1 %tobool.not, label %entry.out_dir_crit_edge, label %if.end
...
if.end:                                           ; preds = %entry
  call void @minix_set_inode(ptr noundef nonnull %call, i32 noundef 0) #5
  call void @inc_nlink(ptr noundef nonnull %call) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call, i32 noundef 7) #5
  %call2 = call i32 @minix_make_empty(ptr noundef nonnull %call, ptr noundef %dir) #5
  %2 = ptrtoint ptr %err to i32
  call void @__asan_store4_noabort(i32 %2)
  store i32 %call2, ptr %err, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call2)
  %tobool3.not = icmp eq i32 %call2, 0
  br i1 %tobool3.not, label %if.end5, label %if.end.out_fail_crit_edge
...
if.end5:                                          ; preds = %if.end
  %call6 = call i32 @minix_add_link(ptr noundef %dentry, ptr noundef nonnull %call) #5
  %3 = ptrtoint ptr %err to i32
  call void @__asan_store4_noabort(i32 %3)
  store i32 %call6, ptr %err, align 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call6)
  %tobool7.not = icmp eq i32 %call6, 0
  br i1 %tobool7.not, label %if.end9, label %if.end5.out_fail_crit_edge

if.end5.out_fail_crit_edge:                       ; preds = %if.end5
  call void @__sanitizer_cov_trace_pc() #7
  br label %out_fail

if.end9:                                          ; preds = %if.end5
  call void @__sanitizer_cov_trace_pc() #7
  call void @d_instantiate(ptr noundef %dentry, ptr noundef nonnull %call) #5
  br label %out

out:                                              ; preds = %out_dir, %if.end9
...
out_fail:                                         ; preds = %if.end5.out_fail_crit_edge, %if.end.out_fail_crit_edge
  call void @drop_nlink(ptr noundef nonnull %call) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call, i32 noundef 7) #5
  call void @drop_nlink(ptr noundef nonnull %call) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call, i32 noundef 7) #5
  call void @iput(ptr noundef nonnull %call) #5
  br label %out_dir
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_rmdir(ptr noundef %dir, ptr noundef %dentry) #0 align 64 {
entry:
  ...
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %d_inode.i, align 8
  %call1 = tail call i32 @minix_empty_dir(ptr noundef %1) #5
...
if.then:                                          ; preds = %entry
  ...
  %call1.i = call ptr @minix_find_entry(ptr noundef %dentry, ptr noundef nonnull %page.i) #5
  %tobool.not.i = icmp eq ptr %call1.i, null
  br i1 %tobool.not.i, label %if.then.minix_unlink.exit.thread_crit_edge, label %if.end.i

if.then.minix_unlink.exit.thread_crit_edge:       ; preds = %if.then
  call void @__sanitizer_cov_trace_pc() #7
  br label %minix_unlink.exit.thread

if.end.i:                                         ; preds = %if.then
  %5 = ptrtoint ptr %page.i to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %page.i, align 4
  %call2.i = call i32 @minix_delete_entry(ptr noundef nonnull %call1.i, ptr noundef %6) #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call2.i)
  %tobool3.not.i = icmp eq i32 %call2.i, 0
  br i1 %tobool3.not.i, label %if.then4, label %if.end.i.minix_unlink.exit.thread_crit_edge

if.end.i.minix_unlink.exit.thread_crit_edge:      ; preds = %if.end.i
  call void @__sanitizer_cov_trace_pc() #7
  br label %minix_unlink.exit.thread

minix_unlink.exit.thread:                         ; preds = %if.end.i.minix_unlink.exit.thread_crit_edge, %if.then.minix_unlink.exit.thread_crit_edge
  %err.0.i.ph = phi i32 [ -2, %if.then.minix_unlink.exit.thread_crit_edge ], [ %call2.i, %if.end.i.minix_unlink.exit.thread_crit_edge ]
...
if.end5:                                          ; preds = %if.then4, %minix_unlink.exit.thread, %entry.if.end5_crit_edge
  %err.0 = phi i32 [ 0, %if.then4 ], [ -39, %entry.if.end5_crit_edge ], [ %err.0.i.ph, %minix_unlink.exit.thread ]
  ret i32 %err.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_mknod(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dir, ptr noundef %dentry, i16 noundef zeroext %mode, i32 noundef %rdev) #0 align 64 {
entry:
  ...
  call void @__asan_store4_noabort(i32 %0)
  store i32 -1, ptr %error, align 4, !annotation !15
  %1 = and i32 %rdev, -267387136
...
if.end:                                           ; preds = %entry
  %call1 = call ptr @minix_new_inode(ptr noundef %dir, i16 noundef zeroext %mode, ptr noundef nonnull %error) #5
  %tobool.not = icmp eq ptr %call1, null
...
if.then2:                                         ; preds = %if.end
  call void @minix_set_inode(ptr noundef nonnull %call1, i32 noundef %rdev) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call1, i32 noundef 7) #5
  %call.i = call i32 @minix_add_link(ptr noundef %dentry, ptr noundef nonnull %call1) #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i)
  %tobool.not.i = icmp eq i32 %call.i, 0
...
if.end4:                                          ; preds = %add_nondir.exit, %if.end.if.end4_crit_edge
...
cleanup:                                          ; preds = %if.end4, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %5, %if.end4 ], [ -22, %entry.cleanup_crit_edge ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %error) #5
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_rename(ptr nocapture noundef readnone %mnt_userns, ptr noundef %old_dir, ptr noundef %old_dentry, ptr noundef %new_dir, ptr noundef %new_dentry, i32 noundef %flags) #0 align 64 {
entry:
...
if.end:                                           ; preds = %entry
  %call2 = call ptr @minix_find_entry(ptr noundef %old_dentry, ptr noundef nonnull %old_page) #5
...
if.then8:                                         ; preds = %if.end5
  %call9 = call ptr @minix_dotdot(ptr noundef %1, ptr noundef nonnull %dir_page) #5
...
land.lhs.true:                                    ; preds = %if.end13
  ...
  %call17 = call i32 @minix_empty_dir(ptr noundef nonnull %3) #5
...
if.end20:                                         ; preds = %land.lhs.true
  %call21 = call ptr @minix_find_entry(ptr noundef %new_dentry, ptr noundef nonnull %new_page) #5
...
if.end20.thread:                                  ; preds = %if.end13.thread
  ...
  store ptr inttoptr (i32 -1 to ptr), ptr %new_page, align 4, !annotation !15
  %call21134 = call ptr @minix_find_entry(ptr noundef %new_dentry, ptr noundef nonnull %new_page) #5
...
if.end24:                                         ; preds = %if.end20.thread.if.end24_crit_edge, %if.end20.if.end24_crit_edge
  ...
  call void @minix_set_link(ptr noundef nonnull %call21138, ptr noundef %12, ptr noundef %1) #5
...
if.else:                                          ; preds = %if.end13
  %call29 = call i32 @minix_add_link(ptr noundef %new_dentry, ptr noundef %1) #5
...
if.else.thread:                                   ; preds = %if.end13.thread
  %call29116 = call i32 @minix_add_link(ptr noundef %new_dentry, ptr noundef %1) #5
...
if.end36:                                         ; preds = %if.then34, %if.else.thread.if.end36_crit_edge, %cleanup
  ...
  %call37 = call i32 @minix_delete_entry(ptr noundef nonnull %call2, ptr noundef %15) #5
  call void @__mark_inode_dirty(ptr noundef %1, i32 noundef 7) #5
...
if.then39:                                        ; preds = %if.end36
  ...
  call void @minix_set_link(ptr noundef nonnull %dir_de.0105, ptr noundef %17, ptr noundef %new_dir) #5
...
do.end5.i.i.i.i:                                  ; preds = %_compound_head.exit.i
  ...
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_page_ref_mod_and_test, i32 0, i32 1), ptr blockaddress(@minix_rename, %if.then.i.i.i.i.i)) #5
...
do.end5.i.i.i.i94:                                ; preds = %_compound_head.exit.i89
  ...
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_page_ref_mod_and_test, i32 0, i32 1), ptr blockaddress(@minix_rename, %if.then.i.i.i.i.i96)) #5
...
declare dso_local i32 @minix_getattr(ptr noundef, ptr noundef, ptr noundef, i32 noundef, i32 noundef) #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @minix_tmpfile(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dir, ptr noundef %dentry, i16 noundef zeroext %mode) #0 align 64 {
entry:
  %error = alloca i32, align 4
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  call void @__asan_store4_noabort(i32 %0)
  store i32 -1, ptr %error, align 4, !annotation !15
  %call = call ptr @minix_new_inode(ptr noundef %dir, i16 noundef zeroext %mode, ptr noundef nonnull %error) #5
  %tobool.not = icmp eq ptr %call, null
...
if.then:                                          ; preds = %entry
  ...
  call void @minix_set_inode(ptr noundef nonnull %call, i32 noundef 0) #5
  call void @__mark_inode_dirty(ptr noundef nonnull %call, i32 noundef 7) #5
  call void @d_tmpfile(ptr noundef %dentry, ptr noundef nonnull %call) #5
  br label %if.end
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @minix_inode_by_name(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local ptr @minix_iget(ptr noundef, i32 noundef) local_unnamed_addr #1
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @minix_add_link(ptr noundef, ptr noundef) local_unnamed_addr #1
...
; Function Attrs: null_pointer_is_valid
declare dso_local ptr @minix_find_entry(ptr noundef, ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @minix_delete_entry(ptr noundef, ptr noundef) local_unnamed_addr #1

; Function Attrs: argmemonly mustprogress nofree nounwind null_pointer_is_valid readonly willreturn
declare dso_local i32 @strlen(ptr nocapture noundef) local_unnamed_addr #3

; Function Attrs: null_pointer_is_valid
declare dso_local ptr @minix_new_inode(ptr noundef, i16 noundef zeroext, ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @minix_set_inode(ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @page_symlink(ptr noundef, ptr noundef, i32 noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @minix_make_empty(ptr noundef, ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @minix_empty_dir(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local ptr @minix_dotdot(ptr noundef, ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @minix_set_link(ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #1
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @d_tmpfile(ptr noundef, ptr noundef) local_unnamed_addr #1
...
!0 = !{ptr @minix_dir_inode_operations, !1, !"minix_dir_inode_operations", i1 false, i1 false}
!1 = !{!"../fs/minix/namei.c", i32 263, i32 31}
...
!18 = !{i64 2153159235, i64 2153159718, i64 2153159272, i64 2153159328, i64 2153159362, i64 2153159386, i64 2153159427, i64 2153159448, i64 2153159476, i64 2153159510}
!19 = !{i64 2148749895}
!20 = !{i64 2148664604, i64 2148664636, i64 2148664665, i64 2148664699, i64 2148664730, i64 2148664753}
!21 = !{i64 2148750124}
!22 = !{i64 2148486017, i64 2148486022, i64 2148486035, i64 2148486079, i64 2148486113, i64 2148486134}
