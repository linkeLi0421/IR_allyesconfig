; ModuleID = '/llk/IR_all_yes/fs/nls/nls_iso8859-1.c_pt.bc'
...
@__initcall__kmod_nls_iso8859_1__106_254_init_nls_iso8859_16 = internal global ptr @init_nls_iso8859_1, section ".initcall6.init", align 4
@__exitcall_exit_nls_iso8859_1 = internal global ptr @exit_nls_iso8859_1, section ".exitcall.exit", align 4
@__UNIQUE_ID_file107 = internal constant [40 x i8] c"nls_iso8859_1.file=fs/nls/nls_iso8859-1\00", section ".modinfo", align 1
@__UNIQUE_ID_license108 = internal constant [35 x i8] c"nls_iso8859_1.license=Dual BSD/GPL\00", section ".modinfo", align 1
@.str = internal constant { [10 x i8], [22 x i8] } { [10 x i8] c"iso8859-1\00", [22 x i8] zeroinitializer }, align 32
...
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 236, i32 25 }
@___asan_gen_.5 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 237, i32 13 }
@___asan_gen_.8 = private unnamed_addr constant [14 x i8] c"charset2lower\00", align 1
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 139, i32 28 }
@___asan_gen_.11 = private unnamed_addr constant [14 x i8] c"charset2upper\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 175, i32 28 }
@___asan_gen_.14 = private unnamed_addr constant [7 x i8] c"page00\00", align 1
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 99, i32 28 }
@___asan_gen_.17 = private unnamed_addr constant [17 x i8] c"page_uni2charset\00", align 1
@___asan_gen_.19 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 135, i32 35 }
@___asan_gen_.20 = private unnamed_addr constant [12 x i8] c"charset2uni\00", align 1
@___asan_gen_.21 = private constant [26 x i8] c"../fs/nls/nls_iso8859-1.c\00", align 1
@___asan_gen_.22 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.21, i32 16, i32 22 }
@llvm.compiler.used = appending global [12 x ptr] [ptr @__UNIQUE_ID_file107, ptr @__UNIQUE_ID_license108, ptr @__exitcall_exit_nls_iso8859_1, ptr @__initcall__kmod_nls_iso8859_1__106_254_init_nls_iso8859_16, ptr @exit_nls_iso8859_1, ptr @table, ptr @.str, ptr @charset2lower, ptr @charset2upper, ptr @page00, ptr @page_uni2charset, ptr @charset2uni], section "llvm.metadata"
@0 = internal global [7 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @table to i32), i32 32, i32 64, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 10, i32 32, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @charset2lower to i32), i32 256, i32 320, i32 ptrtoint (ptr @___asan_gen_.8 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @charset2upper to i32), i32 256, i32 320, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @page00 to i32), i32 256, i32 320, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @page_uni2charset to i32), i32 1024, i32 1280, i32 ptrtoint (ptr @___asan_gen_.17 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.19 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @charset2uni to i32), i32 512, i32 640, i32 ptrtoint (ptr @___asan_gen_.20 to i32), i32 ptrtoint (ptr @___asan_gen_.21 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.22 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal void @exit_nls_iso8859_1() #0 section ".exit.text" align 64 {
entry:
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @init_nls_iso8859_1() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
...
!0 = !{ptr @__initcall__kmod_nls_iso8859_1__106_254_init_nls_iso8859_16, !1, !"__initcall__kmod_nls_iso8859_1__106_254_init_nls_iso8859_16", i1 false, i1 false}
!1 = !{!"../fs/nls/nls_iso8859-1.c", i32 254, i32 1}
!2 = !{ptr @__exitcall_exit_nls_iso8859_1, !3, !"__exitcall_exit_nls_iso8859_1", i1 false, i1 false}
!3 = !{!"../fs/nls/nls_iso8859-1.c", i32 255, i32 1}
!4 = !{ptr @__UNIQUE_ID_file107, !5, !"__UNIQUE_ID_file107", i1 false, i1 false}
!5 = !{!"../fs/nls/nls_iso8859-1.c", i32 257, i32 1}
!6 = !{ptr @__UNIQUE_ID_license108, !5, !"__UNIQUE_ID_license108", i1 false, i1 false}
!7 = !{ptr @.str, !8, !"<string literal>", i1 false, i1 false}
!8 = !{!"../fs/nls/nls_iso8859-1.c", i32 237, i32 13}
!9 = !{ptr @table, !10, !"table", i1 false, i1 false}
!10 = !{!"../fs/nls/nls_iso8859-1.c", i32 236, i32 25}
!11 = !{ptr @page_uni2charset, !12, !"page_uni2charset", i1 false, i1 false}
!12 = !{!"../fs/nls/nls_iso8859-1.c", i32 135, i32 35}
!13 = !{ptr @page00, !14, !"page00", i1 false, i1 false}
!14 = !{!"../fs/nls/nls_iso8859-1.c", i32 99, i32 28}
!15 = !{ptr @charset2uni, !16, !"charset2uni", i1 false, i1 false}
!16 = !{!"../fs/nls/nls_iso8859-1.c", i32 16, i32 22}
!17 = !{ptr @charset2lower, !18, !"charset2lower", i1 false, i1 false}
!18 = !{!"../fs/nls/nls_iso8859-1.c", i32 139, i32 28}
!19 = !{ptr @charset2upper, !20, !"charset2upper", i1 false, i1 false}
!20 = !{!"../fs/nls/nls_iso8859-1.c", i32 175, i32 28}
