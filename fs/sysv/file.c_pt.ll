; ModuleID = '/llk/IR_all_yes/fs/sysv/file.c_pt.bc'
source_filename = "../fs/sysv/file.c"
...
@sysv_file_operations = dso_local constant { %struct.file_operations, [32 x i8] } { %struct.file_operations { ptr null, ptr @generic_file_llseek, ptr null, ptr null, ptr @generic_file_read_iter, ptr @generic_file_write_iter, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @generic_file_mmap, i32 0, ptr null, ptr null, ptr null, ptr @generic_file_fsync, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @generic_file_splice_read, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, [32 x i8] zeroinitializer }, align 32
@sysv_file_inode_operations = dso_local local_unnamed_addr constant %struct.inode_operations { ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @sysv_setattr, ptr @sysv_getattr, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, [36 x i8] undef }, align 128
@init_user_ns = external dso_local global %struct.user_namespace, align 1
@___asan_gen_.1 = private unnamed_addr constant [21 x i8] c"sysv_file_operations\00", align 1
@___asan_gen_.2 = private constant [18 x i8] c"../fs/sysv/file.c\00", align 1
@___asan_gen_.3 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.2, i32 23, i32 30 }
@llvm.compiler.used = appending global [1 x ptr] [ptr @sysv_file_operations], section "llvm.metadata"
@0 = internal global [1 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @sysv_file_operations to i32), i32 128, i32 160, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.3 to i32), i32 0 }]
...
define internal i32 @sysv_setattr(ptr nocapture noundef readnone %mnt_userns, ptr noundef %dentry, ptr noundef %attr) #1 align 64 {
entry:
...
if.end9:                                          ; preds = %if.then4
  ...
  tail call void @sysv_truncate(ptr noundef %1) #3
  br label %if.end11
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @sysv_getattr(ptr noundef, ptr noundef, ptr noundef, i32 noundef, i32 noundef) #0
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @sysv_truncate(ptr noundef) local_unnamed_addr #0
...
!0 = !{ptr @sysv_file_operations, !1, !"sysv_file_operations", i1 false, i1 false}
!1 = !{!"../fs/sysv/file.c", i32 23, i32 30}
!2 = !{ptr @sysv_file_inode_operations, !3, !"sysv_file_inode_operations", i1 false, i1 false}
!3 = !{!"../fs/sysv/file.c", i32 56, i32 31}
