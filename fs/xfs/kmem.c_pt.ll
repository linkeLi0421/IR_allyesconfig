; ModuleID = '/llk/IR_all_yes/fs/xfs/kmem.c_pt.bc'
source_filename = "../fs/xfs/kmem.c"
...
@.str = internal constant { [69 x i8], [59 x i8] } { [69 x i8] c"%s(%u) possible memory allocation deadlock size %u in %s (mode:0x%x)\00", [59 x i8] zeroinitializer }, align 32
@__func__.kmem_alloc = private unnamed_addr constant [11 x i8] c"kmem_alloc\00", align 1
@__tracepoint_kmem_alloc = external dso_local global %struct.tracepoint, align 4
@.str.1 = internal constant { [19 x i8], [45 x i8] } { [19 x i8] c"fs/xfs/xfs_trace.h\00", [45 x i8] zeroinitializer }, align 32
@trace_kmem_alloc.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@___asan_gen_.6 = private constant [17 x i8] c"../fs/xfs/kmem.c\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.6, i32 25, i32 2 }
@___asan_gen_.12 = private unnamed_addr constant [22 x i8] c"../fs/xfs/xfs_trace.h\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 3815, i32 1 }
...
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 69, i32 128, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 19, i32 64, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.2 to i32), i32 41, i32 96, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.3 to i32), i32 24, i32 64, i32 ptrtoint (ptr @___asan_gen_.14 to i32), i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.16 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @kmem_alloc(i32 noundef %size, i32 noundef %flags) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
  %and.i = and i32 %flags, -61
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and.i)
  %tobool.not.i = icmp eq i32 %and.i, 0
  br i1 %tobool.not.i, label %kmem_flags_convert.exit, label %do.body3.i, !prof !25

do.body3.i:                                       ; preds = %entry
  call void @__sanitizer_cov_trace_pc() #8
  tail call void asm sideeffect "1:\09.long ( (((0xe7f001f2) << 24) & 0xFF000000) | (((0xe7f001f2) << 8) & 0x00FF0000) | (((0xe7f001f2) >> 8) & 0x0000FF00) | (((0xe7f001f2) >> 24) & 0x000000FF) )\0A\09\0A.pushsection .rodata.str, \22aMS\22, %progbits, 1\0A2:\09.asciz \22fs/xfs/kmem.h\22\0A.popsection\0A.pushsection __bug_table,\22aw\22\0A.align 2\0A3:\09.word 1b, 2b\0A\09.hword 34, 0\0A.popsection", ""() #6, !srcloc !26
  unreachable

kmem_flags_convert.exit:                          ; preds = %entry
  %and9.i = and i32 %flags, 4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and9.i)
  %tobool10.not.i = icmp eq i32 %and9.i, 0
  %spec.select.i = select i1 %tobool10.not.i, i32 11456, i32 11328
  %and14.i = shl nuw nsw i32 %flags, 11
  %0 = and i32 %and14.i, 16384
  %and18.i = shl nuw nsw i32 %flags, 4
  %1 = and i32 %and18.i, 256
  %and23.i = shl nuw nsw i32 %flags, 20
  %2 = and i32 %and23.i, 33554432
  %3 = or i32 %1, %0
  %4 = or i32 %3, %2
  %5 = or i32 %4, %spec.select.i
  %6 = tail call ptr @llvm.returnaddress(i32 0)
  %7 = ptrtoint ptr %6 to i32
  tail call fastcc void @trace_kmem_alloc(i32 noundef %size, i32 noundef %flags, i32 noundef %7)
  %and = and i32 %flags, 8
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %and)
  %tobool2.not = icmp eq i32 %and, 0
  br label %if.end8.i

if.end8.i:                                        ; preds = %if.end8, %kmem_flags_convert.exit
  %retries.0 = phi i32 [ 0, %kmem_flags_convert.exit ], [ %inc, %if.end8 ]
  %call9.i = tail call noalias align 128 ptr @__kmalloc(i32 noundef %size, i32 noundef %5) #9
...
if.then4:                                         ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #8
  %8 = tail call i32 @llvm.read_register.i32(metadata !15) #6
  %and.i18 = and i32 %8, -16384
  %9 = inttoptr i32 %and.i18 to ptr
  ...
  tail call void (ptr, ptr, ...) @xfs_err(ptr noundef null, ptr noundef nonnull @.str, ptr noundef %comm, i32 noundef %13, i32 noundef %size, ptr noundef nonnull @__func__.kmem_alloc, i32 noundef %5) #6
  br label %if.end8

if.end8:                                          ; preds = %if.then4, %if.end.if.end8_crit_edge
  tail call fastcc void @memalloc_retry_wait(i32 noundef %5)
  br label %if.end8.i
}

; Function Attrs: inlinehint nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal fastcc void @trace_kmem_alloc(i32 noundef %size, i32 noundef %flags, i32 noundef %caller_ip) unnamed_addr #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_kmem_alloc, i32 0, i32 1), ptr blockaddress(@trace_kmem_alloc, %do.body)) #6
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  call void @__sanitizer_cov_trace_pc() #8
  %9 = tail call i32 @llvm.read_register.i32(metadata !15) #6
  ...
  %call42 = tail call i32 @__traceiter_kmem_alloc(ptr noundef null, i32 noundef %size, i32 noundef %flags, i32 noundef %caller_ip) #6
  tail call void asm sideeffect "", "~{memory}"() #6, !srcloc !29
  %13 = tail call i32 @llvm.read_register.i32(metadata !15) #6
...
if.end48:                                         ; preds = %cleanup.thread, %entry
  %17 = tail call i32 @llvm.read_register.i32(metadata !15) #6
...
if.then52:                                        ; preds = %cpu_online.exit85
  %26 = tail call i32 @llvm.read_register.i32(metadata !15) #6
  ...
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_kmem_alloc, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_kmem_alloc, i32 0, i32 7), align 4
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_kmem_alloc.__warned, align 1
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #8
  store i1 true, ptr @trace_kmem_alloc.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.1, i32 noundef 3815, ptr noundef nonnull @.str.2) #6
  br label %do.end67

do.end67:                                         ; preds = %if.then64, %land.lhs.true62.do.end67_crit_edge, %land.lhs.true.do.end67_crit_edge, %if.then52.do.end67_crit_edge
  tail call void asm sideeffect "", "~{memory}"() #6, !srcloc !31
  %31 = tail call i32 @llvm.read_register.i32(metadata !15) #6
...
; Function Attrs: inlinehint nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal fastcc void @memalloc_retry_wait(i32 noundef %gfp_flags) #1 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  br label %__here
...
__here:                                           ; preds = %entry
  ...
  %7 = tail call i32 @llvm.read_register.i32(metadata !15) #6
  ...
  br i1 %tobool.not.i, label %__here.current_gfp_context.exit_crit_edge, label %if.then.i, !prof !25
...
current_gfp_context.exit:                         ; preds = %if.end12.i, %__here.current_gfp_context.exit_crit_edge
  ...
  %call56 = tail call i32 @io_schedule_timeout(i32 noundef %.) #6
  ret void
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_kmem_alloc(ptr noundef, i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #3
...
!1 = !{!"../fs/xfs/kmem.c", i32 25, i32 2}
!2 = !{ptr @__func__.kmem_alloc, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../fs/xfs/kmem.c", i32 27, i32 25}
!4 = distinct !{null, !5, !"__already_done", i1 false, i1 false}
!5 = !{!"../fs/xfs/xfs_trace.h", i32 3815, i32 1}
...
!13 = !{!"../include/linux/sched/mm.h", i32 230, i32 2}
...
!26 = !{i64 2153320108, i64 2153320585, i64 2153320145, i64 2153320201, i64 2153320235, i64 2153320259, i64 2153320300, i64 2153320321, i64 2153320349, i64 2153320383}
!27 = !{i64 2148243832, i64 2148243837, i64 2148243850, i64 2148243894, i64 2148243928, i64 2148243949}
!28 = !{i64 2165419337}
!29 = !{i64 2165419564}
!30 = !{i64 2149945925}
!31 = !{i64 2149946961}
