; ModuleID = '/llk/IR_all_yes/lib/mpi/generic_mpih-add1.c_pt.bc'
...
define dso_local i32 @mpihelp_add_n(ptr nocapture noundef writeonly %res_ptr, ptr nocapture noundef readonly %s1_ptr, ptr nocapture noundef readonly %s2_ptr, i32 noundef %size) local_unnamed_addr #0 align 64 {
entry:
...
do.body:                                          ; preds = %do.body.do.body_crit_edge, %entry
  ...
  %add6 = add i32 %add, %3
  call void @__sanitizer_cov_trace_cmp4(i32 %add6, i32 %3)
  %cmp7 = icmp ult i32 %add6, %3
