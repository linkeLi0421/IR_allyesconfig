; ModuleID = '/llk/IR_all_yes/lib/mpi/generic_mpih-mul1.c_pt.bc'
...
define dso_local i32 @mpihelp_mul_1(ptr nocapture noundef writeonly %res_ptr, ptr nocapture noundef readonly %s1_ptr, i32 noundef %s1_size, i32 noundef %s2_limb) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #3
  call void @llvm.arm.gnu.eabi.mcount()
  %sub = sub i32 0, %s1_size
  %add.ptr = getelementptr i32, ptr %s1_ptr, i32 %s1_size
  %add.ptr2 = getelementptr i32, ptr %res_ptr, i32 %s1_size
  br label %do.body

do.body:                                          ; preds = %do.body.do.body_crit_edge, %entry
  %cy_limb.0 = phi i32 [ 0, %entry ], [ %add4, %do.body.do.body_crit_edge ]
  %j.0 = phi i32 [ %sub, %entry ], [ %inc, %do.body.do.body_crit_edge ]
  %arrayidx = getelementptr i32, ptr %add.ptr, i32 %j.0
  ...
  %arrayidx5 = getelementptr i32, ptr %add.ptr2, i32 %j.0
...
!9 = !{i64 2153661832, i64 2153661861}
