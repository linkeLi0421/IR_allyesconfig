; ModuleID = '/llk/IR_all_yes/lib/mpi/generic_mpih-mul2.c_pt.bc'
...
define dso_local i32 @mpihelp_addmul_1(ptr nocapture noundef %res_ptr, ptr nocapture noundef readonly %s1_ptr, i32 noundef %s1_size, i32 noundef %s2_limb) local_unnamed_addr #0 align 64 {
entry:
...
do.body:                                          ; preds = %do.body.do.body_crit_edge, %entry
  ...
  %add6 = add i32 %add, %4
  call void @__sanitizer_cov_trace_cmp4(i32 %add6, i32 %4)
  %cmp7 = icmp ult i32 %add6, %4
...
!9 = !{i64 2153661850, i64 2153661879}
