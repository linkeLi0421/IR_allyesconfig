; ModuleID = '/llk/IR_all_yes/net/batman-adv/log.c_pt.bc'
source_filename = "../net/batman-adv/log.c"
...
@__tracepoint_batadv_dbg = external dso_local global %struct.tracepoint, align 4
@.str = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"net/batman-adv/trace.h\00", [41 x i8] zeroinitializer }, align 32
@trace_batadv_dbg.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@___asan_gen_ = private constant [24 x i8] c"../net/batman-adv/log.c\00", align 1
@___asan_gen_.7 = private unnamed_addr constant [26 x i8] c"../net/batman-adv/trace.h\00", align 1
...
define dso_local i32 @batadv_debug_log(ptr noundef %bat_priv, ptr noundef %fmt, ...) local_unnamed_addr #0 align 64 {
entry:
  ...
  store ptr inttoptr (i32 -1 to ptr), ptr %args, align 4, !annotation !18
  ...
  call fastcc void @trace_batadv_dbg(ptr noundef %bat_priv, ptr noundef nonnull %vaf)
...
define internal fastcc void @trace_batadv_dbg(ptr noundef %bat_priv, ptr noundef %vaf) unnamed_addr #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_batadv_dbg, i32 0, i32 1), ptr blockaddress(@trace_batadv_dbg, %do.body)) #6
          to label %if.end48 [label %do.body], !srcloc !19
...
land.rhs.i.i.i.i:                                 ; preds = %do.body
  ...
  br i1 %.b37.i.i.i.i, label %land.rhs.i.i.i.i.cpu_online.exit_crit_edge, label %if.then.i.i.i.i, !prof !20
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_batadv_dbg(ptr noundef null, ptr noundef %bat_priv, ptr noundef %vaf) #6
...
land.rhs.i.i.i.i79:                               ; preds = %if.end48
  ...
  br i1 %.b37.i.i.i.i78, label %land.rhs.i.i.i.i79.cpu_online.exit85_crit_edge, label %if.then.i.i.i.i80, !prof !20
...
if.then52:                                        ; preds = %cpu_online.exit85
  ...
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_batadv_dbg, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_batadv_dbg, i32 0, i32 7), align 4
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_batadv_dbg.__warned, align 1
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #8
  store i1 true, ptr @trace_batadv_dbg.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str, i32 noundef 61, ptr noundef nonnull @.str.1) #6
  br label %do.end67
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_batadv_dbg(ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #4
...
!18 = !{!"auto-init"}
!19 = !{i64 2148864747, i64 2148864752, i64 2148864765, i64 2148864809, i64 2148864843, i64 2148864864}
