; ModuleID = '/llk/IR_all_yes/net/bridge/netfilter/ebt_redirect.c_pt.bc'
source_filename = "../net/bridge/netfilter/ebt_redirect.c"
...
@ebt_redirect_tg_reg = internal global %struct.xt_target { %struct.list_head zeroinitializer, [29 x i8] c"redirect\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", i8 0, ptr @ebt_redirect_tg, ptr @ebt_redirect_tg_check, ptr null, ptr null, ptr null, i32 4, i32 0, i32 97, i16 0, i16 7 }, section ".data..read_mostly", align 4
@__initcall__kmod_ebt_redirect__577_78_ebt_redirect_init6 = internal global ptr @ebt_redirect_init, section ".initcall6.init", align 4
@__exitcall_ebt_redirect_fini = internal global ptr @ebt_redirect_fini, section ".exitcall.exit", align 4
@__UNIQUE_ID_description578 = internal constant [67 x i8] c"ebt_redirect.description=Ebtables: Packet redirection to localhost\00", section ".modinfo", align 1
@__UNIQUE_ID_file579 = internal constant [52 x i8] c"ebt_redirect.file=net/bridge/netfilter/ebt_redirect\00", section ".modinfo", align 1
@__UNIQUE_ID_license580 = internal constant [25 x i8] c"ebt_redirect.license=GPL\00", section ".modinfo", align 1
...
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 46, i32 26 }
@___asan_gen_.13 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.14 = private constant [39 x i8] c"../net/bridge/netfilter/ebt_redirect.c\00", align 1
@___asan_gen_.15 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.14, i32 48, i32 26 }
@llvm.compiler.used = appending global [10 x ptr] [ptr @__UNIQUE_ID_description578, ptr @__UNIQUE_ID_file579, ptr @__UNIQUE_ID_license580, ptr @__exitcall_ebt_redirect_fini, ptr @__initcall__kmod_ebt_redirect__577_78_ebt_redirect_init6, ptr @ebt_redirect_fini, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3], section "llvm.metadata"
...
define internal void @ebt_redirect_fini() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  tail call void @xt_unregister_target(ptr noundef nonnull @ebt_redirect_tg_reg) #5
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @ebt_redirect_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @xt_register_target(ptr noundef nonnull @ebt_redirect_tg_reg) #5
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @ebt_redirect_tg(ptr noundef %skb, ptr nocapture noundef readonly %par) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %entry
  ...
  %head.i.i19 = getelementptr inbounds %struct.sk_buff, ptr %skb, i32 0, i32 18
  %7 = ptrtoint ptr %head.i.i19 to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %head.i.i19, align 8
  %mac_header.i.i20 = getelementptr inbounds %struct.sk_buff, ptr %skb, i32 0, i32 15, i32 0, i32 21
  %9 = ptrtoint ptr %mac_header.i.i20 to i32
  call void @__asan_load2_noabort(i32 %9)
  %10 = load i16, ptr %mac_header.i.i20, align 2
  %conv.i.i21 = zext i16 %10 to i32
  %add.ptr.i.i22 = getelementptr i8, ptr %8, i32 %conv.i.i21
  %in.i24 = getelementptr inbounds %struct.nf_hook_state, ptr %4, i32 0, i32 2
  %11 = ptrtoint ptr %in.i24 to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %in.i24, align 4
...
if.then2:                                         ; preds = %if.end
  %rx_handler_data.i = getelementptr inbounds %struct.net_device, ptr %12, i32 0, i32 95
  %13 = ptrtoint ptr %rx_handler_data.i to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load volatile ptr, ptr %rx_handler_data.i, align 4
  %call.i = tail call i32 @rcu_read_lock_held() #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i)
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %land.lhs.true.i, label %if.then2.br_port_get_rcu.exit_crit_edge

if.then2.br_port_get_rcu.exit_crit_edge:          ; preds = %if.then2
  call void @__sanitizer_cov_trace_pc() #7
...
br_port_get_rcu.exit:                             ; preds = %if.then.i, %land.lhs.true4.i.br_port_get_rcu.exit_crit_edge, %land.lhs.true.i.br_port_get_rcu.exit_crit_edge, %if.then2.br_port_get_rcu.exit_crit_edge
  %15 = ptrtoint ptr %14 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %14, align 8
  %dev = getelementptr inbounds %struct.net_bridge, ptr %16, i32 0, i32 3
  %17 = ptrtoint ptr %dev to i32
  call void @__asan_load4_noabort(i32 %17)
  %18 = load ptr, ptr %dev, align 4
  br label %if.end11

if.end11:                                         ; preds = %br_port_get_rcu.exit, %if.end.if.end11_crit_edge
  %.sink = phi ptr [ %18, %br_port_get_rcu.exit ], [ %12, %if.end.if.end11_crit_edge ]
  %dev_addr10 = getelementptr inbounds %struct.net_device, ptr %.sink, i32 0, i32 86
  %19 = ptrtoint ptr %dev_addr10 to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load ptr, ptr %dev_addr10, align 64
  %21 = ptrtoint ptr %20 to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load i32, ptr %20, align 4
  %23 = ptrtoint ptr %add.ptr.i.i22 to i32
  call void @__asan_store4_noabort(i32 %23)
  store i32 %22, ptr %add.ptr.i.i22, align 4
  %add.ptr.i25 = getelementptr i8, ptr %20, i32 4
  %24 = ptrtoint ptr %add.ptr.i25 to i32
  call void @__asan_load2_noabort(i32 %24)
  %25 = load i16, ptr %add.ptr.i25, align 2
  %add.ptr1.i26 = getelementptr i8, ptr %add.ptr.i.i22, i32 4
  %26 = ptrtoint ptr %add.ptr1.i26 to i32
  call void @__asan_store2_noabort(i32 %26)
  store i16 %25, ptr %add.ptr1.i26, align 2
...
cleanup:                                          ; preds = %if.end11, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %29, %if.end11 ], [ -2, %entry.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree nounwind null_pointer_is_valid readonly sanitize_address sspstrong willreturn uwtable(sync)
define internal i32 @ebt_redirect_tg_check(ptr nocapture noundef readonly %par) #3 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
...
!0 = !{ptr @__initcall__kmod_ebt_redirect__577_78_ebt_redirect_init6, !1, !"__initcall__kmod_ebt_redirect__577_78_ebt_redirect_init6", i1 false, i1 false}
!1 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 78, i32 1}
!2 = !{ptr @__exitcall_ebt_redirect_fini, !3, !"__exitcall_ebt_redirect_fini", i1 false, i1 false}
!3 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 79, i32 1}
!4 = !{ptr @__UNIQUE_ID_description578, !5, !"__UNIQUE_ID_description578", i1 false, i1 false}
!5 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 80, i32 1}
!6 = !{ptr @__UNIQUE_ID_file579, !7, !"__UNIQUE_ID_file579", i1 false, i1 false}
!7 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 81, i32 1}
!8 = !{ptr @__UNIQUE_ID_license580, !7, !"__UNIQUE_ID_license580", i1 false, i1 false}
!9 = !{ptr @ebt_redirect_tg_reg, !10, !"ebt_redirect_tg_reg", i1 false, i1 false}
!10 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 56, i32 25}
...
!16 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 46, i32 26}
!17 = !{ptr @.str.3, !18, !"<string literal>", i1 false, i1 false}
!18 = !{!"../net/bridge/netfilter/ebt_redirect.c", i32 48, i32 26}
