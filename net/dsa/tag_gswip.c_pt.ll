; ModuleID = '/llk/IR_all_yes/net/dsa/tag_gswip.c_pt.bc'
source_filename = "../net/dsa/tag_gswip.c"
...
@__UNIQUE_ID_file499 = internal constant [33 x i8] c"tag_gswip.file=net/dsa/tag_gswip\00", section ".modinfo", align 1
@__UNIQUE_ID_license500 = internal constant [22 x i8] c"tag_gswip.license=GPL\00", section ".modinfo", align 1
@__UNIQUE_ID_alias501 = internal constant [26 x i8] c"tag_gswip.alias=dsa_tag-5\00", section ".modinfo", align 1
@__initcall__kmod_tag_gswip__502_111_dsa_tag_driver_module_init6 = internal global ptr @dsa_tag_driver_module_init, section ".initcall6.init", align 4
@dsa_tag_driver_array = internal global { [1 x ptr], [28 x i8] } { [1 x ptr] [ptr @dsa_tag_driver_gswip_netdev_ops], [28 x i8] zeroinitializer }, align 32
@__exitcall_dsa_tag_driver_module_exit = internal global ptr @dsa_tag_driver_module_exit, section ".exitcall.exit", align 4
@dsa_tag_driver_gswip_netdev_ops = internal global { %struct.dsa_tag_driver, [16 x i8] } { %struct.dsa_tag_driver { ptr @gswip_netdev_ops, %struct.list_head zeroinitializer, ptr null }, [16 x i8] zeroinitializer }, align 32
@gswip_netdev_ops = internal constant { %struct.dsa_device_ops, [56 x i8] } { %struct.dsa_device_ops { ptr @gswip_tag_xmit, ptr @gswip_tag_rcv, ptr null, ptr null, ptr null, i32 8, i32 0, ptr @.str, i32 5, i8 0 }, [56 x i8] zeroinitializer }, align 32
...
@___asan_gen_.4 = private unnamed_addr constant [32 x i8] c"dsa_tag_driver_gswip_netdev_ops\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 111, i32 1 }
@___asan_gen_.7 = private unnamed_addr constant [17 x i8] c"gswip_netdev_ops\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 100, i32 36 }
@___asan_gen_.10 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.11 = private constant [23 x i8] c"../net/dsa/tag_gswip.c\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 101, i32 10 }
@llvm.compiler.used = appending global [10 x ptr] [ptr @__UNIQUE_ID_alias501, ptr @__UNIQUE_ID_file499, ptr @__UNIQUE_ID_license500, ptr @__exitcall_dsa_tag_driver_module_exit, ptr @__initcall__kmod_tag_gswip__502_111_dsa_tag_driver_module_init6, ptr @dsa_tag_driver_module_exit, ptr @dsa_tag_driver_array, ptr @dsa_tag_driver_gswip_netdev_ops, ptr @gswip_netdev_ops, ptr @.str], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @dsa_tag_driver_array to i32), i32 4, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @dsa_tag_driver_gswip_netdev_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @gswip_netdev_ops to i32), i32 40, i32 96, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 6, i32 32, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 -1 }]
...
define internal ptr @gswip_tag_xmit(ptr noundef returned %skb, ptr nocapture noundef readonly %dev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call1 = tail call ptr @skb_push(ptr noundef %skb, i32 noundef 4) #3
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal ptr @gswip_tag_rcv(ptr noundef %skb, ptr nocapture noundef readonly %dev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %pskb_may_pull.exit.if.end_crit_edge, %entry.if.end_crit_edge
  ...
  %8 = lshr i8 %7, 4
  %9 = and i8 %8, 7
  %shr = zext i8 %9 to i32
  %dsa_ptr.i = getelementptr inbounds %struct.net_device, ptr %dev, i32 0, i32 75
  %10 = ptrtoint ptr %dsa_ptr.i to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load ptr, ptr %dsa_ptr.i, align 4
  %dst1.i = getelementptr inbounds %struct.dsa_port, ptr %11, i32 0, i32 2
...
for.body.i:                                       ; preds = %for.inc.i.for.body.i_crit_edge, %if.end.for.body.i_crit_edge
  ...
  %15 = ptrtoint ptr %ds.i to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %ds.i, align 4
  ...
  %cmp3.i14 = icmp eq i32 %18, 0
  br i1 %cmp3.i14, label %land.lhs.true.i, label %for.body.i.for.inc.i_crit_edge
...
land.lhs.true.i:                                  ; preds = %for.body.i
  ...
  %19 = ptrtoint ptr %index4.i to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load i32, ptr %index4.i, align 4
  call void @__sanitizer_cov_trace_cmp4(i32 %20, i32 %shr)
  %cmp5.i = icmp eq i32 %20, %shr
...
dsa_master_find_slave.exit:                       ; preds = %land.lhs.true6.i
  ...
  %26 = ptrtoint ptr %dp.0.le.i to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load ptr, ptr %dp.0.le.i, align 4
  %28 = getelementptr inbounds %struct.anon, ptr %skb, i32 0, i32 2
  %29 = ptrtoint ptr %28 to i32
  call void @__asan_store4_noabort(i32 %29)
  store ptr %27, ptr %28, align 8
  %tobool4.not = icmp eq ptr %27, null
  br i1 %tobool4.not, label %dsa_master_find_slave.exit.cleanup_crit_edge, label %if.end6

dsa_master_find_slave.exit.cleanup_crit_edge:     ; preds = %dsa_master_find_slave.exit
  call void @__sanitizer_cov_trace_pc() #5
  br label %cleanup

if.end6:                                          ; preds = %dsa_master_find_slave.exit
  call void @__sanitizer_cov_trace_pc() #5
  %call7 = tail call ptr @skb_pull_rcsum(ptr noundef %skb, i32 noundef 8) #3
  br label %cleanup

cleanup:                                          ; preds = %if.end6, %dsa_master_find_slave.exit.cleanup_crit_edge, %dsa_master_find_slave.exit.thread, %pskb_may_pull.exit.cleanup_crit_edge, %if.end.i.cleanup_crit_edge
  %retval.0 = phi ptr [ %skb, %if.end6 ], [ null, %pskb_may_pull.exit.cleanup_crit_edge ], [ null, %dsa_master_find_slave.exit.cleanup_crit_edge ], [ null, %dsa_master_find_slave.exit.thread ], [ null, %if.end.i.cleanup_crit_edge ]
  ret ptr %retval.0
}
...
!1 = !{!"../net/dsa/tag_gswip.c", i32 108, i32 1}
...
!4 = !{!"../net/dsa/tag_gswip.c", i32 109, i32 1}
!5 = !{ptr @__initcall__kmod_tag_gswip__502_111_dsa_tag_driver_module_init6, !6, !"__initcall__kmod_tag_gswip__502_111_dsa_tag_driver_module_init6", i1 false, i1 false}
!6 = !{!"../net/dsa/tag_gswip.c", i32 111, i32 1}
...
!9 = !{ptr @dsa_tag_driver_gswip_netdev_ops, !6, !"dsa_tag_driver_gswip_netdev_ops", i1 false, i1 false}
!10 = !{ptr @.str, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../net/dsa/tag_gswip.c", i32 101, i32 10}
!12 = !{ptr @gswip_netdev_ops, !13, !"gswip_netdev_ops", i1 false, i1 false}
!13 = !{!"../net/dsa/tag_gswip.c", i32 100, i32 36}
