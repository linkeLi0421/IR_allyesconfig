; ModuleID = '/llk/IR_all_yes/net/dsa/tag_qca.c_pt.bc'
source_filename = "../net/dsa/tag_qca.c"
...
@__UNIQUE_ID_file499 = internal constant [29 x i8] c"tag_qca.file=net/dsa/tag_qca\00", section ".modinfo", align 1
@__UNIQUE_ID_license500 = internal constant [20 x i8] c"tag_qca.license=GPL\00", section ".modinfo", align 1
@__UNIQUE_ID_alias501 = internal constant [25 x i8] c"tag_qca.alias=dsa_tag-10\00", section ".modinfo", align 1
@__initcall__kmod_tag_qca__502_94_dsa_tag_driver_module_init6 = internal global ptr @dsa_tag_driver_module_init, section ".initcall6.init", align 4
@dsa_tag_driver_array = internal global { [1 x ptr], [28 x i8] } { [1 x ptr] [ptr @dsa_tag_driver_qca_netdev_ops], [28 x i8] zeroinitializer }, align 32
@__exitcall_dsa_tag_driver_module_exit = internal global ptr @dsa_tag_driver_module_exit, section ".exitcall.exit", align 4
@dsa_tag_driver_qca_netdev_ops = internal global { %struct.dsa_tag_driver, [16 x i8] } { %struct.dsa_tag_driver { ptr @qca_netdev_ops, %struct.list_head zeroinitializer, ptr null }, [16 x i8] zeroinitializer }, align 32
@qca_netdev_ops = internal constant { %struct.dsa_device_ops, [56 x i8] } { %struct.dsa_device_ops { ptr @qca_tag_xmit, ptr @qca_tag_rcv, ptr null, ptr null, ptr null, i32 2, i32 0, ptr @.str, i32 10, i8 0 }, [56 x i8] zeroinitializer }, align 32
@.str = internal constant { [4 x i8], [28 x i8] } { [4 x i8] c"qca\00", [28 x i8] zeroinitializer }, align 32
@___asan_gen_.1 = private unnamed_addr constant [21 x i8] c"dsa_tag_driver_array\00", align 1
@___asan_gen_.4 = private unnamed_addr constant [30 x i8] c"dsa_tag_driver_qca_netdev_ops\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 94, i32 1 }
@___asan_gen_.7 = private unnamed_addr constant [15 x i8] c"qca_netdev_ops\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 83, i32 36 }
@___asan_gen_.10 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.11 = private constant [21 x i8] c"../net/dsa/tag_qca.c\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 84, i32 10 }
@llvm.compiler.used = appending global [10 x ptr] [ptr @__UNIQUE_ID_alias501, ptr @__UNIQUE_ID_file499, ptr @__UNIQUE_ID_license500, ptr @__exitcall_dsa_tag_driver_module_exit, ptr @__initcall__kmod_tag_qca__502_94_dsa_tag_driver_module_init6, ptr @dsa_tag_driver_module_exit, ptr @dsa_tag_driver_array, ptr @dsa_tag_driver_qca_netdev_ops, ptr @qca_netdev_ops, ptr @.str], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @dsa_tag_driver_array to i32), i32 4, i32 32, i32 ptrtoint (ptr @___asan_gen_.1 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @dsa_tag_driver_qca_netdev_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.6 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @qca_netdev_ops to i32), i32 40, i32 96, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.9 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 4, i32 32, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 -1 }]
...
define internal ptr @qca_tag_xmit(ptr noundef returned %skb, ptr nocapture noundef readonly %dev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %call1 = tail call ptr @skb_push(ptr noundef %skb, i32 noundef 2) #3
  ...
  %conv = or i16 %8, -32640
  %9 = ptrtoint ptr %add.ptr.i7 to i32
  call void @__asan_store2_noabort(i32 %9)
  store i16 %conv, ptr %add.ptr.i7, align 2
  ret ptr %skb
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal ptr @qca_tag_rcv(ptr noundef %skb, ptr nocapture noundef readonly %dev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #5
  call void @llvm.arm.gnu.eabi.mcount()
...
if.end:                                           ; preds = %pskb_may_pull.exit.if.end_crit_edge, %entry.if.end_crit_edge
  ...
  %shr.mask = and i16 %7, -16384
  call void @__sanitizer_cov_trace_const_cmp2(i16 -32768, i16 %shr.mask)
  %cmp.not = icmp eq i16 %shr.mask, -32768
  br i1 %cmp.not, label %if.end14, label %if.end.cleanup_crit_edge, !prof !23
...
if.end14:                                         ; preds = %if.end
  %call15 = tail call ptr @skb_pull_rcsum(ptr noundef %skb, i32 noundef 2) #3
  %8 = ptrtoint ptr %data.i to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load ptr, ptr %data.i, align 4
  %add.ptr.i33 = getelementptr i8, ptr %9, i32 -14
  %add.ptr3.i = getelementptr i8, ptr %9, i32 -16
  %10 = call ptr @memmove(ptr %add.ptr.i33, ptr %add.ptr3.i, i32 12)
  %11 = and i16 %7, 7
  ...
  br i1 %cmp.not3.i, label %if.end14.dsa_master_find_slave.exit_crit_edge, label %if.end14.for.body.i_crit_edge

if.end14.for.body.i_crit_edge:                    ; preds = %if.end14
  br label %for.body.i

if.end14.dsa_master_find_slave.exit_crit_edge:    ; preds = %if.end14
  call void @__sanitizer_cov_trace_pc() #5
  br label %dsa_master_find_slave.exit

for.body.i:                                       ; preds = %for.inc.i.for.body.i_crit_edge, %if.end14.for.body.i_crit_edge
  %.pn4.i = phi ptr [ %.pn.i, %for.inc.i.for.body.i_crit_edge ], [ %.pn2.i, %if.end14.for.body.i_crit_edge ]
  ...
  %cmp3.i34 = icmp eq i32 %20, 0
  br i1 %cmp3.i34, label %land.lhs.true.i, label %for.body.i.for.inc.i_crit_edge
...
land.lhs.true.i:                                  ; preds = %for.body.i
  ...
  call void @__sanitizer_cov_trace_cmp4(i32 %22, i32 %and17)
  %cmp5.i = icmp eq i32 %22, %and17
...
dsa_master_find_slave.exit:                       ; preds = %for.inc.i.dsa_master_find_slave.exit_crit_edge, %if.then.i, %if.end14.dsa_master_find_slave.exit_crit_edge
  %retval.0.i35 = phi ptr [ %26, %if.then.i ], [ null, %if.end14.dsa_master_find_slave.exit_crit_edge ], [ null, %for.inc.i.dsa_master_find_slave.exit_crit_edge ]
  %28 = getelementptr inbounds %struct.anon, ptr %skb, i32 0, i32 2
  %29 = ptrtoint ptr %28 to i32
  call void @__asan_store4_noabort(i32 %29)
  store ptr %retval.0.i35, ptr %28, align 8
  %tobool19.not = icmp eq ptr %retval.0.i35, null
  %.skb = select i1 %tobool19.not, ptr null, ptr %skb
  br label %cleanup

cleanup:                                          ; preds = %dsa_master_find_slave.exit, %if.end.cleanup_crit_edge, %pskb_may_pull.exit.cleanup_crit_edge, %if.end.i.cleanup_crit_edge
  %retval.0 = phi ptr [ null, %pskb_may_pull.exit.cleanup_crit_edge ], [ null, %if.end.cleanup_crit_edge ], [ %.skb, %dsa_master_find_slave.exit ], [ null, %if.end.i.cleanup_crit_edge ]
  ret ptr %retval.0
}
...
!1 = !{!"../net/dsa/tag_qca.c", i32 91, i32 1}
...
!4 = !{!"../net/dsa/tag_qca.c", i32 92, i32 1}
!5 = !{ptr @__initcall__kmod_tag_qca__502_94_dsa_tag_driver_module_init6, !6, !"__initcall__kmod_tag_qca__502_94_dsa_tag_driver_module_init6", i1 false, i1 false}
!6 = !{!"../net/dsa/tag_qca.c", i32 94, i32 1}
...
!9 = !{ptr @dsa_tag_driver_qca_netdev_ops, !6, !"dsa_tag_driver_qca_netdev_ops", i1 false, i1 false}
!10 = !{ptr @.str, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../net/dsa/tag_qca.c", i32 84, i32 10}
!12 = !{ptr @qca_netdev_ops, !13, !"qca_netdev_ops", i1 false, i1 false}
!13 = !{!"../net/dsa/tag_qca.c", i32 83, i32 36}
