; ModuleID = '/llk/IR_all_yes/net/ipv4/xfrm4_output.c_pt.bc'
...
@___asan_gen_ = private constant [27 x i8] c"../net/ipv4/xfrm4_output.c\00", align 1
...
define dso_local i32 @xfrm4_output(ptr noundef %net, ptr noundef %sk, ptr noundef %skb) local_unnamed_addr #0 align 64 {
entry:
...
land.rhs.i:                                       ; preds = %land.lhs.true.i
  ...
  br i1 %tobool3.not.i, label %do.end.i, label %land.rhs.i.skb_dst.exit_crit_edge, !prof !35
...
if.then.i:                                        ; preds = %lor.lhs.false.i.if.then.i_crit_edge, %skb_dst.exit.if.then.i_crit_edge
  %call1.i = tail call i32 @__xfrm4_output(ptr noundef %net, ptr noundef %sk, ptr noundef %skb) #5
  br label %NF_HOOK_COND.exit
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @__xfrm4_output(ptr noundef %net, ptr noundef %sk, ptr noundef %skb) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
...
land.rhs.i.i:                                     ; preds = %land.lhs.true.i.i
  ...
  br i1 %tobool3.not.i.i, label %do.end.i.i, label %land.rhs.i.i.dst_output.exit_crit_edge, !prof !35
...
if.end:                                           ; preds = %skb_dst.exit
  call void @__sanitizer_cov_trace_pc() #7
  %call3 = tail call i32 @xfrm_output(ptr noundef %sk, ptr noundef %skb) #5
  br label %cleanup

cleanup:                                          ; preds = %if.end, %dst_output.exit
  %retval.0 = phi i32 [ %call3, %if.end ], [ %call1.i, %dst_output.exit ]
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @xfrm4_local_error(ptr nocapture noundef readonly %skb, i32 noundef %mtu) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  %head.i.i7 = getelementptr inbounds %struct.sk_buff, ptr %skb, i32 0, i32 18
  %2 = ptrtoint ptr %head.i.i7 to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %head.i.i7, align 8
  ...
  %4 = ptrtoint ptr %network_header.i.i.sink to i32
  call void @__asan_load2_noabort(i32 %4)
  %5 = load i16, ptr %network_header.i.i.sink, align 4
  %conv.i.i8 = zext i16 %5 to i32
  %add.ptr.i.i9 = getelementptr i8, ptr %3, i32 %conv.i.i8
  %6 = getelementptr inbounds %struct.sk_buff, ptr %skb, i32 0, i32 1
  %7 = ptrtoint ptr %6 to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %6, align 4
  %daddr = getelementptr inbounds %struct.iphdr, ptr %add.ptr.i.i9, i32 0, i32 9
  %9 = ptrtoint ptr %daddr to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load i32, ptr %daddr, align 4
  %11 = getelementptr inbounds %struct.sock_common, ptr %8, i32 0, i32 2
  %12 = ptrtoint ptr %11 to i32
  call void @__asan_load2_noabort(i32 %12)
  %13 = load i16, ptr %11, align 4
  tail call void @ip_local_error(ptr noundef %8, i32 noundef 90, i32 noundef %10, i16 noundef zeroext %13, i32 noundef %mtu) #5
  ret void
}
...
entry:
  ...
  call void @__sanitizer_cov_trace_pc() #7
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds ([13 x [7 x %struct.static_key]], ptr @nf_hooks_needed, i32 0, i32 2, i32 4), ptr blockaddress(@nf_hook, %if.end)) #5
          to label %cleanup [label %if.end], !srcloc !36
...
if.then192:                                       ; preds = %sw.epilog
  ...
  store ptr @__xfrm4_output, ptr %okfn5.i, align 4
...
rcu_read_unlock.exit:                             ; preds = %if.then.i8, %land.lhs.true2.i7.rcu_read_unlock.exit_crit_edge, %land.lhs.true.i5.rcu_read_unlock.exit_crit_edge, %if.end194.rcu_read_unlock.exit_crit_edge
  call void asm sideeffect "", "~{memory}"() #5, !srcloc !38
  %13 = call i32 @llvm.read_register.i32(metadata !25) #5
...
!llvm.asan.globals = !{!0, !2, !3, !4, !6, !8, !10, !12, !14, !16, !18, !19, !20, !22, !23}
...
!36 = !{i64 2148831039, i64 2148831044, i64 2148831057, i64 2148831101, i64 2148831135, i64 2148831156}
!37 = !{i64 2149645861}
!38 = !{i64 2149646127}
