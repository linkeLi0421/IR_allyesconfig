; ModuleID = '/llk/IR_all_yes/net/ipv6/netfilter/ip6t_SYNPROXY.c_pt.bc'
source_filename = "../net/ipv6/netfilter/ip6t_SYNPROXY.c"
...
@synproxy_tg6_reg = internal global %struct.xt_target { %struct.list_head zeroinitializer, [29 x i8] c"SYNPROXY\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00", i8 0, ptr @synproxy_tg6, ptr @synproxy_tg6_check, ptr @synproxy_tg6_destroy, ptr null, ptr null, i32 4, i32 0, i32 6, i16 0, i16 10 }, section ".data..read_mostly", align 4
@__initcall__kmod_ip6t_SYNPROXY__690_119_synproxy_tg6_init6 = internal global ptr @synproxy_tg6_init, section ".initcall6.init", align 4
@__exitcall_synproxy_tg6_exit = internal global ptr @synproxy_tg6_exit, section ".exitcall.exit", align 4
@__UNIQUE_ID_file691 = internal constant [52 x i8] c"ip6t_SYNPROXY.file=net/ipv6/netfilter/ip6t_SYNPROXY\00", section ".modinfo", align 1
@__UNIQUE_ID_license692 = internal constant [26 x i8] c"ip6t_SYNPROXY.license=GPL\00", section ".modinfo", align 1
@__UNIQUE_ID_author693 = internal constant [55 x i8] c"ip6t_SYNPROXY.author=Patrick McHardy <kaber@trash.net>\00", section ".modinfo", align 1
@__UNIQUE_ID_description694 = internal constant [93 x i8] c"ip6t_SYNPROXY.description=Intercept IPv6 TCP connections and establish them using syncookies\00", section ".modinfo", align 1
...
@___asan_gen_ = private constant [38 x i8] c"../net/ipv6/netfilter/ip6t_SYNPROXY.c\00", align 1
...
@llvm.compiler.used = appending global [12 x ptr] [ptr @__UNIQUE_ID_author693, ptr @__UNIQUE_ID_description694, ptr @__UNIQUE_ID_file691, ptr @__UNIQUE_ID_license692, ptr @__exitcall_synproxy_tg6_exit, ptr @__initcall__kmod_ip6t_SYNPROXY__690_119_synproxy_tg6_init6, ptr @synproxy_tg6_exit, ptr @.str, ptr @.str.1, ptr @.str.2, ptr @.str.3, ptr @.str.4], section "llvm.metadata"
...
define internal void @synproxy_tg6_exit() #0 section ".exit.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  tail call void @xt_unregister_target(ptr noundef nonnull @synproxy_tg6_reg) #6
  ret void
}
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @synproxy_tg6_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @xt_register_target(ptr noundef nonnull @synproxy_tg6_reg) #6
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @synproxy_tg6(ptr noundef %skb, ptr nocapture noundef readonly %par) #2 align 64 {
entry:
  ...
  %call3 = tail call zeroext i16 @nf_ip6_checksum(ptr noundef %skb, i32 noundef %conv.i, i32 noundef %14, i8 noundef zeroext 6) #6
...
if.end100:                                        ; preds = %if.else, %if.then95
  call void @synproxy_send_client_synack_ipv6(ptr noundef %6, ptr noundef %skb, ptr noundef nonnull %retval.0.i.i181, ptr noundef nonnull %opts) #6
...
if.then128:                                       ; preds = %if.end11
  ...
  %call129 = call zeroext i1 @synproxy_recv_client_ack_ipv6(ptr noundef %6, ptr noundef %skb, ptr noundef nonnull %retval.0.i.i181, ptr noundef nonnull %opts, i32 noundef %60) #6
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @synproxy_tg6_check(ptr nocapture noundef readonly %par) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
...
lor.lhs.false4:                                   ; preds = %lor.lhs.false
  ...
  %10 = load i8, ptr %invflags, align 4
  %11 = and i8 %10, 64
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %11)
  %tobool8.not = icmp eq i8 %11, 0
  br i1 %tobool8.not, label %if.end, label %lor.lhs.false4.cleanup_crit_edge
...
if.end:                                           ; preds = %lor.lhs.false4
  ...
  %call10 = tail call i32 @nf_ct_netns_get(ptr noundef %13, i8 noundef zeroext %15) #6
...
if.end13:                                         ; preds = %if.end
  ...
  %call15 = tail call i32 @nf_synproxy_ipv6_init(ptr noundef %call, ptr noundef %17) #6
...
if.then17:                                        ; preds = %if.end13
  ...
  %21 = load i8, ptr %family, align 4
  tail call void @nf_ct_netns_put(ptr noundef %19, i8 noundef zeroext %21) #6
  br label %cleanup

cleanup:                                          ; preds = %if.then17, %if.end13.cleanup_crit_edge, %if.end.cleanup_crit_edge, %lor.lhs.false4.cleanup_crit_edge, %lor.lhs.false.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %call15, %if.then17 ], [ -22, %lor.lhs.false4.cleanup_crit_edge ], [ -22, %lor.lhs.false.cleanup_crit_edge ], [ -22, %entry.cleanup_crit_edge ], [ %call10, %if.end.cleanup_crit_edge ], [ 0, %if.end13.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @synproxy_tg6_destroy(ptr nocapture noundef readonly %par) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
  %0 = ptrtoint ptr %par to i32
  ...
  tail call void @nf_synproxy_ipv6_fini(ptr noundef %call, ptr noundef %3) #6
...
; Function Attrs: null_pointer_is_valid
declare dso_local zeroext i16 @nf_ip6_checksum(ptr noundef, i32 noundef, i32 noundef, i8 noundef zeroext) local_unnamed_addr #1
...
!0 = !{ptr @__initcall__kmod_ip6t_SYNPROXY__690_119_synproxy_tg6_init6, !1, !"__initcall__kmod_ip6t_SYNPROXY__690_119_synproxy_tg6_init6", i1 false, i1 false}
!1 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 119, i32 1}
!2 = !{ptr @__exitcall_synproxy_tg6_exit, !3, !"__exitcall_synproxy_tg6_exit", i1 false, i1 false}
!3 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 120, i32 1}
!4 = !{ptr @__UNIQUE_ID_file691, !5, !"__UNIQUE_ID_file691", i1 false, i1 false}
!5 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 122, i32 1}
!6 = !{ptr @__UNIQUE_ID_license692, !5, !"__UNIQUE_ID_license692", i1 false, i1 false}
!7 = !{ptr @__UNIQUE_ID_author693, !8, !"__UNIQUE_ID_author693", i1 false, i1 false}
!8 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 123, i32 1}
!9 = !{ptr @__UNIQUE_ID_description694, !10, !"__UNIQUE_ID_description694", i1 false, i1 false}
!10 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 124, i32 1}
!11 = !{ptr @synproxy_tg6_reg, !12, !"synproxy_tg6_reg", i1 false, i1 false}
!12 = !{!"../net/ipv6/netfilter/ip6t_SYNPROXY.c", i32 98, i32 25}
