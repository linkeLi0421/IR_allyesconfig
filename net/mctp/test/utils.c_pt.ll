; ModuleID = '/llk/IR_all_yes/net/mctp/test/utils.c_pt.bc'
source_filename = "../net/mctp/test/utils.c"
...
@.str = internal constant { [11 x i8], [21 x i8] } { [11 x i8] c"mctptest%d\00", [21 x i8] zeroinitializer }, align 32
@mctp_test_netdev_ops = internal constant { %struct.net_device_ops, [80 x i8] } { %struct.net_device_ops { ptr null, ptr null, ptr null, ptr null, ptr @mctp_test_dev_tx, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null }, [80 x i8] zeroinitializer }, align 32
...
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 41, i32 9 }
@___asan_gen_.7 = private unnamed_addr constant [21 x i8] c"mctp_test_netdev_ops\00", align 1
@___asan_gen_.8 = private constant [25 x i8] c"../net/mctp/test/utils.c\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 19, i32 36 }
...
if.end:                                           ; preds = %entry
  ...
  %call3 = tail call i32 @register_netdev(ptr noundef nonnull %call) #5
...
if.then5:                                         ; preds = %if.end
  call void @__sanitizer_cov_trace_pc() #7
  tail call void @free_netdev(ptr noundef nonnull %call) #5
  br label %cleanup

if.end6:                                          ; preds = %if.end
  %1 = tail call i32 @llvm.read_register.i32(metadata !11) #5
...
rcu_read_lock.exit:                               ; preds = %if.then.i, %land.lhs.true2.i.rcu_read_lock.exit_crit_edge, %land.lhs.true.i.rcu_read_lock.exit_crit_edge, %if.end6.rcu_read_lock.exit_crit_edge
  %call7 = tail call ptr @__mctp_dev_get(ptr noundef nonnull %call) #5
  %mdev = getelementptr i8, ptr %call, i32 2308
  %5 = ptrtoint ptr %mdev to i32
  call void @__asan_store4_noabort(i32 %5)
  store ptr %call7, ptr %mdev, align 4
  tail call void @mctp_dev_hold(ptr noundef %call7) #5
...
rcu_read_unlock.exit:                             ; preds = %if.then.i25, %land.lhs.true2.i24.rcu_read_unlock.exit_crit_edge, %land.lhs.true.i22.rcu_read_unlock.exit_crit_edge, %rcu_read_lock.exit.rcu_read_unlock.exit_crit_edge
  ...
  %6 = tail call i32 @llvm.read_register.i32(metadata !11) #5
  %and.i.i.i.i.i26 = and i32 %6, -16384
  %7 = inttoptr i32 %and.i.i.i.i.i26 to ptr
  %preempt_count.i.i.i.i27 = getelementptr inbounds %struct.thread_info, ptr %7, i32 0, i32 1
  %8 = ptrtoint ptr %preempt_count.i.i.i.i27 to i32
  call void @__asan_load4_noabort(i32 %8)
  %9 = load volatile i32, ptr %preempt_count.i.i.i.i27, align 4
...
cleanup:                                          ; preds = %rcu_read_unlock.exit, %if.then5, %entry.cleanup_crit_edge
  %retval.0 = phi ptr [ null, %if.then5 ], [ %add.ptr.i, %rcu_read_unlock.exit ], [ null, %entry.cleanup_crit_edge ]
  ret ptr %retval.0
}
...
define internal void @mctp_test_dev_setup(ptr nocapture noundef writeonly %ndev) #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  ...
  store ptr @mctp_test_netdev_ops, ptr %netdev_ops, align 8
...
; Function Attrs: null_pointer_is_valid
declare dso_local ptr @__mctp_dev_get(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @mctp_dev_hold(ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local void @mctp_test_destroy_dev(ptr nocapture noundef readonly %dev) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
  %mdev = getelementptr inbounds %struct.mctp_test_dev, ptr %dev, i32 0, i32 1
  %0 = ptrtoint ptr %mdev to i32
  call void @__asan_load4_noabort(i32 %0)
  %1 = load ptr, ptr %mdev, align 4
  tail call void @mctp_dev_put(ptr noundef %1) #5
  %2 = ptrtoint ptr %dev to i32
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %dev, align 4
  tail call void @unregister_netdev(ptr noundef %3) #5
  ret void
}

; Function Attrs: null_pointer_is_valid
declare dso_local void @mctp_dev_put(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @unregister_netdev(ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal i32 @mctp_test_dev_tx(ptr noundef %skb, ptr nocapture noundef readnone %ndev) #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #7
  call void @llvm.arm.gnu.eabi.mcount()
...
!llvm.asan.globals = !{!0, !2, !4, !6, !7, !8, !10}
!llvm.named.register.sp = !{!11}
!llvm.module.flags = !{!12, !13, !14, !15, !16, !17, !18, !19}
!llvm.ident = !{!20}

!0 = !{ptr @.str, !1, !"<string literal>", i1 false, i1 false}
!1 = !{!"../net/mctp/test/utils.c", i32 41, i32 9}
!2 = !{ptr @mctp_test_netdev_ops, !3, !"mctp_test_netdev_ops", i1 false, i1 false}
!3 = !{!"../net/mctp/test/utils.c", i32 19, i32 36}
