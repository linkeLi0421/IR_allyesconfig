; ModuleID = '/llk/IR_all_yes/net/netfilter/ipvs/ip_vs_wlc.c_pt.bc'
source_filename = "../net/netfilter/ipvs/ip_vs_wlc.c"
...
@ip_vs_wlc_scheduler = internal global { %struct.ip_vs_scheduler, [52 x i8] } { %struct.ip_vs_scheduler { %struct.list_head { ptr @ip_vs_wlc_scheduler, ptr @ip_vs_wlc_scheduler }, ptr @.str, %struct.atomic_t zeroinitializer, ptr null, ptr null, ptr null, ptr null, ptr null, ptr null, ptr @ip_vs_wlc_schedule }, [52 x i8] zeroinitializer }, align 32
@__initcall__kmod_ip_vs_wlc__588_109_ip_vs_wlc_init6 = internal global ptr @ip_vs_wlc_init, section ".initcall6.init", align 4
@__exitcall_ip_vs_wlc_cleanup = internal global ptr @ip_vs_wlc_cleanup, section ".exitcall.exit", align 4
@__UNIQUE_ID_file589 = internal constant [44 x i8] c"ip_vs_wlc.file=net/netfilter/ipvs/ip_vs_wlc\00", section ".modinfo", align 1
@__UNIQUE_ID_license590 = internal constant [22 x i8] c"ip_vs_wlc.license=GPL\00", section ".modinfo", align 1
@.str = internal constant { [4 x i8], [28 x i8] } { [4 x i8] c"wlc\00", [28 x i8] zeroinitializer }, align 32
@ip_vs_wlc_schedule._entry = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.1, ptr @.str.2, ptr @.str.3, i32 35, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.1 = internal constant { [45 x i8], [51 x i8] } { [45 x i8] c"\017IPVS: ip_vs_wlc_schedule(): Scheduling...\0A\00", [51 x i8] zeroinitializer }, align 32
@.str.2 = internal constant { [19 x i8], [45 x i8] } { [19 x i8] c"ip_vs_wlc_schedule\00", [45 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [31 x i8], [33 x i8] } { [31 x i8] c"net/netfilter/ipvs/ip_vs_wlc.c\00", [33 x i8] zeroinitializer }, align 32
@ip_vs_wlc_schedule._entry_ptr = internal global ptr @ip_vs_wlc_schedule._entry, section ".printk_index", align 4
@ip_vs_wlc_schedule.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@ip_vs_wlc_schedule._entry.6 = internal constant { %struct.pi_entry, [40 x i8] } { %struct.pi_entry { ptr @.str.7, ptr @.str.2, ptr @.str.3, i32 82, ptr null, ptr null }, [40 x i8] zeroinitializer }, align 32
@.str.7 = internal constant { [74 x i8], [54 x i8] } { [74 x i8] c"\017IPVS: WLC: server %s:%u activeconns %d refcnt %d weight %d overhead %d\0A\00", [54 x i8] zeroinitializer }, align 32
@ip_vs_wlc_schedule._entry_ptr.8 = internal global ptr @ip_vs_wlc_schedule._entry.6, section ".printk_index", align 4
...
@___asan_gen_.11 = private unnamed_addr constant [20 x i8] c"ip_vs_wlc_scheduler\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 88, i32 31 }
@___asan_gen_.16 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 90, i32 12 }
@___asan_gen_.28 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 35, i32 2 }
@___asan_gen_.31 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 50, i32 2 }
@___asan_gen_.34 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 58, i32 27 }
@___asan_gen_.35 = private unnamed_addr constant [7 x i8] c"_entry\00", align 1
@___asan_gen_.39 = private constant [34 x i8] c"../net/netfilter/ipvs/ip_vs_wlc.c\00", align 1
@___asan_gen_.40 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.39, i32 76, i32 2 }
...
; Function Attrs: cold nounwind null_pointer_is_valid optsize sanitize_address sspstrong uwtable(sync)
define internal i32 @ip_vs_wlc_init() #0 section ".init.text" align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #8
  call void @llvm.arm.gnu.eabi.mcount()
  %call = tail call i32 @register_ip_vs_scheduler(ptr noundef nonnull @ip_vs_wlc_scheduler) #6
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal ptr @ip_vs_wlc_schedule(ptr noundef %svc, ptr nocapture noundef readnone %skb, ptr nocapture noundef readnone %iph) #2 align 64 {
entry:
...
land.lhs.true9:                                   ; preds = %land.lhs.true
  %.b128 = load i1, ptr @ip_vs_wlc_schedule.__warned, align 1
...
if.then11:                                        ; preds = %land.lhs.true9
  call void @__sanitizer_cov_trace_pc() #8
  store i1 true, ptr @ip_vs_wlc_schedule.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.3, i32 noundef 50, ptr noundef nonnull @.str.4) #6
  br label %do.end14
...
do.end14:                                         ; preds = %if.then11, %land.lhs.true9.do.end14_crit_edge, %land.lhs.true.do.end14_crit_edge, %do.body5.do.end14_crit_edge
  ...
  %dest.0143 = load volatile ptr, ptr %destinations, align 8
  %cmp21.not144 = icmp eq ptr %dest.0143, %destinations
  br i1 %cmp21.not144, label %do.end14.for.end_crit_edge, label %do.end14.for.body_crit_edge
...
for.body:                                         ; preds = %for.inc.for.body_crit_edge, %do.end14.for.body_crit_edge
  %dest.0145 = phi ptr [ %dest.0, %for.inc.for.body_crit_edge ], [ %dest.0143, %do.end14.for.body_crit_edge ]
  %flags = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.0145, i32 0, i32 5
...
land.lhs.true23:                                  ; preds = %for.body
  %weight = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.0145, i32 0, i32 7
...
if.then26:                                        ; preds = %land.lhs.true23
  %activeconns.i = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.0145, i32 0, i32 15
  ...
  %shl.i = shl i32 %6, 8
  %inactconns.i = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.0145, i32 0, i32 16
  ...
  %9 = ptrtoint ptr %dest.0145 to i32
  call void @__asan_load4_noabort(i32 %9)
  %dest.1146 = load volatile ptr, ptr %dest.0145, align 8
  %cmp50.not147 = icmp eq ptr %dest.1146, %destinations
  br i1 %cmp50.not147, label %if.then26.do.body81_crit_edge, label %if.then26.for.body51_crit_edge
...
for.inc:                                          ; preds = %land.lhs.true23.for.inc_crit_edge, %for.body.for.inc_crit_edge
  %10 = ptrtoint ptr %dest.0145 to i32
  call void @__asan_load4_noabort(i32 %10)
  %dest.0 = load volatile ptr, ptr %dest.0145, align 8
...
for.body51:                                       ; preds = %for.inc70.for.body51_crit_edge, %if.then26.for.body51_crit_edge
  %dest.1150 = phi ptr [ %dest.1, %for.inc70.for.body51_crit_edge ], [ %dest.1146, %if.then26.for.body51_crit_edge ]
  %least.0149 = phi ptr [ %least.1, %for.inc70.for.body51_crit_edge ], [ %dest.0145, %if.then26.for.body51_crit_edge ]
  %loh.0148 = phi i32 [ %loh.1, %for.inc70.for.body51_crit_edge ], [ %add.i, %if.then26.for.body51_crit_edge ]
  %flags52 = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.1150, i32 0, i32 5
  %11 = ptrtoint ptr %flags52 to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load volatile i32, ptr %flags52, align 4
  %and53 = and i32 %12, 2
...
if.end56:                                         ; preds = %for.body51
  call void @__sanitizer_cov_trace_pc() #8
  %activeconns.i134 = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.1150, i32 0, i32 15
  %call.i.i.i135 = tail call zeroext i1 @__kasan_check_read(ptr noundef %activeconns.i134, i32 noundef 4) #6
  %13 = ptrtoint ptr %activeconns.i134 to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load volatile i32, ptr %activeconns.i134, align 4
  %shl.i136 = shl i32 %14, 8
  %inactconns.i137 = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.1150, i32 0, i32 16
  %call.i.i3.i138 = tail call zeroext i1 @__kasan_check_read(ptr noundef %inactconns.i137, i32 noundef 4) #6
  %15 = ptrtoint ptr %inactconns.i137 to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load volatile i32, ptr %inactconns.i137, align 4
  %add.i139 = add i32 %16, %shl.i136
  %conv = sext i32 %loh.0148 to i64
  %weight58 = getelementptr inbounds %struct.ip_vs_dest, ptr %dest.1150, i32 0, i32 7
  %call.i.i130 = tail call zeroext i1 @__kasan_check_read(ptr noundef %weight58, i32 noundef 4) #6
  %17 = ptrtoint ptr %weight58 to i32
  call void @__asan_load4_noabort(i32 %17)
  %18 = load volatile i32, ptr %weight58, align 4
  %conv60 = sext i32 %18 to i64
  %mul = mul nsw i64 %conv60, %conv
  %conv61 = sext i32 %add.i139 to i64
  %weight62 = getelementptr inbounds %struct.ip_vs_dest, ptr %least.0149, i32 0, i32 7
  %call.i.i131 = tail call zeroext i1 @__kasan_check_read(ptr noundef %weight62, i32 noundef 4) #6
  %19 = ptrtoint ptr %weight62 to i32
  call void @__asan_load4_noabort(i32 %19)
  %20 = load volatile i32, ptr %weight62, align 4
  %conv64 = sext i32 %20 to i64
  %mul65 = mul nsw i64 %conv64, %conv61
  call void @__sanitizer_cov_trace_cmp8(i64 %mul, i64 %mul65)
  %cmp66 = icmp sgt i64 %mul, %mul65
  %spec.select = select i1 %cmp66, i32 %add.i139, i32 %loh.0148
  %spec.select129 = select i1 %cmp66, ptr %dest.1150, ptr %least.0149
  br label %for.inc70

for.inc70:                                        ; preds = %if.end56, %for.body51.for.inc70_crit_edge
  %loh.1 = phi i32 [ %loh.0148, %for.body51.for.inc70_crit_edge ], [ %spec.select, %if.end56 ]
  %least.1 = phi ptr [ %least.0149, %for.body51.for.inc70_crit_edge ], [ %spec.select129, %if.end56 ]
  %21 = ptrtoint ptr %dest.1150 to i32
  call void @__asan_load4_noabort(i32 %21)
  %dest.1 = load volatile ptr, ptr %dest.1150, align 8
...
do.body81:                                        ; preds = %for.inc70.do.body81_crit_edge, %if.then26.do.body81_crit_edge
  ...
  %least.0.lcssa = phi ptr [ %dest.0145, %if.then26.do.body81_crit_edge ], [ %least.1, %for.inc70.do.body81_crit_edge ]
...
ip_vs_dbg_addr.exit:                              ; preds = %do.end88
  ...
  %call.i.i.i140 = tail call zeroext i1 @__kasan_check_read(ptr noundef %refcnt, i32 noundef 4) #6
  ...
  %32 = ptrtoint ptr %weight95 to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load volatile i32, ptr %weight95, align 4
  %call97 = call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.7, ptr noundef nonnull %ip_vs_dbg_buf, i32 noundef %conv92, i32 noundef %29, i32 noundef %31, i32 noundef %33, i32 noundef %loh.0.lcssa) #9
  br label %if.end98
...
!0 = !{ptr @__initcall__kmod_ip_vs_wlc__588_109_ip_vs_wlc_init6, !1, !"__initcall__kmod_ip_vs_wlc__588_109_ip_vs_wlc_init6", i1 false, i1 false}
!1 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 109, i32 1}
!2 = !{ptr @__exitcall_ip_vs_wlc_cleanup, !3, !"__exitcall_ip_vs_wlc_cleanup", i1 false, i1 false}
!3 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 110, i32 1}
!4 = !{ptr @__UNIQUE_ID_file589, !5, !"__UNIQUE_ID_file589", i1 false, i1 false}
!5 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 111, i32 1}
!6 = !{ptr @__UNIQUE_ID_license590, !5, !"__UNIQUE_ID_license590", i1 false, i1 false}
!7 = !{ptr @.str, !8, !"<string literal>", i1 false, i1 false}
!8 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 90, i32 12}
!9 = !{ptr @ip_vs_wlc_scheduler, !10, !"ip_vs_wlc_scheduler", i1 false, i1 false}
!10 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 88, i32 31}
!11 = !{ptr @.str.1, !12, !"<string literal>", i1 false, i1 false}
!12 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 35, i32 2}
!13 = !{ptr @.str.2, !12, !"<string literal>", i1 false, i1 false}
!14 = !{ptr @.str.3, !12, !"<string literal>", i1 false, i1 false}
!15 = !{ptr @ip_vs_wlc_schedule._entry, !12, !"_entry", i1 false, i1 false}
!16 = !{ptr @ip_vs_wlc_schedule._entry_ptr, !12, !"_entry_ptr", i1 false, i1 false}
!17 = distinct !{null, !18, !"__warned", i1 false, i1 false}
!18 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 50, i32 2}
!19 = !{ptr @.str.4, !18, !"<string literal>", i1 false, i1 false}
!20 = !{ptr @.str.5, !21, !"<string literal>", i1 false, i1 false}
!21 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 58, i32 27}
!22 = !{ptr @.str.7, !23, !"<string literal>", i1 false, i1 false}
!23 = !{!"../net/netfilter/ipvs/ip_vs_wlc.c", i32 76, i32 2}
!24 = !{ptr @ip_vs_wlc_schedule._entry.6, !23, !"_entry", i1 false, i1 false}
!25 = !{ptr @ip_vs_wlc_schedule._entry_ptr.8, !23, !"_entry_ptr", i1 false, i1 false}
...
!40 = !{i64 2158032103, i64 2158032587, i64 2158032140, i64 2158032196, i64 2158032230, i64 2158032254, i64 2158032295, i64 2158032316, i64 2158032344, i64 2158032378}
