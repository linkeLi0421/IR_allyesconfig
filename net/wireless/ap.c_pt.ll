; ModuleID = '/llk/IR_all_yes/net/wireless/ap.c_pt.bc'
...
@.str = internal constant { [18 x i8], [46 x i8] } { [18 x i8] c"net/wireless/ap.c\00", [46 x i8] zeroinitializer }, align 32
...
@trace_rdev_stop_ap.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@___asan_gen_.5 = private constant [21 x i8] c"../net/wireless/ap.c\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 16, i32 2 }
@___asan_gen_.11 = private unnamed_addr constant [24 x i8] c"../net/wireless/trace.h\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 657, i32 1 }
...
define dso_local i32 @__cfg80211_stop_ap(ptr noundef %rdev, ptr noundef %dev, i1 noundef zeroext %notify) local_unnamed_addr #0 align 64 {
entry:
...
do.end:                                           ; preds = %land.rhs
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 16, i32 noundef 9, ptr noundef null) #4
  br label %if.end

if.end:                                           ; preds = %do.end, %land.rhs.if.end_crit_edge, %entry.if.end_crit_edge
  %3 = ptrtoint ptr %rdev to i32
  call void @__asan_load4_noabort(i32 %3)
  %4 = load ptr, ptr %rdev, align 32
  %stop_ap = getelementptr inbounds %struct.cfg80211_ops, ptr %4, i32 0, i32 14
  %5 = ptrtoint ptr %stop_ap to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %stop_ap, align 4
...
if.end26:                                         ; preds = %if.end
  %7 = ptrtoint ptr %ieee80211_ptr to i32
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %ieee80211_ptr, align 16
  %iftype = getelementptr inbounds %struct.wireless_dev, ptr %8, i32 0, i32 1
  %9 = ptrtoint ptr %iftype to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load i32, ptr %iftype, align 4
  %11 = zext i32 %10 to i64
  call void @__sanitizer_cov_trace_switch(i64 %11, ptr @__sancov_gen_cov_switch_values)
  switch i32 %10, label %if.end26.cleanup_crit_edge [
    i32 3, label %if.end26.if.end33_crit_edge
    i32 9, label %if.end26.if.end33_crit_edge66
  ]

if.end26.if.end33_crit_edge66:                    ; preds = %if.end26
  call void @__sanitizer_cov_trace_pc() #6
  br label %if.end33
...
if.end33:                                         ; preds = %if.end26.if.end33_crit_edge, %if.end26.if.end33_crit_edge66
  %beacon_interval = getelementptr inbounds %struct.wireless_dev, ptr %1, i32 0, i32 32
  %12 = ptrtoint ptr %beacon_interval to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load i32, ptr %beacon_interval, align 4
...
if.end36:                                         ; preds = %if.end33
  ...
  tail call fastcc void @trace_rdev_stop_ap(ptr noundef %wiphy.i, ptr noundef %dev) #4
  %14 = ptrtoint ptr %rdev to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load ptr, ptr %rdev, align 32
  %stop_ap.i = getelementptr inbounds %struct.cfg80211_ops, ptr %15, i32 0, i32 14
  %16 = ptrtoint ptr %stop_ap.i to i32
  call void @__asan_load4_noabort(i32 %16)
  %17 = load ptr, ptr %stop_ap.i, align 4
  %call.i63 = tail call i32 %17(ptr noundef %wiphy.i, ptr noundef %dev) #4
  tail call fastcc void @trace_rdev_return_int(ptr noundef %wiphy.i, i32 noundef %call.i63) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i63)
  %tobool38.not = icmp eq i32 %call.i63, 0
  br i1 %tobool38.not, label %if.then39, label %if.end36.if.end45_crit_edge
...
if.then39:                                        ; preds = %if.end36
  ...
  %18 = ptrtoint ptr %conn_owner_nlportid to i32
  ...
  %21 = ptrtoint ptr %ssid_len to i32
  call void @__asan_store1_noabort(i32 %21)
  store i8 0, ptr %ssid_len, align 2
  %22 = ptrtoint ptr %rdev to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %rdev, align 32
  %set_qos_map.i = getelementptr inbounds %struct.cfg80211_ops, ptr %23, i32 0, i32 89
  %24 = ptrtoint ptr %set_qos_map.i to i32
  call void @__asan_load4_noabort(i32 %24)
  %25 = load ptr, ptr %set_qos_map.i, align 4
  %tobool.not.i = icmp eq ptr %25, null
  br i1 %tobool.not.i, label %if.then39.rdev_set_qos_map.exit_crit_edge, label %if.then.i

if.then39.rdev_set_qos_map.exit_crit_edge:        ; preds = %if.then39
  call void @__sanitizer_cov_trace_pc() #6
...
if.then.i:                                        ; preds = %if.then39
  ...
  %27 = load ptr, ptr %rdev, align 32
  %set_qos_map2.i = getelementptr inbounds %struct.cfg80211_ops, ptr %27, i32 0, i32 89
  %28 = ptrtoint ptr %set_qos_map2.i to i32
  call void @__asan_load4_noabort(i32 %28)
  %29 = load ptr, ptr %set_qos_map2.i, align 4
  %call.i65 = tail call i32 %29(ptr noundef %wiphy.i, ptr noundef %dev, ptr noundef null) #4
  tail call fastcc void @trace_rdev_return_int(ptr noundef %wiphy.i, i32 noundef %call.i65) #4
  br label %rdev_set_qos_map.exit

rdev_set_qos_map.exit:                            ; preds = %if.then.i, %if.then39.rdev_set_qos_map.exit_crit_edge
  br i1 %notify, label %if.then43, label %rdev_set_qos_map.exit.if.end44_crit_edge

rdev_set_qos_map.exit.if.end44_crit_edge:         ; preds = %rdev_set_qos_map.exit
  call void @__sanitizer_cov_trace_pc() #6
  br label %if.end44

if.then43:                                        ; preds = %rdev_set_qos_map.exit
  call void @__sanitizer_cov_trace_pc() #6
  tail call void @nl80211_send_ap_stopped(ptr noundef %1) #4
  br label %if.end44

if.end44:                                         ; preds = %if.then43, %rdev_set_qos_map.exit.if.end44_crit_edge
  tail call void @cfg80211_sched_dfs_chan_update(ptr noundef %rdev) #4
  br label %if.end45

if.end45:                                         ; preds = %if.end44, %if.end36.if.end45_crit_edge
  call void @__asan_load4_noabort(i32 ptrtoint (ptr @system_wq to i32))
  %30 = load ptr, ptr @system_wq, align 4
  %call.i.i = tail call zeroext i1 @queue_work_on(i32 noundef 4, ptr noundef %30, ptr noundef nonnull @cfg80211_disconnect_work) #4
  br label %cleanup

cleanup:                                          ; preds = %if.end45, %if.end33.cleanup_crit_edge, %if.end26.cleanup_crit_edge, %if.end.cleanup_crit_edge
  %retval.0 = phi i32 [ %call.i63, %if.end45 ], [ -95, %if.end.cleanup_crit_edge ], [ -95, %if.end26.cleanup_crit_edge ], [ -2, %if.end33.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local void @nl80211_send_ap_stopped(ptr noundef) local_unnamed_addr #1

; Function Attrs: null_pointer_is_valid
declare dso_local void @cfg80211_sched_dfs_chan_update(ptr noundef) local_unnamed_addr #1

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @cfg80211_stop_ap(ptr noundef %rdev, ptr noundef %dev, i1 noundef zeroext %notify) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %ieee80211_ptr = getelementptr inbounds %struct.net_device, ptr %dev, i32 0, i32 82
  ...
  %call = tail call i32 @__cfg80211_stop_ap(ptr noundef %rdev, ptr noundef %dev, i1 noundef zeroext %notify)
...
define internal fastcc void @trace_rdev_stop_ap(ptr noundef %wiphy, ptr noundef %netdev) unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_stop_ap, i32 0, i32 1), ptr blockaddress(@trace_rdev_stop_ap, %do.body)) #4
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_rdev_stop_ap(ptr noundef null, ptr noundef %wiphy, ptr noundef %netdev) #4
...
if.then52:                                        ; preds = %cpu_online.exit85
  ...
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_stop_ap, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_stop_ap, i32 0, i32 7), align 4
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_rdev_stop_ap.__warned, align 1
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #6
  store i1 true, ptr @trace_rdev_stop_ap.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.1, i32 noundef 660, ptr noundef nonnull @.str.2) #4
  br label %do.end67
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @__traceiter_rdev_stop_ap(ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #1
...
land.rhs.i.i.i.i8:                                ; preds = %if.end48
  ...
  br i1 %.b37.i.i.i.i7, label %land.rhs.i.i.i.i8.cpu_online.exit14_crit_edge, label %if.then.i.i.i.i9, !prof !28
...
!1 = !{!"../net/wireless/ap.c", i32 16, i32 2}
!2 = distinct !{null, !3, !"__already_done", i1 false, i1 false}
!3 = !{!"../net/wireless/trace.h", i32 657, i32 1}
...
!14 = !{!"../net/wireless/trace.h", i32 2279, i32 1}
...
!27 = !{i64 2148959465, i64 2148959470, i64 2148959483, i64 2148959527, i64 2148959561, i64 2148959582}
