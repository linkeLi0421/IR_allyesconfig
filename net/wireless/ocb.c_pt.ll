; ModuleID = '/llk/IR_all_yes/net/wireless/ocb.c_pt.bc'
...
@.str = internal constant { [19 x i8], [45 x i8] } { [19 x i8] c"net/wireless/ocb.c\00", [45 x i8] zeroinitializer }, align 32
...
@trace_rdev_join_ocb.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
...
@trace_rdev_leave_ocb.__warned = internal unnamed_addr global i1 false, section ".data.unlikely", align 1
@___asan_gen_.5 = private constant [22 x i8] c"../net/wireless/ocb.c\00", align 1
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.5, i32 24, i32 2 }
@___asan_gen_.11 = private unnamed_addr constant [24 x i8] c"../net/wireless/trace.h\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.11, i32 1519, i32 1 }
...
define dso_local i32 @__cfg80211_join_ocb(ptr noundef %rdev, ptr noundef %dev, ptr noundef %setup) local_unnamed_addr #0 align 64 {
entry:
...
land.rhs:                                         ; preds = %entry
  ...
  br i1 %cmp.not, label %do.end, label %land.rhs.if.end_crit_edge, !prof !26
...
if.end27:                                         ; preds = %if.end
  ...
  %join_ocb = getelementptr inbounds %struct.cfg80211_ops, ptr %8, i32 0, i32 31
  %9 = ptrtoint ptr %join_ocb to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %join_ocb, align 4
...
if.end30:                                         ; preds = %if.end27
  ...
  br i1 %tobool32.not, label %do.end50, label %if.end66, !prof !26

do.end50:                                         ; preds = %if.end30
  call void @__sanitizer_cov_trace_pc() #6
  tail call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str, i32 noundef 32, i32 noundef 9, ptr noundef null) #4
  br label %cleanup

if.end66:                                         ; preds = %if.end30
  %wiphy.i = getelementptr inbounds %struct.cfg80211_registered_device, ptr %rdev, i32 0, i32 48
  tail call fastcc void @trace_rdev_join_ocb(ptr noundef %wiphy.i, ptr noundef %dev, ptr noundef %setup) #4
  %13 = ptrtoint ptr %rdev to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load ptr, ptr %rdev, align 32
  %join_ocb.i = getelementptr inbounds %struct.cfg80211_ops, ptr %14, i32 0, i32 31
  %15 = ptrtoint ptr %join_ocb.i to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %join_ocb.i, align 4
  %call.i83 = tail call i32 %16(ptr noundef %wiphy.i, ptr noundef %dev, ptr noundef %setup) #4
  tail call fastcc void @trace_rdev_return_int(ptr noundef %wiphy.i, i32 noundef %call.i83) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i83)
  %tobool68.not = icmp eq i32 %call.i83, 0
  br i1 %tobool68.not, label %if.then69, label %if.end66.cleanup_crit_edge
...
if.then69:                                        ; preds = %if.end66
  call void @__sanitizer_cov_trace_pc() #6
  %chandef70 = getelementptr inbounds %struct.wireless_dev, ptr %1, i32 0, i32 27
  %17 = call ptr @memcpy(ptr %chandef70, ptr %setup, i32 28)
  br label %cleanup

cleanup:                                          ; preds = %if.then69, %if.end66.cleanup_crit_edge, %do.end50, %if.end27.cleanup_crit_edge, %if.end.cleanup_crit_edge
  %retval.0 = phi i32 [ -22, %do.end50 ], [ -95, %if.end.cleanup_crit_edge ], [ -95, %if.end27.cleanup_crit_edge ], [ 0, %if.then69 ], [ %call.i83, %if.end66.cleanup_crit_edge ]
  ret i32 %retval.0
}
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @cfg80211_join_ocb(ptr noundef %rdev, ptr noundef %dev, ptr noundef %setup) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %ieee80211_ptr = getelementptr inbounds %struct.net_device, ptr %dev, i32 0, i32 82
  ...
  %call = tail call i32 @__cfg80211_join_ocb(ptr noundef %rdev, ptr noundef %dev, ptr noundef %setup)
  tail call void @mutex_unlock(ptr noundef %mtx.i) #4
  ret i32 %call
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @__cfg80211_leave_ocb(ptr noundef %rdev, ptr noundef %dev) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %ieee80211_ptr = getelementptr inbounds %struct.net_device, ptr %dev, i32 0, i32 82
...
if.end27:                                         ; preds = %if.end
  ...
  call void @__asan_load4_noabort(i32 %7)
  %8 = load ptr, ptr %rdev, align 32
  %leave_ocb = getelementptr inbounds %struct.cfg80211_ops, ptr %8, i32 0, i32 32
  %9 = ptrtoint ptr %leave_ocb to i32
  call void @__asan_load4_noabort(i32 %9)
  %10 = load ptr, ptr %leave_ocb, align 4
  %tobool28.not = icmp eq ptr %10, null
  br i1 %tobool28.not, label %if.end27.cleanup_crit_edge, label %if.end30
...
if.end30:                                         ; preds = %if.end27
  %wiphy.i = getelementptr inbounds %struct.cfg80211_registered_device, ptr %rdev, i32 0, i32 48
  tail call fastcc void @trace_rdev_leave_ocb(ptr noundef %wiphy.i, ptr noundef %dev) #4
  %11 = ptrtoint ptr %rdev to i32
  call void @__asan_load4_noabort(i32 %11)
  %12 = load ptr, ptr %rdev, align 32
  %leave_ocb.i = getelementptr inbounds %struct.cfg80211_ops, ptr %12, i32 0, i32 32
  %13 = ptrtoint ptr %leave_ocb.i to i32
  call void @__asan_load4_noabort(i32 %13)
  %14 = load ptr, ptr %leave_ocb.i, align 4
  %call.i42 = tail call i32 %14(ptr noundef %wiphy.i, ptr noundef %dev) #4
  tail call fastcc void @trace_rdev_return_int(ptr noundef %wiphy.i, i32 noundef %call.i42) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call.i42)
  %tobool32.not = icmp eq i32 %call.i42, 0
...
if.then33:                                        ; preds = %if.end30
  ...
  %15 = call ptr @memset(ptr %chandef, i32 0, i32 28)
  br label %cleanup

cleanup:                                          ; preds = %if.then33, %if.end30.cleanup_crit_edge, %if.end27.cleanup_crit_edge, %if.end.cleanup_crit_edge
  %retval.0 = phi i32 [ -95, %if.end.cleanup_crit_edge ], [ -95, %if.end27.cleanup_crit_edge ], [ 0, %if.then33 ], [ %call.i42, %if.end30.cleanup_crit_edge ]
  ret i32 %retval.0
}

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @cfg80211_leave_ocb(ptr noundef %rdev, ptr noundef %dev) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  call void @llvm.arm.gnu.eabi.mcount()
  %ieee80211_ptr = getelementptr inbounds %struct.net_device, ptr %dev, i32 0, i32 82
  ...
  %mtx.i = getelementptr inbounds %struct.wireless_dev, ptr %1, i32 0, i32 7
  tail call void @mutex_lock_nested(ptr noundef %mtx.i, i32 noundef 0) #4
  %call = tail call i32 @__cfg80211_leave_ocb(ptr noundef %rdev, ptr noundef %dev)
  tail call void @mutex_unlock(ptr noundef %mtx.i) #4
  ret i32 %call
}
...
define internal fastcc void @trace_rdev_join_ocb(ptr noundef %wiphy, ptr noundef %netdev, ptr noundef %setup) unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_join_ocb, i32 0, i32 1), ptr blockaddress(@trace_rdev_join_ocb, %do.body)) #4
          to label %if.end48 [label %do.body], !srcloc !27
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  call void @__sanitizer_cov_trace_pc() #6
  %9 = tail call i32 @llvm.read_register.i32(metadata !16) #4
  ...
  %call42 = tail call i32 @__traceiter_rdev_join_ocb(ptr noundef null, ptr noundef %wiphy, ptr noundef %netdev, ptr noundef %setup) #4
  tail call void asm sideeffect "", "~{memory}"() #4, !srcloc !30
  %13 = tail call i32 @llvm.read_register.i32(metadata !16) #4
...
if.end48:                                         ; preds = %cleanup.thread, %entry
  %17 = tail call i32 @llvm.read_register.i32(metadata !16) #4
...
if.then52:                                        ; preds = %cpu_online.exit85
  %26 = tail call i32 @llvm.read_register.i32(metadata !16) #4
  ...
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_join_ocb, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_join_ocb, i32 0, i32 7), align 4
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_rdev_join_ocb.__warned, align 1
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #6
  store i1 true, ptr @trace_rdev_join_ocb.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.1, i32 noundef 1533, ptr noundef nonnull @.str.2) #4
  br label %do.end67

do.end67:                                         ; preds = %if.then64, %land.lhs.true62.do.end67_crit_edge, %land.lhs.true.do.end67_crit_edge, %if.then52.do.end67_crit_edge
  tail call void asm sideeffect "", "~{memory}"() #4, !srcloc !32
  %31 = tail call i32 @llvm.read_register.i32(metadata !16) #4
...
; Function Attrs: inlinehint nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal fastcc void @trace_rdev_leave_ocb(ptr noundef %wiphy, ptr noundef %netdev) unnamed_addr #2 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #6
  callbr void asm sideeffect "1:\0A\09nop\0A\09.pushsection __jump_table,  \22aw\22\0A\09.word 1b, ${1:l}, ${0:c}\0A\09.popsection\0A\09", "i,i"(ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_leave_ocb, i32 0, i32 1), ptr blockaddress(@trace_rdev_leave_ocb, %do.body)) #4
          to label %if.end48 [label %do.body], !srcloc !27
...
cleanup.thread:                                   ; preds = %cpu_online.exit
  ...
  %call42 = tail call i32 @__traceiter_rdev_leave_ocb(ptr noundef null, ptr noundef %wiphy, ptr noundef %netdev) #4
...
if.then52:                                        ; preds = %cpu_online.exit85
  ...
  store volatile i32 %add.i.i, ptr %preempt_count.i.i.i, align 4
  tail call void asm sideeffect "", "~{memory}"() #4, !srcloc !31
  call void @__asan_load4_noabort(i32 ptrtoint (ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_leave_ocb, i32 0, i32 7) to i32))
  %30 = load volatile ptr, ptr getelementptr inbounds (%struct.tracepoint, ptr @__tracepoint_rdev_leave_ocb, i32 0, i32 7), align 4
  %call58 = tail call i32 @rcu_read_lock_sched_held() #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call58)
  %tobool59.not = icmp eq i32 %call58, 0
  br i1 %tobool59.not, label %land.lhs.true, label %if.then52.do.end67_crit_edge
...
land.lhs.true62:                                  ; preds = %land.lhs.true
  %.b72 = load i1, ptr @trace_rdev_leave_ocb.__warned, align 1
  br i1 %.b72, label %land.lhs.true62.do.end67_crit_edge, label %if.then64
...
if.then64:                                        ; preds = %land.lhs.true62
  call void @__sanitizer_cov_trace_pc() #6
  store i1 true, ptr @trace_rdev_leave_ocb.__warned, align 1
  tail call void @lockdep_rcu_suspicious(ptr noundef nonnull @.str.1, i32 noundef 685, ptr noundef nonnull @.str.2) #4
  br label %do.end67
...
!llvm.asan.globals = !{!0, !2, !4, !5, !6, !7, !9, !10, !12, !13, !15}
!llvm.named.register.sp = !{!16}
!llvm.module.flags = !{!17, !18, !19, !20, !21, !22, !23, !24}
!llvm.ident = !{!25}

!0 = !{ptr @.str, !1, !"<string literal>", i1 false, i1 false}
!1 = !{!"../net/wireless/ocb.c", i32 24, i32 2}
!2 = distinct !{null, !3, !"__already_done", i1 false, i1 false}
!3 = !{!"../net/wireless/trace.h", i32 1519, i32 1}
...
!11 = !{!"../net/wireless/trace.h", i32 281, i32 1}
!12 = distinct !{null, !11, !"__warned", i1 false, i1 false}
!13 = distinct !{null, !14, !"__already_done", i1 false, i1 false}
!14 = !{!"../net/wireless/trace.h", i32 682, i32 1}
...
!27 = !{i64 2148959993, i64 2148959998, i64 2148960011, i64 2148960055, i64 2148960089, i64 2148960110}
