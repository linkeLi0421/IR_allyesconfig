; ModuleID = '/llk/IR_all_yes/security/keys/encrypted-keys/masterkey_trusted.c_pt.bc'
source_filename = "../security/keys/encrypted-keys/masterkey_trusted.c"
...
@key_type_trusted = external dso_local global %struct.key_type, align 1
@llvm.used = appending global [1 x ptr] [ptr @asan.module_ctor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local ptr @request_trusted_key(ptr noundef %trusted_desc, ptr nocapture noundef writeonly %master_key, ptr nocapture noundef writeonly %master_keylen) local_unnamed_addr #0 align 64 {
entry:
  call void @__sanitizer_cov_trace_pc() #4
  call void @llvm.arm.gnu.eabi.mcount()
  %call.i = tail call ptr @request_key_tag(ptr noundef nonnull @key_type_trusted, ptr noundef %trusted_desc, ptr noundef null, ptr noundef null) #2
...
if.end:                                           ; preds = %entry
  ...
  tail call void @down_read(ptr noundef %sem) #2
  %0 = getelementptr inbounds %struct.key, ptr %call.i, i32 0, i32 17
  %1 = ptrtoint ptr %0 to i32
  call void @__asan_load4_noabort(i32 %1)
  %2 = load ptr, ptr %0, align 4
  %key = getelementptr inbounds %struct.trusted_key_payload, ptr %2, i32 0, i32 5
  %3 = ptrtoint ptr %master_key to i32
  call void @__asan_store4_noabort(i32 %3)
  store ptr %key, ptr %master_key, align 4
  ...
  %6 = ptrtoint ptr %master_keylen to i32
  call void @__asan_store4_noabort(i32 %6)
  store i32 %5, ptr %master_keylen, align 4
  br label %error
