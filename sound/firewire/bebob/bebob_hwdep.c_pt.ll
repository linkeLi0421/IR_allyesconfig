; ModuleID = '/llk/IR_all_yes/sound/firewire/bebob/bebob_hwdep.c_pt.bc'
source_filename = "../sound/firewire/bebob/bebob_hwdep.c"
...
@snd_bebob_create_hwdep_device.ops = internal constant { %struct.snd_hwdep_ops, [52 x i8] } { %struct.snd_hwdep_ops { ptr null, ptr @hwdep_read, ptr null, ptr null, ptr @hwdep_release, ptr @hwdep_poll, ptr @hwdep_ioctl, ptr null, ptr null, ptr null, ptr null }, [52 x i8] zeroinitializer }, align 32
@.str = internal constant { [6 x i8], [26 x i8] } { [6 x i8] c"BeBoB\00", [26 x i8] zeroinitializer }, align 32
...
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 173, i32 36 }
@___asan_gen_.8 = private constant [38 x i8] c"../sound/firewire/bebob/bebob_hwdep.c\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 183, i32 35 }
...
entry:
  ...
  %lock = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 4
  call void @_raw_spin_lock_irq(ptr noundef %lock) #5
  %dev_lock_changed = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 18
  %16 = ptrtoint ptr %dev_lock_changed to i32
  call void @__asan_load1_noabort(i32 %16)
  %17 = load i8, ptr %dev_lock_changed, align 4, !range !22
  call void @__sanitizer_cov_trace_const_cmp1(i8 0, i8 %17)
  %tobool.not35 = icmp eq i8 %17, 0
  br i1 %tobool.not35, label %while.body.lr.ph, label %entry.while.end_crit_edge
...
while.body.lr.ph:                                 ; preds = %entry
  %hwdep_wait = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 19
  br label %while.body
...
if.end:                                           ; preds = %signal_pending.exit
  ...
  %28 = load i8, ptr %dev_lock_changed, align 4, !range !22
...
while.end:                                        ; preds = %if.end.while.end_crit_edge, %entry.while.end_crit_edge
  ...
  %30 = call i32 @llvm.smin.i32(i32 %count, i32 8)
  %dev_lock_count = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 17
  %31 = ptrtoint ptr %dev_lock_count to i32
  call void @__asan_load4_noabort(i32 %31)
  %32 = load i32, ptr %dev_lock_count, align 8
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %32)
  %cmp11 = icmp sgt i32 %32, 0
  %conv = zext i1 %cmp11 to i32
  %33 = ptrtoint ptr %15 to i32
  call void @__asan_store4_noabort(i32 %33)
  store i32 %conv, ptr %15, align 4
  %34 = ptrtoint ptr %dev_lock_changed to i32
  call void @__asan_store1_noabort(i32 %34)
  store i8 0, ptr %dev_lock_changed, align 4
  call void @_raw_spin_unlock_irq(ptr noundef %lock) #5
  call void @__sanitizer_cov_trace_const_cmp4(i32 8, i32 %30)
  %cmp1.i.i = icmp ugt i32 %30, 8
  br i1 %cmp1.i.i, label %if.then3.i.i, label %if.then.i.i.i, !prof !24

if.then3.i.i:                                     ; preds = %while.end
  call void @__sanitizer_cov_trace_pc() #7
  call void (ptr, i32, i32, ptr, ...) @warn_slowpath_fmt(ptr noundef nonnull @.str.1, i32 noundef 214, i32 noundef 9, ptr noundef nonnull @.str.2, i32 noundef 8, i32 noundef %30) #5
  br label %cleanup

if.then.i.i.i:                                    ; preds = %while.end
  call void @__check_object_size(ptr noundef nonnull %event, i32 noundef %30, i1 noundef zeroext true) #5
...
if.end.i.i:                                       ; preds = %if.then.i.i.i
  %35 = call { i32, i32 } asm ".syntax unified\0Aadds $1, $2, $3; sbcscc $1, $1, $0; movcc $0, #0", "=&r,=&r,r,Ir,0,~{cc}"(ptr %buf, i32 %30, i32 -1226833920) #8, !srcloc !25
...
if.then2.i.i:                                     ; preds = %if.end.i.i
  call void @__sanitizer_cov_trace_pc() #7
  %call.i.i.i = call zeroext i1 @__kasan_check_read(ptr noundef nonnull %event, i32 noundef %30) #5
  %call.i12.i.i = call i32 @arm_copy_to_user(ptr noundef %buf, ptr noundef nonnull %event, i32 noundef %30) #5
  br label %copy_to_user.exit

copy_to_user.exit:                                ; preds = %if.then2.i.i, %if.end.i.i.copy_to_user.exit_crit_edge, %if.then.i.i.i.copy_to_user.exit_crit_edge
  %n.addr.0.i = phi i32 [ %30, %if.then.i.i.i.copy_to_user.exit_crit_edge ], [ %call.i12.i.i, %if.then2.i.i ], [ %30, %if.end.i.i.copy_to_user.exit_crit_edge ]
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %n.addr.0.i)
  %tobool15.not = icmp eq i32 %n.addr.0.i, 0
  %spec.select = select i1 %tobool15.not, i32 %30, i32 -14
  br label %cleanup
...
sw.bb:                                            ; preds = %entry
  ...
  %unit.i = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 1
  ...
  call void @__asan_store4_noabort(i32 %14)
  store i32 3, ptr %info.i, align 4
...
sw.bb1:                                           ; preds = %entry
  %lock.i = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 4
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i) #5
  %dev_lock_count.i = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 17
...
sw.bb3:                                           ; preds = %entry
  %lock.i7 = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 4
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i7) #5
  %dev_lock_count.i8 = getelementptr inbounds %struct.snd_bebob, ptr %1, i32 0, i32 17
...
!0 = !{ptr @snd_bebob_create_hwdep_device.ops, !1, !"ops", i1 false, i1 false}
!1 = !{!"../sound/firewire/bebob/bebob_hwdep.c", i32 173, i32 36}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../sound/firewire/bebob/bebob_hwdep.c", i32 183, i32 35}
...
!25 = !{i64 2152274176, i64 2152274201}
