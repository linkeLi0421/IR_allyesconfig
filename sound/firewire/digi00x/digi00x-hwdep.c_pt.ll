; ModuleID = '/llk/IR_all_yes/sound/firewire/digi00x/digi00x-hwdep.c_pt.bc'
source_filename = "../sound/firewire/digi00x/digi00x-hwdep.c"
...
@snd_dg00x_create_hwdep_device.ops = internal constant { %struct.snd_hwdep_ops, [52 x i8] } { %struct.snd_hwdep_ops { ptr null, ptr @hwdep_read, ptr null, ptr null, ptr @hwdep_release, ptr @hwdep_poll, ptr @hwdep_ioctl, ptr null, ptr null, ptr null, ptr null }, [52 x i8] zeroinitializer }, align 32
@.str = internal constant { [8 x i8], [24 x i8] } { [8 x i8] c"Digi00x\00", [24 x i8] zeroinitializer }, align 32
...
@___asan_gen_.6 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 177, i32 36 }
@___asan_gen_.8 = private constant [42 x i8] c"../sound/firewire/digi00x/digi00x-hwdep.c\00", align 1
@___asan_gen_.9 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.8, i32 187, i32 35 }
...
entry:
  ...
  %lock = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 3
  call void @_raw_spin_lock_irq(ptr noundef %lock) #5
  %dev_lock_changed = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 10
  %16 = ptrtoint ptr %dev_lock_changed to i32
  call void @__asan_load1_noabort(i32 %16)
  %17 = load i8, ptr %dev_lock_changed, align 8, !range !22
...
land.rhs.lr.ph:                                   ; preds = %entry
  %msg = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 13
  %hwdep_wait = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 11
  br label %land.rhs
...
if.end:                                           ; preds = %signal_pending.exit
  ...
  %30 = load i8, ptr %dev_lock_changed, align 8, !range !22
...
if.then13:                                        ; preds = %if.end.if.then13_crit_edge, %entry.if.then13_crit_edge
  ...
  %dev_lock_count = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 9
  %32 = ptrtoint ptr %dev_lock_count to i32
  call void @__asan_load4_noabort(i32 %32)
  %33 = load i32, ptr %dev_lock_count, align 4
...
if.else:                                          ; preds = %land.rhs
  ...
  store i64 8389770063531474944, ptr %event, align 8
  %37 = ptrtoint ptr %msg to i32
  call void @__asan_load4_noabort(i32 %37)
  %38 = load i32, ptr %msg, align 8
...
lor.lhs.false:                                    ; preds = %poll_wait.exit
  ...
  %spec.select = select i1 %tobool1.not, i32 0, i32 65
  br label %if.end
...
sw.bb1:                                           ; preds = %entry
  %lock.i = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 3
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i) #5
  %dev_lock_count.i = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 9
...
sw.bb3:                                           ; preds = %entry
  %lock.i7 = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 3
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i7) #5
  %dev_lock_count.i8 = getelementptr inbounds %struct.snd_dg00x, ptr %1, i32 0, i32 9
...
!0 = !{ptr @snd_dg00x_create_hwdep_device.ops, !1, !"ops", i1 false, i1 false}
!1 = !{!"../sound/firewire/digi00x/digi00x-hwdep.c", i32 177, i32 36}
!2 = !{ptr @.str, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../sound/firewire/digi00x/digi00x-hwdep.c", i32 187, i32 35}
...
!25 = !{i64 2152271400, i64 2152271425}
