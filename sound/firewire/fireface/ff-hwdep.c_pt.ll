; ModuleID = '/llk/IR_all_yes/sound/firewire/fireface/ff-hwdep.c_pt.bc'
source_filename = "../sound/firewire/fireface/ff-hwdep.c"
...
@snd_ff_create_hwdep_devices.hwdep_ops = internal constant { %struct.snd_hwdep_ops, [52 x i8] } { %struct.snd_hwdep_ops { ptr null, ptr @hwdep_read, ptr null, ptr null, ptr @hwdep_release, ptr @hwdep_poll, ptr @hwdep_ioctl, ptr null, ptr null, ptr null, ptr null }, [52 x i8] zeroinitializer }, align 32
...
@___asan_gen_.4 = private constant [38 x i8] c"../sound/firewire/fireface/ff-hwdep.c\00", align 1
...
if.end:                                           ; preds = %entry
  ...
  store i32 26, ptr %iface, align 8
  %ops = getelementptr inbounds %struct.snd_hwdep, ptr %4, i32 0, i32 8
  %8 = call ptr @memcpy(ptr %ops, ptr @snd_ff_create_hwdep_devices.hwdep_ops, i32 44)
...
entry:
  ...
  %lock = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 3
  call void @_raw_spin_lock_irq(ptr noundef %lock) #6
  %dev_lock_changed = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 22
  %16 = ptrtoint ptr %dev_lock_changed to i32
  call void @__asan_load1_noabort(i32 %16)
  %17 = load i8, ptr %dev_lock_changed, align 4, !range !20
...
while.body.lr.ph:                                 ; preds = %entry
  %hwdep_wait = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 23
  br label %while.body
...
if.end:                                           ; preds = %signal_pending.exit
  ...
  %28 = load i8, ptr %dev_lock_changed, align 4, !range !20
...
while.end:                                        ; preds = %if.end.while.end_crit_edge, %entry.while.end_crit_edge
  ...
  %dev_lock_count = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 21
  %30 = ptrtoint ptr %dev_lock_count to i32
  call void @__asan_load4_noabort(i32 %30)
  %31 = load i32, ptr %dev_lock_count, align 8
...
poll_wait.exit:                                   ; preds = %if.then.i, %land.lhs.true.i.poll_wait.exit_crit_edge, %entry.poll_wait.exit_crit_edge
  ...
  %5 = load i8, ptr %dev_lock_changed, align 4, !range !20
...
sw.bb:                                            ; preds = %entry
  ...
  %unit.i = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 1
  ...
  call void @__asan_store4_noabort(i32 %14)
  store i32 8, ptr %info.i, align 4
...
sw.bb1:                                           ; preds = %entry
  %lock.i = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 3
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i) #6
  %dev_lock_count.i = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 21
...
sw.bb3:                                           ; preds = %entry
  %lock.i7 = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 3
  tail call void @_raw_spin_lock_irq(ptr noundef %lock.i7) #6
  %dev_lock_count.i8 = getelementptr inbounds %struct.snd_ff, ptr %1, i32 0, i32 21
...
!0 = !{ptr @snd_ff_create_hwdep_devices.hwdep_ops, !1, !"hwdep_ops", i1 false, i1 false}
!1 = !{!"../sound/firewire/fireface/ff-hwdep.c", i32 167, i32 36}
...
!23 = !{i64 2153234215, i64 2153234240}
