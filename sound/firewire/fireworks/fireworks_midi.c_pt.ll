; ModuleID = '/llk/IR_all_yes/sound/firewire/fireworks/fireworks_midi.c_pt.bc'
source_filename = "../sound/firewire/fireworks/fireworks_midi.c"
...
@snd_efw_create_midi_devices.capture_ops = internal constant { %struct.snd_rawmidi_ops, [16 x i8] } { %struct.snd_rawmidi_ops { ptr @midi_open, ptr @midi_close, ptr @midi_capture_trigger, ptr null }, [16 x i8] zeroinitializer }, align 32
@snd_efw_create_midi_devices.playback_ops = internal constant { %struct.snd_rawmidi_ops, [16 x i8] } { %struct.snd_rawmidi_ops { ptr @midi_open, ptr @midi_close, ptr @midi_playback_trigger, ptr null }, [16 x i8] zeroinitializer }, align 32
...
@___asan_gen_.4 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 94, i32 38 }
@___asan_gen_.5 = private unnamed_addr constant [13 x i8] c"playback_ops\00", align 1
@___asan_gen_.7 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 99, i32 38 }
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 116, i32 4 }
@___asan_gen_.11 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.12 = private constant [45 x i8] c"../sound/firewire/fireworks/fireworks_midi.c\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 88, i32 5 }
@llvm.compiler.used = appending global [4 x ptr] [ptr @snd_efw_create_midi_devices.capture_ops, ptr @snd_efw_create_midi_devices.playback_ops, ptr @.str, ptr @.str.1], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @snd_efw_create_midi_devices.capture_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @snd_efw_create_midi_devices.playback_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 11, i32 32, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @snd_efw_create_midi_devices(ptr noundef %efw) local_unnamed_addr #0 align 64 {
entry:
  ...
  %midi_out_ports = getelementptr inbounds %struct.snd_efw, ptr %efw, i32 0, i32 11
  %3 = ptrtoint ptr %midi_out_ports to i32
  call void @__asan_load4_noabort(i32 %3)
  %4 = load i32, ptr %midi_out_ports, align 4
  %midi_in_ports = getelementptr inbounds %struct.snd_efw, ptr %efw, i32 0, i32 10
  %5 = ptrtoint ptr %midi_in_ports to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load i32, ptr %midi_in_ports, align 8
...
if.end:                                           ; preds = %entry
  ...
  %14 = ptrtoint ptr %midi_in_ports to i32
  call void @__asan_load4_noabort(i32 %14)
  %15 = load i32, ptr %midi_in_ports, align 8
...
if.then8:                                         ; preds = %if.end
  ...
  call void @snd_rawmidi_set_ops(ptr noundef %12, i32 noundef 1, ptr noundef nonnull @snd_efw_create_midi_devices.capture_ops) #4
...
for.body.i:                                       ; preds = %for.body.i.for.body.i_crit_edge, %if.then8.for.body.i_crit_edge
  ...
  %21 = ptrtoint ptr %efw to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load ptr, ptr %efw, align 8
...
if.end9:                                          ; preds = %for.body.i.if.end9_crit_edge, %if.then8.if.end9_crit_edge, %if.end.if.end9_crit_edge
  %26 = ptrtoint ptr %midi_out_ports to i32
  call void @__asan_load4_noabort(i32 %26)
  %27 = load i32, ptr %midi_out_ports, align 4
...
if.then12:                                        ; preds = %if.end9
  ...
  call void @snd_rawmidi_set_ops(ptr noundef %29, i32 noundef 0, ptr noundef nonnull @snd_efw_create_midi_devices.playback_ops) #4
...
for.body.i52:                                     ; preds = %for.body.i52.for.body.i52_crit_edge, %if.then12.for.body.i52_crit_edge
  ...
  %35 = ptrtoint ptr %efw to i32
  call void @__asan_load4_noabort(i32 %35)
  %36 = load ptr, ptr %efw, align 8
...
if.end17:                                         ; preds = %for.body.i52.if.end17_crit_edge, %if.then12.if.end17_crit_edge
  %40 = ptrtoint ptr %midi_out_ports to i32
  call void @__asan_load4_noabort(i32 %40)
  %.pr = load i32, ptr %midi_out_ports, align 4
...
land.lhs.true:                                    ; preds = %if.end17
  %41 = ptrtoint ptr %midi_in_ports to i32
  call void @__asan_load4_noabort(i32 %41)
  %42 = load i32, ptr %midi_in_ports, align 8
...
entry:
  ...
  %call = tail call i32 @snd_efw_stream_lock_try(ptr noundef %3) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call)
  %cmp = icmp slt i32 %call, 0
...
if.end:                                           ; preds = %entry
  %mutex = getelementptr inbounds %struct.snd_efw, ptr %3, i32 0, i32 3
  tail call void @mutex_lock_nested(ptr noundef %mutex, i32 noundef 0) #4
  %call1 = tail call i32 @snd_efw_stream_reserve_duplex(ptr noundef %3, i32 noundef 0, i32 noundef 0, i32 noundef 0) #4
...
if.then3:                                         ; preds = %if.end
  %substreams_counter = getelementptr inbounds %struct.snd_efw, ptr %3, i32 0, i32 19
  ...
  %call4 = tail call i32 @snd_efw_stream_start_duplex(ptr noundef %3) #4
...
if.then12:                                        ; preds = %if.then6, %if.end.if.then12_crit_edge
  ...
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  tail call void @snd_efw_stream_lock_release(ptr noundef %3) #4
  br label %end

end:                                              ; preds = %if.then12, %if.end9, %entry.end_crit_edge
  %err.1 = phi i32 [ %call, %entry.end_crit_edge ], [ %err.0.ph, %if.then12 ], [ %call4, %if.end9 ]
  ret i32 %err.1
}
...
entry:
  ...
  %dec = add i32 %5, -1
  store i32 %dec, ptr %substreams_counter, align 8
  tail call void @snd_efw_stream_stop_duplex(ptr noundef %3) #4
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  tail call void @snd_efw_stream_lock_release(ptr noundef %3) #4
  ret i32 0
}
...
entry:
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %private_data, align 4
  %lock = getelementptr inbounds %struct.snd_efw, ptr %3, i32 0, i32 4
  ...
  %tx_stream5 = getelementptr inbounds %struct.snd_efw, ptr %3, i32 0, i32 15
...
entry:
  ...
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %up)
  %tobool.not = icmp eq i32 %up, 0
  %rx_stream5 = getelementptr inbounds %struct.snd_efw, ptr %3, i32 0, i32 16
  %number6 = getelementptr inbounds %struct.snd_rawmidi_substream, ptr %substrm, i32 0, i32 2
  %4 = ptrtoint ptr %number6 to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load i32, ptr %number6, align 4
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_efw_stream_lock_try(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @mutex_lock_nested(ptr noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_efw_stream_reserve_duplex(ptr noundef, i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_efw_stream_start_duplex(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @mutex_unlock(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @snd_efw_stream_lock_release(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @snd_efw_stream_stop_duplex(ptr noundef) local_unnamed_addr #2
...
!0 = !{ptr @snd_efw_create_midi_devices.capture_ops, !1, !"capture_ops", i1 false, i1 false}
!1 = !{!"../sound/firewire/fireworks/fireworks_midi.c", i32 94, i32 38}
!2 = !{ptr @snd_efw_create_midi_devices.playback_ops, !3, !"playback_ops", i1 false, i1 false}
!3 = !{!"../sound/firewire/fireworks/fireworks_midi.c", i32 99, i32 38}
!4 = !{ptr @.str, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../sound/firewire/fireworks/fireworks_midi.c", i32 116, i32 4}
!6 = !{ptr @.str.1, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../sound/firewire/fireworks/fireworks_midi.c", i32 88, i32 5}
