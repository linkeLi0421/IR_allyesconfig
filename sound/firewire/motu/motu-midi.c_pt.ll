; ModuleID = '/llk/IR_all_yes/sound/firewire/motu/motu-midi.c_pt.bc'
source_filename = "../sound/firewire/motu/motu-midi.c"
...
@snd_motu_create_midi_devices.capture_ops = internal constant { %struct.snd_rawmidi_ops, [16 x i8] } { %struct.snd_rawmidi_ops { ptr @midi_open, ptr @midi_close, ptr @midi_capture_trigger, ptr null }, [16 x i8] zeroinitializer }, align 32
@snd_motu_create_midi_devices.playback_ops = internal constant { %struct.snd_rawmidi_ops, [16 x i8] } { %struct.snd_rawmidi_ops { ptr @midi_open, ptr @midi_close, ptr @midi_playback_trigger, ptr null }, [16 x i8] zeroinitializer }, align 32
...
@___asan_gen_.10 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 118, i32 4 }
@___asan_gen_.11 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.12 = private constant [35 x i8] c"../sound/firewire/motu/motu-midi.c\00", align 1
@___asan_gen_.13 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.12, i32 92, i32 5 }
@llvm.compiler.used = appending global [4 x ptr] [ptr @snd_motu_create_midi_devices.capture_ops, ptr @snd_motu_create_midi_devices.playback_ops, ptr @.str, ptr @.str.1], section "llvm.metadata"
@0 = internal global [4 x { i32, i32, i32, i32, i32, i32, i32, i32 }] [{ i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @snd_motu_create_midi_devices.capture_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.2 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.4 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @snd_motu_create_midi_devices.playback_ops to i32), i32 16, i32 32, i32 ptrtoint (ptr @___asan_gen_.5 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.7 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str to i32), i32 8, i32 32, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.10 to i32), i32 -1 }, { i32, i32, i32, i32, i32, i32, i32, i32 } { i32 ptrtoint (ptr @.str.1 to i32), i32 11, i32 32, i32 ptrtoint (ptr @___asan_gen_.11 to i32), i32 ptrtoint (ptr @___asan_gen_.12 to i32), i32 0, i32 ptrtoint (ptr @___asan_gen_.13 to i32), i32 -1 }]
@llvm.used = appending global [2 x ptr] [ptr @asan.module_ctor, ptr @asan.module_dtor], section "llvm.metadata"
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_ctor, ptr null }]
@llvm.global_dtors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @asan.module_dtor, ptr null }]

; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define dso_local i32 @snd_motu_create_midi_devices(ptr noundef %motu) local_unnamed_addr #0 align 64 {
entry:
  ...
  %call = call i32 @snd_rawmidi_new(ptr noundef %2, ptr noundef %driver, i32 noundef 0, i32 noundef 1, i32 noundef 1, ptr noundef nonnull %rmidi) #4
...
if.end:                                           ; preds = %entry
  ...
  %shortname = getelementptr inbounds %struct.snd_card, ptr %6, i32 0, i32 3
  ...
  %info_flags = getelementptr inbounds %struct.snd_rawmidi, ptr %8, i32 0, i32 3
  %10 = ptrtoint ptr %info_flags to i32
  call void @__asan_load4_noabort(i32 %10)
  %11 = load i32, ptr %info_flags, align 8
  %or = or i32 %11, 7
  store i32 %or, ptr %info_flags, align 8
  call void @snd_rawmidi_set_ops(ptr noundef %8, i32 noundef 1, ptr noundef nonnull @snd_motu_create_midi_devices.capture_ops) #4
  %12 = ptrtoint ptr %rmidi to i32
  call void @__asan_load4_noabort(i32 %12)
  %13 = load ptr, ptr %rmidi, align 4
  %substreams.i = getelementptr %struct.snd_rawmidi, ptr %13, i32 0, i32 8, i32 1, i32 2
  %14 = ptrtoint ptr %substreams.i to i32
...
for.body.i:                                       ; preds = %for.body.i.for.body.i_crit_edge, %if.end.for.body.i_crit_edge
  %subs.014.i = phi ptr [ %subs.0.i, %for.body.i.for.body.i_crit_edge ], [ %subs.012.i, %if.end.for.body.i_crit_edge ]
  %name.i = getelementptr inbounds %struct.snd_rawmidi_substream, ptr %subs.014.i, i32 0, i32 12
  %15 = ptrtoint ptr %motu to i32
  call void @__asan_load4_noabort(i32 %15)
  %16 = load ptr, ptr %motu, align 8
  %shortname.i = getelementptr inbounds %struct.snd_card, ptr %16, i32 0, i32 3
  ...
  %19 = ptrtoint ptr %subs.014.i to i32
...
set_midi_substream_names.exit:                    ; preds = %for.body.i.set_midi_substream_names.exit_crit_edge, %if.end.set_midi_substream_names.exit_crit_edge
  ...
  call void @snd_rawmidi_set_ops(ptr noundef %21, i32 noundef 0, ptr noundef nonnull @snd_motu_create_midi_devices.playback_ops) #4
  %22 = ptrtoint ptr %rmidi to i32
  call void @__asan_load4_noabort(i32 %22)
  %23 = load ptr, ptr %rmidi, align 4
  %substreams.i17 = getelementptr inbounds %struct.snd_rawmidi, ptr %23, i32 0, i32 8, i32 0, i32 2
  %24 = ptrtoint ptr %substreams.i17 to i32
  call void @__asan_load4_noabort(i32 %24)
  %subs.012.i18 = load ptr, ptr %substreams.i17, align 4
  %cmp.not13.i19 = icmp eq ptr %subs.012.i18, %substreams.i17
  br i1 %cmp.not13.i19, label %set_midi_substream_names.exit.cleanup_crit_edge, label %set_midi_substream_names.exit.for.body.i28_crit_edge

set_midi_substream_names.exit.for.body.i28_crit_edge: ; preds = %set_midi_substream_names.exit
  br label %for.body.i28

set_midi_substream_names.exit.cleanup_crit_edge:  ; preds = %set_midi_substream_names.exit
  call void @__sanitizer_cov_trace_pc() #6
  br label %cleanup

for.body.i28:                                     ; preds = %for.body.i28.for.body.i28_crit_edge, %set_midi_substream_names.exit.for.body.i28_crit_edge
  %subs.014.i20 = phi ptr [ %subs.0.i26, %for.body.i28.for.body.i28_crit_edge ], [ %subs.012.i18, %set_midi_substream_names.exit.for.body.i28_crit_edge ]
  %name.i21 = getelementptr inbounds %struct.snd_rawmidi_substream, ptr %subs.014.i20, i32 0, i32 12
  %25 = ptrtoint ptr %motu to i32
  call void @__asan_load4_noabort(i32 %25)
  %26 = load ptr, ptr %motu, align 8
  %shortname.i22 = getelementptr inbounds %struct.snd_card, ptr %26, i32 0, i32 3
  %number.i23 = getelementptr inbounds %struct.snd_rawmidi_substream, ptr %subs.014.i20, i32 0, i32 2
  %27 = ptrtoint ptr %number.i23 to i32
  call void @__asan_load4_noabort(i32 %27)
  %28 = load i32, ptr %number.i23, align 4
  %add.i24 = add i32 %28, 1
  %call.i25 = call i32 (ptr, i32, ptr, ...) @snprintf(ptr noundef %name.i21, i32 noundef 32, ptr noundef nonnull @.str.1, ptr noundef %shortname.i22, i32 noundef %add.i24) #4
  %29 = ptrtoint ptr %subs.014.i20 to i32
  call void @__asan_load4_noabort(i32 %29)
  %subs.0.i26 = load ptr, ptr %subs.014.i20, align 4
  %cmp.not.i27 = icmp eq ptr %subs.0.i26, %substreams.i17
  br i1 %cmp.not.i27, label %for.body.i28.cleanup_crit_edge, label %for.body.i28.for.body.i28_crit_edge

for.body.i28.for.body.i28_crit_edge:              ; preds = %for.body.i28
  call void @__sanitizer_cov_trace_pc() #6
  br label %for.body.i28

for.body.i28.cleanup_crit_edge:                   ; preds = %for.body.i28
  call void @__sanitizer_cov_trace_pc() #6
  br label %cleanup

cleanup:                                          ; preds = %for.body.i28.cleanup_crit_edge, %set_midi_substream_names.exit.cleanup_crit_edge, %entry.cleanup_crit_edge
  %retval.0 = phi i32 [ %call, %entry.cleanup_crit_edge ], [ 0, %set_midi_substream_names.exit.cleanup_crit_edge ], [ 0, %for.body.i28.cleanup_crit_edge ]
...
entry:
  ...
  %call = tail call i32 @snd_motu_stream_lock_try(ptr noundef %3) #4
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %call)
  %cmp = icmp slt i32 %call, 0
  br i1 %cmp, label %entry.cleanup_crit_edge, label %if.end
...
if.end:                                           ; preds = %entry
  %mutex = getelementptr inbounds %struct.snd_motu, ptr %3, i32 0, i32 2
  tail call void @mutex_lock_nested(ptr noundef %mutex, i32 noundef 0) #4
  %call1 = tail call i32 @snd_motu_stream_reserve_duplex(ptr noundef %3, i32 noundef 0, i32 noundef 0, i32 noundef 0) #4
...
if.then3:                                         ; preds = %if.end
  %substreams_counter = getelementptr inbounds %struct.snd_motu, ptr %3, i32 0, i32 11
  ...
  %call4 = tail call i32 @snd_motu_stream_start_duplex(ptr noundef %3) #4
...
if.then12:                                        ; preds = %if.then6, %if.end.if.then12_crit_edge
  ...
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  tail call void @snd_motu_stream_lock_release(ptr noundef %3) #4
  br label %cleanup
...
entry:
  ...
  %dec = add i32 %5, -1
  store i32 %dec, ptr %substreams_counter, align 8
  tail call void @snd_motu_stream_stop_duplex(ptr noundef %3) #4
  tail call void @mutex_unlock(ptr noundef %mutex) #4
  tail call void @snd_motu_stream_lock_release(ptr noundef %3) #4
  ret i32 0
}
...
entry:
  ...
  call void @__asan_load4_noabort(i32 %2)
  %3 = load ptr, ptr %private_data, align 4
  %lock = getelementptr inbounds %struct.snd_motu, ptr %3, i32 0, i32 3
  ...
  %tx_stream5 = getelementptr inbounds %struct.snd_motu, ptr %3, i32 0, i32 7
  ...
  tail call void @amdtp_motu_midi_trigger(ptr noundef %tx_stream5, i32 noundef %5, ptr noundef %.substrm) #4
...
entry:
  ...
  call void @__sanitizer_cov_trace_const_cmp4(i32 0, i32 %up)
  %tobool.not = icmp eq i32 %up, 0
  %rx_stream5 = getelementptr inbounds %struct.snd_motu, ptr %3, i32 0, i32 8
  %number6 = getelementptr inbounds %struct.snd_rawmidi_substream, ptr %substrm, i32 0, i32 2
  %4 = ptrtoint ptr %number6 to i32
  call void @__asan_load4_noabort(i32 %4)
  %5 = load i32, ptr %number6, align 4
  %.substrm = select i1 %tobool.not, ptr null, ptr %substrm
  tail call void @amdtp_motu_midi_trigger(ptr noundef %rx_stream5, i32 noundef %5, ptr noundef %.substrm) #4
  tail call void @_raw_spin_unlock_irqrestore(ptr noundef %lock, i32 noundef %call2) #4
  ret void
}
...
; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_motu_stream_lock_try(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @mutex_lock_nested(ptr noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_motu_stream_reserve_duplex(ptr noundef, i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @snd_motu_stream_start_duplex(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @mutex_unlock(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @snd_motu_stream_lock_release(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local void @snd_motu_stream_stop_duplex(ptr noundef) local_unnamed_addr #2

; Function Attrs: null_pointer_is_valid
declare dso_local i32 @_raw_spin_lock_irqsave(ptr noundef) local_unnamed_addr #2 section ".spinlock.text"

; Function Attrs: null_pointer_is_valid
declare dso_local void @amdtp_motu_midi_trigger(ptr noundef, i32 noundef, ptr noundef) local_unnamed_addr #2
...
!0 = !{ptr @snd_motu_create_midi_devices.capture_ops, !1, !"capture_ops", i1 false, i1 false}
!1 = !{!"../sound/firewire/motu/motu-midi.c", i32 98, i32 38}
!2 = !{ptr @snd_motu_create_midi_devices.playback_ops, !3, !"playback_ops", i1 false, i1 false}
!3 = !{!"../sound/firewire/motu/motu-midi.c", i32 103, i32 38}
!4 = !{ptr @.str, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../sound/firewire/motu/motu-midi.c", i32 118, i32 4}
!6 = !{ptr @.str.1, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../sound/firewire/motu/motu-midi.c", i32 92, i32 5}
