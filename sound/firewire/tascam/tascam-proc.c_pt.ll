; ModuleID = '/llk/IR_all_yes/sound/firewire/tascam/tascam-proc.c_pt.bc'
source_filename = "../sound/firewire/tascam/tascam-proc.c"
...
@.str.2 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"Register: %d (0x%08x)\0A\00", [41 x i8] zeroinitializer }, align 32
@.str.3 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"FPGA:     %d (0x%08x)\0A\00", [41 x i8] zeroinitializer }, align 32
@.str.4 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"ARM:      %d (0x%08x)\0A\00", [41 x i8] zeroinitializer }, align 32
@.str.5 = internal constant { [23 x i8], [41 x i8] } { [23 x i8] c"Hardware: %d (0x%08x)\0A\00", [41 x i8] zeroinitializer }, align 32
@___asan_gen_.8 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 72, i32 48 }
@___asan_gen_.11 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 78, i32 23 }
@___asan_gen_.14 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 46, i32 2 }
@___asan_gen_.17 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 47, i32 2 }
@___asan_gen_.20 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 48, i32 2 }
@___asan_gen_.21 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.22 = private constant [39 x i8] c"../sound/firewire/tascam/tascam-proc.c\00", align 1
@___asan_gen_.23 = private unnamed_addr constant { ptr, i32, i32 } { ptr @___asan_gen_.22, i32 49, i32 2 }
...
if.end:                                           ; preds = %entry
  ...
  %5 = ptrtoint ptr %tscm to i32
  call void @__asan_load4_noabort(i32 %5)
  %6 = load ptr, ptr %tscm, align 8
...
; Function Attrs: nounwind null_pointer_is_valid sanitize_address sspstrong uwtable(sync)
define internal void @proc_read_firmware(ptr nocapture noundef readonly %entry1, ptr nocapture noundef readonly %buffer) #0 align 64 {
entry:
  ...
  store i32 -1, ptr %data, align 4, !annotation !21
  ...
  %call = call i32 @snd_fw_transaction(ptr noundef %4, i32 noundef 4, i64 noundef 281470681743360, ptr noundef nonnull %data, i32 noundef 4, i32 noundef 0) #3
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @snd_fw_transaction(ptr noundef %8, i32 noundef 4, i64 noundef 281470681743364, ptr noundef nonnull %data, i32 noundef 4, i32 noundef 0) #3
...
if.end6:                                          ; preds = %if.end
  ...
  %call8 = call i32 @snd_fw_transaction(ptr noundef %12, i32 noundef 4, i64 noundef 281470681743368, ptr noundef nonnull %data, i32 noundef 4, i32 noundef 0) #3
...
if.end11:                                         ; preds = %if.end6
  ...
  %call13 = call i32 @snd_fw_transaction(ptr noundef %16, i32 noundef 4, i64 noundef 281470681743372, ptr noundef nonnull %data, i32 noundef 4, i32 noundef 0) #3
...
if.end16:                                         ; preds = %if.end11
  ...
  %and = and i32 %6, 65535
  call void (ptr, ptr, ...) @seq_printf(ptr noundef %20, ptr noundef nonnull @.str.2, i32 noundef %and, i32 noundef %6) #3
  %21 = ptrtoint ptr %buffer to i32
  call void @__asan_load4_noabort(i32 %21)
  %22 = load ptr, ptr %buffer, align 4
  %and19 = and i32 %10, 65535
  call void (ptr, ptr, ...) @seq_printf(ptr noundef %22, ptr noundef nonnull @.str.3, i32 noundef %and19, i32 noundef %10) #3
  %23 = ptrtoint ptr %buffer to i32
  call void @__asan_load4_noabort(i32 %23)
  %24 = load ptr, ptr %buffer, align 4
  %and21 = and i32 %14, 65535
  call void (ptr, ptr, ...) @seq_printf(ptr noundef %24, ptr noundef nonnull @.str.4, i32 noundef %and21, i32 noundef %14) #3
  %25 = ptrtoint ptr %buffer to i32
  call void @__asan_load4_noabort(i32 %25)
  %26 = load ptr, ptr %buffer, align 4
  %shr = lshr i32 %18, 16
  call void (ptr, ptr, ...) @seq_printf(ptr noundef %26, ptr noundef nonnull @.str.5, i32 noundef %shr, i32 noundef %18) #3
  br label %cleanup
...
!1 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 72, i32 48}
!2 = !{ptr @.str.1, !3, !"<string literal>", i1 false, i1 false}
!3 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 78, i32 23}
!4 = !{ptr @.str.2, !5, !"<string literal>", i1 false, i1 false}
!5 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 46, i32 2}
!6 = !{ptr @.str.3, !7, !"<string literal>", i1 false, i1 false}
!7 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 47, i32 2}
!8 = !{ptr @.str.4, !9, !"<string literal>", i1 false, i1 false}
!9 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 48, i32 2}
!10 = !{ptr @.str.5, !11, !"<string literal>", i1 false, i1 false}
!11 = !{!"../sound/firewire/tascam/tascam-proc.c", i32 49, i32 2}
